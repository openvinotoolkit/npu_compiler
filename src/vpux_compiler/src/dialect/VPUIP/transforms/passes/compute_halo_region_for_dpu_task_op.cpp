...
class ComputeHaloRegionForDPUTaskOpPass final :
        public VPUIP::impl::ComputeHaloRegionForDPUTaskOpBase<ComputeHaloRegionForDPUTaskOpPass> {
public:
    explicit ComputeHaloRegionForDPUTaskOpPass(Logger log) {
...
std::unique_ptr<mlir::Pass> vpux::VPUIP::createComputeHaloRegionForDPUTaskOpPass(Logger log) {
