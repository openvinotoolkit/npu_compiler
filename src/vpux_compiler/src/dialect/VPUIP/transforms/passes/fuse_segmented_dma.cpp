...
class FuseSegmentedDma final : public VPUIP::impl::FuseSegmentedDMABase<FuseSegmentedDma> {
public:
...
std::unique_ptr<mlir::Pass> vpux::VPUIP::createFuseSegmentedDmaPass(Logger log) {
