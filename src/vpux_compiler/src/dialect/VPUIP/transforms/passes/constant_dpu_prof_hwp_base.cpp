...
class ConstantDpuProfHwpBasePass final : public VPUIP::impl::ConstantDpuProfHwpBaseBase<ConstantDpuProfHwpBasePass> {
public:
...
std::unique_ptr<mlir::Pass> vpux::VPUIP::createConstantDpuProfHwpBasePass(Logger log) {
