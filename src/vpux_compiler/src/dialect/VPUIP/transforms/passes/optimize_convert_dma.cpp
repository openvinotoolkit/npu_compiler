...
class OptimizeConvertDMAPass final : public VPUIP::impl::OptimizeConvertDMAOpBase<OptimizeConvertDMAPass> {
public:
...
std::unique_ptr<mlir::Pass> vpux::VPUIP::createOptimizeConvertDMAOpPass(Logger log) {
