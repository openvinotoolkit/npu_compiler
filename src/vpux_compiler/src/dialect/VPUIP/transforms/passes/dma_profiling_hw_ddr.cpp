...
class DMATaskProfilingHwDdrPass final : public VPUIP::impl::DMATaskProfilingHwDdrBase<DMATaskProfilingHwDdrPass> {
public:
...
std::unique_ptr<mlir::Pass> vpux::VPUIP::createDMATaskProfilingHwDdrPass(const std::string& enableDMAProfiling,
                                                                         Logger log) {
