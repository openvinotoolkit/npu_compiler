...
class ComputeTaskStrippingPass final : public VPUIP::impl::ComputeTaskStrippingBase<ComputeTaskStrippingPass> {
public:
...
std::unique_ptr<mlir::Pass> vpux::VPUIP::createComputeTaskStrippingPass(Logger log, VPU::DPUDryRunMode dpuDryRun,
