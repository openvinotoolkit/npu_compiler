...
class AddStartBarrierPass final : public VPUIP::impl::AddStartBarrierBase<AddStartBarrierPass> {
public:
...
std::unique_ptr<mlir::Pass> vpux::VPUIP::createAddStartBarrierPass(
