...
std::unique_ptr<IGreedilyPassStrategy> VPUIP::createUnrollDepthToSpaceDMAStrategy(mlir::func::FuncOp funcOp) {
    ...
    case config::ArchKind::NPU37XX:
        return std::make_unique<VPUIP::arch37xx::UnrollDepthToSpaceDMAStrategy>(dmaPortCount);
        break;
    default:
        return std::make_unique<VPUIP::arch40xx::UnrollDepthToSpaceDMAStrategy>(dmaPortCount);
        break;
    }
}
