...
vpux::VPU::DistributionInfo vpux::VPU::RoundOp::getExplicitDistributionInfoAttr(
...
mlir::LogicalResult vpux::VPU::RoundOp::reifyResultShapes(mlir::OpBuilder& builder,
