...
mlir::LogicalResult vpux::VPU::ReduceSumOp::reifyResultShapes(mlir::OpBuilder& builder,
...
vpux::VPU::DistributionInfo vpux::VPU::ReduceSumOp::getExplicitDistributionInfoAttr(
