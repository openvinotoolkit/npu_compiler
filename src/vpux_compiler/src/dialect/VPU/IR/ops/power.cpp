...
mlir::LogicalResult vpux::VPU::PowerOp::inferReturnTypes(mlir::MLIRContext* ctx, std::optional<mlir::Location> optLoc,
    ...
    return inferEltwiseReturnTypes(inferredReturnTypes, loc, power.getInput1(), power.getInput2(),
                                   power.getAutoBroadcast());
}
...
bool vpux::VPU::PowerOp::checkStrategyCompatibility(VPU::MultiClusterStrategy strategy, size_t) {
...
vpux::VPU::DistributionInfo vpux::VPU::PowerOp::getExplicitDistributionInfoAttr(
