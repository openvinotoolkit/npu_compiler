...
mlir::LogicalResult vpux::VPU::ClampOp::inferReturnTypes(mlir::MLIRContext* ctx, std::optional<mlir::Location> optLoc,
    ...
    VPU::ClampOpAdaptor clamp(operands, attrs, prop);
...
bool vpux::VPU::ClampOp::checkStrategyCompatibility(VPU::MultiClusterStrategy strategy, size_t) {
...
vpux::VPU::DistributionInfo vpux::VPU::ClampOp::getExplicitDistributionInfoAttr(
