...
mlir::LogicalResult vpux::VPU::GreaterOp::inferReturnTypes(mlir::MLIRContext* ctx, std::optional<mlir::Location> optLoc,
    ...
    return inferEltwiseReturnTypes(inferredReturnTypes, loc, greater.getInput1(), greater.getInput2(),
                                   greater.getAutoBroadcast(), getBool8Type(ctx));
}
...
vpux::VPU::DistributionInfo vpux::VPU::GreaterOp::getExplicitDistributionInfoAttr(
...
bool vpux::VPU::GreaterOp::isOperationSplitOverHeightCompatible(const vpux::TileInfo& outputTile) {
    return VPU::isEltwiseSWOpSplitOverHeightCompatible(getOperation(), outputTile.shape);
}

bool vpux::VPU::GreaterOp::isOperationSplitOverWidthCompatible(ShapeRef outputShape, ShapeRef /*offset*/,
                                                               ShapeRef /*axis*/) {
