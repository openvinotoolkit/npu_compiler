...
mlir::LogicalResult vpux::VPU::ReduceMeanOp::reifyResultShapes(mlir::OpBuilder& builder,
...
vpux::VPU::DistributionInfo vpux::VPU::ReduceMeanOp::getExplicitDistributionInfoAttr(
...
SmallVector<int64_t> vpux::VPU::ReduceMeanOp::getMaxNumTiles() {
