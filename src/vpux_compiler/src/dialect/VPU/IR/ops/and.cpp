...
mlir::LogicalResult vpux::VPU::AndOp::inferReturnTypes(mlir::MLIRContext* ctx, std::optional<mlir::Location> optLoc,
    ...
    const auto in1Type = mlir::cast<vpux::NDTypeInterface>(logicalAnd.getInput1().getType());
    const auto in2Type = mlir::cast<vpux::NDTypeInterface>(logicalAnd.getInput2().getType());
...
vpux::VPU::DistributionInfo vpux::VPU::AndOp::getExplicitDistributionInfoAttr(
