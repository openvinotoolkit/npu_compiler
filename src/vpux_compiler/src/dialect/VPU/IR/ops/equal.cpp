...
mlir::LogicalResult vpux::VPU::EqualOp::inferReturnTypes(mlir::MLIRContext* ctx, std::optional<mlir::Location> optLoc,
    ...
    return inferEltwiseReturnTypes(inferredReturnTypes, loc, equal.getInput1(), equal.getInput2(),
                                   equal.getAutoBroadcast(), getBool8Type(ctx));
}
...
vpux::VPU::DistributionInfo vpux::VPU::EqualOp::getExplicitDistributionInfoAttr(
