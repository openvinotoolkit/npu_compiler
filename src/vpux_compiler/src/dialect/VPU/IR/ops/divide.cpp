...
mlir::LogicalResult vpux::VPU::DivideOp::inferReturnTypes(mlir::MLIRContext* ctx, std::optional<mlir::Location> optLoc,
    ...
    VPU::DivideOpAdaptor divide(operands, attrs, prop);
...
bool vpux::VPU::DivideOp::checkStrategyCompatibility(VPU::MultiClusterStrategy strategy, size_t) {
...
bool vpux::VPU::DivideOp::isOperationSplitOverHeightCompatible(const vpux::TileInfo& outputTile) {
    return VPU::isEltwiseSWOpSplitOverHeightCompatible(getOperation(), outputTile.shape);
}

bool vpux::VPU::DivideOp::isOperationSplitOverWidthCompatible(ShapeRef outputShape, ShapeRef /*offset*/,
                                                              ShapeRef /*axis*/) {
