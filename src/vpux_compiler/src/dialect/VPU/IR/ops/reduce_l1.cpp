...
mlir::LogicalResult vpux::VPU::ReduceL1Op::inferReturnTypes(mlir::MLIRContext* ctx,
    ...
    VPU::ReduceL1OpAdaptor reduceL1(operands, attrs, prop);
...
mlir::LogicalResult vpux::VPU::ReduceL1Op::reifyResultShapes(mlir::OpBuilder& builder,
...
bool vpux::VPU::ReduceL1Op::fitIntoCMX(llvm::ArrayRef<vpux::NDTypeInterface> buffers) {
    return fitIntoCMXReduce(getOperation(), buffers);
}

bool vpux::VPU::ReduceL1Op::supportCycleCostCalculation() {
    return false;
}
...
void vpux::VPU::ReduceL1Op::adjustAttrs(const TilingInfo& /*inputTiling*/, const TileInfo& /*outputTile*/) {
}

mlir::FailureOr<OutputTiling> vpux::VPU::ReduceL1Op::getTilingStrategy(TilingMode tilingMode, Logger log) {
    return vpux::getSWLayerTilingStrategy(getOperation(), tilingMode, log);
}

SmallVector<int64_t> vpux::VPU::ReduceL1Op::getMaxNumTiles() {
...
void vpux::VPU::ReduceL1Op::build(::mlir::OpBuilder& builder, ::mlir::OperationState& state, ::mlir::Value input,
