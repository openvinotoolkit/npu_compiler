...
void vpux::IE::registerMergeWeightsSharedConvRewriters(RewriterRegistry& registry, Logger log) {
    registry.registerRewriter<MergeWeightsSharedConv>("merge-weights-shared-conv", log);
}
