...
mlir::LogicalResult SplitConvToMultiConvWithAddConverter::matchAndRewrite(IE::ConvolutionOp origOp,
...
void vpux::IE::registerConvertLargeConvToMultiConvWithAddRewriters(RewriterRegistry& registry, Logger log) {
    registry.registerRewriter<SplitConvToMultiConvWithAddConverter>("convert-large-conv-to-multi-conv-with-add", log);
}
