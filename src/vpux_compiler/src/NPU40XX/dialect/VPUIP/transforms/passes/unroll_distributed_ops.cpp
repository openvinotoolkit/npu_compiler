...
class UnrollDistributedOpsPass final :
        public VPUIP::arch40xx::impl::UnrollDistributedOpsBase<UnrollDistributedOpsPass> {
public:
    explicit UnrollDistributedOpsPass(Logger log, bool enableSegmentedDmaFusion)
...
private:
    ...
    bool _enableSegmentedDmaFusion;
};
...
void UnrollDistributedOpsPass::safeRunOnFunc() {
    ...
    VPUIP::unrollDistributedOpsCommon40XXPlus(func, std::move(dmaFusionHandler), _log);
...
std::unique_ptr<mlir::Pass> vpux::VPUIP::arch40xx::createUnrollDistributedOpsPass(Logger log,
                                                                                  bool enableSegmentedDmaFusion) {
