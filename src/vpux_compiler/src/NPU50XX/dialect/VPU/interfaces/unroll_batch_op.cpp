...
void vpux::VPU::arch50xx::registerUnrollBatchOpInterfaces(mlir::DialectRegistry& registry) {
    registry.addExtension(+[](mlir::MLIRContext* ctx, IE::IEDialect*) {
        ...
        IE::SubtractOp::attachInterface<UnrollBatchEltwiseOpModel<IE::SubtractOp>>(*ctx);
