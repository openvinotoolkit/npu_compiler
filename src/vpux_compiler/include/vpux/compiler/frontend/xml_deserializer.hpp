...
/**
 * @brief Deserializes a model from the legacy binary format (all weights copied into the buffer).
 * @throws InvalidIrError on version mismatch or malformed input.
 */
