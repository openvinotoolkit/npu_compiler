...
public:
    ...
    NetworkDescriptionView compile(const std::shared_ptr<ov::Model>& model, const intel_npu::Config& config,
                                   BlobAllocator& allocator, bool allocateCompatibilityString = false) const override;
    ...
    ov::SupportedOpsMap queryFromDesc(const vcl_query_desc_t& desc, vcl_compiler_desc_t& compilerDesc,
                                      ...
                                      intel_npu::Config& config, bool isDeviceDescEmpty) const final;
    ...
    NetworkDescriptionView compileFromDesc(const vcl_executable_desc_t& desc,
                                           ...
                                           vcl_compiler_desc_t& compilerDesc, vcl_device_desc_t& deviceDesc,
                                           intel_npu::Config& config, bool isDeviceDescEmpty, BlobAllocator& allocator,
                                           bool generateCompatibilityString = false) const final;
