...
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(EmbeddingBagPackedSumLayerTest);
...
TEST_P(EmbeddingBagPackedSumLayerTestCommon, NPU5010_SW) {
    setReferenceSoftwareMode();
    run(Platform::NPU5010);
}
TEST_P(EmbeddingBagPackedSumLayerTestCommon, NPU5020_SW) {
    setReferenceSoftwareMode();
