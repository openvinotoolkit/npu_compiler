...
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(ConcatLayerTest);
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(ConcatStringLayerTest);
...
TEST_P(ConcatLayerTestCommon, NPU5020_HW) {
    setDefaultHardwareMode();
