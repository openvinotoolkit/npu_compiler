...
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(ExtractImagePatchesTest);
...
TEST_P(ExtractImagePatchesLayerTestCommon, NPU5010_SW) {
    setReferenceSoftwareMode();
    run(Platform::NPU5010);
}

TEST_P(ExtractImagePatchesLayerTestCommon, NPU5020_SW) {
    setReferenceSoftwareMode();
