...
// CHECK:    bytecode.string @function_name "fn"
// CHECK:    bytecode.string @assert_msg "Assertion failed"
// CHECK:  }
// CHECK:  bytecode.type_section @type_section {
// CHECK:    bytecode.type @function_type #bytecode.function_type<arguments = [], results = []>
// CHECK:  }
// CHECK:  bytecode.func_section @func_section {
// CHECK:    bytecode.func @fn @string_section::@function_name @type_section::@function_type {
// CHECK:      [[REG:%.+]] = bytecode.virtual_general_register
// CHECK:      bytecode.set_imm [[REG]], 0
// CHECK:      bytecode.assert [[REG]], @assert_msg
// CHECK:      bytecode.ret
// CHECK:    }
// CHECK:  }
...
// CHECK:  bytecode.string_section @string_section {
// CHECK:    bytecode.string @function_name "add"
// CHECK:  }
// CHECK:  bytecode.type_section @type_section {
// CHECK:    bytecode.type @i64 #bytecode.integer_type<width = 64, is_signed = true>
// CHECK:    bytecode.type @function_type #bytecode.function_type<arguments = [@i64, @i64], results = [@i64]>
// CHECK:  }
// CHECK:  bytecode.func_section @func_section {
// CHECK:    bytecode.func @add @string_section::@function_name @type_section::@function_type {
// CHECK:      [[REG:%.+]] = bytecode.virtual_general_register
...
// CHECK:  bytecode.type_section @type_section {
// CHECK:    bytecode.type @i64 #bytecode.integer_type<width = 64, is_signed = true>
// CHECK:    bytecode.type @function_type #bytecode.function_type<arguments = [@i64], results = [@i64]>
// CHECK:  }
...
// CHECK:    bytecode.type @buffer_type #bytecode.buffer_type<element_type = @f32, rank = 3, shape = [2, 3, 4]
// CHECK-SAME: strides = [12, 4, 1]>
// CHECK:    bytecode.type @function_type #bytecode.function_type<arguments = [@buffer_type], results = []>
// CHECK:  }
...
// CHECK:    bytecode.type @function_type #bytecode.function_type<arguments = [@f8_e4m3], results = []>
// CHECK:  }
...
// CHECK:    bytecode.type @function_type #bytecode.function_type<arguments = [@f8_e5m2], results = []>
// CHECK:  }
...
// CHECK:  bytecode.type_section @type_section {
// CHECK:    bytecode.type @i64 #bytecode.integer_type<width = 64, is_signed = true>
// CHECK:    bytecode.type @buffer_type #bytecode.buffer_type<element_type = @i64, rank = 4, shape = [1, 16, 32, 32]
...
bytecode.func_section @func_section {
  ...
  bytecode.ext.func @caller_buf (memref<2x3xf32>) -> () {
    ...
    bytecode.set_imm_idx %func_idx, @func_section::@callee_buf
...
// CHECK:  bytecode.string_section @string_section {
// CHECK:    bytecode.string @function_name "callee_buf"
// CHECK:    bytecode.string @function_name_1 "caller_buf"
// CHECK:  }
// CHECK:  bytecode.type_section @type_section {
// CHECK:    bytecode.type @f32 #bytecode.float_type<width = 32, format = IEEE754>
// CHECK:    bytecode.type @buffer_type #bytecode.buffer_type<element_type = @f32, rank = 2, shape = [2, 3]
// CHECK-SAME: strides = [3, 1]>
// CHECK:    bytecode.type @function_type #bytecode.function_type<arguments = [@buffer_type], results = []>
// CHECK:  }
// CHECK:  bytecode.func_section @func_section {
// CHECK:    bytecode.func @callee_buf @string_section::@function_name @type_section::@function_type {
// CHECK:      bytecode.ret
// CHECK:    }
// CHECK:    bytecode.func @caller_buf @string_section::@function_name_1 @type_section::@function_type {
// CHECK:      [[BUF:%.+]] = bytecode.virtual_parameter_register 0
// CHECK:      [[FUNC_IDX:%.+]] = bytecode.virtual_general_register
// CHECK:      bytecode.set_imm_idx [[FUNC_IDX]], @func_section::@callee_buf
...
// CHECK:        [[S0:%.+]] = bytecode.imm_register 2
// CHECK:        [[S1:%.+]] = bytecode.imm_register 3
// CHECK:        [[ST0:%.+]] = bytecode.imm_register 3
// CHECK:        [[ST1:%.+]] = bytecode.imm_register 1
// CHECK:        bytecode.buffer.create [[DST]], @type_section::@f32 shape([[S0]], [[S1]]) strides([[ST0]], [[ST1]])
// CHECK:        bytecode.ret
...
// CHECK:    bytecode.string @function_name "alloc_fn"
// CHECK:  }
// CHECK:  bytecode.type_section @type_section {
// CHECK:    bytecode.type @type_f16 #bytecode.float_type<width = 16, format = IEEE754>
// CHECK:    bytecode.type @function_type #bytecode.function_type<arguments = [], results = []>
// CHECK:    bytecode.type @f32 #bytecode.float_type<width = 32, format = IEEE754>
// CHECK:    bytecode.type @buffer_type #bytecode.buffer_type<element_type = @f32, rank = 2, shape = [2, 3], strides = [3, 1]>
// CHECK:  }
