...
module @TestConvolution {
  ...
  func.func @main(%arg0: memref<1x16x16x16xf16, @DDR>, %arg1: memref<1x16x14x14xf16, @DDR>) -> memref<1x16x14x14xf16, @DDR> {
    ...
    input(%6 : memref<1x16x16x16xf16, {order = #NHWC}, [@CMX_NN, 0]>) weights(%6 : memref<1x16x16x16xf16, {order = #NHWC}, [@CMX_NN, 0]>) outputs(%3 : memref<1x16x16x16xf16, {order = #NWCH}, [@CMX_NN, 0]>)
    waits(%10 : !VPURegMapped.Index<0:0:0>) updates(%11 : !VPURegMapped.Index<0:0:1>) -> <0:0:0> PPE : {
    }
    ...
    previousTask(%17 : !VPURegMapped.Index<0:0:0>) input(%7 : memref<1x16x16x16xf16, {order = #NHWC}, [@CMX_NN, 0]>) weights(%9 : memref<16x16x3x3xf16, {order = #NHWC}, [@CMX_NN, 0]>)
    weight_table(%8 : memref<16x1x1x4xsi32, [@CMX_NN, 0]>) outputs(%4 : memref<1x16x14x14xf16, [@CMX_NN, 0]>) waits(%11 : !VPURegMapped.Index<0:0:1>)
    updates(%12 : !VPURegMapped.Index<0:0:2>) -> <0:0:1> PPE : {
    }
    %19 = VPUMI40XX.DPUVariant calls(%17 : <0:0:0>) weights(%6 : memref<1x16x16x16xf16, {order = #NHWC}, [@CMX_NN, 0]>) <{end = [15, 15, 15], inEnd = [15, 15, 15], inStart = [0, 0, 0], mpe_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<ELTWISE>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, start = [0, 0, 0]}> -> <0:0:0>
...
module @Convolution attributes {config.compilationMode = #config.compilation_mode<DefaultHW>} {
  ...
  func.func @main(%arg0: memref<1x32x16x16xf16, @DDR>, %arg1: memref<1x32x14x14xf16, @DDR>) -> memref<1x32x14x14xf16, @DDR> {
    ...
    %32 = VPURT.DeclareBuffer <CMX_NN> [0] <24576> -> memref<1x16x32x3xf16, {order = #NHWC}, [@CMX_NN, 0]>
    %33 = VPURT.DeclareBuffer <CMX_NN> [1] <24576> -> memref<1x16x32x3xf16, {order = #NHWC}, [@CMX_NN, 1]>
    %34 = VPURT.DeclareBuffer <CMX_NN> [2] <24576> -> memref<1x16x32x3xf16, {order = #NHWC}, [@CMX_NN, 2]>
    %35 = VPURT.DeclareBuffer <CMX_NN> [3] <24576> -> memref<1x16x32x3xf16, {order = #NHWC}, [@CMX_NN, 3]>
    %36 = VPURT.DeclareBuffer <CMX_NN> [4] <24576> -> memref<1x16x32x2xf16, {order = #NHWC}, [@CMX_NN, 4]>
    %37 = VPURT.DeclareBuffer <CMX_NN> [5] <24576> -> memref<1x16x32x2xf16, {order = #NHWC}, [@CMX_NN, 5]>
    %38 = VPURT.DeclareBuffer <CMX_NN> [0] <24576> -> memref<1x16x32x3xf16, {order = #NHWC}, [@CMX_NN, 0]>
    %39 = VPURT.DeclareBuffer <CMX_NN> [1] <24576> -> memref<1x16x32x3xf16, {order = #NHWC}, [@CMX_NN, 1]>
    %40 = VPURT.DeclareBuffer <CMX_NN> [2] <24576> -> memref<1x16x32x3xf16, {order = #NHWC}, [@CMX_NN, 2]>
    %41 = VPURT.DeclareBuffer <CMX_NN> [3] <24576> -> memref<1x16x32x3xf16, {order = #NHWC}, [@CMX_NN, 3]>
    %42 = VPURT.DeclareBuffer <CMX_NN> [4] <24576> -> memref<1x16x32x2xf16, {order = #NHWC}, [@CMX_NN, 4]>
    %43 = VPURT.DeclareBuffer <CMX_NN> [5] <24576> -> memref<1x16x32x2xf16, {order = #NHWC}, [@CMX_NN, 5]>
    %44 = VPURT.DeclareBuffer <CMX_NN> [0] <19456> -> memref<1x32x5x16xf16, {order = #NHWC}, [@CMX_NN, 0]>
    %45 = VPURT.DeclareBuffer <CMX_NN> [1] <19456> -> memref<1x32x5x16xf16, {order = #NHWC}, [@CMX_NN, 1]>
    %46 = VPURT.DeclareBuffer <CMX_NN> [2] <19456> -> memref<1x32x4x16xf16, {order = #NHWC}, [@CMX_NN, 2]>
    %47 = VPURT.DeclareBuffer <CMX_NN> [3] <19456> -> memref<1x32x4x16xf16, {order = #NHWC}, [@CMX_NN, 3]>
    %48 = VPURT.DeclareBuffer <CMX_NN> [4] <19456> -> memref<1x32x4x16xf16, {order = #NHWC}, [@CMX_NN, 4]>
    %49 = VPURT.DeclareBuffer <CMX_NN> [5] <19456> -> memref<1x32x4x16xf16, {order = #NHWC}, [@CMX_NN, 5]>
    ...
    %56 = VPURT.DeclareBuffer <CMX_NN> [0] <1024> -> memref<32x32x3x3xf16, {order = #NHWC}, [@CMX_NN, 0]>
    %57 = VPURT.DeclareBuffer <CMX_NN> [1] <1024> -> memref<32x32x3x3xf16, {order = #NHWC}, [@CMX_NN, 1]>
    %58 = VPURT.DeclareBuffer <CMX_NN> [2] <1024> -> memref<32x32x3x3xf16, {order = #NHWC}, [@CMX_NN, 2]>
    %59 = VPURT.DeclareBuffer <CMX_NN> [3] <1024> -> memref<32x32x3x3xf16, {order = #NHWC}, [@CMX_NN, 3]>
    %60 = VPURT.DeclareBuffer <CMX_NN> [4] <1024> -> memref<32x32x3x3xf16, {order = #NHWC}, [@CMX_NN, 4]>
    %61 = VPURT.DeclareBuffer <CMX_NN> [5] <1024> -> memref<32x32x3x3xf16, {order = #NHWC}, [@CMX_NN, 5]>
    ...
    %97 = VPUMI40XX.DPUInvariant <{clean_after = 0 : ui64, mpe_frequent_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<ELTWISE>, start_after = 0 : ui64}> input(%38 : memref<1x16x32x3xf16, {order = #NHWC}, [@CMX_NN, 0]>) weights(%32 : memref<1x16x32x3xf16, {order = #NHWC}, [@CMX_NN, 0]>) outputs(%68 : memref<1x16x32x5xf16, {order = #NWCH}, [@CMX_NN, 0]>) waits(%76 : !VPURegMapped.Index<0:0:2>) updates(%77 : !VPURegMapped.Index<0:0:3>) -> <0:0:0> PPE : {}
    %98 = VPUMI40XX.DPUInvariant <{clean_after = 0 : ui64, mpe_frequent_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<ELTWISE>, start_after = 0 : ui64}> input(%39 : memref<1x16x32x3xf16, {order = #NHWC}, [@CMX_NN, 1]>) weights(%33 : memref<1x16x32x3xf16, {order = #NHWC}, [@CMX_NN, 1]>) outputs(%69 : memref<1x16x32x5xf16, {order = #NWCH}, [@CMX_NN, 1]>) waits(%76 : !VPURegMapped.Index<0:0:2>) updates(%77 : !VPURegMapped.Index<0:0:3>) -> <1:0:0> PPE : {}
    %99 = VPUMI40XX.DPUInvariant <{clean_after = 0 : ui64, mpe_frequent_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<ELTWISE>, start_after = 0 : ui64}> input(%40 : memref<1x16x32x3xf16, {order = #NHWC}, [@CMX_NN, 2]>) weights(%34 : memref<1x16x32x3xf16, {order = #NHWC}, [@CMX_NN, 2]>) outputs(%70 : memref<1x16x32x4xf16, {order = #NWCH}, [@CMX_NN, 2]>) waits(%76 : !VPURegMapped.Index<0:0:2>) updates(%77 : !VPURegMapped.Index<0:0:3>) -> <2:0:0> PPE : {}
    %100 = VPUMI40XX.DPUInvariant <{clean_after = 0 : ui64, mpe_frequent_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<ELTWISE>, start_after = 0 : ui64}> input(%41 : memref<1x16x32x3xf16, {order = #NHWC}, [@CMX_NN, 3]>) weights(%35 : memref<1x16x32x3xf16, {order = #NHWC}, [@CMX_NN, 3]>) outputs(%71 : memref<1x16x32x4xf16, {order = #NWCH}, [@CMX_NN, 3]>) waits(%76 : !VPURegMapped.Index<0:0:2>) updates(%77 : !VPURegMapped.Index<0:0:3>) -> <3:0:0> PPE : {}
    %101 = VPUMI40XX.DPUInvariant <{clean_after = 0 : ui64, mpe_frequent_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<ELTWISE>, start_after = 0 : ui64}> input(%42 : memref<1x16x32x2xf16, {order = #NHWC}, [@CMX_NN, 4]>) weights(%36 : memref<1x16x32x2xf16, {order = #NHWC}, [@CMX_NN, 4]>) outputs(%72 : memref<1x16x32x4xf16, {order = #NWCH}, [@CMX_NN, 4]>) waits(%76 : !VPURegMapped.Index<0:0:2>) updates(%77 : !VPURegMapped.Index<0:0:3>) -> <4:0:0> PPE : {
    }
    %102 = VPUMI40XX.DPUInvariant <{clean_after = 0 : ui64, mpe_frequent_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<ELTWISE>, start_after = 0 : ui64}>
     input(%43 : memref<1x16x32x2xf16, {order = #NHWC}, [@CMX_NN, 5]>) weights(%37 : memref<1x16x32x2xf16, {order = #NHWC}, [@CMX_NN, 5]>) outputs(%73 : memref<1x16x32x4xf16, {order = #NWCH}, [@CMX_NN, 5]>)
     waits(%76 : !VPURegMapped.Index<0:0:2>) updates(%77 : !VPURegMapped.Index<0:0:3>) -> <5:0:0> PPE : {
    }
    %103 = VPUMI40XX.DPUInvariant <{clean_after = 0 : ui64, is_superdense, kernel_padding = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, kernel_size = [3, 3],
    kernel_strides = [1, 1], mpe_frequent_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<CONV>, start_after = 0 : ui64}>
    previousTask(%97 : !VPURegMapped.Index<0:0:0>) input(%44 : memref<1x32x5x16xf16, {order = #NHWC}, [@CMX_NN, 0]>) weights(%56 : memref<32x32x3x3xf16, {order = #NHWC}, [@CMX_NN, 0]>)
    weight_table(%50 : memref<32x1x1x4xsi32, [@CMX_NN, 0]>) outputs(%26 : memref<1x32x3x14xf16, [@CMX_NN, 0]>) waits(%77 : !VPURegMapped.Index<0:0:3>) updates(%78 : !VPURegMapped.Index<0:0:4>) -> <0:0:1> PPE : {
    }
    %104 = VPUMI40XX.DPUInvariant <{clean_after = 0 : ui64, is_superdense, kernel_padding = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, kernel_size = [3, 3],
    kernel_strides = [1, 1], mpe_frequent_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<CONV>, start_after = 0 : ui64}>
    previousTask(%98 : !VPURegMapped.Index<1:0:0>) input(%45 : memref<1x32x5x16xf16, {order = #NHWC}, [@CMX_NN, 1]>) weights(%57 : memref<32x32x3x3xf16, {order = #NHWC}, [@CMX_NN, 1]>)
    weight_table(%51 : memref<32x1x1x4xsi32, [@CMX_NN, 1]>) outputs(%27 : memref<1x32x3x14xf16, [@CMX_NN, 1]>) waits(%77 : !VPURegMapped.Index<0:0:3>) updates(%78 : !VPURegMapped.Index<0:0:4>) -> <1:0:1> PPE : {
    }
    %105 = VPUMI40XX.DPUInvariant <{clean_after = 0 : ui64, is_superdense, kernel_padding = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, kernel_size = [3, 3],
    kernel_strides = [1, 1], mpe_frequent_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<CONV>, start_after = 0 : ui64}>
    previousTask(%99 : !VPURegMapped.Index<2:0:0>) input(%46 : memref<1x32x4x16xf16, {order = #NHWC}, [@CMX_NN, 2]>) weights(%58 : memref<32x32x3x3xf16, {order = #NHWC}, [@CMX_NN, 2]>)
    weight_table(%52 : memref<32x1x1x4xsi32, [@CMX_NN, 2]>) outputs(%28 : memref<1x32x2x14xf16, [@CMX_NN, 2]>) waits(%77 : !VPURegMapped.Index<0:0:3>) updates(%78 : !VPURegMapped.Index<0:0:4>) -> <2:0:1> PPE : {
    }
    %106 = VPUMI40XX.DPUInvariant <{clean_after = 0 : ui64, is_superdense, kernel_padding = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, kernel_size = [3, 3],
    kernel_strides = [1, 1], mpe_frequent_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<CONV>, start_after = 0 : ui64}>
    previousTask(%100 : !VPURegMapped.Index<3:0:0>) input(%47 : memref<1x32x4x16xf16, {order = #NHWC}, [@CMX_NN, 3]>) weights(%59 : memref<32x32x3x3xf16, {order = #NHWC}, [@CMX_NN, 3]>)
    weight_table(%53 : memref<32x1x1x4xsi32, [@CMX_NN, 3]>) outputs(%29 : memref<1x32x2x14xf16, [@CMX_NN, 3]>) waits(%77 : !VPURegMapped.Index<0:0:3>) updates(%78 : !VPURegMapped.Index<0:0:4>) -> <3:0:1> PPE : {
    }
    %107 = VPUMI40XX.DPUInvariant <{clean_after = 0 : ui64, is_superdense, kernel_padding = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, kernel_size = [3, 3],
    kernel_strides = [1, 1], mpe_frequent_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<CONV>, start_after = 0 : ui64}>
    previousTask(%101 : !VPURegMapped.Index<4:0:0>) input(%48 : memref<1x32x4x16xf16, {order = #NHWC}, [@CMX_NN, 4]>) weights(%60 : memref<32x32x3x3xf16, {order = #NHWC}, [@CMX_NN, 4]>)
    weight_table(%54 : memref<32x1x1x4xsi32, [@CMX_NN, 4]>) outputs(%30 : memref<1x32x2x14xf16, [@CMX_NN, 4]>) waits(%77 : !VPURegMapped.Index<0:0:3>) updates(%78 : !VPURegMapped.Index<0:0:4>) -> <4:0:1> PPE : {
    }
    %108 = VPUMI40XX.DPUInvariant <{clean_after = 0 : ui64, is_superdense, kernel_padding = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, kernel_size = [3, 3],
    kernel_strides = [1, 1], mpe_frequent_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<CONV>, start_after = 0 : ui64}>
    previousTask(%102 : !VPURegMapped.Index<5:0:0>) input(%49 : memref<1x32x4x16xf16, {order = #NHWC}, [@CMX_NN, 5]>) weights(%61 : memref<32x32x3x3xf16, {order = #NHWC}, [@CMX_NN, 5]>)
    weight_table(%55 : memref<32x1x1x4xsi32, [@CMX_NN, 5]>) outputs(%31 : memref<1x32x2x14xf16, [@CMX_NN, 5]>) waits(%77 : !VPURegMapped.Index<0:0:3>) updates(%78 : !VPURegMapped.Index<0:0:4>) -> <5:0:1> PPE : {
    }
    %109 = VPUMI40XX.DPUVariant calls(%97 : <0:0:0>) weights(%32 : memref<1x16x32x3xf16, {order = #NHWC}, [@CMX_NN, 0]>) <{end = [2, 31, 15], haloRegions = [], inEnd = [2, 31, 15], inStart = [0, 0, 0], mpe_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<ELTWISE>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, start = [0, 0, 0]}> -> <0:0:0>
    %110 = VPUMI40XX.DPUVariant calls(%98 : <1:0:0>) weights(%33 : memref<1x16x32x3xf16, {order = #NHWC}, [@CMX_NN, 1]>) <{cluster_id = 1 : ui64, end = [2, 31, 15], haloRegions = [#VPUIP.DPUHaloRegionAttr<xStart = 0 : i64, xEnd = 15 : i64, yStart = 0 : i64, yEnd = 1 : i64, zStart = 0 : i64, zEnd = 31 : i64, targetOffset = 3072 : i64, targetClusters = [0], targetWidth = 16 : i64>], inEnd = [2, 31, 15], inStart = [0, 0, 0], mpe_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<ELTWISE>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, start = [0, 0, 0]}> -> <1:0:0>
    %111 = VPUMI40XX.DPUVariant calls(%99 : <2:0:0>) weights(%34 : memref<1x16x32x3xf16, {order = #NHWC}, [@CMX_NN, 2]>) <{cluster_id = 2 : ui64, end = [2, 31, 15], haloRegions = [#VPUIP.DPUHaloRegionAttr<xStart = 0 : i64, xEnd = 15 : i64, yStart = 0 : i64, yEnd = 1 : i64, zStart = 0 : i64, zEnd = 31 : i64, targetOffset = 3072 : i64, targetClusters = [1], targetWidth = 16 : i64>, #VPUIP.DPUHaloRegionAttr<xStart = 0 : i64, xEnd = 15 : i64, yStart = 2 : i64, yEnd = 2 : i64, zStart = 0 : i64, zEnd = 31 : i64, targetOffset = -2048 : i64, targetClusters = [3], targetWidth = 16 : i64>], inEnd = [2, 31, 15], inStart = [0, 0, 0], mpe_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<ELTWISE>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, start = [0, 0, 0]}> -> <2:0:0>
    %112 = VPUMI40XX.DPUVariant calls(%100 : <3:0:0>) weights(%35 : memref<1x16x32x3xf16, {order = #NHWC}, [@CMX_NN, 3]>) <{cluster_id = 3 : ui64, end = [3, 31, 15], haloRegions = [#VPUIP.DPUHaloRegionAttr<xStart = 0 : i64, xEnd = 15 : i64, yStart = 1 : i64, yEnd = 1 : i64, zStart = 0 : i64, zEnd = 31 : i64, targetOffset = 2048 : i64, targetClusters = [2], targetWidth = 16 : i64>, #VPUIP.DPUHaloRegionAttr<xStart = 0 : i64, xEnd = 15 : i64, yStart = 2 : i64, yEnd = 3 : i64, zStart = 0 : i64, zEnd = 31 : i64, targetOffset = -2048 : i64, targetClusters = [4], targetWidth = 16 : i64>], inEnd = [2, 31, 15], inStart = [0, 0, 0], mpe_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<ELTWISE>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, start = [1, 0, 0]}> -> <3:0:0>
    %113 = VPUMI40XX.DPUVariant calls(%101 : <4:0:0>) weights(%36 : memref<1x16x32x2xf16, {order = #NHWC}, [@CMX_NN, 4]>) <{cluster_id = 4 : ui64, end = [3, 31, 15], haloRegions = [#VPUIP.DPUHaloRegionAttr<xStart = 0 : i64, xEnd = 15 : i64, yStart = 2 : i64, yEnd = 3 : i64, zStart = 0 : i64, zEnd = 31 : i64, targetOffset = -2048 : i64, targetClusters = [5], targetWidth = 16 : i64>], inEnd = [1, 31, 15], inStart = [0, 0, 0], mpe_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<ELTWISE>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, start = [2, 0, 0]}> -> <4:0:0>
    %114 = VPUMI40XX.DPUVariant calls(%102 : <5:0:0>) weights(%37 : memref<1x16x32x2xf16, {order = #NHWC}, [@CMX_NN, 5]>) <{cluster_id = 5 : ui64, end = [3, 31, 15], haloRegions = [], inEnd = [1, 31, 15], inStart = [0, 0, 0], mpe_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<ELTWISE>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, start = [2, 0, 0]}> -> <5:0:0>
    %115 = VPUMI40XX.DPUVariant previousTask(%109 : !VPURegMapped.Index<0:0:0>) calls(%103 : <0:0:1>) weights(%56 : memref<32x32x3x3xf16, {order = #NHWC}, [@CMX_NN, 0]>) weight_table(%50 : memref<32x1x1x4xsi32, [@CMX_NN, 0]>) <{end = [13, 2, 31], inEnd = [15, 4, 31], inStart = [0, 0, 0], mpe_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<CONV>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, start = [0, 0, 0]}> -> <0:0:1>
    %116 = VPUMI40XX.DPUVariant previousTask(%110 : !VPURegMapped.Index<1:0:0>) calls(%104 : <1:0:1>) weights(%57 : memref<32x32x3x3xf16, {order = #NHWC}, [@CMX_NN, 1]>) weight_table(%51 : memref<32x1x1x4xsi32, [@CMX_NN, 1]>) <{cluster_id = 1 : ui64, end = [13, 2, 31], inEnd = [15, 4, 31], inStart = [0, 0, 0], mpe_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<CONV>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, start = [0, 0, 0]}> -> <1:0:1>
    %117 = VPUMI40XX.DPUVariant previousTask(%111 : !VPURegMapped.Index<2:0:0>) calls(%105 : <2:0:1>) weights(%58 : memref<32x32x3x3xf16, {order = #NHWC}, [@CMX_NN, 2]>) weight_table(%52 : memref<32x1x1x4xsi32, [@CMX_NN, 2]>) <{cluster_id = 2 : ui64, end = [13, 1, 31], inEnd = [15, 3, 31], inStart = [0, 0, 0], mpe_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<CONV>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, start = [0, 0, 0]}> -> <2:0:1>
    %118 = VPUMI40XX.DPUVariant previousTask(%112 : !VPURegMapped.Index<3:0:0>) calls(%106 : <3:0:1>) weights(%59 : memref<32x32x3x3xf16, {order = #NHWC}, [@CMX_NN, 3]>) weight_table(%53 : memref<32x1x1x4xsi32, [@CMX_NN, 3]>) <{cluster_id = 3 : ui64, end = [13, 1, 31], inEnd = [15, 3, 31], inStart = [0, 0, 0], mpe_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<CONV>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, start = [0, 0, 0]}> -> <3:0:1>
    %119 = VPUMI40XX.DPUVariant previousTask(%113 : !VPURegMapped.Index<4:0:0>) calls(%107 : <4:0:1>) weights(%60 : memref<32x32x3x3xf16, {order = #NHWC}, [@CMX_NN, 4]>) weight_table(%54 : memref<32x1x1x4xsi32, [@CMX_NN, 4]>) <{cluster_id = 4 : ui64, end = [13, 1, 31], inEnd = [15, 3, 31], inStart = [0, 0, 0], mpe_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<CONV>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, start = [0, 0, 0]}> -> <4:0:1>
    %120 = VPUMI40XX.DPUVariant previousTask(%114 : !VPURegMapped.Index<5:0:0>) calls(%108 : <5:0:1>) weights(%61 : memref<32x32x3x3xf16, {order = #NHWC}, [@CMX_NN, 5]>) weight_table(%55 : memref<32x1x1x4xsi32, [@CMX_NN, 5]>) <{cluster_id = 5 : ui64, end = [13, 1, 31], inEnd = [15, 3, 31], inStart = [0, 0, 0], mpe_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<CONV>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, start = [0, 0, 0]}> -> <5:0:1>
...
module @TestSoftmax {
  ...
  %66 = VPUMI40XX.NNDMA <{is_out_of_order, port = 0 : i64}> inputs(%0 : memref<1x1000x1x1xf16, {order = affine_map<(d0, d1, d2, d3) -> (d0, d2, d3, d1)>}, @DDR>) outputs(%22, %23, %87, %88 : memref<1x1000x1x1xf16, {order = affine_map<(d0, d1, d2, d3) -> (d0, d2, d3, d1)>}, [@CMX_NN, 0]>, memref<1x1000x1x1xf16, {order = affine_map<(d0, d1, d2, d3) -> (d0, d2, d3, d1)>}, [@CMX_NN, 1]>, memref<1x1000x1x1xf16, {order = affine_map<(d0, d1, d2, d3) -> (d0, d2, d3, d1)>}, [@CMX_NN, 0]>, memref<1x1000x1x1xf16, {order = affine_map<(d0, d1, d2, d3) -> (d0, d2, d3, d1)>}, [@CMX_NN, 1]>) previousDMA(%65 : !VPURegMapped.Index<0:0:0>) waits(%42 : !VPURegMapped.Index<0:0:0>) updates(%43 : !VPURegMapped.Index<0:0:1>) start_after(0) clean_after(0) acceleration_mode(<DISABLE>) dma_transaction(#VPUMI40XX.NNDMATransaction<inputType = memref<1x1000x1x1xf16, {order = affine_map<(d0, d1, d2, d3) -> (d0, d2, d3, d1)>}, @DDR>, outputType = !VPUIP.DistributedBuffer<1x1000x1x1xf16, affine_map<(d0, d1, d2, d3) -> (d0, d2, d3, d1)>, @CMX_NN, {mode = "DUPLICATED", num_clusters = 2 : i64, uniform_distributed_segments, compute_shapes = [[1, 1000, 1, 1], [1, 1000, 1, 1]], compute_offsets = [[0, 0, 0, 0], [0, 0, 0, 0]], memory_shapes = [[1, 1000, 1, 1], [1, 1000, 1, 1]], memory_offsets = [[0, 0, 0, 0], [0, 0, 0, 0]]}>>) -> !VPURegMapped.Index<0:0:1>
