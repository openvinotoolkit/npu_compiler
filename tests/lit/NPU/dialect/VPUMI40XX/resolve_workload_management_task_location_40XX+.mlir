...
// RUN: vpux-opt --split-input-file --init-compiler="vpu-arch=%arch% allow-custom-values=true" --resolve-wlm-task-location %s | FileCheck %s
...
// CHECK: [[TBI30:%.*]] = VPURegMapped.DeclareTaskBuffer <DPUInvariant> -> !VPURegMapped.Index<0:0:30>
// CHECK: [[TBI31:%.*]] = VPURegMapped.DeclareTaskBuffer <DPUInvariant> -> !VPURegMapped.Index<0:0:31>

// CHECK: [[TBV62:%.*]] = VPURegMapped.DeclareTaskBuffer <DPUVariant> -> !VPURegMapped.Index<0:0:62>
// CHECK: [[TBV63:%.*]] = VPURegMapped.DeclareTaskBuffer <DPUVariant> -> !VPURegMapped.Index<0:0:63>
