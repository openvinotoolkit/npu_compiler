...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform% compilation-mode=ReferenceSW" --mlir-elide-elementsattrs-if-larger 8 --reference-sw-mode-ie %s | FileCheck %s --strict-whitespace
