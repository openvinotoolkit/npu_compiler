...
func.func @MixedPrecisionFloatInputQuantWeightsConvNF4(%arg0: tensor<1x1x28x28xf16>) -> tensor<1x1x29x29xf16> {
  %weights = const.Declare tensor<1x1x2x2x!qElemType> = dense_resource<blob> : tensor<1x1x2x2xui4>, [#const.ConvertElemType<f32>, #const.CastElemType<!quantFloatType>, #const.CastElemType<f16>, #const.CastElemType<ui4>, #const.CastElemType<!qElemType>]
