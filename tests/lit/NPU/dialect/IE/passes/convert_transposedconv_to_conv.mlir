...
// CHECK-SAME:     [[ARG_0:%[^:]+]]: tensor<1x128x24x42xf16>
func.func @ConvertTransposedConv2DToConv2DWhitPadding(%input: tensor<1x128x24x42xf16>) -> tensor<1x128x48x83xf16> {
    ...
    // CHECK-NOT:  IE.TransposedConvolution
    // CHECK:      [[UPSAMPLING:%.+]] = IE.Upsampling([[ARG_0]])
...
// CHECK-LABEL: @ConvertTransposedConvToConvLargeKernelSize
...
func.func @main(%input: tensor<1x32x23x30xf16>) -> tensor<1x16x60x74xf16> {
