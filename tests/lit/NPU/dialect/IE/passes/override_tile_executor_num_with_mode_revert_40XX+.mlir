...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform% allow-custom-values=true" --override-tile-executor-num="override-to-tiles-per-batch-mode=revert" %s | FileCheck %s
...
module @OverrideToTilesPerBatchForBatchedCase {
    ...
    // CHECK: config.Resources 6 of @NCE at 1.700000e+03 MHz
