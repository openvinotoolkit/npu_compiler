...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform% allow-custom-values=true" --run-mem-permute-processing-rewriters="rewriter=optimize-concat-with-conv-set" %s | FileCheck %s
