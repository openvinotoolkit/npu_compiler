...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform% enable-sw-kernel-fifo-per-shave-engine=true" --barrier-optimization %s | FileCheck %s
// REQUIRES: platform-NPU4000 || platform-NPU5010

#NHWC = affine_map<(d0, d1, d2, d3) -> (d0, d2, d3, d1)>

!type_DDR = memref<1x3x224x224xf16, {order = #NHWC}, @DDR>

//CHECK-LABEL: @BarrierOptimizationSamePortAndChannel
func.func @BarrierOptimizationSamePortAndChannel() -> !type_DDR {
...
!type_DDR = memref<1x3x224x224xf16, {order = #NHWC}, @DDR>
!type_CMX = memref<1x3x224x224xf16, {order = #NHWC}, [@CMX_NN, 0]>

//CHECK-LABEL: @NoBarrierOptimizationSamePortDifferentChannel
func.func @NoBarrierOptimizationSamePortDifferentChannel() -> !type_DDR {
...
//CHECK-LABEL: @NoBarrierOptimizationDifferentPortSameChannel
func.func @NoBarrierOptimizationDifferentPortSameChannel() -> !type_DDR {
...
// CHECK-SAME:      [[ARG_1:%[^:]+]]: memref<1x64x112x112xf16, @DDR>
func.func @removeRedundantWaitAndUpdateBarriers(%arg0: memref<1x3x224x224xf16, @DDR>, %arg1: memref<1x64x112x112xf16, @DDR>) -> memref<1x64x112x112xf16, @DDR> {
    ...
    %29 = VPURT.DeclareBuffer <CMX_NN> [0] <141760> -> memref<1x64x28x112xf16, {order = #NHWC}, [@CMX_NN, 0]>
    %30 = VPURT.DeclareBuffer <CMX_NN> [1] <141760> -> memref<1x64x28x112xf16, {order = #NHWC}, [@CMX_NN, 1]>
    %31 = VPURT.DeclareBuffer <CMX_NN> [2] <141760> -> memref<1x64x28x112xf16, {order = #NHWC}, [@CMX_NN, 2]>
    %32 = VPURT.DeclareBuffer <CMX_NN> [3] <141760> -> memref<1x64x28x112xf16, {order = #NHWC}, [@CMX_NN, 3]>
    %33 = VPURT.DeclareBuffer <CMX_NN> [0] <576> -> memref<1x224x3x56xf16, {order = #NHWC}, [@CMX_NN, 0]>
    %34 = VPURT.DeclareBuffer <CMX_NN> [1] <576> -> memref<1x224x3x56xf16, {order = #NHWC}, [@CMX_NN, 1]>
    %35 = VPURT.DeclareBuffer <CMX_NN> [2] <576> -> memref<1x224x3x56xf16, {order = #NHWC}, [@CMX_NN, 2]>
    %36 = VPURT.DeclareBuffer <CMX_NN> [3] <576> -> memref<1x224x3x56xf16, {order = #NHWC}, [@CMX_NN, 3]>
    %37 = VPURT.DeclareBuffer <CMX_NN> [0] <576> -> memref<1x224x3x56xf16, {order = #NHWC}, [@CMX_NN, 0]>
    %38 = VPURT.DeclareBuffer <CMX_NN> [1] <576> -> memref<1x224x3x56xf16, {order = #NHWC}, [@CMX_NN, 1]>
    %39 = VPURT.DeclareBuffer <CMX_NN> [2] <576> -> memref<1x224x3x56xf16, {order = #NHWC}, [@CMX_NN, 2]>
    %40 = VPURT.DeclareBuffer <CMX_NN> [3] <576> -> memref<1x224x3x56xf16, {order = #NHWC}, [@CMX_NN, 3]>
    %41 = VPURT.DeclareBuffer <CMX_NN> [0] <130496> -> memref<64x16x7x7x!qElemType, {order = #NHWC}, [@CMX_NN, 0]>
    %42 = VPURT.DeclareBuffer <CMX_NN> [1] <130496> -> memref<64x16x7x7x!qElemType, {order = #NHWC}, [@CMX_NN, 1]>
    %43 = VPURT.DeclareBuffer <CMX_NN> [2] <130496> -> memref<64x16x7x7x!qElemType, {order = #NHWC}, [@CMX_NN, 2]>
    %44 = VPURT.DeclareBuffer <CMX_NN> [3] <130496> -> memref<64x16x7x7x!qElemType, {order = #NHWC}, [@CMX_NN, 3]>
    %45 = VPURT.DeclareBuffer <CMX_NN> [0] <75840> -> memref<1x16x58x224x!qElemType3, {order = #NHWC}, [@CMX_NN, 0]>
    %46 = VPURT.DeclareBuffer <CMX_NN> [1] <75840> -> memref<1x16x61x224x!qElemType3, {order = #NHWC}, [@CMX_NN, 1]>
    %47 = VPURT.DeclareBuffer <CMX_NN> [2] <75840> -> memref<1x16x61x224x!qElemType3, {order = #NHWC}, [@CMX_NN, 2]>
    %48 = VPURT.DeclareBuffer <CMX_NN> [3] <75840> -> memref<1x16x59x224x!qElemType3, {order = #NHWC}, [@CMX_NN, 3]>
    ...
    VPURT.Task waits(%bar0, %bar2 : !VPURT.Barrier, !VPURT.Barrier) updates(%bar1: !VPURT.Barrier) {
      %49 = VPUIP.NCEClusterTask {resultSegmentSizes = array<i32: 1, 0, 0, 0, 0, 0>} <{cm_sp_pattern = 7 : i64, input_channels_compression, kernel_padding = #VPU.Padding<left = 3 : i64, right = 2 : i64, top = 3 : i64, bottom = 0 : i64>, kernel_size = [7, 7], kernel_strides = [2, 2], task_type = #VPUIP.nce_task_type<CONV>}> input(%45 : memref<1x16x58x224x!qElemType3, {order = #NHWC}, [@CMX_NN, 0]>) weights(%41 : memref<64x16x7x7x!qElemType, {order = #NHWC}, [@CMX_NN, 0]>) parent_input(%45 : memref<1x16x58x224x!qElemType3, {order = #NHWC}, [@CMX_NN, 0]>) parent_output(%29 : memref<1x64x28x112xf16, {order = #NHWC}, [@CMX_NN, 0]>) outputs(%29 : memref<1x64x28x112xf16, {order = #NHWC}, [@CMX_NN, 0]>) -> memref<1x64x28x112xf16, {order = #NHWC}, [@CMX_NN, 0]> variants : {
    ...
    VPURT.Task waits(%bar0, %bar3 : !VPURT.Barrier, !VPURT.Barrier) updates(%bar1: !VPURT.Barrier) {
      %49 = VPUIP.NCEClusterTask {resultSegmentSizes = array<i32: 1, 0, 0, 0, 0, 0>} <{cm_sp_pattern = 7 : i64, input_channels_compression, kernel_padding = #VPU.Padding<left = 3 : i64, right = 2 : i64, top = 0 : i64, bottom = 0 : i64>, kernel_size = [7, 7], kernel_strides = [2, 2], task_type = #VPUIP.nce_task_type<CONV>}> input(%46 : memref<1x16x61x224x!qElemType3, {order = #NHWC}, [@CMX_NN, 1]>) weights(%42 : memref<64x16x7x7x!qElemType, {order = #NHWC}, [@CMX_NN, 1]>) parent_input(%46 : memref<1x16x61x224x!qElemType3, {order = #NHWC}, [@CMX_NN, 1]>) parent_output(%30 : memref<1x64x28x112xf16, {order = #NHWC}, [@CMX_NN, 1]>) outputs(%30 : memref<1x64x28x112xf16, {order = #NHWC}, [@CMX_NN, 1]>) -> memref<1x64x28x112xf16, {order = #NHWC}, [@CMX_NN, 1]> variants : {
    ...
    VPURT.Task waits(%bar0, %bar4 : !VPURT.Barrier, !VPURT.Barrier) updates(%bar1: !VPURT.Barrier) {
      %49 = VPUIP.NCEClusterTask {resultSegmentSizes = array<i32: 1, 0, 0, 0, 0, 0>} <{cm_sp_pattern = 7 : i64, input_channels_compression, kernel_padding = #VPU.Padding<left = 3 : i64, right = 2 : i64, top = 0 : i64, bottom = 0 : i64>, kernel_size = [7, 7], kernel_strides = [2, 2], task_type = #VPUIP.nce_task_type<CONV>}> input(%47 : memref<1x16x61x224x!qElemType3, {order = #NHWC}, [@CMX_NN, 2]>) weights(%43 : memref<64x16x7x7x!qElemType, {order = #NHWC}, [@CMX_NN, 2]>) parent_input(%47 : memref<1x16x61x224x!qElemType3, {order = #NHWC}, [@CMX_NN, 2]>) parent_output(%31 : memref<1x64x28x112xf16, {order = #NHWC}, [@CMX_NN, 2]>) outputs(%31 : memref<1x64x28x112xf16, {order = #NHWC}, [@CMX_NN, 2]>) -> memref<1x64x28x112xf16, {order = #NHWC}, [@CMX_NN, 2]> variants : {
    ...
    VPURT.Task waits(%bar0, %bar5 : !VPURT.Barrier, !VPURT.Barrier) updates(%bar1: !VPURT.Barrier) {
      %49 = VPUIP.NCEClusterTask {resultSegmentSizes = array<i32: 1, 0, 0, 0, 0, 0>} <{cm_sp_pattern = 7 : i64, input_channels_compression, kernel_padding = #VPU.Padding<left = 3 : i64, right = 2 : i64, top = 0 : i64, bottom = 2 : i64>, kernel_size = [7, 7], kernel_strides = [2, 2], task_type = #VPUIP.nce_task_type<CONV>}> input(%48 : memref<1x16x59x224x!qElemType3, {order = #NHWC}, [@CMX_NN, 3]>) weights(%44 : memref<64x16x7x7x!qElemType, {order = #NHWC}, [@CMX_NN, 3]>) parent_input(%48 : memref<1x16x59x224x!qElemType3, {order = #NHWC}, [@CMX_NN, 3]>) parent_output(%32 : memref<1x64x28x112xf16, {order = #NHWC}, [@CMX_NN, 3]>) outputs(%32 : memref<1x64x28x112xf16, {order = #NHWC}, [@CMX_NN, 3]>) -> memref<1x64x28x112xf16, {order = #NHWC}, [@CMX_NN, 3]> variants : {
    ...
    // CHECK:       return [[ARG_1]] : memref<1x64x112x112xf16, @DDR>
}
