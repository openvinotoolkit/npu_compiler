...
// RUN: vpux-opt --split-input-file --platform=%platform% --insert-shave-submit-skip-dmas="num-dma-engines=2" %s | FileCheck %s
...
module @Activation attributes {config.compilationMode = #config.compilation_mode<DefaultHW>, config.elf_version = #config.version<2 : 0 : 0>, config.platform = #config.platform<NPU5010>, config.revisionID = #config.revision_id<REVISION_NONE>} {
  ...
  func.func @main(%main: memref<1x1x1x4194304xf16, @DDR>, %main_0: memref<4xsi32, @DDR>, %main_1: memref<1x1x1x4194304xf16, @DDR>, %main_2: memref<4xsi32, @DDR>) -> (memref<1x1x1x4194304xf16, @DDR>, memref<4xsi32, @DDR>) {
    ...
    %16 = VPURT.DeclareBuffer <CMX_NN> [0] <0> -> memref<0x0x0x0xui8, [@CMX_NN, 0]>
    ...
    VPURT.Task updates(%bar2 : !VPURT.Barrier)  {
      %15 = VPUIP.FetchDMA <{port = 1 : i64}> inputs(%10 : memref<0x0x0x0xi32, @DDR>) outputs(%10 : memref<0x0x0x0xi32, @DDR>) fetch_dma(<<DMA_NN>, tile = 0 : i64, list = 0 : i64, fetchType = <SingleDescriptor>, logicalTaskIdx = 0 : i64, descId = 2 : i64>) -> memref<0x0x0x0xi32, @DDR>
    }
    VPURT.Task updates(%bar2 : !VPURT.Barrier)  {
      %15 = VPUIP.FetchDMA <{port = 0 : i64}> inputs(%10 : memref<0x0x0x0xi32, @DDR>) outputs(%10 : memref<0x0x0x0xi32, @DDR>) fetch_dma(<<DMA_NN>, tile = 0 : i64, list = 1 : i64, fetchType = <SingleDescriptor>, logicalTaskIdx = 0 : i64, descId = 4 : i64>) -> memref<0x0x0x0xi32, @DDR>
    }
    VPURT.Task updates(%bar2 : !VPURT.Barrier)  {
      %15 = VPUIP.FetchDMA <{port = 1 : i64}> inputs(%10 : memref<0x0x0x0xi32, @DDR>) outputs(%10 : memref<0x0x0x0xi32, @DDR>) fetch_dma(<<DMA_NN>, tile = 0 : i64, list = 1 : i64, fetchType = <SingleDescriptor>, logicalTaskIdx = 0 : i64, descId = 6 : i64>) -> memref<0x0x0x0xi32, @DDR>
    }
    ...
    VPURT.Task waits(%bar0 : !VPURT.Barrier) updates(%bar1 : !VPURT.Barrier) {
      %15 = VPUIP.SyncDMA {logical_task = 0 : i64} <{port = 1 : i64}> inputs(%10 : memref<0x0x0x0xi32, @DDR>) outputs(%10 : memref<0x0x0x0xi32, @DDR>) -> memref<0x0x0x0xi32, @DDR>
    }
    VPURT.Task waits(%bar0 : !VPURT.Barrier) updates(%bar1 : !VPURT.Barrier) {
      %15 = VPUIP.SyncDMA {logical_task = 0 : i64} <{port = 0 : i64}> inputs(%16 : memref<0x0x0x0xui8, [@CMX_NN, 0]>) outputs(%10 : memref<0x0x0x0xi32, @DDR>) -> memref<0x0x0x0xi32, @DDR>
    }
    VPURT.Task waits(%bar0 : !VPURT.Barrier) updates(%bar1 : !VPURT.Barrier) {
      %15 = VPUIP.SyncDMA {logical_task = 0 : i64} <{port = 1 : i64}> inputs(%16 : memref<0x0x0x0xui8, [@CMX_NN, 0]>) outputs(%10 : memref<0x0x0x0xi32, @DDR>) -> memref<0x0x0x0xi32, @DDR>
    }
    VPURT.Task waits(%bar0 : !VPURT.Barrier) updates(%bar1 : !VPURT.Barrier)  {
      %bar1_19:2, %bar1_20 = VPUIP.SW.Kernel {dynamicInputShapesMap = array<i32: 0, -1>, dynamicOutputShapesMap = array<i32: 0, -1>, logical_task = 0 : i64, resultSegmentSizes = array<i32: 2, 1, 0>, skipDescIds = [0, 1, 2, 3]} @VPU.SW::@builtin_AtanDma inputs(%13 as %main_21: memref<1x1x1x4194304xf16, @DDR>, %14 as %bar1_22: memref<1x1x1x1049600xui8, [@CMX_NN, 0]>) dynamicInputShapes(%9 : memref<4xsi32, @DDR>) outputs(%8 as %main_23: memref<1x1x1x4194304xf16, @DDR>, %14 as %bar1_24: memref<1x1x1x1049600xui8, [@CMX_NN, 0]>) dynamicOutputShapes(%9 : memref<4xsi32, @DDR>) on tile 0 list 0 -> (memref<1x1x1x4194304xf16, @DDR>, memref<1x1x1x1049600xui8, [@CMX_NN, 0]>, memref<4xsi32, @DDR>){
    ...
    VPURT.Task waits(%bar0 : !VPURT.Barrier) updates(%bar1 : !VPURT.Barrier)  {
      %bar1_19:2, %bar1_20 = VPUIP.SW.Kernel {dynamicInputShapesMap = array<i32: 0, -1>, dynamicOutputShapesMap = array<i32: 0, -1>, logical_task = 0 : i64, resultSegmentSizes = array<i32: 2, 1, 0>, skipDescIds = [4, 5, 6, 7]} @VPU.SW::@builtin_AtanDma inputs(%13 as %main_21: memref<1x1x1x4194304xf16, @DDR>, %14 as %bar1_22: memref<1x1x1x1049600xui8, [@CMX_NN, 0]>) dynamicInputShapes(%9 : memref<4xsi32, @DDR>) outputs(%8 as %main_23: memref<1x1x1x4194304xf16, @DDR>, %14 as %bar1_24: memref<1x1x1x1049600xui8, [@CMX_NN, 0]>) dynamicOutputShapes(%9 : memref<4xsi32, @DDR>) on tile 0 list 1 -> (memref<1x1x1x4194304xf16, @DDR>, memref<1x1x1x1049600xui8, [@CMX_NN, 0]>, memref<4xsi32, @DDR>){
        VPUIP.SW.Kernel.run {attrs = [8589934593, 999, 999, 8589934593, 999, 999]}(%main_21, %bar1_22, %main_23, %bar1_24) : memref<1x1x1x4194304xf16, @DDR>, memref<1x1x1x1049600xui8, [@CMX_NN, 0]>, memref<1x1x1x4194304xf16, @DDR>, memref<1x1x1x1049600xui8, [@CMX_NN, 0]>
      }
    }
    ...
    VPURT.Task waits(%bar1 : !VPURT.Barrier) {
      %15 = VPUIP.SyncDMA {logical_task = 0 : i64, shv_release_dma} <{port = 1 : i64}> inputs(%10 : memref<0x0x0x0xi32, @DDR>) outputs(%10 : memref<0x0x0x0xi32, @DDR>) -> memref<0x0x0x0xi32, @DDR>
    }
    VPURT.Task waits(%bar1 : !VPURT.Barrier) {
      %15 = VPUIP.SyncDMA {logical_task = 0 : i64, shv_release_dma} <{port = 0 : i64}> inputs(%16 : memref<0x0x0x0xui8, [@CMX_NN, 0]>) outputs(%10 : memref<0x0x0x0xi32, @DDR>) -> memref<0x0x0x0xi32, @DDR>
    }
    VPURT.Task waits(%bar1 : !VPURT.Barrier) {
      %15 = VPUIP.SyncDMA {logical_task = 0 : i64, shv_release_dma} <{port = 1 : i64}> inputs(%16 : memref<0x0x0x0xui8, [@CMX_NN, 0]>) outputs(%10 : memref<0x0x0x0xi32, @DDR>) -> memref<0x0x0x0xi32, @DDR>
    }
    VPURT.Task waits(%bar1 : !VPURT.Barrier)  {
  ...
  // Port 0 DDR Sync
  // CHECK-DAG: VPUIP.SkipDMA <{port = 0 : i64}> inputs(%3 : memref<0x0x0x0xi32, @DDR>) outputs(%2 : memref<0x0x0x0xi32, @DDR>) skip_dma(<tile = 0 : i64, list = 1 : i64, logicalTask = 0 : i64, descId = 4 : i64>) -> memref<0x0x0x0xi32, @DDR>
  // CHECK-DAG: VPUIP.SkipDMA <{port = 0 : i64}> inputs(%3 : memref<0x0x0x0xi32, @DDR>) outputs(%2 : memref<0x0x0x0xi32, @DDR>) skip_dma(<tile = 0 : i64, list = 0 : i64, logicalTask = 0 : i64, descId = 0 : i64>) -> memref<0x0x0x0xi32, @DDR>
  // CHECK: VPURT.Task waits([[BAR1]] : !VPURT.Barrier) {
  // CHECK: VPUIP.SyncDMA {logical_task = 0 : i64, shv_release_dma} <{port = 0 : i64}> inputs(%17 : memref<0x0x0x0xi32, @DDR>) outputs(%17 : memref<0x0x0x0xi32, @DDR>) -> memref<0x0x0x0xi32, @DDR>
  
  
  // Port 1 DDR Sync
  // CHECK-DAG: VPUIP.SkipDMA <{port = 1 : i64}> inputs(%5 : memref<0x0x0x0xi32, @DDR>) outputs(%2 : memref<0x0x0x0xi32, @DDR>) skip_dma(<tile = 0 : i64, list = 1 : i64, logicalTask = 0 : i64, descId = 6 : i64>) -> memref<0x0x0x0xi32, @DDR>
  // CHECK-DAG: VPUIP.SkipDMA <{port = 1 : i64}> inputs(%5 : memref<0x0x0x0xi32, @DDR>) outputs(%2 : memref<0x0x0x0xi32, @DDR>) skip_dma(<tile = 0 : i64, list = 0 : i64, logicalTask = 0 : i64, descId = 2 : i64>) -> memref<0x0x0x0xi32, @DDR>
  // CHECK: VPURT.Task waits([[BAR1]] : !VPURT.Barrier) {
  // CHECK: VPUIP.SyncDMA {logical_task = 0 : i64, shv_release_dma} <{port = 1 : i64}> inputs(%17 : memref<0x0x0x0xi32, @DDR>) outputs(%17 : memref<0x0x0x0xi32, @DDR>) -> memref<0x0x0x0xi32, @DDR>
  
  
  // Port 0 CMX Sync
  // CHECK-DAG: VPUIP.SkipDMA <{port = 0 : i64}> inputs(%4 : memref<0x0x0x0xi32, [@CMX_NN, 0]>) outputs(%2 : memref<0x0x0x0xi32, @DDR>) skip_dma(<tile = 0 : i64, list = 1 : i64, logicalTask = 0 : i64, descId = 5 : i64>) -> memref<0x0x0x0xi32, @DDR>
  // CHECK-DAG: VPUIP.SkipDMA <{port = 0 : i64}> inputs(%4 : memref<0x0x0x0xi32, [@CMX_NN, 0]>) outputs(%2 : memref<0x0x0x0xi32, @DDR>) skip_dma(<tile = 0 : i64, list = 0 : i64, logicalTask = 0 : i64, descId = 1 : i64>) -> memref<0x0x0x0xi32, @DDR>
  // CHECK: VPURT.Task waits([[BAR1]] : !VPURT.Barrier) {
  // CHECK: VPUIP.SyncDMA {logical_task = 0 : i64, shv_release_dma} <{port = 0 : i64}> inputs(%22 : memref<0x0x0x0xui8, [@CMX_NN, 0]>) outputs(%17 : memref<0x0x0x0xi32, @DDR>) -> memref<0x0x0x0xi32, @DDR>
  
  
  // Port 1 CMX Sync
  // CHECK-DAG: VPUIP.SkipDMA <{port = 1 : i64}> inputs(%6 : memref<0x0x0x0xi32, [@CMX_NN, 0]>) outputs(%2 : memref<0x0x0x0xi32, @DDR>) skip_dma(<tile = 0 : i64, list = 1 : i64, logicalTask = 0 : i64, descId = 7 : i64>) -> memref<0x0x0x0xi32, @DDR>
  // CHECK-DAG: VPUIP.SkipDMA <{port = 1 : i64}> inputs(%6 : memref<0x0x0x0xi32, [@CMX_NN, 0]>) outputs(%2 : memref<0x0x0x0xi32, @DDR>) skip_dma(<tile = 0 : i64, list = 0 : i64, logicalTask = 0 : i64, descId = 3 : i64>) -> memref<0x0x0x0xi32, @DDR>
  // CHECK: VPURT.Task waits([[BAR1]] : !VPURT.Barrier) {
  // CHECK: VPUIP.SyncDMA {logical_task = 0 : i64, shv_release_dma} <{port = 1 : i64}> inputs(%22 : memref<0x0x0x0xui8, [@CMX_NN, 0]>) outputs(%17 : memref<0x0x0x0xi32, @DDR>) -> memref<0x0x0x0xi32, @DDR>
}
