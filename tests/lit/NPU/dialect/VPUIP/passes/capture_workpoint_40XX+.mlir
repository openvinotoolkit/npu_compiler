...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform% allow-custom-values=true" --capture-workpoint %s | FileCheck %s
...
module @Graph {
  ...
  func.func @main(%arg0: !dataType, %arg1: !dataType, %arg2: memref<2xui64>) -> (!dataType, memref<2xui64>) {
    ...
    VPURT.Task {
      %19 = VPUIP.NNDMA inputs(%3 : !frcRegType) outputs(%4 : !frcCmxType) -> !frcCmxType
    }
    VPURT.Task attributes {isTrailingSWLayer = false} {
      %19 = VPUIP.NNDMA inputs(%arg0 : !dataType) outputs(%1 : !dataType) -> !dataType
    }
    %5 = VPURT.DeclareBuffer <Register> <637702144> -> !frcRegType
    %6 = VPURT.DeclareBuffer <CMX_NN> [0] <8> -> !frcCmxType
    VPURT.Task {
      %19 = VPUIP.NNDMA inputs(%5 : !frcRegType) outputs(%6 : !frcCmxType) -> !frcCmxType
    }
    ...
    VPURT.Task updates(%0 : !VPURT.Barrier) {
      %19 = VPUIP.NNDMA inputs(%7 : memref<2xui64, [@CMX_NN, 0]>) outputs(%8 : memref<2xui64>) -> memref<2xui64>
    }
...
// CHECK-NOT:       VPURT.DeclareBuffer <Register> <537403424> -> memref<1xui32, @Register>
// CHECK-NOT:       VPURT.DeclareBuffer <ProfilingOutput> [1] <0> -> memref<1xui32>
