...
func.func @main(%arg0:  memref<1x16x32x17xf16>, %arg1:  memref<1x16x32x17xf16>, %arg2:  memref<1x16x32x17xf16>, %arg3:  memref<1x32x32x18xf16, {order = #NHWC}, [@CMX_NN, 0]>, %arg4:  memref<1x32x32x19xf16, {order = #NHWC}, [@CMX_NN, 1]>, %arg5:  memref<1x32x32x18xf16, {order = #NHWC}, [@CMX_NN, 2]>) -> (memref<1x32x32x18xf16, {order = #NHWC}, [@CMX_NN, 0]>, memref<1x32x32x19xf16, {order = #NHWC}, [@CMX_NN, 1]>, memref<1x32x32x18xf16, {order = #NHWC}, [@CMX_NN, 2]>) {
    ...
    %weights0 = VPURT.DeclareBuffer <CMX_NN> [0] <37888> -> memref<32x16x1x1xf16, {order = #NHWC}, [@CMX_NN, 0]>
    %weights1 = VPURT.DeclareBuffer <CMX_NN> [1] <37888> -> memref<32x16x1x1xf16, {order = #NHWC}, [@CMX_NN, 1]>
    %weights2 = VPURT.DeclareBuffer <CMX_NN> [2] <37888> -> memref<32x16x1x1xf16, {order = #NHWC}, [@CMX_NN, 2]>
    ...
    return %arg3, %arg4, %arg5: memref<1x32x32x18xf16, {order = #NHWC}, [@CMX_NN, 0]>, memref<1x32x32x19xf16, {order = #NHWC}, [@CMX_NN, 1]>, memref<1x32x32x18xf16, {order = #NHWC}, [@CMX_NN, 2]>
}
...
!Input0 = memref<1x128x14x56xf16, {order = #NHWC}, [@CMX_NN, 0]>

!Input1 = memref<1x128x14x56xf16, {order = #NHWC}, [@CMX_NN, 1]>

!Input2 = memref<1x128x14x56xf16, {order = #NHWC}, [@CMX_NN, 2]>

!Input3 = memref<1x128x14x56xf16, {order = #NHWC}, [@CMX_NN, 3]>
...
func.func @main(%arg0:  memref<1x128x14x56xf16>, %arg1:  memref<1x128x14x56xf16>, %arg2:  memref<1x128x14x56xf16>, %arg3:  memref<1x128x14x56xf16>, %arg4:  memref<1x128x15x56x!qElemType1, {order = #NHWC}, [@CMX_NN, 0]>, %arg5:  memref<1x128x15x56x!qElemType1, {order = #NHWC}, [@CMX_NN, 1]>, %arg6:  memref<1x128x15x56x!qElemType1, {order = #NHWC}, [@CMX_NN, 2]>, %arg7:  memref<1x128x15x56x!qElemType1, {order = #NHWC}, [@CMX_NN, 3]>) -> (memref<1x128x15x56x!qElemType1, {order = #NHWC}, [@CMX_NN, 0]>, memref<1x128x15x56x!qElemType1, {order = #NHWC}, [@CMX_NN, 1]>, memref<1x128x15x56x!qElemType1, {order = #NHWC}, [@CMX_NN, 2]>, memref<1x128x15x56x!qElemType1, {order = #NHWC}, [@CMX_NN, 3]>) {
    %input0 = VPURT.DeclareBuffer <CMX_NN> [0] <0> -> !Input0
    %input1 = VPURT.DeclareBuffer <CMX_NN> [1] <0> -> !Input1
    %input2 = VPURT.DeclareBuffer <CMX_NN> [2] <0> -> !Input2
    %input3 = VPURT.DeclareBuffer <CMX_NN> [3] <0> -> !Input3
    ...
    %weights0 = VPURT.DeclareBuffer <CMX_NN> [0] <2816> -> memref<128x16x1x1x!qElemType0, {order = #NHWC}, [@CMX_NN, 0]>
    %weights1 = VPURT.DeclareBuffer <CMX_NN> [1] <2816> -> memref<128x16x1x1x!qElemType0, {order = #NHWC}, [@CMX_NN, 1]>
    %weights2 = VPURT.DeclareBuffer <CMX_NN> [2] <2816> -> memref<128x16x1x1x!qElemType0, {order = #NHWC}, [@CMX_NN, 2]>
    %weights3 = VPURT.DeclareBuffer <CMX_NN> [3] <2816> -> memref<128x16x1x1x!qElemType0, {order = #NHWC}, [@CMX_NN, 3]>
    ...
    VPURT.Task {
        VPUIP.NCEClusterTask {resultSegmentSizes = array<i32: 1, 0, 0, 0, 0, 0>} <{
            ...
            input(%input0: !Input0)
            weights(%weights0: memref<128x16x1x1x!qElemType0, {order = #NHWC}, [@CMX_NN, 0]>)
            parent_input(%input0: !Input0)
            parent_output(%output0: !OutputITI0)
            output_ITI_buff(%output1, %output2, %output3 : !OutputITI1, !OutputITI2, !OutputITI3)
            outputs(%output0: !OutputITI0)
    ...
    VPURT.Task {
        VPUIP.NCEClusterTask {resultSegmentSizes = array<i32: 1, 0, 0, 0, 0, 0>} <{
            ...
            input(%input1: !Input1)
            weights(%weights1: memref<128x16x1x1x!qElemType0, {order = #NHWC}, [@CMX_NN, 1]>)
            parent_input(%input1: !Input1)
            parent_output(%output1: !OutputITI1)
            output_ITI_buff(%output0, %output2, %output3: !OutputITI0, !OutputITI2, !OutputITI3)
            outputs(%output1: !OutputITI1)
    ...
    VPURT.Task {
        VPUIP.NCEClusterTask {resultSegmentSizes = array<i32: 1, 0, 0, 0, 0, 0>} <{
            ...
            input(%input2: !Input2)
            weights(%weights2: memref<128x16x1x1x!qElemType0, {order = #NHWC}, [@CMX_NN, 2]>)
            parent_input(%input2: !Input2)
            parent_output(%output2: !OutputITI2)
            output_ITI_buff(%output0, %output1, %output3: !OutputITI0, !OutputITI1, !OutputITI3)
            outputs(%output2: !OutputITI2)
    ...
    VPURT.Task {
        VPUIP.NCEClusterTask {resultSegmentSizes = array<i32: 1, 0, 0, 0, 0, 0>} <{
            ...
            input(%input3: !Input3)
            weights(%weights3: memref<128x16x1x1x!qElemType0, {order = #NHWC}, [@CMX_NN, 3]>)
            parent_input(%input3: !Input3)
            parent_output(%output3: !OutputITI3)
            output_ITI_buff(%output0, %output1, %output2: !OutputITI0, !OutputITI1, !OutputITI2)
            outputs(%output3: !OutputITI3)
    ...
    return %arg4, %arg5, %arg6, %arg7: memref<1x128x15x56x!qElemType1, {order = #NHWC}, [@CMX_NN, 0]>, memref<1x128x15x56x!qElemType1, {order = #NHWC}, [@CMX_NN, 1]>, memref<1x128x15x56x!qElemType1, {order = #NHWC}, [@CMX_NN, 2]>, memref<1x128x15x56x!qElemType1, {order = #NHWC}, [@CMX_NN, 3]>
}

//CHECK:    [[INPUT_0:%.+]] = VPURT.DeclareBuffer <CMX_NN> [0] <0> -> memref<1x128x14x56xf16, {order = #NHWC}, [@CMX_NN, 0]>
//CHECK:    [[INPUT_1:%.+]] = VPURT.DeclareBuffer <CMX_NN> [1] <0> -> memref<1x128x14x56xf16, {order = #NHWC}, [@CMX_NN, 1]>
//CHECK:    [[INPUT_2:%.+]] = VPURT.DeclareBuffer <CMX_NN> [2] <0> -> memref<1x128x14x56xf16, {order = #NHWC}, [@CMX_NN, 2]>
//CHECK:    [[INPUT_3:%.+]] = VPURT.DeclareBuffer <CMX_NN> [3] <0> -> memref<1x128x14x56xf16, {order = #NHWC}, [@CMX_NN, 3]>
...
//CHECK:    [[WTS_0:%.+]] = VPURT.DeclareBuffer <CMX_NN> [0] <2816> -> memref<128x16x1x1x!qElemType1, {order = #NHWC}, [@CMX_NN, 0]>
//CHECK:    [[WTS_1:%.+]] = VPURT.DeclareBuffer <CMX_NN> [1] <2816> -> memref<128x16x1x1x!qElemType1, {order = #NHWC}, [@CMX_NN, 1]>
//CHECK:    [[WTS_2:%.+]] = VPURT.DeclareBuffer <CMX_NN> [2] <2816> -> memref<128x16x1x1x!qElemType1, {order = #NHWC}, [@CMX_NN, 2]>
//CHECK:    [[WTS_3:%.+]] = VPURT.DeclareBuffer <CMX_NN> [3] <2816> -> memref<128x16x1x1x!qElemType1, {order = #NHWC}, [@CMX_NN, 3]>
...
//CHECK:      input([[INPUT_0]] : memref<1x128x14x56xf16, {order = #NHWC}, [@CMX_NN, 0]>)
//CHECK:      weights([[WTS_0]] : memref<128x16x1x1x!qElemType1, {order = #NHWC}, [@CMX_NN, 0]>)
//CHECK:      parent_input([[INPUT_0]] : memref<1x128x14x56xf16, {order = #NHWC}, [@CMX_NN, 0]>)
...
//CHECK-SAME:      kernel_strides = [1, 1],
//CHECK-SAME:      task_type = #VPUIP.nce_task_type<DWCONV>}>
//CHECK:      input([[INPUT_1]] : memref<1x128x14x56xf16, {order = #NHWC}, [@CMX_NN, 1]>)
//CHECK:      weights([[WTS_1]] : memref<128x16x1x1x!qElemType1, {order = #NHWC}, [@CMX_NN, 1]>)
//CHECK:      parent_input([[INPUT_1]] : memref<1x128x14x56xf16, {order = #NHWC}, [@CMX_NN, 1]>)
...
//CHECK-SAME:      kernel_strides = [1, 1],
//CHECK-SAME:      task_type = #VPUIP.nce_task_type<DWCONV>}>
//CHECK:      input([[INPUT_2]] : memref<1x128x14x56xf16, {order = #NHWC}, [@CMX_NN, 2]>)
//CHECK:      weights([[WTS_2]] : memref<128x16x1x1x!qElemType1, {order = #NHWC}, [@CMX_NN, 2]>)
//CHECK:      parent_input([[INPUT_2]] : memref<1x128x14x56xf16, {order = #NHWC}, [@CMX_NN, 2]>)
...
//CHECK-SAME:      kernel_strides = [1, 1],
//CHECK-SAME:      task_type = #VPUIP.nce_task_type<DWCONV>}>
//CHECK:      input([[INPUT_3]] : memref<1x128x14x56xf16, {order = #NHWC}, [@CMX_NN, 3]>)
//CHECK:      weights([[WTS_3]] : memref<128x16x1x1x!qElemType1, {order = #NHWC}, [@CMX_NN, 3]>)
//CHECK:      parent_input([[INPUT_3]] : memref<1x128x14x56xf16, {order = #NHWC}, [@CMX_NN, 3]>)
...
!Input0 = memref<
    1x16x2x121xf16, {order = #NHWC}, [@CMX_NN, 0]
>

!Input1 = memref<
    1x16x2x121xf16, {order = #NHWC}, [@CMX_NN, 1]
>
...
func.func @main(%arg0:  memref<1x16x2x121xf16, {order = #NHWC}, [@CMX_NN, 0]>, %arg1:  memref<1x16x2x121xf16, {order = #NHWC}, [@CMX_NN, 1]>,
                %arg2:  memref<1x16x4x121xf16, {order = #NHWC}, [@CMX_NN, 0]>, %arg3: memref<1x16x4x121xf16, {order = #NHWC}, [@CMX_NN, 1]>)
-> (memref<1x16x4x121xf16, {order = #NHWC}, [@CMX_NN, 0]>, memref<1x16x4x121xf16, {order = #NHWC}, [@CMX_NN, 1]>) {
    ...
    return %arg2, %arg3: memref<1x16x4x121xf16, {order = #NHWC}, [@CMX_NN, 0]>, memref<1x16x4x121xf16, {order = #NHWC}, [@CMX_NN, 1]>
