...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform% allow-custom-values=true" --unroll-upsampling-dma %s | FileCheck %s
// REQUIRES: platform-NPU4000

#NCHW = affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>
// CHECK-LABEL: @NoUnrollUpsamplingDMAWithNCHW
func.func @NoUnrollUpsamplingDMAWithNCHW() -> memref<1x4x33554432x60xf16, @DDR> {
    %bar0 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier

    %input = VPURT.DeclareBuffer <NetworkInput> [0] <0> -> memref<1x4x16777216x30xf16, @DDR>
    %output = VPURT.DeclareBuffer <DDR> <262144> -> memref<1x4x33554432x60xf16, @DDR>
    VPURT.Task updates(%bar0 : !VPURT.Barrier) attributes {isTrailingSWLayer = false} {
        %111 = VPUIP.UpsamplingDMAOp <{port = 0 : i64, upsampling_factor = [1, 1, 2, 2]}>
                        inputs(%input : memref<1x4x16777216x30xf16, @DDR>)
                        outputs(%output : memref<1x4x33554432x60xf16, @DDR>) -> memref<1x4x33554432x60xf16, @DDR>
    }
    return %output: memref<1x4x33554432x60xf16, @DDR>
    ...
    // CHECK-DAG:    [[OUTPUT_0:%.+]] = VPURT.DeclareBuffer <DDR> <262144> -> memref<1x1x134217728x60xf16
...
func.func @UnrollUpsamplingDMAWithNCHW() -> memref<1x4x33554432x64xf16, @DDR> {
    %bar0 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier

    %input = VPURT.DeclareBuffer <NetworkInput> [0] <0> -> memref<1x4x16777216x32xf16, @DDR>
    %output = VPURT.DeclareBuffer <DDR> <262144> -> memref<1x4x33554432x64xf16, @DDR>
    VPURT.Task updates(%bar0 : !VPURT.Barrier) attributes {isTrailingSWLayer = false} {
        %111 = VPUIP.UpsamplingDMAOp <{port = 0 : i64, upsampling_factor = [1, 1, 2, 2]}>
                        inputs(%input : memref<1x4x16777216x32xf16, @DDR>)
                        outputs(%output : memref<1x4x33554432x64xf16, @DDR>) -> memref<1x4x33554432x64xf16, @DDR>
    }
    return %output: memref<1x4x33554432x64xf16, @DDR>

    // CHECK:    [[BARRIER:%.+]] = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    // CHECK-DAG:    [[INPUT_0:%.+]] = VPURT.DeclareBuffer <NetworkInput> [0] <4294967232> -> memref<1x1x1x32xf16, [@DDR, 0]>
    // CHECK-DAG:    [[INPUT_1:%.+]] = VPURT.DeclareBuffer <NetworkInput> [0] <0> -> memref<1x1x67108863x32xf16
...
func.func @UnrollUpsamplingDMAWithNHWC() -> memref<1x32x8x33554432xf16, {order = #NHWC}, @DDR> {
    %bar0 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier

    %input = VPURT.DeclareBuffer <NetworkInput> [0] <0> -> memref<1x32x4x16777216xf16, {order = #NHWC}, @DDR>
    %output = VPURT.DeclareBuffer <DDR> <524288> -> memref<1x32x8x33554432xf16, {order = #NHWC}, @DDR>
    VPURT.Task updates(%bar0 : !VPURT.Barrier) attributes {isTrailingSWLayer = false} {
        %111 = VPUIP.UpsamplingDMAOp <{port = 0 : i64, upsampling_factor = [1, 1, 2, 2]}>
                        inputs(%input : memref<1x32x4x16777216xf16, {order = #NHWC}, @DDR>)
                        outputs(%output : memref<1x32x8x33554432xf16, {order = #NHWC}, @DDR>) -> memref<1x32x8x33554432xf16, {order = #NHWC}, @DDR>
    }

    return %output: memref<1x32x8x33554432xf16, {order = #NHWC}, @DDR>

    // CHECK:    [[BARRIER:%.+]] = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    // CHECK-DAG:    [[INPUT_0:%.+]] = VPURT.DeclareBuffer <NetworkInput> [0] <3221225472> -> memref<1x32x1x16777216xf16, {order = #NHWC}, [@DDR, 0]>
    // CHECK-DAG:    [[INPUT_1:%.+]] = VPURT.DeclareBuffer <NetworkInput> [0] <0> -> memref<1x32x3x16777216xf16, {order = #NHWC}, [@DDR, 0]>

    // CHECK-DAG:    [[OUTPUT:%.+]] = VPURT.DeclareBuffer <DDR> <524288> -> memref<1x32x8x33554432xf16, {order = #NHWC}, @DDR>
    // CHECK-DAG:    [[OUTPUT_0:%.+]] = VPURT.DeclareBuffer <DDR> <12885426176> -> memref<1x32x2x33554432xf16, {order = #NHWC}, @DDR>
    // CHECK-DAG:    [[OUTPUT_1:%.+]] = VPURT.DeclareBuffer <DDR> <524288> -> memref<1x32x6x33554432xf16, {order = #NHWC}, @DDR>
    // CHECK:    VPURT.Task updates([[BARRIER]] : !VPURT.Barrier)
    // CHECK-SAME:  {
    // CHECK:           VPUIP.UpsamplingDMAOp <{
    // CHECK-SAME:          dma_descriptor = #VPUIP.DMADescriptorAttr<
    ...
    // CHECK-SAME:          upsampling_factor = [1, 1, 2, 2]
    // CHECK-SAME:      }
    // CHECK-SAME:      inputs([[INPUT_1]] : memref<1x32x3x16777216xf16, {order = #NHWC}, [@DDR, 0]>)
    // CHECK-SAME:      outputs([[OUTPUT_1]] : memref<1x32x6x33554432xf16, {order = #NHWC}, @DDR>) -> memref<1x32x6x33554432xf16, {order = #NHWC}, @DDR>
    // CHECK:       }
    ...
    // CHECK-SAME:          port = 1 : i64
    // CHECK-SAME:          upsampling_factor = [1, 1, 2, 2]
    // CHECK-SAME:      inputs([[INPUT_0]] : memref<1x32x1x16777216xf16, {order = #NHWC}, [@DDR, 0]>)
    // CHECK-SAME:      outputs([[OUTPUT_0]] : memref<1x32x2x33554432xf16, {order = #NHWC}, @DDR>) -> memref<1x32x2x33554432xf16, {order = #NHWC}, @DDR>
    // CHECK:       }

    // CHECK:    return [[OUTPUT]] : memref<1x32x8x33554432xf16, {order = #NHWC}, @DDR>
}
...
func.func @UnrollUpsamplingDMAWithExpandAttrWithNHWC() -> memref<1x40x8x33554432xf16, {order = #NHWC}, @DDR> {
    %bar0 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier

    %input = VPURT.DeclareBuffer <NetworkInput> [0] <0> -> memref<1x32x4x16777216xf16, {order = #NHWC}, @DDR>
    %output = VPURT.DeclareBuffer <DDR> <524288> -> memref<1x40x8x33554432xf16, {order = #NHWC}, @DDR>

    VPURT.Task updates(%bar0 : !VPURT.Barrier) attributes {isTrailingSWLayer = false} {
        %3 = VPUIP.UpsamplingDMAOp <{expand = [0, 8, 0, 0], port = 1 : i64, upsampling_factor = [1, 1, 2, 2]}>
        inputs(%input : memref<1x32x4x16777216xf16, {order = #NHWC}, @DDR>)
        outputs(%output : memref<1x40x8x33554432xf16, {order = #NHWC}, @DDR>) -> memref<1x40x8x33554432xf16, {order = #NHWC}, @DDR>
    }

    return %output: memref<1x40x8x33554432xf16, {order = #NHWC}, @DDR>

    // CHECK:    [[BARRIER:%.+]] = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    // CHECK-DAG:    [[INPUT_0:%.+]] = VPURT.DeclareBuffer <NetworkInput> [0] <3221225472> -> memref<1x32x1x16777216xf16, {order = #NHWC}, [@DDR, 0]>
    // CHECK-DAG:    [[INPUT_1:%.+]] = VPURT.DeclareBuffer <NetworkInput> [0] <0> -> memref<1x32x3x16777216xf16, {order = #NHWC}, [@DDR, 0]>

    // CHECK-DAG:    [[OUTPUT:%.+]] = VPURT.DeclareBuffer <DDR> <524288> -> memref<1x40x8x33554432xf16, {order = #NHWC}, @DDR>
    // CHECK-DAG:    [[OUTPUT_0:%.+]] = VPURT.DeclareBuffer <DDR> <16106651648> -> memref<1x40x2x33554432xf16, {order = #NHWC}, @DDR>
    // CHECK-DAG:    [[OUTPUT_1:%.+]] = VPURT.DeclareBuffer <DDR> <524288> -> memref<1x40x6x33554432xf16, {order = #NHWC}, @DDR>
    // CHECK:    VPURT.Task updates([[BARRIER]] : !VPURT.Barrier)
    // CHECK-SAME:  {
    // CHECK:           VPUIP.UpsamplingDMAOp <{
    // CHECK-SAME:          dma_descriptor = #VPUIP.DMADescriptorAttr<
    ...
    // CHECK-SAME:      }
    // CHECK-SAME:      inputs([[INPUT_1]] : memref<1x32x3x16777216xf16, {order = #NHWC}, [@DDR, 0]>)
    // CHECK-SAME:      outputs([[OUTPUT_1]] : memref<1x40x6x33554432xf16, {order = #NHWC}, @DDR>) -> memref<1x40x6x33554432xf16, {order = #NHWC}, @DDR>
    // CHECK:       }
    ...
    // CHECK-SAME:          upsampling_factor = [1, 1, 2, 2]
    // CHECK-SAME:      inputs([[INPUT_0]] : memref<1x32x1x16777216xf16, {order = #NHWC}, [@DDR, 0]>)
    // CHECK-SAME:      outputs([[OUTPUT_0]] : memref<1x40x2x33554432xf16, {order = #NHWC}, @DDR>) -> memref<1x40x2x33554432xf16, {order = #NHWC}, @DDR>
    // CHECK:       }

    // CHECK:    return [[OUTPUT]] : memref<1x40x8x33554432xf16, {order = #NHWC}, @DDR>
}
...
func.func @UnrollUpsamplingDMAWithCstInputWithNHWC() -> memref<1x32x8x33554432xf16, {order = #NHWC}, [@CMX_NN, 0]> {
    %bar0 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    %bar1 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier

    %cst = const.Declare memref<1x32x4x16777216xf16, {order = #NHWC}> = dense<1.0> : tensor<1x32x4x16777216xf16>, [#const.Reorder<#NHWC>]
    %output  = VPURT.DeclareBuffer <CMX_NN> [0] <0> -> memref<1x32x8x33554432xf16, {order = #NHWC}, [@CMX_NN, 0]>
    VPURT.Task waits(%bar0 : !VPURT.Barrier) updates(%bar1 : !VPURT.Barrier) {
        %3 = VPUIP.UpsamplingDMAOp <{upsampling_factor = [1, 1, 2, 2]}> inputs(%cst : memref<1x32x4x16777216xf16, {order = #NHWC}>)
        outputs(%output : memref<1x32x8x33554432xf16, {order = #NHWC}, [@CMX_NN, 0]>) -> memref<1x32x8x33554432xf16, {order = #NHWC}, [@CMX_NN, 0]>
    }
    return %output: memref<1x32x8x33554432xf16, {order = #NHWC}, [@CMX_NN, 0]>


    // CHECK:    [[BARRIER_0:%.+]] = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    // CHECK:    [[BARRIER_1:%.+]] = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier

    // CHECK:    [[CST_0:%.+]] = const.Declare memref<1x32x4x16777216xf16, {order = #NHWC}> = dense<1.000000e+00> : tensor<1x32x4x16777216xf16>, [#const.Reorder<#NHWC>]

    // CHECK:    [[OUTPUT:%.+]] = VPURT.DeclareBuffer <CMX_NN> [0] <0> -> memref<1x32x8x33554432xf16, {order = #NHWC}, [@CMX_NN, 0]>
    // CHECK:    [[OUTPUT_0:%.+]] = VPURT.DeclareBuffer <CMX_NN> [0] <12884901888> -> memref<1x32x2x33554432xf16, {order = #NHWC}, [@CMX_NN, 0]>
    // CHECK:    [[OUTPUT_1:%.+]] = VPURT.DeclareBuffer <CMX_NN> [0] <0> -> memref<1x32x6x33554432xf16, {order = #NHWC}, [@CMX_NN, 0]>

    // CHECK:    [[SUBVIEW_0:%.+]] = VPUIP.SubView [[CST_0]] [0, 0, 0, 0] [1, 32, 3, 16777216] : memref<1x32x4x16777216xf16, {order = #NHWC}> to memref<1x32x3x16777216xf16, {order = #NHWC, strides = [2147483648, 1, 536870912, 32]}>
    ...
    // CHECK-SAME:      outputs([[OUTPUT_1]] : memref<1x32x6x33554432xf16, {order = #NHWC}, [@CMX_NN, 0]>) -> memref<1x32x6x33554432xf16, {order = #NHWC}, [@CMX_NN, 0]>
    // CHECK:       }

    // CHECK:    [[SUBVIEW_1:%.+]] = VPUIP.SubView [[CST_0]] [0, 0, 3, 0] [1, 32, 1, 16777216] : memref<1x32x4x16777216xf16, {order = #NHWC}> to memref<1x32x1x16777216xf16, {order = #NHWC, strides = [2147483648, 1, 536870912, 32]}>
    // CHECK:       VPURT.Task waits([[BARRIER_0]] : !VPURT.Barrier) updates([[BARRIER_1]] : !VPURT.Barrier)
    // CHECK-SAME:  {
    // CHECK:           VPUIP.UpsamplingDMAOp <{
    // CHECK-SAME:      dma_descriptor = #VPUIP.DMADescriptorAttr<
    ...
    // CHECK-SAME:      outputs([[OUTPUT_0]] : memref<1x32x2x33554432xf16, {order = #NHWC}, [@CMX_NN, 0]>) -> memref<1x32x2x33554432xf16, {order = #NHWC}, [@CMX_NN, 0]>
    // CHECK:       }

    // CHECK:    return [[OUTPUT]] : memref<1x32x8x33554432xf16, {order = #NHWC}, [@CMX_NN, 0]>
}
}
...
func.func @UnrollUpsamplingDMAWithCstInputWithNCHW() -> memref<1x4x33554432x64xf16, [@CMX_NN, 0]> {
    %bar0 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    %bar1 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    ...
    return %output: memref<1x4x33554432x64xf16, [@CMX_NN, 0]>
    ...
    // CHECK:    [[OUTPUT_1:%.+]] = VPURT.DeclareBuffer <CMX_NN> [0] <0> -> memref<1x1x134217726x64xf16
