...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform%" --convert-func-args-to-declarations --canonicalize --move-declarations-to-top --verify-diagnostics %s
