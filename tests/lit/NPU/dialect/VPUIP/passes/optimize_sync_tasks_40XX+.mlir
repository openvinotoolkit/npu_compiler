...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform%" --optimize-sync-tasks %s | FileCheck %s
...
func.func @MergeSyncTasks() -> memref<1x16x1x1xf16, {order = #NHWC}, @DDR> {
    // barriers
    ...
    VPURT.Task updates(%bar0: !VPURT.Barrier) {
        VPUIP.NNDMA <{port = 0 : i64}> inputs(%buf0: memref<1x16x1x1xf16, {order = #NHWC}, @DDR>) outputs(%buf1: memref<1x16x1x1xf16, {order = #NHWC}, @DDR>) -> memref<1x16x1x1xf16, {order = #NHWC}, @DDR>
    }

    VPURT.Task updates(%bar0: !VPURT.Barrier) {
        VPUIP.NNDMA <{port = 1 : i64}> inputs(%buf0: memref<1x16x1x1xf16, {order = #NHWC}, @DDR>) outputs(%buf1: memref<1x16x1x1xf16, {order = #NHWC}, @DDR>) -> memref<1x16x1x1xf16, {order = #NHWC}, @DDR>
    }
...
func.func @DoNotRemoveSyncTaskIfItHasMultipleProducersAndConsumers() -> memref<1x16x1x1xf16, {order = #NHWC}, @DDR> {
    // barriers
    %bar0 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    %bar1 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    %bar2 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
...
func.func @RemoveRedundantSyncTaskBarDepAfter() -> memref<1x16x1x1xf16, {order = #NHWC}, @DDR> {
    // barriers
    %bar0 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    %bar1 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    %bar2 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
...
func.func @RemoveRedundantSyncTaskBarDepBefore() -> memref<1x16x1x1xf16, {order = #NHWC}, @DDR> {
    // barriers
    %bar0 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    %bar1 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    %bar2 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
...
func.func @RemoveRedundantSyncTaskFifoDepAfter() -> memref<1x16x1x1xf16, {order = #NHWC}, @DDR> {
    // barriers
    %bar0 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    %bar1 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
...
func.func @RemoveRedundantSyncTaskFifoDepBefore() -> memref<1x16x1x1xf16, {order = #NHWC}, @DDR> {
    // barriers
    %bar0 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    %bar1 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
...
func.func @RemoveRedundantSyncTaskIfFirst() -> memref<1x16x1x1xf16, {order = #NHWC}, @DDR> {
    // barriers
    %bar0 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
...
func.func @RemoveRedundantSyncTaskIfFirstDoNotRemoveBar() -> memref<1x16x1x1xf16, {order = #NHWC}, @DDR> {
    // barriers
    %bar0 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
...
func.func @RemoveRedundantSyncTaskIfLast() -> memref<1x16x1x1xf16, {order = #NHWC}, @DDR> {
    // barriers
    %bar0 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
...
func.func @RemoveRedundantSyncTaskFirstAndLast() -> memref<1x16x1x1xf16, {order = #NHWC}, @DDR> {
    // barriers
    %bar0 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    %bar1 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
...
!CmxType = memref<1x64x32x32xf16, {order = #NHWC}, [@CMX_NN, 0]>

// CHECK-LABEL: @DoNotRemoveSyncTaskBarVariantLimit
func.func @DoNotRemoveSyncTaskBarVariantLimit() -> memref<1x64x32x32xf16, {order = #NHWC}, [@CMX_NN, 0]> {
    // barriers
    %bar0 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    %bar1 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    ...
    VPURT.Task updates(%bar0 : !VPURT.Barrier) {
      VPUIP.NCEClusterTask {resultSegmentSizes = array<i32: 1, 0, 0, 0, 0, 0>} <{task_type = #VPUIP.nce_task_type<ELTWISE>}> input(%buf0: !CmxType) weights(%buf0: !CmxType) parent_input(%buf0: !CmxType) parent_output(%buf1: !CmxType) outputs(%buf1: !CmxType) -> !CmxType variants : {
