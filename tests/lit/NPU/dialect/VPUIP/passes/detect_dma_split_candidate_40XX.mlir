...
// CHECK-LABEL: @AssignSplitCandidateToConvertDMA
func.func @AssignSplitCandidateToConvertDMA(%arg0: !DummyT) -> !DummyT {
    %0 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    %1 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    %2 = VPURT.DeclareBuffer <DDR> <0> -> memref<1x1x1024x1024xf32, @DDR>
    %3 = VPURT.DeclareBuffer <DDR> <4194304> -> memref<1x1x1024x1024xf16, @DDR>

    VPURT.Task waits(%0 : !VPURT.Barrier) updates(%1 : !VPURT.Barrier) {
      %4 = VPUIP.ConvertDMA <{port = 0 : i64}> inputs(%2 : memref<1x1x1024x1024xf32, @DDR>) outputs(%3 : memref<1x1x1024x1024xf16, @DDR>) -> memref<1x1x1024x1024xf16, @DDR>
    }

    // CHECK:       [[CONVERTDMA:%.+]] = VPUIP.ConvertDMA <{port = 0 : i64, split_candidate = true}>
...
// CHECK-LABEL: @NotAssignSplitCandidateToSmallConvertDMA
func.func @NotAssignSplitCandidateToSmallConvertDMA(%arg0: !DummyT) -> !DummyT {
    %0 = VPURT.DeclareBuffer <DDR> <0> -> memref<1x1x1x16xf32, @DDR>
    %1 = VPURT.DeclareBuffer <DDR> <100> -> memref<1x1x1x16xf16, @DDR>

    VPURT.Task {
      %2 = VPUIP.ConvertDMA <{port = 0 : i64}> inputs(%0 : memref<1x1x1x16xf32, @DDR>) outputs(%1 : memref<1x1x1x16xf16, @DDR>) -> memref<1x1x1x16xf16, @DDR>
    }
