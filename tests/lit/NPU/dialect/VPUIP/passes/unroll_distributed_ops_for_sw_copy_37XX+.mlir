...
module @VPU.SW {
    func.func nested @builtin_Copy(memref<*xui4, @DDR>, memref<*xui4, @CMX_NN>) attributes {VPU.kernel_code = "copy.cpp", VPU.kernel_entry = "copy", VPU.task_type = @COMPUTE}
...
VPURT.SW.Runtime entryPoint : @VPU.SW::@runtime stack_configuration : [4096, 4096, 4096, 4096]
module @VPU.SW {
    func.func nested @builtin_Copy(memref<*xi4, @CMX_NN>, memref<*xi4, @DDR>) attributes {VPU.kernel_code = "copy.cpp", VPU.kernel_entry = "copy", VPU.task_type = @COMPUTE}
    func.func nested @runtime() attributes {VPU.kernel_code = "nnActEntry"}
}
...
// CHECK:        [[OUTPUT_TILE_0:%.+]] = VPURT.DeclareBuffer <DDR> <0> -> memref<1x1x10x20xsi8, @DDR>
// CHECK:        [[OUTPUT_TILE_1:%.+]] = VPURT.DeclareBuffer <DDR> <200> -> memref<1x1x10x20xsi8, @DDR>
...
// CHECK:        VPURT.Task waits([[BARRIER_3]] : !VPURT.Barrier) {
// CHECK:          [[NNDMA_0:%.+]] = VPUIP.NNDMA <{port = 0 : i64}> inputs([[INPUT_CMX_0]] : memref<1x1x10x20xsi8, [@CMX_NN, 0]>) outputs([[OUTPUT_TILE_0]] : memref<1x1x10x20xsi8, @DDR>) -> memref<1x1x10x20xsi8, @DDR>
// CHECK:        }
// CHECK:        VPURT.Task waits([[BARRIER_3]] : !VPURT.Barrier) {
// CHECK:          [[NNDMA_1:%.+]] = VPUIP.NNDMA <{port = 1 : i64}> inputs([[INPUT_CMX_1]] : memref<1x1x10x20xsi8, [@CMX_NN, 1]>) outputs([[OUTPUT_TILE_1]] : memref<1x1x10x20xsi8, @DDR>) -> memref<1x1x10x20xsi8, @DDR>
// CHECK:        }
...
VPURT.SW.Runtime entryPoint : @VPU.SW::@runtime stack_configuration : [4096, 4096, 4096, 4096]
module @VPU.SW {
    func.func nested @builtin_Copy(memref<*xsi4, @CMX_NN>, memref<*xsi4, @DDR>) attributes {VPU.kernel_code = "copy.cpp", VPU.kernel_entry = "copy", VPU.task_type = @COMPUTE}
    func.func nested @runtime() attributes {VPU.kernel_code = "nnActEntry"}
}
...
// CHECK:          [[INPUT_TILE_0:%.+]] = VPURT.DeclareBuffer <DDR> <0> -> memref<1x1x10x20xf16, @DDR>
// CHECK:          [[INPUT_TILE_1:%.+]] = VPURT.DeclareBuffer <DDR> <400> -> memref<1x1x10x20xf16, @DDR>
...
// CHECK:          VPURT.Task updates([[BARRIER_0]] : !VPURT.Barrier) {
// CHECK:            [[NNDMA_0:%.+]] = VPUIP.NNDMA <{port = 0 : i64}> inputs([[INPUT_TILE_0]] : memref<1x1x10x20xf16, @DDR>) outputs([[OUTPUT_CMX_0]] : memref<1x1x10x20xf16, [@CMX_NN, 0]>) -> memref<1x1x10x20xf16, [@CMX_NN, 0]>
// CHECK:          }
// CHECK:          VPURT.Task updates([[BARRIER_0]] : !VPURT.Barrier) {
// CHECK:            [[NNDMA_1:%.+]] = VPUIP.NNDMA <{port = 1 : i64}> inputs([[INPUT_TILE_1]] : memref<1x1x10x20xf16, @DDR>) outputs([[OUTPUT_CMX_1]] : memref<1x1x10x20xf16, [@CMX_NN, 1]>) -> memref<1x1x10x20xf16, [@CMX_NN, 1]>
// CHECK:          }
