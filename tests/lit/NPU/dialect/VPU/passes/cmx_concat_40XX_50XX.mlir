...
func.func @ConcatDistributedOpWithExplicitDistributedAttrAndConstantSecondInput(%arg0: !ConvInput_DDR,
    ...
    %convOutput = VPU.NCE.Convolution(%inputCMX, %weights0, %weightsTable) rawFilterShape [128, 128, 3, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
    ...
    %output = VPU.NCE.Convolution(%concatOutCMX, %weights1, %weightsTable) rawFilterShape [128, 128, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
...
func.func @SOWProducersSOWConsumersOfConcatWithExplicitDistributedAttrWithHSlice(
    ...
    %conv0Output = VPU.NCE.Convolution(%input0CMX, %weights0, %weightsTable0) rawFilterShape [64, 64, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
    ...
    %conv1Output = VPU.NCE.Convolution(%input1CMX, %weights1, %weightsTable1) rawFilterShape [16, 16, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
            pad = #VPU.Padding<left = 0, right = 0, top = 0, bottom = 0>,
            ppe = #VPU.PPEStub<>,
             strides = [1, 1]}
    ...
    %output0 = VPU.NCE.Convolution(%input2CMX, %weights2, %weightsTable0) rawFilterShape [64, 80, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
            pad = #VPU.Padding<left = 1, right = 1, top = 1, bottom = 1>,
            ppe = #VPU.PPEStub<>,
             strides = [1, 1]}
    ...
    %output1 = VPU.NCE.Convolution(%input3CMX, %weights3, %weightsTable0) rawFilterShape [64, 80, 5, 5] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
...
func.func @SOHProducersSOHConsumersOfConcatWithExplicitDistributedAttrWithHSlice(
    ...
    %conv0Output = VPU.NCE.Convolution(%input0CMX, %weights0, %weightsTable0) rawFilterShape [16, 16, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
            pad = #VPU.Padding<left = 0, right = 0, top = 0, bottom = 0>,
            ppe = #VPU.PPEStub<>,
             strides = [1, 1]}
    ...
    %conv1Output = VPU.NCE.Convolution(%input1CMX, %weights1, %weightsTable1) rawFilterShape [32, 32, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
            pad = #VPU.Padding<left = 0, right = 0, top = 0, bottom = 0>,
            ppe = #VPU.PPEStub<>,
             strides = [1, 1]}
    ...
    %output0 = VPU.NCE.Convolution(%input2CMX, %weights2, %weightsTable2) rawFilterShape [48, 48, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
            pad = #VPU.Padding<left = 1, right = 1, top = 1, bottom = 1>,
            ppe = #VPU.PPEStub<>,
             strides = [1, 1]}
    ...
    %output1 = VPU.NCE.Convolution(%input3CMX, %weights3, %weightsTable2) rawFilterShape [48, 48, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
            pad = #VPU.Padding<left = 0, right = 0, top = 0, bottom = 0>,
            ppe = #VPU.PPEStub<>,
             strides = [1, 1]}
...
func.func @SOKProducersSOHConsumersOfConcatWithExplicitDistributedAttrWithHSlice(
    ...
    %conv0Output = VPU.NCE.Convolution(%inputCMX, %weights0, %weightsTable0) rawFilterShape [32, 16, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
            pad = #VPU.Padding<left = 0, right = 0, top = 0, bottom = 0>,
            ppe = #VPU.PPEStub<>,
             strides = [1, 1]}
    ...
    %conv1Output = VPU.NCE.Convolution(%inputCMX, %weights1, %weightsTable1) rawFilterShape [64, 16, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
            pad = #VPU.Padding<left = 0, right = 0, top = 0, bottom = 0>,
            ppe = #VPU.PPEStub<>,
             strides = [1, 1]}
    ...
    %output0 = VPU.NCE.Convolution(%input2CMX, %weights2, %weightsTable2) rawFilterShape [96, 96, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
            pad = #VPU.Padding<left = 0, right = 0, top = 0, bottom = 0>,
            ppe = #VPU.PPEStub<>,
             strides = [1, 1]}
    ...
    %output1 = VPU.NCE.Convolution(%input3CMX, %weights2, %weightsTable2) rawFilterShape [96, 96, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
            pad = #VPU.Padding<left = 0, right = 0, top = 0, bottom = 0>,
            ppe = #VPU.PPEStub<>,
             strides = [1, 1]}
...
func.func @SparseConvolution(%input: !SparseConvInput,
    ...
    // Convolution 0
    %1 = VPU.NCE.Convolution(%0, %weights, %weightsTable) rawFilterShape [128, 256, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
    ...
    // Convolution 1
    %3 = VPU.NCE.Convolution(%0, %weights, %weightsTable) rawFilterShape [128, 256, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
            pad = #VPU.Padding<left = 1 : i64, right = 0 : i64, top = 1 : i64, bottom = 0 : i64>,
            ppe = #VPU.PPEStub<>,
             strides = [2, 2]}
                : !SparseDistributedInput, !WeightsType, !WeightsTableType -> !SparseDistributedOutput
    ...
    // Convolution 2
    %7 = VPU.NCE.Convolution(%6, %weights, %weightsTable) rawFilterShape [128, 256, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
...
func.func @SOKProducersSOKConsumersOfConcatWithExplicitDistributedAttrWithHSlice(
    ...
    %output0 = VPU.NCE.Convolution(%input2CMX, %weights2, %weightsTable0) rawFilterShape [64, 96, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
            pad = #VPU.Padding<left = 1, right = 1, top = 1, bottom = 1>,
            ppe = #VPU.PPEStub<>,
             strides = [1, 1]}
    ...
    %output1 = VPU.NCE.Convolution(%input3CMX, %weights3, %weightsTable0) rawFilterShape [64, 96, 5, 5] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
            pad = #VPU.Padding<left = 2, right = 2, top = 2, bottom = 2>,
            ppe = #VPU.PPEStub<>,
             strides = [1, 1]}
...
func.func @ComplexConcatWithExplicitDistribution(
    ...
    %output1 = VPU.NCE.Convolution(%input3CMX, %weights3, %weightsTable0) rawFilterShape [64, 80, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
            pad = #VPU.Padding<left = 1, right = 1, top = 1, bottom = 1>,
            ppe = #VPU.PPEStub<>,
             strides = [1, 1]}
...
func.func @SkipCMXConcatForNCEPermute(%arg0: tensor<1x16x90x160xf16, {order = #NHWC}>,
    ...
    %1 = VPU.NCE.MaxPool(%0, %maxPoolWeightsTable) {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
                pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,
                ppe = #VPU.PPEStub<>,
                strides = [1, 1],
                kernel_size = [1, 1]
    ...
    %8 = VPU.NCE.MaxPool(%7, %maxPoolWeightsTable1) {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
                pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,
                ppe = #VPU.PPEStub<>,
                strides = [1, 1],
                kernel_size = [1, 1]
...
func.func @DisableCMXConcatWhenConcatAxisIsHigher(
    ...
    %conv1Output = VPU.NCE.Convolution(%input1CMX, %weights1, %weightsTable1) rawFilterShape [64, 64, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
            pad = #VPU.Padding<left = 0, right = 0, top = 0, bottom = 0>,
            ppe = #VPU.PPEStub<>,
             strides = [1, 1]}
    ...
    %output0 = VPU.NCE.Convolution(%input2CMX, %weights2, %weightsTable0) rawFilterShape [64, 64, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
            pad = #VPU.Padding<left = 1, right = 1, top = 1, bottom = 1>,
            ppe = #VPU.PPEStub<>,
             strides = [1, 1]}
