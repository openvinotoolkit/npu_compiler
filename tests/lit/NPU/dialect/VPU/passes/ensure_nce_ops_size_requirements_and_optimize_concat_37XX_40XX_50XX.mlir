...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform%" --ensure-nce-ops-size-requirements --optimize-concat --canonicalize %s | FileCheck %s
...
func.func @SplitNCEConvWithEltwiseAddOverOC(%input1: tensor<1x128x256x4xf16, {order = #NHWC}>, %input2: tensor<1x128x256x4xf16, {order = #NHWC}>) -> tensor<1x18944x256x4xf16, {order = #NHWC}> {
    ...
    %conv0 = VPU.NCE.Convolution(%input1, %weights0, %weightsTable0) rawFilterShape [18944, 128, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
    ...
    %conv1 = VPU.NCE.Convolution(%input2, %weights1, %weightsTable1) rawFilterShape [18944, 128, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
        pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,
        ppe = #VPU.PPEInt<mode = <NOOP>, clamp_low = -2147483648 : i64, clamp_high = 2147483647 : i64,
        lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, fp_prelu_alpha = 1.000000e+00 : f64>,
         strides = [1, 1]
  ...
  //CHECK:        [[CONV_0:%.+]] = VPU.NCE.Convolution([[INPUT0]], [[CST_3]], [[CST_4]]) rawFilterShape [6320, 128, 1, 1] {
  ...
  //CHECK:        [[CONV_1:%.+]] = VPU.NCE.Convolution([[INPUT0]], [[CST_2]], [[CST_1]]) rawFilterShape [6320, 128, 1, 1] {
  //CHECK-SAME:       pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,
  //CHECK-SAME:       ppe = #VPU.PPEInt<mode = <NOOP>, clamp_low = -2147483648 : i64, clamp_high = 2147483647 : i64,
  //CHECK-SAME:       lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, fp_prelu_alpha = 1.000000e+00 : f64>,
  // CHECK-SAME:      strides = [1, 1]
  ...
  //CHECK:        [[CONV_2:%.+]] = VPU.NCE.Convolution([[INPUT0]], [[CST_0]], [[CST]]) rawFilterShape [6304, 128, 1, 1] {
  //CHECK-SAME:       pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,
  //CHECK-SAME:       ppe = #VPU.PPEInt<mode = <NOOP>, clamp_low = -2147483648 : i64, clamp_high = 2147483647 : i64,
  //CHECK-SAME:       lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, fp_prelu_alpha = 1.000000e+00 : f64>,
  // CHECK-SAME:      strides = [1, 1]
  ...
  //CHECK:        [[CONV_3:%.+]] = VPU.NCE.Convolution([[INPUT1]], [[CST_3]], [[CST_4]]) rawFilterShape [6320, 128, 1, 1] {
  //CHECK-SAME:       pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,
  //CHECK-SAME:       ppe = #VPU.PPEInt<mode = <NOOP>, clamp_low = -2147483648 : i64, clamp_high = 2147483647 : i64,
  //CHECK-SAME:       lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, fp_prelu_alpha = 1.000000e+00 : f64>,
  // CHECK-SAME:      strides = [1, 1]
  ...
  //CHECK:        [[CONV_4:%.+]] = VPU.NCE.Convolution([[INPUT1]], [[CST_2]], [[CST_1]]) rawFilterShape [6320, 128, 1, 1] {
  //CHECK-SAME:       pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,
  //CHECK-SAME:       ppe = #VPU.PPEInt<mode = <NOOP>, clamp_low = -2147483648 : i64, clamp_high = 2147483647 : i64,
  //CHECK-SAME:       lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, fp_prelu_alpha = 1.000000e+00 : f64>,
  // CHECK-SAME:      strides = [1, 1]
  ...
  //CHECK:        [[CONV_5:%.+]] = VPU.NCE.Convolution([[INPUT1]], [[CST_0]], [[CST]]) rawFilterShape [6304, 128, 1, 1] {
  //CHECK-SAME:       pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,
  //CHECK-SAME:       ppe = #VPU.PPEInt<mode = <NOOP>, clamp_low = -2147483648 : i64, clamp_high = 2147483647 : i64,
  //CHECK-SAME:       lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, fp_prelu_alpha = 1.000000e+00 : f64>,
  // CHECK-SAME:      strides = [1, 1]
