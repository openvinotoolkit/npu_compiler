...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform% allow-custom-values=true enable-vpunn-pre-split=true" --split-NCE-ops-onto-workloads %s | FileCheck %s
