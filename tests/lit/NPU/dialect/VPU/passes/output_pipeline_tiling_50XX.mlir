...
module @executors {
    ...
    func.func @OutputPipeliningWithMinFragmentation(%arg0: tensor<1x8192x256x4xf16, {order = #NHWC}>, %arg1: tensor<128x8192x1x1xf16, {order = #NHWC}>, %arg2: tensor<128x1x1x4xsi32>) -> tensor<1x128x256x4xf16, {order = #NHWC}> {
        %0 = VPU.NCE.Convolution(%arg0, %arg1, %arg2) rawFilterShape [128, 8192, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
        ...
        // CHECK:       [[CONV:%.+]] = VPU.NCE.Convolution([[INPUT0]], [[INPUT1]], [[INPUT2]]) rawFilterShape [128, 8192, 1, 1] {
