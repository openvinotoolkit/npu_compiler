...
func.func @EltwiseStrategyStaticAndDynamic(%arg0: tensor<1x32x800x1280xf16, {order = #NHWC}>, %arg1: tensor<1x32x?x?xf16, {bounds = #const.OpaqueI64Elements<[1, 32, 800, 1280]> : tensor<4xsi64>, order = #NHWC}>)
    ...
    // CHECK-SAME: [[ARG0:%.+]]: tensor<1x32x800x1280xf16, {order = #NHWC}>
    // CHECK-SAME: [[ARG1:%.+]]: tensor<1x32x?x?xf16, {bounds = #const.OpaqueI64Elements<[1, 32, 800, 1280]> : tensor<4xsi64>, order = #NHWC}>
    %0 = VPU.NCE.Eltwise(%arg0, %arg0) {is_inplace = true, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, op_type = #VPU.eltwise_type<ADD>, ppe = #VPU.PPEInt<mode = <NOOP>, clamp_low = -2147483648 : i64, clamp_high = 2147483647 : i64, lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, quant_scale = [1.000000e+00], fp_prelu_alpha = 1.000000e+00 : f64>} : tensor<1x32x800x1280xf16, {order = #NHWC}>, tensor<1x32x800x1280xf16, {order = #NHWC}> -> tensor<1x32x800x1280xf16, {order = #NHWC}>
    %1 = VPU.NCE.Eltwise(%arg1, %arg1) {is_inplace = true, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, op_type = #VPU.eltwise_type<ADD>, ppe = #VPU.PPEInt<mode = <NOOP>, clamp_low = -2147483648 : i64, clamp_high = 2147483647 : i64,
