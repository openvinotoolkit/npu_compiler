...
// CHECK-LABEL: @SplitNCEConvWithRestraintOfMinimalW
// CHECK-SAME:      [[INPUT:%.+]]: tensor<1x256x512x512xf16, {order = #NHWC}>
func.func @SplitNCEConvWithRestraintOfMinimalW(%arg0: tensor<1x256x512x512xf16, {order = #NHWC}>) -> tensor<1x256x512x512xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.Convolution(%arg0, %cst, %cst_0) rawFilterShape [256, 256, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
    ...
    // CHECK:       [[CONV:%.+]] = VPU.NCE.Convolution([[INPUT]], [[WEIGHTS]], [[WEIGHTS_TABLE]]) rawFilterShape [256, 256, 3, 3] {
    // CHECK-SAME:          multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK-SAME:          pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>
    // CHECK-SAME:          strides = [1, 1], tilingStrategy = [1, 2, 1, 52]
    // CHECK-SAME:      }
...
func.func @Split4BitMaxPool(%arg0: tensor<1x4608x28x128x!qElemType, {order = #NHWC}>) -> tensor<1x4608x28x128x!qElemType, {order = #NHCW}> {
    %0 = VPU.NCE.MaxPool(%arg0) {resultSegmentSizes = array<i32: 1, 0, 0, 0>, kernel_size = [1, 1], multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>,
