...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x256x16x32xf16, {order = #NHWC}>)
func.func @AdaptSWAlignmentToAvoidSpilling(%arg0: tensor<1x256x16x32xf16, {order = #NHWC}>) -> tensor<1x256x16x32xf16, {order = #NHWC}> {
    ...
    %13 = VPU.NCE.DepthConvolution(%12, %cst_44, %cst_45) rawFilterShape [256, 1, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,  strides = [1, 1]} -> tensor<1x256x16x32x!qElemType, {order = #NHWC}>
    %14 = VPU.NCE.Convolution(%13, %cst_1, %cst_43) rawFilterShape [256, 256, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>,  strides = [1, 1]} : tensor<1x256x16x32x!qElemType, {order = #NHWC}>, tensor<256x256x3x3x!qElemType, {order = #NHWC}>, tensor<256x1x1x4xsi32> -> tensor<1x256x16x32xf16, {order = #NHWC}>
    ...
    %16 = VPU.NCE.DepthConvolution(%15, %cst_41, %cst_42) rawFilterShape [256, 1, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,  strides = [1, 1]} -> tensor<1x256x16x32x!qElemType, {order = #NHWC}>
    %17 = VPU.NCE.Convolution(%16, %cst_2, %cst_40) rawFilterShape [256, 256, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>,  strides = [1, 1]} : tensor<1x256x16x32x!qElemType, {order = #NHWC}>, tensor<256x256x3x3x!qElemType, {order = #NHWC}>, tensor<256x1x1x4xsi32> -> tensor<1x256x16x32xf16, {order = #NHWC}>
    ...
    %19 = VPU.NCE.DepthConvolution(%18, %cst_38, %cst_39) rawFilterShape [256, 1, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,  strides = [1, 1]} -> tensor<1x256x16x32x!qElemType, {order = #NHWC}>
    ...
    %22 = VPU.NCE.Eltwise(%20, %21) {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, op_type = #VPU.eltwise_type<ADD>} -> tensor<1x16x32x256x!qElemType, {order = #NHWC}>
    ...
    %24 = VPU.NCE.Convolution(%23, %cst_3, %cst_37) rawFilterShape [256, 256, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>,  strides = [1, 1]} : tensor<1x256x16x32x!qElemType, {order = #NHWC}>, tensor<256x256x3x3x!qElemType, {order = #NHWC}>, tensor<256x1x1x4xsi32> -> tensor<1x256x16x32xf16, {order = #NHWC}>
    return %24 : tensor<1x256x16x32xf16, {order = #NHWC}>

    //CHECK-COUNT-13:   const.Declare
    //CHECK:            [[VAL0:%.+]] = VPU.MVN([[ARG_0]])
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x32x60x60x!qElemType, {order = #NHWC}>)
func.func @NoSpillingWhenSOHAlignmentCanBeAdjustedCompatible(%arg0: tensor<1x32x60x60x!qElemType, {order = #NHWC}>) -> tensor<1x32x15x15x!qElemType, {order = #NHWC}>  {
    ...
    %0 = VPU.NCE.Convolution(%arg0, %cst, %cst_6) rawFilterShape [16, 32, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 1 : i64, right = 0 : i64, top = 1 : i64, bottom = 0 : i64>,  strides = [2, 2]} : tensor<1x32x60x60x!qElemType, {order = #NHWC}>, tensor<16x32x3x3x!qElemType, {order = #NHWC}>, tensor<16x1x1x4xsi32> -> tensor<1x16x30x30x!qElemType, {order = #NHWC}>
    %1 = VPU.NCE.Convolution(%0, %cst_0, %cst_5) rawFilterShape [64, 16, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>,  strides = [1, 1]} : tensor<1x16x30x30x!qElemType, {order = #NHWC}>, tensor<64x16x3x3x!qElemType, {order = #NHWC}>, tensor<64x1x1x4xsi32> -> tensor<1x64x30x30xf16, {order = #NHWC}>
    %2 = VPU.NCE.DepthConvolution(%1, %cst_4, %cst_3) rawFilterShape [64, 1, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,  strides = [1, 1]} -> tensor<1x64x30x30x!qElemType, {order = #NHWC}>
    %3 = VPU.NCE.Convolution(%2, %cst_1, %cst_2) rawFilterShape [32, 64, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 1 : i64, right = 0 : i64, top = 1 : i64, bottom = 0 : i64>,  strides = [2, 2]} : tensor<1x64x30x30x!qElemType, {order = #NHWC}>, tensor<32x64x3x3x!qElemType, {order = #NHWC}>, tensor<32x1x1x4xsi32> -> tensor<1x32x15x15x!qElemType, {order = #NHWC}>

    return %3 : tensor<1x32x15x15x!qElemType, {order = #NHWC}>

    //CHECK-COUNT-7:    const.Declare
    //CHECK:            [[VAL0:%.+]] = VPU.NCE.Convolution([[ARG_0]],
    //CHECK-SAME:          multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x16x135x240x!qElemType, {order = #NHWC}>)
func.func @ConsiderDualPortDMAForSOHSpilling(%arg0: tensor<1x16x135x240x!qElemType, {order = #NHWC}>) -> tensor<1x32x135x240x!qElemType, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.Convolution(%arg0, %cst_1, %cst_4) rawFilterShape [32, 16, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>,  strides = [1, 1]} : tensor<1x16x135x240x!qElemType, {order = #NHWC}>, tensor<32x16x3x3x!qElemType, {order = #NHWC}>, tensor<32x1x1x4xsi32> -> tensor<1x32x135x240x!qElemType, {order = #NHWC}>
    %1 = VPU.NCE.Convolution(%0, %cst, %cst_3) rawFilterShape [128, 32, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>,  strides = [1, 1]} : tensor<1x32x135x240x!qElemType, {order = #NHWC}>, tensor<128x32x3x3x!qElemType, {order = #NHWC}>, tensor<128x1x1x4xsi32> -> tensor<1x128x135x240x!qElemType, {order = #NHWC}>
    %2 = VPU.NCE.Convolution(%1, %cst_0, %cst_2) rawFilterShape [32, 128, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>,  strides = [1, 1]} : tensor<1x128x135x240x!qElemType, {order = #NHWC}>, tensor<32x128x3x3x!qElemType, {order = #NHWC}>, tensor<32x1x1x4xsi32> -> tensor<1x32x135x240x!qElemType, {order = #NHWC}>
...
func.func @ConvAssignedSOH(%arg0: tensor<1x64x28x28xf16, {order = #NHWC}>) -> tensor<1x80x28x28xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.Convolution(%arg0, %cst_0, %cst) rawFilterShape [80, 64, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>,  strides = [1, 1]} : tensor<1x64x28x28xf16, {order = #NHWC}>, tensor<80x64x3x3xf16, {order = #NHWC}>, tensor<80x1x1x4xsi32> -> tensor<1x80x28x28xf16, {order = #NHWC}>
    ...
    //CHECK:        [[VAL0:%.+]] = VPU.NCE.Convolution([[ARG_0]], [[WEIGHTS]], [[WEIGHTSTABLE]]) rawFilterShape [80, 64, 3, 3]
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x128x1x1xf16, {order = #NHWC}>)
func.func @ConvAssignedSOK(%arg0: tensor<1x128x1x1xf16, {order = #NHWC}>) -> tensor<1x1024x1x1xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.Convolution(%arg0, %cst_0, %cst) rawFilterShape [1024, 128, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,  strides = [1, 1]} : tensor<1x128x1x1xf16, {order = #NHWC}>, tensor<1024x128x1x1xf16, {order = #NHWC}>, tensor<1024x1x1x4xsi32> -> tensor<1x1024x1x1xf16, {order = #NHWC}>
    ...
    //CHECK:        [[VAL0:%.+]] = VPU.NCE.Convolution([[ARG_0]], [[WEIGHTS]], [[WEIGHTSTABLE]]) rawFilterShape [1024, 128, 1, 1]
...
// CHECK-LABEL: @ConvAssignedSOK
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x64x1x1xf16, {order = #NHWC}>)
func.func @ConvAssignedSOK(%arg0: tensor<1x64x1x1xf16, {order = #NHWC}>) -> tensor<1x48x1x1xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.Convolution(%arg0, %cst_0, %cst) rawFilterShape [48, 64, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>,  strides = [1, 1]} : tensor<1x64x1x1xf16, {order = #NHWC}>, tensor<48x64x3x3xf16, {order = #NHWC}>, tensor<48x1x1x4xsi32> -> tensor<1x48x1x1xf16, {order = #NHWC}>
    ...
    //CHECK:        [[VAL0:%.+]] = VPU.NCE.Convolution([[ARG_0]], [[WEIGHTS]], [[WEIGHTSTABLE]]) rawFilterShape [48, 64, 3, 3]
    //CHECK-SAME:   {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, ppe = #VPU.PPEStub<>, resultSegmentSizes = array<i32: 1, 0, 0, 0>, strides = [1, 1]}
...
func.func @ConvAssignedSOB(%arg0: tensor<2x16x96x96xf16, {order = #NHWC}>) -> tensor<2x16x96x94xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.Convolution(%arg0, %cst_0, %cst) rawFilterShape [16, 16, 3, 5] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>,  strides = [1, 1]} : tensor<2x16x96x96xf16, {order = #NHWC}>, tensor<16x16x3x5xf16, {order = #NHWC}>, tensor<16x1x1x4xsi32> -> tensor<2x16x96x94xf16, {order = #NHWC}>
    ...
    //CHECK:        [[VAL0:%.+]] = VPU.NCE.Convolution([[INPUT]], [[WEIGHTS]], [[WEIGHTSTABLE]]) rawFilterShape [16, 16, 3, 5]
    //CHECK-SAME:   {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverBatch>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, ppe = #VPU.PPEStub<>, resultSegmentSizes = array<i32: 1, 0, 0, 0>, strides = [1, 1]}
...
func.func @DepthConvAssignedSOK(%arg0: tensor<1x32x112x112xf16, {order = #NHWC}>) -> tensor<1x32x112x112xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.DepthConvolution(%arg0, %cst_1, %cst_0) rawFilterShape [32, 1, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>,  strides = [1, 1]} -> tensor<1x32x112x112xf16, {order = #NHWC}>
    ...
    //CHECK:        [[VAL0:%.+]] = VPU.NCE.DepthConvolution([[ARG_0]], [[WEIGHTS]], [[WEIGHTSTABLE]]) rawFilterShape [32, 1, 3, 3]
    //CHECK-SAME:   {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, ppe = #VPU.PPEStub<>, resultSegmentSizes = array<i32: 1, 0, 0, 0>, strides = [1, 1]}
...
func.func @DepthConvAssignedSOK(%arg0: tensor<1x128x1x1xf16, {order = #NHWC}>) -> tensor<1x128x1x1xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.DepthConvolution(%arg0, %cst_1, %cst_0) rawFilterShape [128, 1, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>,  strides = [1, 1]} -> tensor<1x128x1x1xf16, {order = #NHWC}>
    ...
    //CHECK:        [[VAL0:%.+]] = VPU.NCE.DepthConvolution([[ARG_0]], [[WEIGHTS]], [[WEIGHTSTABLE]]) rawFilterShape [128, 1, 3, 3]
    //CHECK-SAME:   {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, ppe = #VPU.PPEStub<>, resultSegmentSizes = array<i32: 1, 0, 0, 0>, strides = [1, 1]}
...
func.func @DepthConvAssignedSOK(%arg0: tensor<1x32x1x1xf16, {order = #NHWC}>) -> tensor<1x32x1x1xf16, {order = #NHWC}> {
    %cst_0 = const.Declare tensor<32x1x1x4xsi32> = dense<10> : tensor<32x1x1x4xsi32>
    %cst_1 = const.Declare tensor<32x16x1x1xf16, {order = #NHWC}> = dense<1.000000e+00> : tensor<32x1x1x3x3xf16>, [#const.Reshape<[32, 1, 3, 3]>, #const.Reorder<#NHWC>, #const.Reorder<#NCHW>, #const.Reshape<[32, 9, 1, 1]>, #const.PadWithZero<[0, 0, 0, 0], [0, 7, 0, 0]>, #const.Reorder<#NHWC>]
    %0 = VPU.NCE.DepthConvolution(%arg0, %cst_1, %cst_0) rawFilterShape [32, 1, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>,  strides = [1, 1]} -> tensor<1x32x1x1xf16, {order = #NHWC}>
...
func.func @MaxPoolAssignedSOH(%arg0: tensor<1x32x112x112xf16, {order = #NHWC}>) -> tensor<1x32x112x112xf16, {order = #NHWC}> {
    ...
    //CHECK:        [[VAL0:%.+]] = VPU.NCE.MaxPool([[ARG_0]])
    //CHECK-SAME:   {kernel_size = [1, 1], multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, ppe = #VPU.PPEStub<>,
...
func.func @MaxPoolAssignedSOK(%arg0: tensor<1x32x1x1xf16, {order = #NHWC}>) -> tensor<1x32x1x1xf16, {order = #NHWC}> {
    ...
    //CHECK:        [[VAL0:%.+]] = VPU.NCE.MaxPool([[ARG_0]])
    //CHECK-SAME:   {kernel_size = [1, 1], multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, ppe = #VPU.PPEStub<>,
    // CHECK-SAME:  strides = [1, 1]}
    //CHECK-SAME:   -> tensor<1x32x1x1xf16, {order = #NHWC}>
    ...
    >
{
    ...
    %0 = VPU.NCE.Convolution(%input_sparse, %weights_sparse, %weights_table) rawFilterShape [512, 512, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
    ...
    // CHECK: [[OUT:%.+]] = VPU.NCE.Convolution([[INPUT_SPARSE]], [[WEIGHTS_SPARSE]], [[CST_WEIGHTS_TABLE]]) rawFilterShape [512, 512, 3, 3]
    // CHECK-SAME: multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x64x28x28xf16, {order = #NHWC}>, [[ARG_1:%[^:]+]]: tensor<1x64x28x28xi1, {order = #NHWC}>)
...
func.func @SparseConvAssignedSOH(%arg0 : tensor<1x64x28x28xf16, {order = #NHWC}>, %arg1 : tensor<1x64x28x28xi1, {order = #NHWC}>)
    ...
    %0 = VPU.NCE.Convolution(%input_sparse, %weights_sparse, %weights_table) rawFilterShape [80, 64, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
            pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 01 : i64, bottom = 1 : i64>,
            ppe = #VPU.PPEStub<>,

            strides = [1, 1]
        } : !VPU.SparseTensor<data=tensor<1x64x28x28xf16, {order = #NHWC}>, sparsity_map=tensor<1x64x28x28xi1, {order = #NHWC}>>, !VPU.SparseTensor<data=tensor<80x64x3x3xf16, {order = #NHWC}>, sparsity_map=tensor<80x1x1x640xi1>, is_weights, #VPU.SparsityCompression<axis = 0 : i64, numElems = dense<64> : tensor<80xi64>, alignment = 16 : i64>>, tensor<80x1x1x4xsi32> -> !VPU.SparseTensor<data=tensor<1x80x28x28xf16, {order = #NHWC}>,
                               sparsity_map=tensor<1x80x28x28xi1, {order = #NHWC}>> {
    ...
    // CHECK:       [[OUT:%.+]] = VPU.NCE.Convolution([[INPUT_SPARSE]], [[WEIGHTS_SPARSE]], [[CST_WEIGHTS_TABLE]]) rawFilterShape [80, 64, 3, 3]
    // CHECK-SAME:          {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>,
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x128x1x1xf16, {order = #NHWC}>, [[ARG_1:%[^:]+]]: tensor<1x128x1x1xi1, {order = #NHWC}>)
// CHECK-SAME:        -> !VPU.SparseTensor<data=tensor<1x1008x1x1xf16, {order = #NHWC}>, sparsity_map=tensor<1x1008x1x1xi1, {order = #NHWC}>>
func.func @SparseConvAssignedSOK(%arg0 : tensor<1x128x1x1xf16, {order = #NHWC}>, %arg1 : tensor<1x128x1x1xi1, {order = #NHWC}>)
    ...
    %0 = VPU.NCE.Convolution(%input_sparse, %weights_sparse, %weights_table) rawFilterShape [1008, 128, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
            pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,
            ppe = #VPU.PPEStub<>,

            strides = [1, 1]
        } : !VPU.SparseTensor<data=tensor<1x128x1x1xf16, {order = #NHWC}>, sparsity_map=tensor<1x128x1x1xi1, {order = #NHWC}>>, !VPU.SparseTensor<data=tensor<1008x128x1x1xf16, {order = #NHWC}>, sparsity_map=tensor<1008x1x1x128xi1>, is_weights, #VPU.SparsityCompression<axis = 0 : i64, numElems = dense<64> : tensor<1008xi64>, alignment = 16 : i64>>, tensor<1008x1x1x4xsi32> -> !VPU.SparseTensor<data=tensor<1x1008x1x1xf16, {order = #NHWC}>,
                               sparsity_map=tensor<1x1008x1x1xi1, {order = #NHWC}>> {
            VPU.DPU.Workload outOffsets [0, 0, 0, 0] outSizes [1, 32, 16, 16] pad [0, 0, 0, 0] #VPU.mpe_mode<VECTOR_FP16>
        }
    ...
    // CHECK:       [[OUT:%.+]] = VPU.NCE.Convolution([[INPUT_SPARSE]], [[WEIGHTS_SPARSE]], [[CST_WEIGHTS_TABLE]]) rawFilterShape [1008, 128, 1, 1]
    // CHECK-SAME:          {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>,
    // CHECK-SAME:          pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,
    // CHECK-SAME:          ppe = #VPU.PPEStub<>,
    // CHECK-SAME:          strides = [1, 1]}
...
func.func @SparseConvNotAssignedSOK(%arg0 : tensor<1x128x1x1xf16, {order = #NHWC}>, %arg1 : tensor<1x128x1x1xi1, {order = #NHWC}>)
    ...
    %0 = VPU.NCE.Convolution(%input_sparse, %weights_sparse, %weights_table) rawFilterShape [1008, 128, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
            ...
            strides = [1, 1]
        } : !VPU.SparseTensor<data=tensor<1x128x1x1xf16, {order = #NHWC}>, sparsity_map=tensor<1x128x1x1xi1, {order = #NHWC}>>, !VPU.SparseTensor<data=tensor<1008x128x1x1xf16, {order = #NHWC}>, sparsity_map=tensor<1008x1x1x128xi1>, is_weights, #VPU.SparsityCompression<axis = 0 : i64, numElems = dense<0> : tensor<1008xi64>, alignment = 16 : i64>>, tensor<1008x1x1x4xsi32> -> !VPU.SparseTensor<data=tensor<1x1008x1x1xf16, {order = #NHWC}>,
                               sparsity_map=tensor<1x1008x1x1xi1, {order = #NHWC}>> {
            VPU.DPU.Workload outOffsets [0, 0, 0, 0] outSizes [1, 32, 16, 16] pad [0, 0, 0, 0] #VPU.mpe_mode<VECTOR_FP16>
        }
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x4x1x512xf16, {order = #NCHW}>)
func.func @TanhAssignedClustering(%arg0: tensor<1x4x1x512xf16, {order = #NCHW}>) -> tensor<1x4x1x512xf16, {order = #NCHW}> {
    ...
    //CHECK:   [[ResultTANH:%.+]] = VPU.Tanh([[ARG_0]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<Clustering>} : tensor<1x4x1x512xf16, {order = #NCHW}> -> tensor<1x4x1x512xf16, {order = #NCHW}>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x4x32x512xf16, {order = #NCHW}>)
func.func @TanhAssignedSOHForEqualCost(%arg0: tensor<1x4x32x512xf16, {order = #NCHW}>) -> tensor<1x4x32x512xf16, {order = #NCHW}> {
    ...
    //CHECK:   [[ResultTANH:%.+]] = VPU.Tanh([[ARG_0]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>} : tensor<1x4x32x512xf16, {order = #NCHW}> -> tensor<1x4x32x512xf16, {order = #NCHW}>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x1x1x512xf16, {order = #NCHW}>)
func.func @MVNAssignedClustering(%arg0: tensor<1x1x1x512xf16, {order = #NCHW}>) -> tensor<1x1x1x512xf16, {order = #NCHW}> {
    ...
    //CHECK:   [[ResultMVN:%.+]] = VPU.MVN([[ARG_0]]) {across_channels = false, eps = 1.0013580322265625E-5 : f64, multiClusterStrategy = #VPU.multi_cluster_strategy<Clustering>, normalize_variance = true} : tensor<1x1x1x512xf16, {order = #NCHW}> -> tensor<1x1x1x512xf16, {order = #NCHW}>
...
func.func @SoftMaxAssignedClustering(%arg0: tensor<1x1x1x512xf16, {order = #NCHW}>) -> tensor<1x1x1x512xf16, {order = #NCHW}> {
    ...
    //CHECK:   [[ResultSoftMax:%.+]] = VPU.SoftMax([[ARG_0]]) {axisInd = 3 : i64, multiClusterStrategy = #VPU.multi_cluster_strategy<Clustering>} : tensor<1x1x1x512xf16, {order = #NCHW}> -> tensor<1x1x1x512xf16, {order = #NCHW}>
...
func.func @SoftMaxAssignedSplitOverKernel(%arg0: tensor<1x4x1x512xf16, {order = #NCHW}>) -> tensor<1x4x1x512xf16, {order = #NCHW}> {
    ...
    //CHECK:   [[ResultSoftMax:%.+]] = VPU.SoftMax([[ARG_0]]) {axisInd = 3 : i64, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>} : tensor<1x4x1x512xf16, {order = #NCHW}> -> tensor<1x4x1x512xf16, {order = #NCHW}>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x4x2x512xf16, {order = #NHWC}>)
func.func @SoftMaxAssignedSplitOverHeight(%arg0: tensor<1x4x2x512xf16, {order = #NHWC}>) -> tensor<1x4x2x512xf16, {order = #NHWC}> {
    ...
    //CHECK:   [[ResultSoftMax:%.+]] = VPU.SoftMax([[ARG_0]]) {axisInd = 3 : i64, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>} : tensor<1x4x2x512xf16, {order = #NHWC}> -> tensor<1x4x2x512xf16, {order = #NHWC}>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x1x2x512xf16, {order = #NCHW}>)
func.func @SoftMaxAssignedSplitOverWidth(%arg0: tensor<1x1x2x512xf16, {order = #NCHW}>) -> tensor<1x1x2x512xf16, {order = #NCHW}> {
    ...
    //CHECK:   [[ResultSoftMax:%.+]] = VPU.SoftMax([[ARG_0]]) {axisInd = 2 : i64, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverWidth>} : tensor<1x1x2x512xf16, {order = #NCHW}> -> tensor<1x1x2x512xf16, {order = #NCHW}>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x8x4x76xf16, {order = #NHWC}>)
func.func @NHWCSoftMaxAssignedSplitOverHeight(%arg0: tensor<1x8x4x76xf16, {order = #NHWC}>) -> tensor<1x8x4x76xf16, {order = #NHWC}> {
    ...
    //CHECK:   [[ResultSoftMax:%.+]] = VPU.SoftMax([[ARG_0]]) {axisInd = 3 : i64, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>} : tensor<1x8x4x76xf16, {order = #NHWC}> -> tensor<1x8x4x76xf16, {order = #NHWC}>
...
func.func @MVNAssignedSplitOverKernel(%arg0: tensor<1x4x1x512xf16, {order = #NCHW}>) -> tensor<1x4x1x512xf16, {order = #NCHW}> {
    ...
    //CHECK:   [[ResultMVN:%.+]] = VPU.MVN([[ARG_0]]) {across_channels = false, eps = 1.0013580322265625E-5 : f64, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>, normalize_variance = true} : tensor<1x4x1x512xf16, {order = #NCHW}> -> tensor<1x4x1x512xf16, {order = #NCHW}>
...
func.func @TanhAfterConvAssignedClustering(%arg0: tensor<1x4x1x512xf16, {order = #NCHW}>) -> tensor<1x1024x1x1xf16, {order = #NHWC}> {
    ...
    %42 = VPU.NCE.Convolution(%40, %cst_7, %cst_27) rawFilterShape [1024, 1024, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,  strides = [1, 1]} : tensor<1x1024x1x1xf16, {order = #NHWC}>, tensor<1024x1024x1x1xf16, {order = #NHWC}>, tensor<1024x1x1x4xsi32> -> tensor<1x1024x1x1xf16, {order = #NHWC}>
    ...
    //CHECK:   [[ResultConvolution:%.+]] = VPU.NCE.Convolution([[cst0:%.+]], [[cst1:%.+]], [[cst2:%.+]]) rawFilterShape [1024, 1024, 1, 1] {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, ppe = #VPU.PPEStub<>,
// CHECK-SAME: strides = [1, 1]}
    //CHECK-SAME:   -> tensor<1x1024x1x1xf16, {order = #NHWC}>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x1x96x160xf16>)
func.func @InterpolateHalfPixelAssignedSOHOverlapped(%arg0: tensor<1x1x96x160xf16>) -> tensor<1x1x192x320xf16> {
    %0 = VPU.Interpolate(%arg0) {attr = #IE.Interpolate<antialias = false, coord_mode = <HALF_PIXEL>, cube_coeff = -7.500000e-01 : f64, mode = <LINEAR_ONNX>, nearest_mode = <ROUND_PREFER_FLOOR>, pads_begin = [0, 0, 0, 0], pads_end = [0, 0, 0, 0], shape_calc_mode = <SIZES>>, axes_attr = [2, 3], operandSegmentSizes = array<i32: 1, 0, 0, 0, 0, 0, 0, 0>, scales_attr = [2.000000e+00, 2.000000e+00], sizes_attr = [192, 320]} : tensor<1x1x96x160xf16> -> tensor<1x1x192x320xf16>
    return %0 : tensor<1x1x192x320xf16>
    //CHECK:   [[INTERPOLATE:%.+]] = VPU.Interpolate([[ARG_0]]) {attr = #IE.Interpolate<mode = <LINEAR_ONNX>, shape_calc_mode = <SIZES>, coord_mode = <HALF_PIXEL>, nearest_mode = <ROUND_PREFER_FLOOR>, antialias = false, pads_begin = [0, 0, 0, 0], pads_end = [0, 0, 0, 0], cube_coeff = -7.500000e-01 : f64>, axes_attr = [2, 3], multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeightOverlapped>, operandSegmentSizes = array<i32: 1, 0, 0, 0, 0, 0, 0, 0>, scales_attr = [2.000000e+00, 2.000000e+00], sizes_attr = [192, 320]} : tensor<1x1x96x160xf16> -> tensor<1x1x192x320xf16>
...
func.func @InterpolateAlignCornersAssignedSOHOverlapped(%arg0: tensor<1x1x96x160xf16>) -> tensor<1x1x192x320xf16> {
    ...
    return %0 : tensor<1x1x192x320xf16>
    //CHECK:   [[INTERPOLATE:%.+]] = VPU.Interpolate([[ARG_0]]) {attr = #IE.Interpolate<mode = <LINEAR_ONNX>, shape_calc_mode = <SIZES>, coord_mode = <ALIGN_CORNERS>, nearest_mode = <ROUND_PREFER_FLOOR>, antialias = false, pads_begin = [0, 0, 0, 0], pads_end = [0, 0, 0, 0], cube_coeff = -7.500000e-01 : f64>, axes_attr = [2, 3], multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeightOverlapped>, operandSegmentSizes = array<i32: 1, 0, 0, 0, 0, 0, 0, 0>, scales_attr = [2.000000e+00, 2.000000e+00], sizes_attr = [192, 320]} : tensor<1x1x96x160xf16> -> tensor<1x1x192x320xf16>
    //CHECK:   return [[INTERPOLATE]] : tensor<1x1x192x320xf16>
}
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x1x1x160xf16>)
func.func @InterpolateAlignCornersAssignedClustering(%arg0: tensor<1x1x1x160xf16>) -> tensor<1x1x1x320xf16> {
    %0 = VPU.Interpolate(%arg0) {attr = #IE.Interpolate<antialias = false, coord_mode = <ALIGN_CORNERS>, cube_coeff = -7.500000e-01 : f64, mode = <LINEAR_ONNX>, nearest_mode = <ROUND_PREFER_FLOOR>, pads_begin = [0, 0, 0, 0], pads_end = [0, 0, 0, 0], shape_calc_mode = <SIZES>>, axes_attr = [2, 3], operandSegmentSizes = array<i32: 1, 0, 0, 0, 0, 0, 0, 0>, scales_attr = [1.000000e+00, 2.000000e+00], sizes_attr = [1, 320]} : tensor<1x1x1x160xf16> -> tensor<1x1x1x320xf16>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x1x64x64xf16, {order = #NHWC}>)
func.func @SwishAssignedSplitOverHeight(%arg0: tensor<1x1x64x64xf16, {order = #NHWC}>) -> tensor<1x1x64x64xf16, {order = #NHWC}> {
    ...
    //CHECK:      [[ResultSwish:%.+]] = VPU.Swish([[ARG_0]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>} :
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x64x1x64xf16, {order = #NHWC}>)
func.func @SwishAssignedSplitOverWidth(%arg0: tensor<1x64x1x64xf16, {order = #NHWC}>) -> tensor<1x64x1x64xf16, {order = #NHWC}> {

    %0 = VPU.Swish(%arg0) : tensor<1x64x1x64xf16, {order = #NHWC}> -> tensor<1x64x1x64xf16, {order = #NHWC}>

    return %0 : tensor<1x64x1x64xf16, {order = #NHWC}>

    //CHECK:      [[ResultSwish:%.+]] = VPU.Swish([[ARG_0]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverWidth>} :
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x1x4x512xf16, {order = #NCHW}>)
func.func @GeluAssignedSplitOverHeight(%arg0: tensor<1x1x4x512xf16, {order = #NCHW}>) -> tensor<1x1x4x512xf16, {order = #NCHW}> {
    ...
    //CHECK:   [[ResultGelu:%.+]] = VPU.Gelu([[ARG_0]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>} : tensor<1x1x4x512xf16, {order = #NCHW}> -> tensor<1x1x4x512xf16, {order = #NCHW}>
...
func.func @GeluAssignedSplitOverKernel(%arg0: tensor<1x4x1x512xf16, {order = #NCHW}>) -> tensor<1x4x1x512xf16, {order = #NCHW}> {
    ...
    //CHECK:   [[ResultGelu:%.+]] = VPU.Gelu([[ARG_0]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>} : tensor<1x4x1x512xf16, {order = #NCHW}> -> tensor<1x4x1x512xf16, {order = #NCHW}>
...
func.func @HardSigmoidAssignedSplitOverHeight(%arg0: tensor<1x1x4x512xf16, {order = #NCHW}>) -> tensor<1x1x4x512xf16, {order = #NCHW}> {
    ...
    //CHECK:   [[Result:%.+]] = VPU.HardSigmoid([[ARG_0]]) {alpha_value = 0.1666259765625 : f64, beta_value = 5.000000e-01 : f64, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>} : tensor<1x1x4x512xf16, {order = #NCHW}> -> tensor<1x1x4x512xf16, {order = #NCHW}>
...
func.func @HardSigmoidAssignedSplitOverKernel(%arg0: tensor<1x4x1x512xf16, {order = #NCHW}>) -> tensor<1x4x1x512xf16, {order = #NCHW}> {
    ...
    //CHECK:   [[Result:%.+]] = VPU.HardSigmoid([[ARG_0]]) {alpha_value = 0.1666259765625 : f64, beta_value = 5.000000e-01 : f64, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>} : tensor<1x4x1x512xf16, {order = #NCHW}> -> tensor<1x4x1x512xf16, {order = #NCHW}>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x3x224x224xf16, {order = #NHWC}>)
func.func @CompressConvolutionAssignedSOHOverlapped(%arg0: tensor<1x3x224x224xf16, {order = #NHWC}>) -> tensor<1x64x112x112xf16, {order = #NHWC}> {
    ...
    //CHECK:        [[VAL0:%.+]] = VPU.NCE.CompressConvolution([[EXPAND]], [[FILTER]], [[WEIGHTS_TABLE]]) rawFilterShape [64, 4, 7, 7]
...
func.func @CompressConvolutionAssignedSOB(%arg0: tensor<2x3x224x224xf16, {order = #NHWC}>) -> tensor<2x64x112x112xf16, {order = #NHWC}> {
    ...
    %compress_conv = VPU.NCE.CompressConvolution(%expand, %filter, %weight_table) rawFilterShape [64, 3, 7, 7] {
        cm_sp_pattern = 7 : i64,
        pad = #VPU.Padding<left = 3 : i64, right = 2 : i64, top = 3 : i64, bottom = 2 : i64>,
        ppe = #VPU.PPEStub<>,
         strides = [2, 2]
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x4x60x60xf16, {order = #NHWC}>)
func.func @CompressConvolutionSOHOverlappedRollback(%arg0: tensor<1x4x60x60xf16, {order = #NHWC}>) -> tensor<1x16x30x30xf16, {order = #NHWC}> {
    ...
    %compress_conv = VPU.NCE.CompressConvolution(%arg0, %filter, %weight_table) rawFilterShape [32, 3, 3, 3] {
            cm_sp_pattern = 7 : i64,
            pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>,
            ppe = #VPU.PPEStub<>,
             strides = [1, 1]
    ...
    %depth_conv = VPU.NCE.DepthConvolution(%compress_conv, %depth_conv_filter, %depth_conv_weight_table) rawFilterShape [32, 1, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
            pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,
            ppe = #VPU.PPEStub<>,
             strides = [1, 1]
        } -> tensor<1x32x60x60xf16, {order = #NHWC}>

    %conv = VPU.NCE.Convolution(%depth_conv, %conv_filter, %conv_weight_table) rawFilterShape [16, 32, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
            pad = #VPU.Padding<left = 1 : i64, right = 0 : i64, top = 1 : i64, bottom = 0 : i64>,
            ppe = #VPU.PPEStub<>,
             strides = [2, 2]
        } : tensor<1x32x60x60xf16, {order = #NHWC}>, tensor<16x32x3x3xf16, {order = #NHWC}>, tensor<16x1x1x4xsi32> -> tensor<1x16x30x30xf16, {order = #NHWC}>
    ...
    //CHECK:        [[VAL0:%.+]] = VPU.NCE.CompressConvolution([[ARG_0]], [[COMPRESS_CONV_FILTER]], [[COMPRESS_CONV_WEIGHTS_TABLE]])
...
// CHECK-SAME: [[INPUT0:%.+]]: tensor<1x32x44x44xf16, {order = #NHWC}>, [[INPUT1:%.+]]: tensor<1x1x44x44xf16, {order = #NHWC}>
func.func @MultiplyAssignedSplitOverHeight(%arg0: tensor<1x32x44x44xf16, {order = #NHWC}>,
    ...
    //CHECK:      [[MULTIPLY:%.+]] = VPU.Multiply([[INPUT0]], [[INPUT1]]) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>} : tensor<1x32x44x44xf16, {order = #NHWC}>, tensor<1x1x44x44xf16, {order = #NHWC}> -> tensor<1x32x44x44xf16, {order = #NHWC}>
...
// CHECK-LABEL: @MultiplyAssignedSplitOverWidth
// CHECK-SAME: [[INPUT0:%.+]]: tensor<1x32x1x44xf16, {order = #NHWC}>, [[INPUT1:%.+]]: tensor<1x1x1x44xf16, {order = #NHWC}>
func.func @MultiplyAssignedSplitOverWidth(%arg0: tensor<1x32x1x44xf16, {order = #NHWC}>,
    ...
    //CHECK:      [[MULTIPLY:%.+]] = VPU.Multiply([[INPUT0]], [[INPUT1]]) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverWidth>} : tensor<1x32x1x44xf16, {order = #NHWC}>, tensor<1x1x1x44xf16, {order = #NHWC}> -> tensor<1x32x1x44xf16, {order = #NHWC}>
...
// CHECK-LABEL: @MultiplyAssignedSplitOverWidthSecond
// CHECK-SAME: [[INPUT0:%.+]]: tensor<1x1x1x128xf16, {order = #NHWC}>, [[INPUT1:%.+]]: tensor<1x1x1x128xf16, {order = #NHWC}>
func.func @MultiplyAssignedSplitOverWidthSecond(%arg0: tensor<1x1x1x128xf16, {order = #NHWC}>,
            %arg1: tensor<1x1x1x128xf16, {order = #NHWC}>) -> tensor<1x1x1x128xf16, {order = #NHWC}> {

    %0 = VPU.Multiply(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>} :
                tensor<1x1x1x128xf16, {order = #NHWC}>,
                tensor<1x1x1x128xf16, {order = #NHWC}> -> tensor<1x1x1x128xf16, {order = #NHWC}>

    return %0 : tensor<1x1x1x128xf16, {order = #NHWC}>

    //CHECK:      [[MULTIPLY:%.+]] = VPU.Multiply([[INPUT0]], [[INPUT1]]) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverWidth>} : tensor<1x1x1x128xf16, {order = #NHWC}>, tensor<1x1x1x128xf16, {order = #NHWC}> -> tensor<1x1x1x128xf16, {order = #NHWC}>
    //CHECK:      return [[MULTIPLY]] : tensor<1x1x1x128xf16, {order = #NHWC}>
}
...
// CHECK-SAME: [[INPUT:%.+]]: tensor<1x1x4x512xf16, {order = #NCHW}>
func.func @HSwishAssignedSplitOverHeight(%arg0: tensor<1x1x4x512xf16, {order = #NCHW}>) -> tensor<1x1x4x512xf16, {order = #NCHW}> {
    ...
    //CHECK:   [[ResultHSwish:%.+]] = VPU.HSwish([[INPUT]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>} : tensor<1x1x4x512xf16, {order = #NCHW}> -> tensor<1x1x4x512xf16, {order = #NCHW}>
...
func.func @HSwishAssignedSplitOverKernel(%arg0: tensor<1x4x1x512xf16, {order = #NCHW}>) -> tensor<1x4x1x512xf16, {order = #NCHW}> {
    ...
    //CHECK:   [[ResultHSwish:%.+]] = VPU.HSwish([[INPUT]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>} : tensor<1x4x1x512xf16, {order = #NCHW}> -> tensor<1x4x1x512xf16, {order = #NCHW}>
...
func.func @InterpolateNearestAssignedSOH(%input_data: tensor<1x64x10x10xf16, {order = #NHWC}>) -> tensor<1x64x20x20xf16, {order = #NHWC}> {
    ...
    // CHECK:       [[OUTPUT:%.+]] = VPU.NCE.Interpolate([[INPUT_SPARSE]], [[WEIGHTS]], [[WEIGHTS_TABLE]]) rawFilterShape [64, 64, 1, 1]
...
func.func @InterpolateNearestAssignedSOK(%input_data: tensor<1x256x5x10xf16, {order = #NHWC}>) -> tensor<1x256x10x20xf16, {order = #NHWC}> {
    ...
    %interpolate = VPU.NCE.Interpolate(%input, %weights, %weights_table) rawFilterShape [256, 256, 1, 1] {
        ppe = #VPU.PPEStub<>,
    ...
    // CHECK:       [[OUTPUT:%.+]] = VPU.NCE.Interpolate([[INPUT_SPARSE]], [[WEIGHTS]], [[WEIGHTS_TABLE]]) rawFilterShape [256, 256, 1, 1]
    // CHECK-SAME:      mode = #VPU.nce_interpolate_mode<NEAREST>,
    // CHECK-SAME:      multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>,
    // CHECK-SAME:      ppe = #VPU.PPEStub<>,
    // CHECK-SAME:      scales_attr = [2, 2]
...
func.func @InterpolateBilinearAssignedSOH(%input_data: tensor<1x64x20x20xf16, {order = #NHWC}>) -> tensor<1x64x40x40xf16, {order = #NHWC}> {
    ...
    %interpolate = VPU.NCE.Interpolate(%input, %weights, %weights_table) rawFilterShape [64, 64, 2, 2] {
        ppe = #VPU.PPEStub<>,
    ...
    // CHECK:       [[OUTPUT:%.+]] = VPU.NCE.Interpolate([[INPUT_SPARSE]], [[WEIGHTS]], [[WEIGHTS_TABLE]]) rawFilterShape [64, 64, 2, 2]
...
func.func @InterpolateBilinearAssignedSOK(%input_data: tensor<1x256x5x10xf16, {order = #NHWC}>) -> tensor<1x256x10x20xf16, {order = #NHWC}> {
    ...
    %interpolate = VPU.NCE.Interpolate(%input, %weights, %weights_table) rawFilterShape [256, 256, 2, 2] {
        ppe = #VPU.PPEStub<>,
    ...
    // CHECK:       [[OUTPUT:%.+]] = VPU.NCE.Interpolate([[INPUT_SPARSE]], [[WEIGHTS]], [[WEIGHTS_TABLE]]) rawFilterShape [256, 256, 2, 2]
    // CHECK-SAME:      mode = #VPU.nce_interpolate_mode<BILINEAR>,
    // CHECK-SAME:      multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>,
    // CHECK-SAME:      ppe = #VPU.PPEStub<>,
    // CHECK-SAME:      scales_attr = [2, 2]
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x64x5x5xf16, {order = #NHWC}>
func.func @SparseTensorDataAlignmentCheckSOK(%arg0: tensor<1x64x5x5xf16, {order = #NHWC}>) -> tensor<1x64x10x10xf16, {order = #NHWC}> {
    ...
    %interpolate = VPU.NCE.Interpolate(%input, %weights, %weights_table) rawFilterShape [64, 64, 4, 4] {
        ppe = #VPU.PPEStub<>,
    ...
    // CHECK:       [[OUTPUT:%.+]] = VPU.NCE.Interpolate([[INPUT_SPARSE]], [[WEIGHTS]], [[WEIGHTS_TABLE]]) rawFilterShape [64, 64, 4, 4]
    // CHECK-SAME:      mode = #VPU.nce_interpolate_mode<BILINEAR>,
    // CHECK-SAME:      multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>,
    // CHECK-SAME:      ppe = #VPU.PPEStub<>,
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x16x5x5xf16, {order = #NHWC}>
func.func @SparseTensorDataAlignmentCheckSOH(%arg0: tensor<1x16x5x5xf16, {order = #NHWC}>) -> tensor<1x16x10x10xf16, {order = #NHWC}> {
    ...
    %interpolate = VPU.NCE.Interpolate(%input, %weights, %weights_table) rawFilterShape [16, 16, 4, 4] {
        ppe = #VPU.PPEStub<>,
    ...
    // CHECK:       [[OUTPUT:%.+]] = VPU.NCE.Interpolate([[INPUT_SPARSE]], [[WEIGHTS]], [[WEIGHTS_TABLE]]) rawFilterShape [16, 16, 4, 4]
    // CHECK-SAME:      mode = #VPU.nce_interpolate_mode<BILINEAR>,
    // CHECK-SAME:      multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>,
    // CHECK-SAME:      ppe = #VPU.PPEStub<>,
    // CHECK-SAME:      scales_attr = [4, 4], strides = [2, 2]}
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x16x160x160xf16, {order = #NHWC}>
...
// CHECK-LABEL: @ConvertOpAssignedMCStratF32To16
...
func.func @ConvertOpAssignedMCStratF32To16(%arg0: tensor<1x48x160x80xf32>) -> tensor<1x48x160x80xf16> {
    ...
    // CHECK:       [[CONVERT:%.+]] = VPU.Convert([[ARG_0]]) {dstElemType = f16, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>} : tensor<1x48x160x80xf32> -> tensor<1x48x160x80xf16>
    // CHECK:       return [[CONVERT]] : tensor<1x48x160x80xf16>
}

// -----

// CHECK-LABEL: @ConvertOpAssignedMCStratF16To32
...
func.func @ConvertOpAssignedMCStratF16To32(%arg0: tensor<1x48x160x80xf16>) -> tensor<1x48x160x80xf32> {
    ...
    // CHECK:       [[CONVERT:%.+]] = VPU.Convert([[ARG_0]]) {dstElemType = f32, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>} : tensor<1x48x160x80xf16> -> tensor<1x48x160x80xf32>
    // CHECK:       return [[CONVERT]] : tensor<1x48x160x80xf32>
}

// -----

// CHECK-LABEL: @ConvertOpAssignedMCStratClustering
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<2x48x160x80xf16>)
func.func @ConvertOpAssignedMCStratClustering(%arg0: tensor<2x48x160x80xf16>) -> tensor<2x48x160x80xf32> {
    ...
    // CHECK:       [[CONVERT:%.+]] = VPU.Convert([[ARG_0]]) {dstElemType = f32, multiClusterStrategy = #VPU.multi_cluster_strategy<Clustering>} : tensor<2x48x160x80xf16> -> tensor<2x48x160x80xf32>
    // CHECK:       return [[CONVERT]] : tensor<2x48x160x80xf32>
}

// -----

// CHECK-LABEL: @ConvertOpAssignedMCStratSOK
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x48x3x3xf16>)
func.func @ConvertOpAssignedMCStratSOK(%arg0: tensor<1x48x3x3xf16>) -> tensor<1x48x3x3xf32> {
    ...
    // CHECK:       [[CONVERT:%.+]] = VPU.Convert([[ARG_0]]) {dstElemType = f32, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>} : tensor<1x48x3x3xf16> -> tensor<1x48x3x3xf32>
...
func.func @AssignSOHForLayerWithLargeActivation(%arg0: tensor<1x64x250x250xf16, {order = #NHWC}>) -> tensor<1x32x250x250xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.Convolution(%arg0, %cst_0, %cst) rawFilterShape [32, 64, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>,  strides = [1, 1]} : tensor<1x64x250x250xf16, {order = #NHWC}>, tensor<32x64x3x3xf16, {order = #NHWC}>, tensor<32x1x1x4xsi32> -> tensor<1x32x250x250xf16, {order = #NHWC}>
    ...
    //CHECK:        [[VAL0:%.+]] = VPU.NCE.Convolution([[ARG_0]], [[WEIGHTS]], [[WEIGHTSTABLE]]) rawFilterShape [32, 64, 3, 3]
    //CHECK-SAME:        multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    //CHECK-SAME:        pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>
    //CHECK-SAME:        ppe = #VPU.PPEStub<>,
    // CHECK-SAME:       strides = [1, 1]
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x151x513x513xf16>)
func.func @AssignClusteringForLayerWithNormalizeL2(%arg0: tensor<1x151x513x513xf16>) -> tensor<1x151x513x513xf16> {
    ...
    //CHECK:        [[OUTPUT_VALUES:%.+]] = VPU.NormalizeL2([[ARG_0]])
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x1x513x513xf16>)
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x128x64x128xf16, {order = #NHWC}>)
func.func @NoAssignHKSwitchForLayerWithTiling(%arg0: tensor<1x128x64x128xf16, {order = #NHWC}>) -> tensor<1x64x64x128xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.Convolution(%arg0, %cst_0, %cst_1) rawFilterShape [64, 128, 4, 4] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 2 : i64, right = 1 : i64, top = 2 : i64, bottom = 1 : i64>,
               strides = [1, 1]} : tensor<1x128x64x128xf16, {order = #NHWC}>, tensor<64x128x4x4xf16, {order = #NHWC}>, tensor<64x1x1x4xsi32> -> tensor<1x64x64x128xf16, {order = #NHWC}>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x16x1x513xf16, {order = #NCHW}>)
func.func @SigmoidAssignedSplitOverKernel(%arg0: tensor<1x16x1x513xf16, {order = #NCHW}>) -> tensor<1x16x1x513xf16, {order = #NCHW}> {
    ...
    //CHECK:   [[Result:%.+]] = VPU.Sigmoid([[ARG_0]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>} : tensor<1x16x1x513xf16, {order = #NCHW}> -> tensor<1x16x1x513xf16, {order = #NCHW}>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x1x16x513xf16, {order = #NCHW}>)
func.func @SigmoidAssignedSplitOverHeight(%arg0: tensor<1x1x16x513xf16, {order = #NCHW}>) -> tensor<1x1x16x513xf16, {order = #NCHW}> {
    ...
    //CHECK:   [[Result:%.+]] = VPU.Sigmoid([[ARG_0]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>} : tensor<1x1x16x513xf16, {order = #NCHW}> -> tensor<1x1x16x513xf16, {order = #NCHW}>
...
func.func @LogAssignedSplitOverKernel(%arg0: tensor<1x16x1x513xf16, {order = #NCHW}>) -> tensor<1x16x1x513xf16, {order = #NCHW}> {
    ...
    //CHECK:   [[Result:%.+]] = VPU.Log([[ARG_0]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>} : tensor<1x16x1x513xf16, {order = #NCHW}> -> tensor<1x16x1x513xf16, {order = #NCHW}>
    //CHECK:   return [[Result]] : tensor<1x16x1x513xf16, {order = #NCHW}>
}
...
func.func @LogAssignedSplitOverHeight(%arg0: tensor<1x1x16x513xf16, {order = #NCHW}>) -> tensor<1x1x16x513xf16, {order = #NCHW}> {
    ...
    //CHECK:   [[Result:%.+]] = VPU.Log([[ARG_0]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>} : tensor<1x1x16x513xf16, {order = #NCHW}> -> tensor<1x1x16x513xf16, {order = #NCHW}>
    //CHECK:   return [[Result]] : tensor<1x1x16x513xf16, {order = #NCHW}>
}
...
func.func @SqrtAssignedSplitOverKernel(%arg0: tensor<1x16x1x513xf16, {order = #NCHW}>) -> tensor<1x16x1x513xf16, {order = #NCHW}> {
    ...
    //CHECK:   [[Result:%.+]] = VPU.Sqrt([[ARG_0]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>} : tensor<1x16x1x513xf16, {order = #NCHW}> -> tensor<1x16x1x513xf16, {order = #NCHW}>
    //CHECK:   return [[Result]] : tensor<1x16x1x513xf16, {order = #NCHW}>
}
...
func.func @SqrtAssignedSplitOverHeight(%arg0: tensor<1x1x16x513xf16, {order = #NCHW}>) -> tensor<1x1x16x513xf16, {order = #NCHW}> {
    ...
    //CHECK:   [[Result:%.+]] = VPU.Sqrt([[ARG_0]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>} : tensor<1x1x16x513xf16, {order = #NCHW}> -> tensor<1x1x16x513xf16, {order = #NCHW}>
    //CHECK:   return [[Result]] : tensor<1x1x16x513xf16, {order = #NCHW}>
}
...
// CHECK-LABEL: @LogAssignedSplitOverKernel
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x16x1x513xf32, {order = #NCHW}>)
func.func @LogAssignedSplitOverKernel(%arg0: tensor<1x16x1x513xf32, {order = #NCHW}>) -> tensor<1x16x1x513xf32, {order = #NCHW}> {
    ...
    //CHECK:   [[Result:%.+]] = VPU.Log([[ARG_0]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>} : tensor<1x16x1x513xf32, {order = #NCHW}> -> tensor<1x16x1x513xf32, {order = #NCHW}>
...
// CHECK-LABEL: @LogAssignedSplitOverHeight
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x1x16x513xf32, {order = #NCHW}>)
func.func @LogAssignedSplitOverHeight(%arg0: tensor<1x1x16x513xf32, {order = #NCHW}>) -> tensor<1x1x16x513xf32, {order = #NCHW}> {
    ...
    //CHECK:   [[Result:%.+]] = VPU.Log([[ARG_0]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>} : tensor<1x1x16x513xf32, {order = #NCHW}> -> tensor<1x1x16x513xf32, {order = #NCHW}>
...
func.func @SqrtAssignedSplitOverKernel(%arg0: tensor<1x16x1x513xf32, {order = #NCHW}>) -> tensor<1x16x1x513xf32, {order = #NCHW}> {
    ...
    //CHECK:   [[Result:%.+]] = VPU.Sqrt([[ARG_0]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>} : tensor<1x16x1x513xf32, {order = #NCHW}> -> tensor<1x16x1x513xf32, {order = #NCHW}>
    //CHECK:   return [[Result]] : tensor<1x16x1x513xf32, {order = #NCHW}>
}
...
func.func @SqrtAssignedSplitOverHeight(%arg0: tensor<1x1x16x513xf32, {order = #NCHW}>) -> tensor<1x1x16x513xf32, {order = #NCHW}> {
    ...
    //CHECK:   [[Result:%.+]] = VPU.Sqrt([[ARG_0]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>} : tensor<1x1x16x513xf32, {order = #NCHW}> -> tensor<1x1x16x513xf32, {order = #NCHW}>
    //CHECK:   return [[Result]] : tensor<1x1x16x513xf32, {order = #NCHW}>
}
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x128x180x270xf16, {order = #NHWC}>)
func.func @DepthToSpaceAssignedSplitOverHeight(%arg0: tensor<1x128x180x270xf16, {order = #NHWC}>) -> tensor<1x8x720x1080xf16, {order = #NHWC}> {
    ...
    //CHECK:   [[Result:%.+]] = VPU.DepthToSpace([[ARG_0]]) {block_size = 4 : i64, mode = #IE.depth_to_space_mode<DEPTH_FIRST>, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>} : tensor<1x128x180x270xf16, {order = #NHWC}> -> tensor<1x8x720x1080xf16, {order = #NHWC}>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x128x1x270xf16, {order = #NHWC}>)
func.func @DepthToSpaceAssignedSplitOverWidth(%arg0: tensor<1x128x1x270xf16, {order = #NHWC}>) -> tensor<1x8x4x1080xf16, {order = #NHWC}> {
    ...
    //CHECK:   [[Result:%.+]] = VPU.DepthToSpace([[ARG_0]]) {block_size = 4 : i64, mode = #IE.depth_to_space_mode<DEPTH_FIRST>, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverWidth>} : tensor<1x128x1x270xf16, {order = #NHWC}> -> tensor<1x8x4x1080xf16, {order = #NHWC}>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x1x44x44xf16, {order = #NCHW}>, [[ARG_1:%[^:]+]]: tensor<1x1x44x44xf16, {order = #NCHW}>)
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x44x1x44xf16, {order = #NCHW}>, [[ARG_1:%[^:]+]]: tensor<1x44x1x44xf16, {order = #NCHW}>)
...
// CHECK-SAME:      [[ARG_0:%[^:]+]]: tensor<1x1x44x44xf16, {order = #NCHW}>
// CHECK-SAME:      [[ARG_1:%[^:]+]]: tensor<1x1x44x44xf16, {order = #NCHW}>
func.func @MaximumAssignedSplitOverHeight(%arg0: tensor<1x1x44x44xf16, {order = #NCHW}>,
    ...
    //CHECK:      [[MAXIMUM:%.+]] = VPU.Maximum([[ARG_0]], [[ARG_1]]) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>} : tensor<1x1x44x44xf16, {order = #NCHW}>, tensor<1x1x44x44xf16, {order = #NCHW}> -> tensor<1x1x44x44xf16, {order = #NCHW}>
...
// CHECK-SAME:      [[ARG_0:%[^:]+]]: tensor<1x44x1x44xf16, {order = #NCHW}>
// CHECK-SAME:      [[ARG_1:%[^:]+]]: tensor<1x44x1x44xf16, {order = #NCHW}>
func.func @MaximumAssignedSplitOverKernel(%arg0: tensor<1x44x1x44xf16, {order = #NCHW}>,
    ...
    //CHECK:      [[MAXIMUM:%.+]] = VPU.Maximum([[ARG_0]], [[ARG_1]]) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>} : tensor<1x44x1x44xf16, {order = #NCHW}>, tensor<1x44x1x44xf16, {order = #NCHW}> -> tensor<1x44x1x44xf16, {order = #NCHW}>
...
// CHECK-SAME:      [[ARG_0:%[^:]+]]: tensor<1x1x1x1xf16, {order = #NCHW}>
// CHECK-SAME:      [[ARG_1:%[^:]+]]: tensor<1x1x1x1xf16, {order = #NCHW}>
func.func @MaximumAssignedClustering(%arg0: tensor<1x1x1x1xf16, {order = #NCHW}>,
    ...
    //CHECK:      [[MAXIMUM:%.+]] = VPU.Maximum([[ARG_0]], [[ARG_1]]) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>, multiClusterStrategy = #VPU.multi_cluster_strategy<Clustering>} : tensor<1x1x1x1xf16, {order = #NCHW}>, tensor<1x1x1x1xf16, {order = #NCHW}> -> tensor<1x1x1x1xf16, {order = #NCHW}>
...
func.func @SOKCONVConsiderDMAPrefetching(%arg0: tensor<1x960x65x65xf16, {order = #NHWC}>) -> tensor<1x320x65x65xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.DepthConvolution(%arg0, %cst_1, %cst_2) rawFilterShape [960, 1, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
        pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>,
        ppe = #VPU.PPEStub<>,
         strides = [1, 1]} -> tensor<1x960x65x65xf16, {order = #NHWC}>
    %1 = VPU.NCE.Convolution(%0, %cst, %cst_0) rawFilterShape [320, 960, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
        pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,
        ppe = #VPU.PPEStub<>,
         strides = [1, 1]} : tensor<1x960x65x65xf16, {order = #NHWC}>, tensor<320x960x1x1xf16, {order = #NHWC}>, tensor<320x1x1x4xsi32> -> tensor<1x320x65x65xf16, {order = #NHWC}>
...
// CHECK-SAME: [[ARG_0:%[^:]+]]: tensor<1x16x1x112xf16>
// CHECK-SAME: [[ARG_1:%[^:]+]]: tensor<1x16x32x112xf16>
func.func @ParentPermuteOpWithHeightEqualOneNoStrategy(%arg0: tensor<1x16x1x112xf16>, %arg1: tensor<1x16x32x112xf16>) -> tensor<1x16x33x112xf16, {order = #NHWC}> {
    ...
    //CHECK: [[Permute_1:%.+]] = VPU.NCE.Permute([[ARG_0]]) {dstElemType = f16, dstOrder = #NHWC, expandedChannels = 16 : i64, ppe = #VPU.PPEStub<>} -> tensor<1x16x1x112xf16, {order = #NHWC}>
    ...
    //CHECK: [[Permute_2:%.+]] = VPU.NCE.Permute([[ARG_1]]) {dstElemType = f16, dstOrder = #NHWC, expandedChannels = 16 : i64, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeightOverlapped>, ppe = #VPU.PPEStub<>} -> tensor<1x16x32x112xf16, {order = #NHWC}>
...
// CHECK-SAME: [[ARG_0:%[^:]+]]: tensor<1x512x1x16xf16>
// CHECK-SAME: [[ARG_1:%[^:]+]]: tensor<1x512x1x32xf16>
...
// CHECK-SAME: [[ARG_0:%[^:]+]]: tensor<1x384x8x8xf16, {order = #NHWC}>)
func.func @ConvAssignedStrategySOHCostMax(%arg0: tensor<1x384x8x8xf16, {order = #NHWC}>) -> tensor<1x112x8x8xf16, {order = #NHWC}> {
    ...
    %conv = VPU.NCE.Convolution(%arg0, %weights_sparse, %weights_table) rawFilterShape [112, 384, 7, 7] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
            pad = #VPU.Padding<left = 3 : i64, right = 3 : i64, top = 3 : i64, bottom = 3 : i64>,
            ppe = #VPU.PPEStub<>,
             strides = [1, 1]}
            : tensor<1x384x8x8xf16, {order = #NHWC}>, !VPU.SparseTensor<data=tensor<112x384x7x7xf16, {order = #NHWC}>, sparsity_map=tensor<112x1x1x18816xi1>, is_weights, #VPU.SparsityCompression<axis = 0 : i64, numElems = dense<64> : tensor<112xi64>, alignment = 16 : i64>>, tensor<112x1x1x4xsi32> -> tensor<1x112x8x8xf16, {order = #NHWC}>
    ...
    //CHECK:    [[CONV:%.+]] = VPU.NCE.Convolution([[ARG_0]], [[WEIGHTS_SPARSE]], [[WEIGHTS_TBL]]) rawFilterShape [112, 384, 7, 7] {
...
func.func @SOHOPermuteOutputOverlapped(%arg0: tensor<1x4x64x64x!qElemType, {order = #NCHW}>) -> tensor<1x64x8x8x!qElemType, {order = #NHWC}> {
    ...
    %1 = VPU.NCE.CompressConvolution(%0, %cst_3, %cst_4) rawFilterShape [16, 1, 3, 3] {cm_sp_pattern = 1 : i64, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 0 : i64, right = 1 : i64, top = 0 : i64, bottom = 1 : i64>,  strides = [2, 2]} -> tensor<1x16x32x32x!qElemType, {order = #NHWC}>
    %2 = VPU.NCE.Convolution(%1, %cst, %cst_0) rawFilterShape [32, 16, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 0 : i64, right = 1 : i64, top = 0 : i64, bottom = 1 : i64>,  strides = [2, 2]} : tensor<1x16x32x32x!qElemType, {order = #NHWC}>, tensor<32x16x3x3x!qElemType, {order = #NHWC}>, tensor<32x1x1x4xsi32> -> tensor<1x32x16x16x!qElemType, {order = #NHWC}>
    %3 = VPU.NCE.Convolution(%2, %cst_1, %cst_2) rawFilterShape [64, 32, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 0 : i64, right = 1 : i64, top = 0 : i64, bottom = 1 : i64>,  strides = [2, 2]} : tensor<1x32x16x16x!qElemType, {order = #NHWC}>, tensor<64x32x3x3x!qElemType, {order = #NHWC}>, tensor<64x1x1x4xsi32> -> tensor<1x64x8x8x!qElemType, {order = #NHWC}>
...
// CHECK-SAME: [[ARG_0:%[^:]+]]: tensor<1x16x1x60xf16, {order = #NHWC}>)
...
// CHECK-SAME: [[ARG_0:%[^:]+]]: tensor<1x16x128x60xf16, {order = #NHWC}>)
...
// CHECK-SAME: [[ARG_0:%[^:]+]]: tensor<1x16x1x60xf16>)
...
// CHECK-SAME: [[ARG_0:%[^:]+]]: tensor<1x1x128x60xf16>)
...
// CHECK-SAME: [[ARG_0:%[^:]+]]: tensor<1x106x1x256xf16>,
// CHECK-SAME: [[ARG_1:%[^:]+]]: tensor<1x106x1x1xf16>)
func.func @DivideAssignedSplitOverKernel(%arg0: tensor<1x106x1x256xf16>, %arg1: tensor<1x106x1x1xf16>) -> tensor<1x106x1x256xf16> {
    ...
    //CHECK:   [[DIVIDE:%.+]] = VPU.Divide([[ARG_0]], [[ARG_1]]) {
    //CHECK-SAME:       multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>}
...
// CHECK-SAME: [[ARG_0:%[^:]+]]: tensor<1x16x256x256xf16>,
...
func.func @PowerAssignedSplitOverKernel(%arg0: tensor<1x106x1x256xf16>, %arg1: tensor<1x106x1x1xf16>) -> tensor<1x106x1x256xf16> {
    ...
    //CHECK:   [[POWER:%.+]] = VPU.Power([[ARG_0]], [[ARG_1]]) {
    //CHECK-SAME:       multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>}
    //CHECK-SAME:       tensor<1x106x1x256xf16>, tensor<1x106x1x1xf16> -> tensor<1x106x1x256xf16>
...
// CHECK-SAME: [[ARG_0:%[^:]+]]: tensor<2x106x1x256xf16>,
// CHECK-SAME: [[ARG_1:%[^:]+]]: tensor<2x106x1x1xf16>)
...
// CHECK-SAME: [[ARG_0:%[^:]+]]: tensor<1x64x100x170xf16, {order = #NHWC}>
// CHECK-SAME: [[ARG_1:%[^:]+]]: tensor<1x64x100x170xf16, {order = #NHWC}>
func.func @SOHEltwiseAlignment(%arg0: tensor<1x64x100x170xf16, {order = #NHWC}>, %arg1: tensor<1x64x100x170xf16, {order = #NHWC}>) -> tensor<1x64x100x170xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.Eltwise(%arg0, %arg1) {resultSegmentSizes = array<i32: 1, 0, 0, 0>, is_inplace = true, op_type = #VPU.eltwise_type<ADD>, ppe = #VPU.PPEStub<>} -> tensor<1x64x100x170xf16, {order = #NHWC}>
    %1 = VPU.NCE.Convolution(%0, %cst, %cst_0) rawFilterShape [16, 64, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,  strides = [1, 1]} : tensor<1x64x100x170xf16, {order = #NHWC}>, tensor<16x64x1x1xf16, {order = #NHWC}>, tensor<16x1x1x4xsi32> -> tensor<1x16x100x170xf16, {order = #NHWC}>
    %2 = VPU.NCE.DepthConvolution(%1, %cst_1, %cst_2) rawFilterShape [16, 1, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>,  strides = [1, 1]} -> tensor<1x16x100x170xf16, {order = #NHWC}>
    %3 = VPU.NCE.Convolution(%2, %cst_3, %cst_4) rawFilterShape [64, 16, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,  strides = [1, 1]} : tensor<1x16x100x170xf16, {order = #NHWC}>, tensor<64x16x1x1xf16, {order = #NHWC}>, tensor<64x1x1x4xsi32> -> tensor<1x64x100x170xf16, {order = #NHWC}>
    %4 = VPU.NCE.Eltwise(%0, %3) {resultSegmentSizes = array<i32: 1, 0, 0, 0>, is_inplace = true, op_type = #VPU.eltwise_type<ADD>, ppe = #VPU.PPEStub<>} -> tensor<1x64x100x170xf16, {order = #NHWC}>
    ...
    // CHECK:           [[ADD_0:%.+]] = VPU.NCE.Eltwise([[ARG_0]], [[ARG_1]]) {
    // CHECK-SAME:          is_inplace = true, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, op_type = #VPU.eltwise_type<ADD>, ppe = #VPU.PPEStub<>, resultSegmentSizes = array<i32: 1, 0, 0, 0>}
    // CHECK-SAME:          -> tensor<1x64x100x170xf16, {order = #NHWC}>
    // CHECK:           [[CONV_0:%.+]] = VPU.NCE.Convolution([[ADD_0]], [[CST]], [[CST_0]]) rawFilterShape [16, 64, 1, 1] {
    ...
    // CHECK:           [[DWCONV_0:%.+]] = VPU.NCE.DepthConvolution([[CONV_0]], [[CST_1]], [[CST_2]]) rawFilterShape [16, 1, 3, 3] {
    ...
    // CHECK-SAME:          -> tensor<1x16x100x170xf16, {order = #NHWC}>
    // CHECK:           [[CONV_1:%.+]] = VPU.NCE.Convolution([[DWCONV_0]], [[CST_3]], [[CST_4]]) rawFilterShape [64, 16, 1, 1] {
    // CHECK-SAME:          multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, ppe = #VPU.PPEStub<>,
    // CHECK-SAME:          strides = [1, 1]}
    // CHECK-SAME:          -> tensor<1x64x100x170xf16, {order = #NHWC}>
...
// CHECK-SAME: [[ARG_0:%[^:]+]]: tensor<1x1024x4x4x!qElemType, {order = #NHWC}>
// CHECK-SAME: [[ARG_1:%[^:]+]]: tensor<1x1024x4x4x!qElemType, {order = #NHWC}>
func.func @SOKConvolutionEltwise(%arg0: tensor<1x1024x4x4x!quant.uniform<u8:f16, 0.015109125305624568:128>, {order = #NHWC}>, %arg1: tensor<1x1024x4x4x!quant.uniform<u8:f16, 0.015109125305624568:128>, {order = #NHWC}>) -> tensor<1x2048x2x2xf16> {
    ...
    %0 = VPU.NCE.Eltwise(%arg0, %arg1)  {resultSegmentSizes = array<i32: 1, 0, 0, 0>, op_type = #VPU.eltwise_type<ADD>, ppe = #VPU.PPEStub<>} -> tensor<1x1024x4x4x!quant.uniform<u8:f16, 0.0091846662409165325>, {order = #NHWC}>
    %1 = VPU.NCE.Convolution(%0, %cst, %cst_0) rawFilterShape [2048, 1024, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,  strides = [2, 2]} : tensor<1x1024x4x4x!quant.uniform<u8:f16, 0.0091846662409165325>, {order = #NHWC}>, tensor<2048x1024x1x1x!quant.uniform<u8<0:254>:f16, 0.011682062637148879:127>, {order = #NHWC}>, tensor<2048x1x1x4xsi32> -> tensor<1x2048x2x2x!quant.uniform<u8:f16, 0.017686840132171033:128>, {order = #NHWC}>
    %2 = VPU.NCE.Convolution(%0, %cst_1, %cst_2) rawFilterShape [1024, 1024, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,  strides = [1, 1]} : tensor<1x1024x4x4x!quant.uniform<u8:f16, 0.0091846662409165325>, {order = #NHWC}>, tensor<1024x1024x1x1x!quant.uniform<u8<0:254>:f16, 0.0036145465111169289:127>, {order = #NHWC}>, tensor<1024x1x1x4xsi32> -> tensor<1x1024x4x4x!quant.uniform<u8:f16, 0.0040072758992513021>, {order = #NHWC}>
    %3 = VPU.NCE.Convolution(%2, %cst_3, %cst_4) rawFilterShape [2048, 1024, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 1 : i64, right = 0 : i64, top = 1 : i64, bottom = 0 : i64>,  strides = [2, 2]} : tensor<1x1024x4x4x!quant.uniform<u8:f16, 0.0040072758992513021>, {order = #NHWC}>, tensor<2048x1024x3x3x!quant.uniform<u8<0:254>:f16, 0.0093559721323448839:127>, {order = #NHWC}>, tensor<2048x1x1x4xsi32> -> tensor<1x2048x2x2x!quant.uniform<u8:f16, 0.0040072758992513021>, {order = #NHWC}>
    %4 = VPU.NCE.Eltwise(%1, %3) {resultSegmentSizes = array<i32: 1, 0, 0, 0>, op_type = #VPU.eltwise_type<ADD>, ppe = #VPU.PPEStub<>} -> tensor<1x2048x2x2xf16>
    ...
    // CHECK:           [[ADD_0:%.+]] = VPU.NCE.Eltwise([[ARG_0]], [[ARG_1]]) {
    // CHECK-SAME:          multiClusterStrategy = #VPU.multi_cluster_strategy<HKSwitch>, op_type = #VPU.eltwise_type<ADD>, ppe = #VPU.PPEStub<>, resultSegmentSizes = array<i32: 1, 0, 0, 0>}
    // CHECK-SAME:          -> tensor<1x1024x4x4x!qElemType7, {order = #NHWC}>
    // CHECK:           [[CONV_0:%.+]] = VPU.NCE.Convolution([[ADD_0]], [[CST]], [[CST_0]]) rawFilterShape [2048, 1024, 1, 1] {
    ...
    // CHECK:           [[CONV_1:%.+]] = VPU.NCE.Convolution([[ADD_0]], [[CST_1]], [[CST_2]]) rawFilterShape [1024, 1024, 1, 1] {
    // CHECK-SAME:          multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, ppe = #VPU.PPEStub<>,
    // CHECK-SAME:          strides = [1, 1]}
    // CHECK-SAME:          -> tensor<1x1024x4x4x!qElemType9, {order = #NHWC}>
    // CHECK:           [[CONV_2:%.+]] = VPU.NCE.Convolution([[CONV_1]], [[CST_3]], [[CST_4]]) rawFilterShape [2048, 1024, 3, 3] {
    ...
    // CHECK-SAME:          multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, op_type = #VPU.eltwise_type<ADD>, ppe = #VPU.PPEStub<>, resultSegmentSizes = array<i32: 1, 0, 0, 0>}
...
// CHECK-SAME: [[ARG_0:%[^:]+]]: tensor<1x128x72x72xf16, {order = #NHWC}>
// CHECK-SAME: [[ARG_1:%[^:]+]]: tensor<1x64x144x144xf16, {order = #NHWC}>
func.func @SkipSubGraphOptimizationForINFCost(%input_data: tensor<1x128x72x72xf16, {order = #NHWC}>, %input_data2: tensor<1x64x144x144xf16, {order = #NHWC}>) -> tensor<1x64x144x144xf16, {order = #NHWC}> {
    ...
    %conv = VPU.NCE.Convolution(%input_data, %convWeights, %convWeightsTable) rawFilterShape [64, 128, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
        pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,
        ppe = #VPU.PPEStub<>,
         strides = [1, 1]
    } : tensor<1x128x72x72xf16, {order = #NHWC}>, tensor<64x128x1x1xf16, {order = #NHWC}>, tensor<64x1x1x4xsi32> -> tensor<1x64x72x72xf16, {order = #NHWC}>
    ...
    %transposedConv = VPU.NCE.Convolution(%input, %weights, %weightsTable) rawFilterShape [64, 64, 4, 4] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
        pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,
        ppe = #VPU.PPEStub<>,
         strides = [1, 1]
    } : !VPU.SparseTensor< data=tensor<1x64x72x72xf16, {order = #NHWC}>, sparsity_map=tensor<1x64x147x147xi1, {order = #NHWC}>, storage_element_table=tensor<1x1x147x147xi32, {order = #NHWC}>, #VPU.SEUpsampling< factors = [1, 1], padding = [2, 2, 2, 2]>>, !VPU.SparseTensor<data=tensor<64x64x4x4xf16, {order = #NHWC}>, sparsity_map=tensor<64x1x1x1024xi1>, is_weights, #VPU.SparsityCompression<axis = 0 : i64, numElems = dense<16> : tensor<64xi64>, alignment = 16 : i64>>, tensor<64x1x1x4xsi32> -> tensor<1x64x144x144xf16, {order = #NHWC}>

    // add
    %add = VPU.NCE.Eltwise(%transposedConv, %input_data2) {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
        is_inplace = true,
    ...
    // CHECK:        [[CONV:%.+]] = VPU.NCE.Convolution([[ARG_0]], [[CONV_WEIGHTS]], [[CONV_WEIGHTS_TBL]]) rawFilterShape [64, 128, 1, 1]
    // CHECK-SAME:        {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>,
    // CHECK-SAME:        pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,
    // CHECK-SAME:        ppe = #VPU.PPEStub<>,
    // CHECK-SAME:        strides = [1, 1]}
    // CHECK-SAME:        -> tensor<1x64x72x72xf16, {order = #NHWC}>
    ...
    // CHECK:        [[DECONV:%.+]] = VPU.NCE.Convolution([[SPARSE_INPUT]], [[DECONV_WEIGHTS]], [[DECONV_WEIGHTS_TBL]]) rawFilterShape [64, 64, 4, 4]
    // CHECK-SAME:        {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>,
    // CHECK-SAME:        pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,
    // CHECK-SAME:        ppe = #VPU.PPEStub<>,
    // CHECK-SAME:        strides = [1, 1]}
    ...
    // CHECK:        [[ADD:%.+]] = VPU.NCE.Eltwise([[DECONV]], [[ARG_1]])
...
func.func @AssignedAccordingToParentStrategySOK(%arg0: tensor<1x128x2x2xf16, {order = #NHWC}>) -> tensor<1x1024x2x2xf16, {order = #NHWC}> {
    %cst = const.Declare tensor<1024x1x1x4xsi32> = dense<10> : tensor<1024x1x1x4xsi32>
    %cst_0 = const.Declare tensor<1024x128x1x1xf16, {order = #NHWC}> = dense<1.000000e+00> : tensor<1024x128x1x1xf16>, [#const.Reorder<#NHWC>]
    %0 = VPU.NCE.Convolution(%arg0, %cst_0, %cst) rawFilterShape [1024, 128, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,  strides = [1, 1]} : tensor<1x128x2x2xf16, {order = #NHWC}>, tensor<1024x128x1x1xf16, {order = #NHWC}>, tensor<1024x1x1x4xsi32> -> tensor<1x1024x2x2xf16, {order = #NHWC}>
...
func.func @PropagateDistributedPermuteCast(%arg0: tensor<1x144x16x48xf16, {order = #NHWC}>) -> tensor<1x128x144x16xf16, {order = #NHWC}>{
    ...
    %conv = VPU.NCE.Convolution(%permute_cast, %weights, %wt) rawFilterShape [128, 48, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
        pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>,
        ppe = #VPU.PPEStub<>,
         strides = [1, 1]}
            : tensor<1x48x144x16xf16, {order = #NHWC}>, tensor<128x48x3x3xf16, {order = #NHWC}>, tensor<128x1x1x4xsi32> -> tensor<1x128x144x16xf16, {order = #NHWC}>
...
func.func @PropagateDistributedLayoutCast(%arg0: tensor<1x48x144x16xf16, {order = #NHWC}>) -> tensor<1x128x144x16xf16, {order = #NHWC}>{
    ...
    %wt = const.Declare tensor<128x1x1x4xsi32> = dense<1> : tensor<128x1x1x4xsi32>
    %weights = const.Declare tensor<128x48x3x3xf16, {order = #NHWC}> = dense<1.000000e+00> : tensor<128x48x3x3xf16, {order = #NHWC}>
    %conv = VPU.NCE.Convolution(%layout_cast, %weights, %wt) rawFilterShape [128, 48, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
        pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>,
        ppe = #VPU.PPEStub<>,
         strides = [1, 1]}
            : tensor<1x48x144x16xf16, {order = #NHWC}>, tensor<128x48x3x3xf16, {order = #NHWC}>, tensor<128x1x1x4xsi32> -> tensor<1x128x144x16xf16, {order = #NHWC}>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x64x52x52xf16>)
func.func @AssignedAccordingToParentStrategyWithRollback(%arg0: tensor<1x64x52x52xf16>) -> tensor<1x64x52x52xf16> {
    ...
    %4 = VPU.NCE.DepthConvolution(%3, %cst_0, %cst) rawFilterShape [64, 1, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>,  strides = [1, 1]} -> tensor<1x64x52x52xf16>
    ...
    //CHECK:            [[SWISH_1:%.+]] = VPU.Swish([[ARG_0]]) {beta_value = 1.000000e+00 : f64, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>} : tensor<1x64x52x52xf16> -> tensor<1x64x52x52xf16>
    ...
    //CHECK:            [[DEPTHCONV:%.+]] = VPU.NCE.DepthConvolution([[SHAPECAST_2]], [[WEIGHTS]], [[WEIGHTSTABLE]]) rawFilterShape [64, 1, 3, 3]
    //CHECK-SAME:                   {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, ppe = #VPU.PPEStub<>, resultSegmentSizes = array<i32: 1, 0, 0, 0>, strides = [1, 1]} -> tensor<1x64x52x52xf16>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x3x20x35971xf16>, [[ARG_1:%[^:]+]]: tensor<1x3x1x1xf16, {order = #NHWC}>)
func.func @MVN1NormalizeAssignedSplitOverKernel(%arg0: tensor<1x3x20x35971xf16>, %arg1: tensor<1x3x1x1xf16, {order = #NHWC}>) -> tensor<1x3x20x35971xf16> {
    ...
    //CHECK:        [[VAL0:%.+]] = VPU.MVN1Normalize([[ARG_0]], [[ARG_1]])
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x1x1x2xf32, {order = #NHWC}>)
func.func @MVN1MeanVarAssignedClustering(%arg0: tensor<1x1x1x2xf32, {order = #NHWC}>) -> tensor<1x1x1x2xf16, {order = #NHWC}> {
    ...
    //CHECK:        [[VAL0:%.+]] = VPU.MVN1MeanVar([[ARG_0]])
    // CHECK-SAME:       multiClusterStrategy = #VPU.multi_cluster_strategy<Clustering>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x12x20x3997xf16>)
func.func @MVN1SumAssignedSplitOverKernel(%arg0: tensor<1x12x20x3997xf16>) -> tensor<1x12x1x2xf32, {order = #NHWC}> {
    ...
    //CHECK:        [[VAL0:%.+]] = VPU.MVN1SumOp([[ARG_0]])
    // CHECK-SAME:       multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x3x3997x1xf16, {order = #NHWC}>)
...
// Per-W broadcast slope: slope [1,1,1,3] with input [1,4,2,3].
// Strategy assignment should pick SplitOverKernel (C=4 is the largest splittable dim).
// CHECK-LABEL: func.func @PReluBroadcastSlopeAssignedSOK
// CHECK-SAME:    ([[INPUT_DATA:%.+]]: tensor<1x4x2x3xf16>)
func.func @PReluBroadcastSlopeAssignedSOK(%arg0: tensor<1x4x2x3xf16>) -> tensor<1x4x2x3xf16> {

    %cst = const.Declare tensor<1x1x1x3xf16> = dense<-1.000000e+00> : tensor<1x1x1x3xf16>
    %0 = VPU.PRelu(%arg0, %cst) : tensor<1x4x2x3xf16>, tensor<1x1x1x3xf16> -> tensor<1x4x2x3xf16>

    return %0 : tensor<1x4x2x3xf16>

    // CHECK-DAG:    [[SLOPE:%.+]] = const.Declare tensor<1x1x1x3xf16>
    // CHECK:        [[PRELU:%.+]] = VPU.PRelu([[INPUT_DATA]], [[SLOPE]]) {
    // CHECK-SAME:               multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>}
    // CHECK-SAME:             : tensor<1x4x2x3xf16>, tensor<1x1x1x3xf16> -> tensor<1x4x2x3xf16>
    // CHECK:        return [[PRELU]] : tensor<1x4x2x3xf16>
}
