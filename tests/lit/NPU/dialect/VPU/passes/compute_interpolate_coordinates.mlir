...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform%" --make-ops-with-distributed-tensor --compute-interpolate-coordinates %s | FileCheck %s
...
func.func @interpolateNHWCAxes23(%arg0: tensor<1x21x14x14xf16, {order = #NHWC}>) -> tensor<1x21x16x10xf16, {order = #NHWC}> {
    %0 = VPU.Interpolate(%arg0) {attr = #IE.Interpolate<mode = <LINEAR_ONNX>, shape_calc_mode = <SIZES>, coord_mode = <ASYMMETRIC>, nearest_mode = <ROUND_PREFER_FLOOR>, antialias = false, pads_begin = [0, 0, 0, 0], pads_end = [0, 0, 0, 0], cube_coeff = -7.500000e-01 : f64>, axes_attr = [2, 3], initial_input_dims_attr = [1, 21, 14, 14], initial_output_dims_attr = [1, 21, 16, 10], multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeightOverlapped>, operandSegmentSizes = array<i32: 1, 0, 0, 0, 0, 0, 0, 0>, scales_attr = [2.3571428571428572, 2.3571428571428572], sizes_attr = [16, 10], tile_offset_attr = [0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00]} : tensor<1x21x14x14xf16, {order = #NHWC}> -> tensor<1x21x16x10xf16, {order = #NHWC}>
...
func.func @interpolateNHWCAxes12(%arg0: tensor<1x14x14x21xf16, {order = #NHWC}>) -> tensor<1x10x16x21xf16, {order = #NHWC}> {
    %0 = VPU.Interpolate(%arg0) {attr = #IE.Interpolate<mode = <LINEAR>, shape_calc_mode = <SIZES>, coord_mode = <ASYMMETRIC>, nearest_mode = <ROUND_PREFER_FLOOR>, antialias = false, pads_begin = [0, 0, 0, 0], pads_end = [0, 0, 0, 0], cube_coeff = -7.500000e-01 : f64>, axes_attr = [1, 2], initial_input_dims_attr = [1, 14, 14, 21], initial_output_dims_attr = [1, 10, 16, 21], multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeightOverlapped>, operandSegmentSizes = array<i32: 1, 0, 0, 0, 0, 0, 0, 0>, scales_attr = [2.3571428571428572, 2.3571428571428572], sizes_attr = [10, 16], tile_offset_attr = [0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00]} : tensor<1x14x14x21xf16, {order = #NHWC}> -> tensor<1x10x16x21xf16, {order = #NHWC}>
...
func.func @interpolateNCHWAxes23(%arg0: tensor<1x21x14x14xf16>) -> tensor<1x21x16x10xf16> {
    %0 = VPU.Interpolate(%arg0) {attr = #IE.Interpolate<mode = <LINEAR_ONNX>, shape_calc_mode = <SIZES>, coord_mode = <ASYMMETRIC>, nearest_mode = <ROUND_PREFER_FLOOR>, antialias = false, pads_begin = [0, 0, 0, 0], pads_end = [0, 0, 0, 0], cube_coeff = -7.500000e-01 : f64>, axes_attr = [2, 3], initial_input_dims_attr = [1, 21, 14, 14], initial_output_dims_attr = [1, 21, 16, 10], multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeightOverlapped>, operandSegmentSizes = array<i32: 1, 0, 0, 0, 0, 0, 0, 0>, scales_attr = [2.3571428571428572, 2.3571428571428572], sizes_attr = [16, 10], tile_offset_attr = [0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00]} : tensor<1x21x14x14xf16> -> tensor<1x21x16x10xf16>
...
func.func @interpolateNCHWAxes12(%arg0: tensor<1x14x14x21xf16>) -> tensor<1x16x10x21xf16> {
    %0 = VPU.Interpolate(%arg0) {attr = #IE.Interpolate<mode = <LINEAR>, shape_calc_mode = <SIZES>, coord_mode = <ASYMMETRIC>, nearest_mode = <ROUND_PREFER_FLOOR>, antialias = false, pads_begin = [0, 0, 0, 0], pads_end = [0, 0, 0, 0], cube_coeff = -7.500000e-01 : f64>, axes_attr = [1, 2], initial_input_dims_attr = [1, 21, 14, 14], initial_output_dims_attr = [1, 16, 10, 21], multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeightOverlapped>, operandSegmentSizes = array<i32: 1, 0, 0, 0, 0, 0, 0, 0>, scales_attr = [2.3571428571428572, 2.3571428571428572], sizes_attr = [16, 10], tile_offset_attr = [0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00]} : tensor<1x14x14x21xf16> -> tensor<1x16x10x21xf16>
