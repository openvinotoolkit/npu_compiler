...
module @Test {
    ...
    // CHECK-LABEL:   func.func @DynamicQuantizeClustering
    func.func @DynamicQuantizeClustering(
        ...
        return %output, %scale, %zero_point : tensor<1x2x2x6xui8>, tensor<1x1x1x1xf32>, tensor<1x1x1x1xui8>
