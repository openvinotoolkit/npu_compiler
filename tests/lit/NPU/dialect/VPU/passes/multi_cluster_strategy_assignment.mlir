...
func.func @EltwiseAddAssignedSOHOverlapped(%arg0: tensor<1x32x112x112xf16, {order = #NHWC}>, %arg1: tensor<1x32x112x112xf16, {order = #NHWC}>) -> tensor<1x32x112x112xf16, {order = #NHWC}> {
    %0 = VPU.NCE.Eltwise(%arg0, %arg1) {resultSegmentSizes = array<i32: 1, 0, 0, 0>,  op_type = #VPU.eltwise_type<ADD>, ppe = #VPU.PPEStub<> } :
    ...
    // CHECK:        [[VAL0:%.+]] = VPU.NCE.Eltwise([[ARG_0]], [[ARG_1]]){{.*}} {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, op_type = #VPU.eltwise_type<ADD>, ppe = #VPU.PPEStub<>, resultSegmentSizes = array<i32: 1, 0, 0, 0>} -> tensor<1x32x112x112xf16, {order = #NHWC}>
...
func.func @ConvAssignedSOHForLargeLayer(%arg0: tensor<1x64x608x608xf16, {order = #NHWC}>) -> tensor<1x80x608x608xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.Convolution(%arg0, %cst_0) rawFilterShape [80, 64, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, ppe = #VPU.PPEStub<>,  strides = [1, 1]} : tensor<1x64x608x608xf16, {order = #NHWC}>, tensor<80x64x3x3xf16, {order = #NHWC}> -> tensor<1x80x608x608xf16, {order = #NHWC}>
    ...
    // CHECK:        [[VAL0:%.+]] = VPU.NCE.Convolution([[INPUT]], [[WEIGHTS]]) rawFilterShape [80, 64, 3, 3] {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, ppe = #VPU.PPEStub<>,
...
func.func @InterpolateNearestAssignedClustering(%input_data: tensor<1x16x1x1xf16, {order = #NHWC}>) -> tensor<1x16x2x2xf16, {order = #NHWC}> {
    ...
    %interpolate = VPU.NCE.Interpolate(%input, %weights) rawFilterShape [16, 16, 1, 1] {
    ...
    // CHECK:       [[OUTPUT:%.+]] = VPU.NCE.Interpolate([[INPUT_SPARSE]], [[WEIGHTS]]) rawFilterShape [16, 16, 1, 1] {
...
func.func @InterpolateBilinearAssignedClustering(%input_data: tensor<1x16x1x1xf16, {order = #NHWC}>) -> tensor<1x16x2x2xf16, {order = #NHWC}> {
    ...
    %interpolate = VPU.NCE.Interpolate(%input, %weights) rawFilterShape [16, 16, 2, 2] {
    ...
    // CHECK:       [[OUTPUT:%.+]] = VPU.NCE.Interpolate([[INPUT_SPARSE]], [[WEIGHTS]]) rawFilterShape [16, 16, 2, 2] {
...
func.func @ConvAssignedSOKForSmallHW(%input_data: tensor<1x1024x4x4xf16, {order = #NHWC}>) -> tensor<1x2048x2x2xf16, {order = #NHWC}> {
    ...
    %conv = VPU.NCE.Convolution(%input_data, %weights) rawFilterShape [2048, 1024, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
    ...
    // CHECK:        [[CONV:%.+]] = VPU.NCE.Convolution([[INPUT_DATA]], [[WEIGHTS]]) rawFilterShape [2048, 1024, 1, 1] {
...
func.func @ConvAssignedSOKInCaseOfINFCost(%arg0: tensor<1x4096x1x1xf16, {order = #NHWC}>) -> tensor<1x5504x1x1xf16, {order = #NHWC}> {
    ...
    %conv = VPU.NCE.Convolution(%arg0, %weights) rawFilterShape [5504, 4096, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
        pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,
        ppe = #VPU.PPEStub<>,
         strides = [1, 1]
    ...
    // CHECK:       [[CONV:%.+]] = VPU.NCE.Convolution([[INPUT]], [[WEIGHTS]]) rawFilterShape [5504, 4096, 1, 1] {
...
func.func @MVN_PermuteCast_DepthConv_ReShape_Subgraph(%arg0: tensor<1x77x768x1xf16>) -> tensor<1x768x77x1xf16, {order = affine_map<(d0, d1, d2, d3) -> (d0, d2, d3, d1)>}> {
    ...
    %3 = VPU.NCE.DepthConvolution(%2, %cst) rawFilterShape [768, 1, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, ppe = #VPU.PPEInt<mode = <NOOP>, clamp_low = -2147483648 : i64, clamp_high = 2147483647 : i64, lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, fp_prelu_alpha = 1.000000e+00 : f64>,  strides = [1, 1]} -> tensor<1x768x11x7xf16, {order = affine_map<(d0, d1, d2, d3) -> (d0, d2, d3, d1)>}>
    ...
    // CHECK-SAME:    multiClusterStrategy = #VPU.multi_cluster_strategy<{{SplitOverHeight|SplitOverKernel}}>
...
// CHECK-SAME:     ([[INPUT:%.+]]: tensor<1x1x1x128xf16>, [[INPUT0:%.+]]: tensor<1x1x1x128xf16>)
func.func @SelectAssignedSplitOverWidth(%arg0: tensor<1x1x1x128xf16>, %arg1: tensor<1x1x1x128xf16>) -> tensor<1x1x1x128xf16> {
    %cst = const.Declare tensor<1x1x1x128xf16> = dense<0.000000e+00> : tensor<1x1x1x128xf16>
    %0 = VPU.Select(%arg0, %cst, %arg1) {
            auto_broadcast = #IE.auto_broadcast_type<NUMPY>} : tensor<1x1x1x128xf16>, tensor<1x1x1x128xf16>, tensor<1x1x1x128xf16> -> tensor<1x1x1x128xf16>
    return %0 : tensor<1x1x1x128xf16>

    // CHECK-DAG:    [[INPUT1:%.+]] = const.Declare tensor<1x1x1x128xf16> = dense<0.000000e+00> : tensor<1x1x1x128xf16>
    // CHECK:        [[SELECT:%.+]] = VPU.Select([[INPUT]], [[INPUT1]], [[INPUT0]]) {
    // CHECK-SAME:           auto_broadcast = #IE.auto_broadcast_type<NUMPY>,
    // CHECK-SAME:           multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverWidth>
    // CHECK-SAME:           } : tensor<1x1x1x128xf16>, tensor<1x1x1x128xf16>, tensor<1x1x1x128xf16> -> tensor<1x1x1x128xf16>
    // CHECK:        return [[SELECT]] : tensor<1x1x1x128xf16>
}
...
// CHECK-LABEL: @LSTMSequenceBidirectionalAssignedSplitOverKernel
func.func @LSTMSequenceBidirectionalAssignedSplitOverKernel(%input: tensor<1x2x35x512xf16>,
        %initialHiddenState: tensor<1x2x1x128xf16>, %initialCellState: tensor<1x2x1x128xf16>,
        %reccurrenceWeights: tensor<1x4x128x128xf16, {order = #NWHC}>, %biases: tensor<1x1x4x128xf16, {order = #NCWH}>)
...
// CHECK-LABEL: @LSTMSequenceForwardNotAssignedSplitOverKernel
func.func @LSTMSequenceForwardNotAssignedSplitOverKernel(%input: tensor<1x2x35x512xf16>,
        %initialHiddenState: tensor<1x1x1x128xf16>, %initialCellState: tensor<1x1x1x128xf16>,
        %reccurrenceWeights: tensor<1x4x128x128xf16, {order = #NWHC}>, %biases: tensor<1x1x4x128xf16, {order = #NCWH}>)
        -> (tensor<1x1x35x128xf16>, tensor<1x1x1x128xf16>, tensor<1x1x1x128xf16>) {
    %syncBuffer = const.Declare tensor<1x1x1x2xsi32> = dense<0> : tensor<1x1x1x2xsi32>

    // Note: By OpenVINO specification, C dimension of initial {hidden, cell}
...
// CHECK-LABEL: @LSTMSequenceReverseNotAssignedSplitOverKernel
func.func @LSTMSequenceReverseNotAssignedSplitOverKernel(%input: tensor<1x2x35x512xf16>,
        %initialHiddenState: tensor<1x1x1x128xf16>, %initialCellState: tensor<1x1x1x128xf16>,
        %reccurrenceWeights: tensor<1x4x128x128xf16, {order = #NWHC}>, %biases: tensor<1x1x4x128xf16, {order = #NCWH}>)
        -> (tensor<1x1x35x128xf16>, tensor<1x1x1x128xf16>, tensor<1x1x1x128xf16>) {
    %syncBuffer = const.Declare tensor<1x1x1x2xsi32> = dense<0> : tensor<1x1x1x2xsi32>
...
func.func @SoftMaxAssignedSplitOverHeightAndBigConvolutionToo(%arg0: tensor<1x48x1024x4x!qElemType, {order = #NHWC}>) -> tensor<1x4096x1024x4xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.Convolution(%arg0, %cst) rawFilterShape [4096, 48, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,  strides = [1, 1]} : tensor<1x48x1024x4x!qElemType, {order = #NHWC}>, tensor<4096x48x1x1x!qElemType, {order = #NHWC}> -> tensor<1x4096x1024x4xf16, {order = #NHWC}>
...
func.func @ConvAssignedSplitOverHeight(%arg0: tensor<1x1504x375x4xf16, {order = #NHWC}>) -> tensor<1x64x375x4xf16, {order = #NHWC}> {
    ...
    %1 = VPU.NCE.Convolution(%0, %cst) rawFilterShape [64, 1504, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
        pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,
        ppe = #VPU.PPEStub<>,  strides = [1, 1]} : tensor<1x1504x375x4xf16, {order = #NHWC}>, tensor<64x1504x1x1xf16, {order = #NHWC}> -> tensor<1x64x375x4xf16, {order = #NHWC}>
...
func.func @ThreeConvolutionsAssignedSOH(%input: tensor<1x128x92x92x!qElemType, {order = #NHWC}>) -> tensor<1x256x92x92x!qElemType, {order = #NHWC}> {
    ...
    %conv1 = VPU.NCE.Convolution(%input, %weights1) rawFilterShape [256, 128, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
    ...
    %conv2 = VPU.NCE.Convolution(%conv1, %weights2) rawFilterShape [256, 256, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
        pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>,
        ppe = #VPU.PPEStub<>,  strides = [1, 1]} :
    ...
    %conv3 = VPU.NCE.Convolution(%conv2, %weights3) rawFilterShape [256, 256, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
        pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>,
        ppe = #VPU.PPEStub<>,  strides = [1, 1]} :
            tensor<1x256x92x92x!qElemType, {order = #NHWC}>, tensor<256x256x3x3x!qElemType, {order = #NHWC}> -> tensor<1x256x92x92x!qElemType, {order = #NHWC}>
...
func.func @RMSNormAssignedSplitOverHeight(%arg: tensor<1x1x32x16xf16>) -> tensor<1x1x32x16xf16> {
    ...
    %0 = VPU.RMS(%arg, %cst_0) {eps = 9.9999997473787516E-6 : f64} : tensor<1x1x32x16xf16>, tensor<1x1x1x16xf16> -> tensor<1x1x32x16xf16>
...
func.func @RemoveClusteringStrategy(%arg0: tensor<1x1x1x77xf16>, %arg1: tensor<77x768xf16>) -> tensor<1x768xf16> {
    ...
    %aux = const.Declare tensor<1x1x1x1232xui8> = dense<0> : tensor<1x1x1x1232xui8>
    %output_values, %target_shape = VPU.TopK(%0, %aux) {axis = 3 : i64, element_type = si32, k_value = 1 : i64, mode = #IE.topk_mode<MAX>, sort = #IE.topk_sort_type<NONE>} : tensor<1x1x1x77xsi32>, tensor<1x1x1x1232xui8> -> tensor<1x1x1x1xsi32>, tensor<1x1x1x1xsi32>
    ...
    // CHECK: [[TOPK_AUX:%.+]] = const.Declare tensor<1x1x1x1232xui8> = dense<0> : tensor<1x1x1x1232xui8>
    // CHECK: [[TOPK_VALUE:%.+]], [[TOPK_SHAPE:%.+]] = VPU.TopK([[CONVERT]], [[TOPK_AUX]])
...
func.func @RMSNormAssignedClustering(%arg: tensor<1x1x1x768xf16>) -> tensor<1x1x1x768xf16> {
    ...
    %0 = VPU.RMS(%arg, %cst_0) {eps = 1.0013580322265625E-5 : f64} : tensor<1x1x1x768xf16>, tensor<1x1x1x768xf16> -> tensor<1x1x1x768xf16>
...
// CHECK-LABEL:   @SubtractSplitOverWidth
// CHECK-SAME:    [[INPUT0:%.+]]: tensor<1x28x64x128xf16, {order = #NWCH}>
// CHECK-SAME:    [[INPUT1:%.+]]: tensor<1x1x1x1xf16, {order = #NWCH}>
func.func @SubtractSplitOverWidth(%arg0: tensor<1x28x64x128xf16, {order = #NWCH}>, %arg1: tensor<1x1x1x1xf16, {order = #NWCH}>) -> tensor<1x28x64x128xf16, {order = #NWCH}> {
    %0 = VPU.Subtract(%arg0, %arg1) {
        auto_broadcast = #IE.auto_broadcast_type<NUMPY>
    } : tensor<1x28x64x128xf16, {order = #NWCH}>, tensor<1x1x1x1xf16, {order = #NWCH}> -> tensor<1x28x64x128xf16, {order = #NWCH}>

    return %0 : tensor<1x28x64x128xf16, {order = #NWCH}>

    // CHECK:       [[SUB:%.+]] = VPU.Subtract([[INPUT0]], [[INPUT1]]) {
    // CHECK-SAME:       multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverWidth>

    // CHECK:        return [[SUB]] : tensor<1x28x64x128xf16, {order = #NWCH}>
}
...
// CHECK-LABEL:   @AddSplitOverWidth
// CHECK-SAME:    [[INPUT0:%.+]]: tensor<1x16x16x14580xf16, {order = #NWCH}>
// CHECK-SAME:    [[INPUT1:%.+]]: tensor<1x16x1x14580xf16, {order = #NWCH}>
func.func @AddSplitOverWidth(%arg0: tensor<1x16x16x14580xf16, {order = #NWCH}>, %arg1: tensor<1x16x1x14580xf16, {order = #NWCH}>) -> tensor<1x16x16x14580xf16, {order = #NWCH}> {
    %0 = VPU.Add(%arg0, %arg1) {
        auto_broadcast = #IE.auto_broadcast_type<NUMPY>
    } : tensor<1x16x16x14580xf16, {order = #NWCH}>, tensor<1x16x1x14580xf16, {order = #NWCH}> -> tensor<1x16x16x14580xf16, {order = #NWCH}>
    ...
    // CHECK:        return [[ADD]] : tensor<1x16x16x14580xf16, {order = #NWCH}>
}
...
// CHECK-LABEL:   @AddAssignedSOW
// CHECK-SAME:    [[INPUT0:%.+]]: tensor<1x1x1x160xf16, {order = #NWCH}>, [[INPUT1:%.+]]: tensor<1x1x1x160xf16, {order = #NWCH}>
func.func @AddAssignedSOW(%arg0: tensor<1x1x1x160xf16, {order = #NWCH}>, %arg1: tensor<1x1x1x160xf16, {order = #NWCH}>) -> tensor<1x1x1x160xf16, {order = #NWCH}> {
    %0 = VPU.Add(%arg0, %arg1) {
        auto_broadcast = #IE.auto_broadcast_type<NUMPY>
    } : tensor<1x1x1x160xf16, {order = #NWCH}>, tensor<1x1x1x160xf16, {order = #NWCH}> -> tensor<1x1x1x160xf16, {order = #NWCH}>

    return %0 : tensor<1x1x1x160xf16, {order = #NWCH}>

    // CHECK:       [[ADD:%.+]] = VPU.Add([[INPUT0]], [[INPUT1]]) {
    // CHECK-SAME:       multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverWidth>

    // CHECK:        return [[ADD]] : tensor<1x1x1x160xf16, {order = #NWCH}>
}
...
// CHECK-SAME:    [[INPUT0:%.+]]: tensor<1x1x1x64xf16, {order = #NWCH}>, [[INPUT1:%.+]]: tensor<1x1x1x64xf16, {order = #NWCH}>
func.func @AddAssignedClustering(%arg0: tensor<1x1x1x64xf16, {order = #NWCH}>, %arg1: tensor<1x1x1x64xf16, {order = #NWCH}>) -> tensor<1x1x1x64xf16, {order = #NWCH}> {
    %0 = VPU.Add(%arg0, %arg1) {
        auto_broadcast = #IE.auto_broadcast_type<NUMPY>
    } : tensor<1x1x1x64xf16, {order = #NWCH}>, tensor<1x1x1x64xf16, {order = #NWCH}> -> tensor<1x1x1x64xf16, {order = #NWCH}>

    return %0 : tensor<1x1x1x64xf16, {order = #NWCH}>

    // CHECK:       [[ADD:%.+]] = VPU.Add([[INPUT0]], [[INPUT1]]) {
    // CHECK-SAME:       multiClusterStrategy = #VPU.multi_cluster_strategy<Clustering>

    // CHECK:        return [[ADD]] : tensor<1x1x1x64xf16, {order = #NWCH}>
}
...
func.func @DynamicQuantizeAssignedSplitOverHeight(%arg0: tensor<1x1x1792x16xf32>, %arg1: tensor<1x1x1x1xf32>, %arg2: tensor<1x1x1x1xf32>) -> (tensor<1x1x1792x16xui8>, tensor<1x1x1x1xf32>, tensor<1x1x1x1xui8>) {
    %output, %scale, %zero_point = VPU.DynamicQuantize(%arg0, %arg1, %arg2) {dstElemType = ui8} : tensor<1x1x1792x16xf32>, tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32> -> tensor<1x1x1792x16xui8>, tensor<1x1x1x1xf32>, tensor<1x1x1x1xui8>
...
func.func @DynamicQuantizeAssignedSplitOverKernel(%arg0: tensor<1x1792x1x16xf32>, %arg1: tensor<1x1x1x1xf32>, %arg2: tensor<1x1x1x1xf32>) -> (tensor<1x1792x1x16xui8>, tensor<1x1x1x1xf32>, tensor<1x1x1x1xui8>) {
    %output, %scale, %zero_point = VPU.DynamicQuantize(%arg0, %arg1, %arg2) {dstElemType = ui8} : tensor<1x1792x1x16xf32>, tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32> -> tensor<1x1792x1x16xui8>, tensor<1x1x1x1xf32>, tensor<1x1x1x1xui8>
...
func.func @DynamicQuantizeAssignedClustering(%arg0: tensor<1x1x1x1xf32>, %arg1: tensor<1x1x1x1xf32>, %arg2: tensor<1x1x1x1xf32>) -> (tensor<1x1x1x1xui8>, tensor<1x1x1x1xf32>, tensor<1x1x1x1xui8>) {
    %output, %scale, %zero_point = VPU.DynamicQuantize(%arg0, %arg1, %arg2) {dstElemType = ui8} : tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32> -> tensor<1x1x1x1xui8>, tensor<1x1x1x1xf32>, tensor<1x1x1x1xui8>
...
func.func @DynamicQuantizeAssignedSplitOverWidth(%arg0: tensor<1x1x1x8192xf32>, %arg1: tensor<1x1x1x1xf32>, %arg2: tensor<1x1x1x1xf32>) -> (tensor<1x1x1x8192xui8>, tensor<1x1x1x1xf32>, tensor<1x1x1x1xui8>) {
    %output, %scale, %zero_point = VPU.DynamicQuantize(%arg0, %arg1, %arg2) {dstElemType = ui8} : tensor<1x1x1x8192xf32>, tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32> -> tensor<1x1x1x8192xui8>, tensor<1x1x1x1xf32>, tensor<1x1x1x1xui8>
...
func.func @NCEToOpWithMultipleResults(
    ...
    %nce = VPU.NCE.Eltwise(%input1, %input2) {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
    ...
    %dyn_quant, %scale, %zero_point = VPU.DynamicQuantize(%nce, %min, %max) {dstElemType = ui8} : tensor<1x16x1792x16xf32>, tensor<1x1x1x1xf32>, tensor<1x1x1x1xf32> -> tensor<1x16x1792x16xui8>, tensor<1x1x1x1xf32>, tensor<1x1x1x1xui8>
...
// CHECK-LABEL:   @ReverseSequenceAssignedSplitOverHeight
// CHECK-SAME:    [[DATA:%.+]]: tensor<1x1x1024x10xf16>
// CHECK-SAME:    [[SEQ_LENS:%.+]]: tensor<1x1x1x1xsi32>
func.func @ReverseSequenceAssignedSplitOverHeight(%data: tensor<1x1x1024x10xf16>, %seq_lens: tensor<1x1x1x1xsi32>) -> tensor<1x1x1024x10xf16> {
    %0 = VPU.ReverseSequence(%data, %seq_lens) {batch_axis = 0 : i64, seq_axis = 3 : i64} : tensor<1x1x1024x10xf16>, tensor<1x1x1x1xsi32> -> tensor<1x1x1024x10xf16>
    return %0 : tensor<1x1x1024x10xf16>

    // CHECK:       [[REVERSESEQUENCE:%.+]] = VPU.ReverseSequence([[DATA]], [[SEQ_LENS]])
    // CHECK-SAME:         {batch_axis = 0 : i64, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, seq_axis = 3 : i64} : tensor<1x1x1024x10xf16>, tensor<1x1x1x1xsi32> -> tensor<1x1x1024x10xf16>
    // CHECK:        return [[REVERSESEQUENCE]] : tensor<1x1x1024x10xf16>
}

// -----

// CHECK-LABEL:   @ReverseSequenceAssignedSplitOverKernel
// CHECK-SAME:    [[DATA:%.+]]: tensor<1x16x1x1xf16>
// CHECK-SAME:    [[SEQ_LENS:%.+]]: tensor<1x1x1x1xsi32>
func.func @ReverseSequenceAssignedSplitOverKernel(%data: tensor<1x16x1x1xf16>, %seq_lens: tensor<1x1x1x1xsi32>) -> tensor<1x16x1x1xf16> {
    %0 = VPU.ReverseSequence(%data, %seq_lens) {batch_axis = 0 : i64, seq_axis = 2 : i64} : tensor<1x16x1x1xf16>, tensor<1x1x1x1xsi32> -> tensor<1x16x1x1xf16>
    return %0 : tensor<1x16x1x1xf16>

    // CHECK:       [[REVERSESEQUENCE:%.+]] = VPU.ReverseSequence([[DATA]], [[SEQ_LENS]])
    // CHECK-SAME:         {batch_axis = 0 : i64, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>, seq_axis = 2 : i64} : tensor<1x16x1x1xf16>, tensor<1x1x1x1xsi32> -> tensor<1x16x1x1xf16>
    // CHECK:        return [[REVERSESEQUENCE]] : tensor<1x16x1x1xf16>
}
...
// CHECK-LABEL:   @BitwiseRightShiftAssignedSplitOverHeight
// CHECK-SAME:    [[INPUT0:%.+]]: tensor<1x1x1152x1xi8>, [[INPUT1:%.+]]: tensor<1x1x1152x1xi8>
func.func @BitwiseRightShiftAssignedSplitOverHeight(%arg0: tensor<1x1x1152x1xi8>, %arg1: tensor<1x1x1152x1xi8>) -> tensor<1x1x1152x1xi8> {
    %0 = VPU.BitwiseRightShift(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>} : tensor<1x1x1152x1xi8>, tensor<1x1x1152x1xi8> -> tensor<1x1x1152x1xi8>
    return %0 : tensor<1x1x1152x1xi8>

    // CHECK:   [[BITWISERIGHTSHIFT:%.+]] = VPU.BitwiseRightShift([[INPUT0]], [[INPUT1]]) {
    // CHECK-SAME:       multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>}
    // CHECK:   return [[BITWISERIGHTSHIFT]] : tensor<1x1x1152x1xi8>
}

// -----

// CHECK-LABEL:   @BitwiseRightShiftAssignedSplitOverKernel
// CHECK-SAME:    [[INPUT0:%.+]]: tensor<1x1152x1x1xi8>, [[INPUT1:%.+]]: tensor<1x1152x1x1xi8>
func.func @BitwiseRightShiftAssignedSplitOverKernel(%arg0: tensor<1x1152x1x1xi8>, %arg1: tensor<1x1152x1x1xi8>) -> tensor<1x1152x1x1xi8> {
    %0 = VPU.BitwiseRightShift(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>} : tensor<1x1152x1x1xi8>, tensor<1x1152x1x1xi8> -> tensor<1x1152x1x1xi8>
    return %0 : tensor<1x1152x1x1xi8>

    // CHECK:   [[BITWISERIGHTSHIFT:%.+]] = VPU.BitwiseRightShift([[INPUT0]], [[INPUT1]]) {
    // CHECK-SAME:       multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>}
    // CHECK:   return [[BITWISERIGHTSHIFT]] : tensor<1x1152x1x1xi8>
}

// -----

// CHECK-LABEL:   @BitwiseRightShiftAssignedClustering
// CHECK-SAME:    [[INPUT0:%.+]]: tensor<1x1x1x513xi8>, [[INPUT1:%.+]]: tensor<1x1x1x513xi8>
func.func @BitwiseRightShiftAssignedClustering(%arg0: tensor<1x1x1x513xi8>, %arg1: tensor<1x1x1x513xi8>) -> tensor<1x1x1x513xi8> {
    %0 = VPU.BitwiseRightShift(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>} : tensor<1x1x1x513xi8>, tensor<1x1x1x513xi8> -> tensor<1x1x1x513xi8>
    return %0 : tensor<1x1x1x513xi8>

    // CHECK:   [[BITWISERIGHTSHIFT:%.+]] = VPU.BitwiseRightShift([[INPUT0]], [[INPUT1]]) {
    // CHECK-SAME:       multiClusterStrategy = #VPU.multi_cluster_strategy<Clustering>}
    // CHECK:   return [[BITWISERIGHTSHIFT]] : tensor<1x1x1x513xi8>
}

// -----

// CHECK-LABEL:   @BitwiseLeftShiftAssignedSplitOverHeight
// CHECK-SAME:    [[INPUT0:%.+]]: tensor<1x1x1152x1xi8>, [[INPUT1:%.+]]: tensor<1x1x1152x1xi8>
func.func @BitwiseLeftShiftAssignedSplitOverHeight(%arg0: tensor<1x1x1152x1xi8>, %arg1: tensor<1x1x1152x1xi8>) -> tensor<1x1x1152x1xi8> {
    %0 = VPU.BitwiseLeftShift(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>} : tensor<1x1x1152x1xi8>, tensor<1x1x1152x1xi8> -> tensor<1x1x1152x1xi8>
    return %0 : tensor<1x1x1152x1xi8>

    // CHECK:   [[BITWISELEFTSHIFT:%.+]] = VPU.BitwiseLeftShift([[INPUT0]], [[INPUT1]]) {
    // CHECK-SAME:       multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>}
    // CHECK:   return [[BITWISELEFTSHIFT]] : tensor<1x1x1152x1xi8>
}

// -----

// CHECK-LABEL:   @BitwiseLeftShiftAssignedSplitOverKernel
// CHECK-SAME:    [[INPUT0:%.+]]: tensor<1x1152x1x1xi8>, [[INPUT1:%.+]]: tensor<1x1152x1x1xi8>
func.func @BitwiseLeftShiftAssignedSplitOverKernel(%arg0: tensor<1x1152x1x1xi8>, %arg1: tensor<1x1152x1x1xi8>) -> tensor<1x1152x1x1xi8> {
    %0 = VPU.BitwiseLeftShift(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>} : tensor<1x1152x1x1xi8>, tensor<1x1152x1x1xi8> -> tensor<1x1152x1x1xi8>
    return %0 : tensor<1x1152x1x1xi8>

    // CHECK:   [[BITWISELEFTSHIFT:%.+]] = VPU.BitwiseLeftShift([[INPUT0]], [[INPUT1]]) {
    // CHECK-SAME:       multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>}
    // CHECK:   return [[BITWISELEFTSHIFT]] : tensor<1x1152x1x1xi8>
}

// -----

// CHECK-LABEL:   @BitwiseLeftShiftAssignedClustering
// CHECK-SAME:    [[INPUT0:%.+]]: tensor<1x1x1x513xi8>, [[INPUT1:%.+]]: tensor<1x1x1x513xi8>
func.func @BitwiseLeftShiftAssignedClustering(%arg0: tensor<1x1x1x513xi8>, %arg1: tensor<1x1x1x513xi8>) -> tensor<1x1x1x513xi8> {
    %0 = VPU.BitwiseLeftShift(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>} : tensor<1x1x1x513xi8>, tensor<1x1x1x513xi8> -> tensor<1x1x1x513xi8>
    return %0 : tensor<1x1x1x513xi8>

    // CHECK:   [[BITWISELEFTSHIFT:%.+]] = VPU.BitwiseLeftShift([[INPUT0]], [[INPUT1]]) {
    // CHECK-SAME:       multiClusterStrategy = #VPU.multi_cluster_strategy<Clustering>}
    // CHECK:   return [[BITWISELEFTSHIFT]] : tensor<1x1x1x513xi8>
}
...
// CHECK-LABEL:   @IsInfAssignedSplitOverKernel
// CHECK-SAME:    [[INPUT:%.+]]: tensor<1x106x1x256xf16>
func.func @IsInfAssignedSplitOverKernel(%arg0: tensor<1x106x1x256xf16>) -> tensor<1x106x1x256xi8> {
    %0 = VPU.IsInf(%arg0) : tensor<1x106x1x256xf16> -> tensor<1x106x1x256xi8>
    return %0 : tensor<1x106x1x256xi8>

    // CHECK:   [[RET:%.+]] = VPU.IsInf([[INPUT]]) {
    // CHECK-SAME:       multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>}
}

// -----

// CHECK-LABEL:   @IsInfAssignedSplitOverHeight
// CHECK-SAME:    [[INPUT:%.+]]: tensor<1x1x256x256xf16>
func.func @IsInfAssignedSplitOverHeight(%arg0: tensor<1x1x256x256xf16>) -> tensor<1x1x256x256xi8> {
    %0 = VPU.IsInf(%arg0) : tensor<1x1x256x256xf16> -> tensor<1x1x256x256xi8>
...
// CHECK-LABEL:   @IsInfAssignedClustering
// CHECK-SAME:    [[INPUT:%.+]]: tensor<1x1x1x256xf16>
func.func @IsInfAssignedClustering(%arg0: tensor<1x1x1x256xf16>) -> tensor<1x1x1x256xi8> {
    %0 = VPU.IsInf(%arg0) : tensor<1x1x1x256xf16> -> tensor<1x1x1x256xi8>
    return %0 : tensor<1x1x1x256xi8>
...
// CHECK-LABEL:   @IsFiniteAssignedSplitOverKernel
// CHECK-SAME:    [[INPUT:%.+]]: tensor<1x106x1x256xf16>
func.func @IsFiniteAssignedSplitOverKernel(%arg0: tensor<1x106x1x256xf16>) -> tensor<1x106x1x256xi8> {
    %0 = VPU.IsFinite(%arg0) : tensor<1x106x1x256xf16> -> tensor<1x106x1x256xi8>
    return %0 : tensor<1x106x1x256xi8>

    // CHECK:   [[RET:%.+]] = VPU.IsFinite([[INPUT]]) {
    // CHECK-SAME:       multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>}
}

// -----

// CHECK-LABEL:   @IsFiniteAssignedSplitOverHeight
// CHECK-SAME:    [[INPUT:%.+]]: tensor<1x1x256x256xf16>
func.func @IsFiniteAssignedSplitOverHeight(%arg0: tensor<1x1x256x256xf16>) -> tensor<1x1x256x256xi8> {
    %0 = VPU.IsFinite(%arg0) : tensor<1x1x256x256xf16> -> tensor<1x1x256x256xi8>
    return %0 : tensor<1x1x256x256xi8>
...
// CHECK-LABEL:   @IsFiniteAssignedClustering
// CHECK-SAME:    [[INPUT:%.+]]: tensor<1x1x1x256xf16>
func.func @IsFiniteAssignedClustering(%arg0: tensor<1x1x1x256xf16>) -> tensor<1x1x1x256xi8> {
    %0 = VPU.IsFinite(%arg0) : tensor<1x1x1x256xf16> -> tensor<1x1x1x256xi8>
    return %0 : tensor<1x1x1x256xi8>
...
// CHECK-LABEL:   @LogicalOrAssignedSplitOverKernel
// CHECK-SAME:    [[INPUT_0:%.+]]: tensor<1x106x1x256xf16>, [[INPUT_1:%.+]]: tensor<1x106x1x1xf16>
func.func @LogicalOrAssignedSplitOverKernel(%arg0: tensor<1x106x1x256xf16>, %arg1: tensor<1x106x1x1xf16>) -> tensor<1x106x1x256xf16> {

    %0 = VPU.LogicalOr(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>} : tensor<1x106x1x256xf16>, tensor<1x106x1x1xf16> -> tensor<1x106x1x256xf16>

    return %0 : tensor<1x106x1x256xf16>

    // CHECK:   [[LOGICALOR:%.+]] = VPU.LogicalOr([[INPUT_0]], [[INPUT_1]]) {
    // CHECK-SAME:       multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>}
    // CHECK-SAME:       tensor<1x106x1x256xf16>, tensor<1x106x1x1xf16> -> tensor<1x106x1x256xf16>
    // CHECK:   return [[LOGICALOR]] : tensor<1x106x1x256xf16>
}

// -----

// CHECK-LABEL:   @LogicalOrAssignedSplitOverHeight
// CHECK-SAME:    [[INPUT_0:%.+]]: tensor<1x1x256x256xf16>, [[INPUT_1:%.+]]: tensor<1x1x1x1xf16>
func.func @LogicalOrAssignedSplitOverHeight(%arg0: tensor<1x1x256x256xf16>, %arg1: tensor<1x1x1x1xf16>) -> tensor<1x1x256x256xf16> {

    %0 = VPU.LogicalOr(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>} : tensor<1x1x256x256xf16>, tensor<1x1x1x1xf16> -> tensor<1x1x256x256xf16>
    ...
    // CHECK-SAME:       multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>}
    // CHECK-SAME:       tensor<1x1x256x256xf16>, tensor<1x1x1x1xf16> -> tensor<1x1x256x256xf16>
    // CHECK:   return [[LOGICALOR]] : tensor<1x1x256x256xf16>
}

// -----

// CHECK-LABEL:   @LogicalOrAssignedClustering
// CHECK-SAME:    [[INPUT_0:%.+]]: tensor<2x106x1x256xf16>, [[INPUT_1:%.+]]: tensor<2x106x1x1xf16>
func.func @LogicalOrAssignedClustering(%arg0: tensor<2x106x1x256xf16>, %arg1: tensor<2x106x1x1xf16>) -> tensor<2x106x1x256xf16> {

    %0 = VPU.LogicalOr(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>} : tensor<2x106x1x256xf16>, tensor<2x106x1x1xf16> -> tensor<2x106x1x256xf16>
    ...
    // CHECK-SAME:       multiClusterStrategy = #VPU.multi_cluster_strategy<Clustering>}
    // CHECK-SAME:       tensor<2x106x1x256xf16>, tensor<2x106x1x1xf16> -> tensor<2x106x1x256xf16>
    // CHECK:   return [[LOGICALOR]] : tensor<2x106x1x256xf16>
}
...
// CHECK-LABEL:   @ReLUAssignedSplitOverKernel
// CHECK-SAME:    [[INPUT:%.+]]: tensor<1x106x1x256xf16>
func.func @ReLUAssignedSplitOverKernel(%arg0: tensor<1x106x1x256xf16>) -> tensor<1x106x1x256xf16> {
    %0 = VPU.ReLU(%arg0) : tensor<1x106x1x256xf16> -> tensor<1x106x1x256xf16>
    return %0 : tensor<1x106x1x256xf16>

    // CHECK:   [[RELU:%.+]] = VPU.ReLU([[INPUT]]) {
    // CHECK-SAME:       multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>}
}

// -----

// CHECK-LABEL:   @ReLUAssignedSplitOverHeight
// CHECK-SAME:    [[INPUT:%.+]]: tensor<1x1x256x256xf16>
func.func @ReLUAssignedSplitOverHeight(%arg0: tensor<1x1x256x256xf16>) -> tensor<1x1x256x256xf16> {
    %0 = VPU.ReLU(%arg0) : tensor<1x1x256x256xf16> -> tensor<1x1x256x256xf16>
    return %0 : tensor<1x1x256x256xf16>
...
// CHECK-LABEL:   @ReLUAssignedClustering
// CHECK-SAME:    [[INPUT:%.+]]: tensor<1x1x1x256xf16>
func.func @ReLUAssignedClustering(%arg0: tensor<1x1x1x256xf16>) -> tensor<1x1x1x256xf16> {
    %0 = VPU.ReLU(%arg0) : tensor<1x1x1x256xf16> -> tensor<1x1x1x256xf16>
    return %0 : tensor<1x1x1x256xf16>
...
// CHECK-LABEL: @SWEltwiseNeedAlignmentAssignedSOW
// CHECK-SAME:    [[INPUT_0:%.+]]: tensor<1x2x1x255xf16>
// CHECK-SAME:    [[INPUT_1:%.+]]: tensor<1x2x1x1xf16>
func.func @SWEltwiseNeedAlignmentAssignedSOW(%arg0: tensor<1x2x1x255xf16>, %arg1: tensor<1x2x1x1xf16>) -> tensor<1x2x1x255xf16> {
    %0 = VPU.Multiply(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x2x1x255xf16>, tensor<1x2x1x1xf16> -> tensor<1x2x1x255xf16>
    return %0: tensor<1x2x1x255xf16>

    // CHECK:       [[MULTIPLY:%.+]] = VPU.Multiply([[INPUT_0]], [[INPUT_1]])
    // CHECK-SAME:    {auto_broadcast = #IE.auto_broadcast_type<NUMPY>, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverWidth>}
    // CHECK-SAME:    : tensor<1x2x1x255xf16>, tensor<1x2x1x1xf16> -> tensor<1x2x1x255xf16>

    // CHECK:       return [[MULTIPLY]] : tensor<1x2x1x255xf16>
}

// -----

// CHECK-LABEL:   @MaxPool8AssignedSOB
// CHECK-SAME:    [[INPUT_0:%.+]]: tensor<8x2x667x667xf16>
func.func @MaxPool8AssignedSOB(%arg0: tensor<8x2x667x667xf16>) -> (tensor<8x2x333x333xf16>, tensor<8x2x333x333xsi32>) {
    %output, %output_index = VPU.MaxPool8(%arg0) {axis = 0 : i64, dilations = [1, 1], index_element_type = si32,
                                initial_input_dims_attr = [8, 2, 667, 667], initial_output_dims_attr = [8, 2, 333, 333],
                                kernel_size = [2, 2],
                                pads_begin = [0, 0], pads_end = [0, 0], rounding_type = #IE.rounding_type<FLOOR>, strides = [2, 2]}
    : tensor<8x2x667x667xf16> -> tensor<8x2x333x333xf16>, tensor<8x2x333x333xsi32>
    return %output, %output_index : tensor<8x2x333x333xf16>, tensor<8x2x333x333xsi32>

    // CHECK:       [[MAXPOOL8:%.+]], [[MAXPOOL8_INDEX:%.+]] = VPU.MaxPool8([[INPUT_0]]) {
    // CHECK-SAME:       multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverBatch>
    // CHECK-SAME:       }
}
...
// CHECK-LABEL:   @MaxPool8AssignedSOK
// CHECK-SAME:    [[INPUT_0:%.+]]: tensor<1x8x667x667xf16>
func.func @MaxPool8AssignedSOK(%arg0: tensor<1x8x667x667xf16>) -> (tensor<1x8x333x333xf16>, tensor<1x8x333x333xsi32>) {
    %output, %output_index = VPU.MaxPool8(%arg0) {axis = 0 : i64, dilations = [1, 1], index_element_type = si32,
                                initial_input_dims_attr = [1, 8, 667, 667], initial_output_dims_attr = [1, 8, 333, 333],
                                kernel_size = [2, 2],
                                pads_begin = [0, 0], pads_end = [0, 0], rounding_type = #IE.rounding_type<FLOOR>, strides = [2, 2]}
    : tensor<1x8x667x667xf16> -> tensor<1x8x333x333xf16>, tensor<1x8x333x333xsi32>
    return %output, %output_index : tensor<1x8x333x333xf16>, tensor<1x8x333x333xsi32>
...
// CHECK-LABEL: @SWScatterElementsUpdateAssignedSOW
// CHECK-SAME:    [[INPUT:%.+]]: tensor<1x1x1024x2048xf16>
// CHECK-SAME:    [[INDICES:%.+]]: tensor<1x1x32x2048xsi32>
// CHECK-SAME:    [[UPDATE:%.+]]: tensor<1x1x32x2048xf16>
func.func @SWScatterElementsUpdateAssignedSOW(%arg0 : tensor<1x1x1024x2048xf16>, %arg1 : tensor<1x1x32x2048xsi32>, %arg2 : tensor<1x1x32x2048xf16>) -> tensor<1x1x1024x2048xf16> {
...
// CHECK-LABEL: @SWScatterElementsUpdateAssignedSOH
// CHECK-SAME:    [[INPUT:%.+]]: tensor<1x1x1024x128xf16>
// CHECK-SAME:    [[INDICES:%.+]]: tensor<1x1x1024x8xsi32>
// CHECK-SAME:    [[UPDATE:%.+]]: tensor<1x1x1024x8xf16>
func.func @SWScatterElementsUpdateAssignedSOH(%arg0 : tensor<1x1x1024x128xf16>, %arg1 : tensor<1x1x1024x8xsi32>, %arg2 : tensor<1x1x1024x8xf16>) -> tensor<1x1x1024x128xf16> {
    %0 = VPU.ScatterElementsUpdate(%arg0, %arg1, %arg2) {axis = 3 : i64, reduction = #IE.scatter_elements_update_reduction_type<NONE>, use_init_val = true}
            : tensor<1x1x1024x128xf16>, tensor<1x1x1024x8xsi32>, tensor<1x1x1024x8xf16> -> tensor<1x1x1024x128xf16>
    return %0 : tensor<1x1x1024x128xf16>

    // CHECK:    [[SCATTER_ELEMENTS:%.+]] = VPU.ScatterElementsUpdate([[INPUT]], [[INDICES]], [[UPDATE]])
    // CHECK-SAME:       {axis = 3 : i64, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, reduction = #IE.scatter_elements_update_reduction_type<NONE>, use_init_val = true} : tensor<1x1x1024x128xf16>, tensor<1x1x1024x8xsi32>, tensor<1x1x1024x8xf16> -> tensor<1x1x1024x128xf16>
    // CHECK:    return [[SCATTER_ELEMENTS]] : tensor<1x1x1024x128xf16>
}
...
// CHECK-LABEL:   @SquaredDifferenceAssignedSplitOverHeight
// CHECK-SAME:    [[INPUT0:%.+]]: tensor<1x1x256x256xf16>, [[INPUT1:%.+]]: tensor<1x1x256x256xf16>
func.func @SquaredDifferenceAssignedSplitOverHeight(%arg0: tensor<1x1x256x256xf16>, %arg1: tensor<1x1x256x256xf16>) -> tensor<1x1x256x256xf16> {
    %0 = VPU.SquaredDiff(%arg0, %arg1) {
        auto_broadcast = #IE.auto_broadcast_type<NUMPY>
    } : tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16> -> tensor<1x1x256x256xf16>
    ...
    // CHECK:        return [[SQDIFF]] : tensor<1x1x256x256xf16>
}

// -----

// CHECK-LABEL:   @SquaredDifferenceAssignedSplitOverKernel
// CHECK-SAME:    [[INPUT0:%.+]]: tensor<1x106x1x256xf16>, [[INPUT1:%.+]]: tensor<1x106x1x1xf16>
func.func @SquaredDifferenceAssignedSplitOverKernel(%arg0: tensor<1x106x1x256xf16>, %arg1: tensor<1x106x1x1xf16>) -> tensor<1x106x1x256xf16> {
    %0 = VPU.SquaredDiff(%arg0, %arg1) {
        auto_broadcast = #IE.auto_broadcast_type<NUMPY>
    } : tensor<1x106x1x256xf16>, tensor<1x106x1x1xf16> -> tensor<1x106x1x256xf16>
    ...
    // CHECK:        return [[SQDIFF]] : tensor<1x106x1x256xf16>
}

// -----

// CHECK-LABEL:   @SquaredDifferenceAssignedSplitOverWidth
// CHECK-SAME:    [[INPUT0:%.+]]: tensor<1x1x1x256xf16>, [[INPUT1:%.+]]: tensor<1x1x1x256xf16>
func.func @SquaredDifferenceAssignedSplitOverWidth(%arg0: tensor<1x1x1x256xf16>, %arg1: tensor<1x1x1x256xf16>) -> tensor<1x1x1x256xf16> {
    %0 = VPU.SquaredDiff(%arg0, %arg1) {
        auto_broadcast = #IE.auto_broadcast_type<NUMPY>
    } : tensor<1x1x1x256xf16>, tensor<1x1x1x256xf16> -> tensor<1x1x1x256xf16>
    ...
    // CHECK:        return [[SQDIFF]] : tensor<1x1x1x256xf16>
}

// -----

// CHECK-LABEL:   @SquaredDifferenceAssignedClustering
// CHECK-SAME:    [[INPUT0:%.+]]: tensor<1x1x1x1xf16>,
// CHECK-SAME:    [[INPUT1:%.+]]: tensor<1x1x1x1xf16>
func.func @SquaredDifferenceAssignedClustering(%arg0: tensor<1x1x1x1xf16>, %arg1: tensor<1x1x1x1xf16>) -> tensor<1x1x1x1xf16> {
    %0 = VPU.SquaredDiff(%arg0, %arg1) {
        auto_broadcast = #IE.auto_broadcast_type<NUMPY>
    ...
    // CHECK:        return [[SQDIFF]] : tensor<1x1x1x1xf16>
}
...
// CHECK-LABEL: @ConvKeepsSOHAfterHeightSliceOfSOHPool
// CHECK-SAME:  [[INPUT:%.+]]: tensor<1x32x5760x1xf16, {order = #NHWC}>
func.func @ConvKeepsSOHAfterHeightSliceOfSOHPool(%arg0: tensor<1x32x5760x1xf16, {order = #NHWC}>) -> tensor<1x32x2880x1xf16, {order = #NHWC}> {
    %weights = const.Declare tensor<32x32x1x1xf16, {order = #NHWC}> = dense<1.0e+00> : tensor<32x32x1x1xf16>, [#const.Reorder<#NHWC>]

    %pool = VPU.NCE.AveragePool(%arg0) {
        kernel_size = [1, 1],
        pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,
        ppe = #VPU.PPEStub<>,
        strides = [1, 1]
    } : tensor<1x32x5760x1xf16, {order = #NHWC}> -> tensor<1x32x5760x1xf16, {order = #NHWC}>

    %slice = VPU.Slice %pool [0, 0, 1, 0] [1, 32, 5759, 1]
        : tensor<1x32x5760x1xf16, {order = #NHWC}> to tensor<1x32x5759x1xf16, {order = #NHWC}>

    %conv = VPU.NCE.Convolution(%slice, %weights) rawFilterShape [32, 32, 1, 1] {
        pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,
        ppe = #VPU.PPEStub<>,

        resultSegmentSizes = array<i32: 1, 0, 0, 0>,
        strides = [2, 1]
    } : tensor<1x32x5759x1xf16, {order = #NHWC}>, tensor<32x32x1x1xf16, {order = #NHWC}>
      -> tensor<1x32x2880x1xf16, {order = #NHWC}>

    return %conv : tensor<1x32x2880x1xf16, {order = #NHWC}>

    // CHECK: [[POOL:%.+]] = VPU.NCE.AveragePool([[INPUT]]
    // CHECK-SAME: multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>

    // CHECK: [[SLICE:%.+]] = VPU.Slice [[POOL]] [0, 0, 1, 0] [1, 32, 5759, 1]
...
// CHECK-LABEL:   @LRNAssignedSplitOverHeight
// CHECK-SAME:    [[INPUT:%.+]]: tensor<1x64x128x128xf16>
func.func @LRNAssignedSplitOverHeight(%arg0: tensor<1x64x128x128xf16>) -> tensor<1x64x128x128xf16> {
    %0 = VPU.LRN(%arg0) {alpha = 1.000000e-04 : f64, axes = [1], beta = 2.000000e+00 : f64, bias = 1.000000e+00 : f64, size = 5 : i64} : tensor<1x64x128x128xf16> -> tensor<1x64x128x128xf16>
    return %0 : tensor<1x64x128x128xf16>

    // CHECK:       [[LRN:%.+]] = VPU.LRN([[INPUT]]) {
    // CHECK-SAME:      multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>

    // CHECK:        return [[LRN]] : tensor<1x64x128x128xf16>
}

// -----

// CHECK-LABEL:   @LRNAssignedSplitOverKernel
// CHECK-SAME:    [[INPUT:%.+]]: tensor<1x64x128x128xf16>
func.func @LRNAssignedSplitOverKernel(%arg0: tensor<1x64x128x128xf16>) -> tensor<1x64x128x128xf16> {
    %0 = VPU.LRN(%arg0) {alpha = 1.000000e-04 : f64, axes = [2], beta = 2.000000e+00 : f64, bias = 1.000000e+00 : f64, size = 5 : i64} : tensor<1x64x128x128xf16> -> tensor<1x64x128x128xf16>
    return %0 : tensor<1x64x128x128xf16>
...
// CHECK-LABEL:   @LRNAssignedClustering
// CHECK-SAME:    [[INPUT:%.+]]: tensor<1x1x1x256xf16>
func.func @LRNAssignedClustering(%arg0: tensor<1x1x1x256xf16>) -> tensor<1x1x1x256xf16> {
    %0 = VPU.LRN(%arg0) {alpha = 1.000000e-04 : f64, axes = [1, 2, 3], beta = 2.000000e+00 : f64, bias = 1.000000e+00 : f64, size = 5 : i64} : tensor<1x1x1x256xf16> -> tensor<1x1x1x256xf16>
    return %0 : tensor<1x1x1x256xf16>

    // CHECK:       [[LRN:%.+]] = VPU.LRN([[INPUT]]) {
    // CHECK-SAME:      multiClusterStrategy = #VPU.multi_cluster_strategy<Clustering>

    // CHECK:        return [[LRN]] : tensor<1x1x1x256xf16>
}
...
// CHECK-LABEL:   @MultiplyBroadcastedInputAssignedSOH
// CHECK-SAME:    [[INPUT0:%.+]]: tensor<1x1x1x500xf16, {order = #NHWC}>
// CHECK-SAME:    [[INPUT1:%.+]]: tensor<1x64x256x500xf16, {order = #NHWC}>
func.func @MultiplyBroadcastedInputAssignedSOH(%arg0: tensor<1x1x1x500xf16, {order = #NHWC}>, %arg1: tensor<1x64x256x500xf16, {order = #NHWC}>) -> tensor<1x64x256x500xf16, {order = #NHWC}> {
    %0 = VPU.Multiply(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x1x500xf16, {order = #NHWC}>, tensor<1x64x256x500xf16, {order = #NHWC}> -> tensor<1x64x256x500xf16, {order = #NHWC}>
    return %0 : tensor<1x64x256x500xf16, {order = #NHWC}>

    // CHECK:       [[MULTIPLY:%.+]] = VPU.Multiply([[INPUT0]], [[INPUT1]])
    // CHECK-SAME:      {auto_broadcast = #IE.auto_broadcast_type<NUMPY>, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>}
    // CHECK-SAME:      : tensor<1x1x1x500xf16, {order = #NHWC}>, tensor<1x64x256x500xf16, {order = #NHWC}> -> tensor<1x64x256x500xf16, {order = #NHWC}>

    // CHECK:       return [[MULTIPLY]] : tensor<1x64x256x500xf16, {order = #NHWC}>
}
...
// CHECK-LABEL:   @AddBroadcastedInputAssignedSOH
// CHECK-SAME:    [[INPUT0:%.+]]: tensor<1x1x1x500xf16, {order = #NHWC}>
// CHECK-SAME:    [[INPUT1:%.+]]: tensor<1x64x256x500xf16, {order = #NHWC}>
func.func @AddBroadcastedInputAssignedSOH(%arg0: tensor<1x1x1x500xf16, {order = #NHWC}>, %arg1: tensor<1x64x256x500xf16, {order = #NHWC}>) -> tensor<1x64x256x500xf16, {order = #NHWC}> {
    ...
    // CHECK:       return [[ADD]] : tensor<1x64x256x500xf16, {order = #NHWC}>
}

// CHECK-LABEL:   @ErfInvAssignedSplitOverKernel
// CHECK-SAME:    [[INPUT:%.+]]: tensor<1x320x1x1280xf16>
func.func @ErfInvAssignedSplitOverKernel(%arg0: tensor<1x320x1x1280xf16>) -> tensor<1x320x1x1280xf16> {
    %0 = VPU.ErfInv(%arg0) : tensor<1x320x1x1280xf16> -> tensor<1x320x1x1280xf16>
    return %0 : tensor<1x320x1x1280xf16>

    // CHECK:       [[ERFINV:%.+]] = VPU.ErfInv([[INPUT]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>} : tensor<1x320x1x1280xf16> -> tensor<1x320x1x1280xf16>
    // CHECK:       return [[ERFINV]] : tensor<1x320x1x1280xf16>
}

// -----

// CHECK-LABEL: @DivideSOHBroadcastedOnSegAxis
// CHECK-SAME:  [[INPUT0:%.+]]: tensor<1x1x256x256xf16>,
// CHECK-SAME:  [[INPUT1:%.+]]: tensor<1x1x1x256xf16>
func.func @DivideSOHBroadcastedOnSegAxis(%arg0: tensor<1x1x256x256xf16>, %arg1: tensor<1x1x1x256xf16>) -> (tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>) {
    %0 = VPU.Divide(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x256x256xf16>, tensor<1x1x1x256xf16> -> tensor<1x1x256x256xf16>
    %1 = VPU.Divide(%arg1, %arg0) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x1x256xf16>, tensor<1x1x256x256xf16> -> tensor<1x1x256x256xf16>
    return %0, %1 : tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>

    // CHECK: [[DIV0:%.+]] = VPU.Divide([[INPUT0]], [[INPUT1]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: [[DIV1:%.+]] = VPU.Divide([[INPUT1]], [[INPUT0]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: return [[DIV0]], [[DIV1]] : tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>
}

// -----

// CHECK-LABEL: @MinimumSOHBroadcastedOnSegAxis
// CHECK-SAME:  [[INPUT0:%.+]]: tensor<1x1x256x256xf16>,
// CHECK-SAME:  [[INPUT1:%.+]]: tensor<1x1x1x256xf16>
func.func @MinimumSOHBroadcastedOnSegAxis(%arg0: tensor<1x1x256x256xf16>, %arg1: tensor<1x1x1x256xf16>) -> (tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>) {
    %0 = VPU.Minimum(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x256x256xf16>, tensor<1x1x1x256xf16> -> tensor<1x1x256x256xf16>
    %1 = VPU.Minimum(%arg1, %arg0) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x1x256xf16>, tensor<1x1x256x256xf16> -> tensor<1x1x256x256xf16>
    return %0, %1 : tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>

    // CHECK: [[MIN0:%.+]] = VPU.Minimum([[INPUT0]], [[INPUT1]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: [[MIN1:%.+]] = VPU.Minimum([[INPUT1]], [[INPUT0]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: return [[MIN0]], [[MIN1]] : tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>
}

// -----

// CHECK-LABEL: @MaximumSOHBroadcastedOnSegAxis
// CHECK-SAME:  [[INPUT0:%.+]]: tensor<1x1x256x256xf16>,
// CHECK-SAME:  [[INPUT1:%.+]]: tensor<1x1x1x256xf16>
func.func @MaximumSOHBroadcastedOnSegAxis(%arg0: tensor<1x1x256x256xf16>, %arg1: tensor<1x1x1x256xf16>) -> (tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>) {
    %0 = VPU.Maximum(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x256x256xf16>, tensor<1x1x1x256xf16> -> tensor<1x1x256x256xf16>
    %1 = VPU.Maximum(%arg1, %arg0) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x1x256xf16>, tensor<1x1x256x256xf16> -> tensor<1x1x256x256xf16>
    return %0, %1 : tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>

    // CHECK: [[MAX0:%.+]] = VPU.Maximum([[INPUT0]], [[INPUT1]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: [[MAX1:%.+]] = VPU.Maximum([[INPUT1]], [[INPUT0]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: return [[MAX0]], [[MAX1]] : tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>
}

// -----

// CHECK-LABEL: @MaximumSOWBroadcastedOnSegAxis
// CHECK-SAME:  [[INPUT0:%.+]]: tensor<1x1x1x256xf16>,
// CHECK-SAME:  [[INPUT1:%.+]]: tensor<1x1x1x1xf16>
func.func @MaximumSOWBroadcastedOnSegAxis(%arg0: tensor<1x1x1x256xf16>, %arg1: tensor<1x1x1x1xf16>) -> (tensor<1x1x1x256xf16>, tensor<1x1x1x256xf16>) {
    %0 = VPU.Maximum(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x1x256xf16>, tensor<1x1x1x1xf16> -> tensor<1x1x1x256xf16>
    %1 = VPU.Maximum(%arg1, %arg0) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x1x1xf16>, tensor<1x1x1x256xf16> -> tensor<1x1x1x256xf16>
    return %0, %1 : tensor<1x1x1x256xf16>, tensor<1x1x1x256xf16>

    // CHECK: [[MAX0:%.+]] = VPU.Maximum([[INPUT0]], [[INPUT1]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverWidth>
    // CHECK: [[MAX1:%.+]] = VPU.Maximum([[INPUT1]], [[INPUT0]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverWidth>
    // CHECK: return [[MAX0]], [[MAX1]] : tensor<1x1x1x256xf16>, tensor<1x1x1x256xf16>
}

// -----

// CHECK-LABEL: @PowerSOHBroadcastedOnSegAxis
// CHECK-SAME:  [[INPUT0:%.+]]: tensor<1x1x256x256xf16>,
// CHECK-SAME:  [[INPUT1:%.+]]: tensor<1x1x1x256xf16>
func.func @PowerSOHBroadcastedOnSegAxis(%arg0: tensor<1x1x256x256xf16>, %arg1: tensor<1x1x1x256xf16>) -> (tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>) {
    %0 = VPU.Power(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x256x256xf16>, tensor<1x1x1x256xf16> -> tensor<1x1x256x256xf16>
    %1 = VPU.Power(%arg1, %arg0) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x1x256xf16>, tensor<1x1x256x256xf16> -> tensor<1x1x256x256xf16>
    return %0, %1 : tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>

    // CHECK: [[POW0:%.+]] = VPU.Power([[INPUT0]], [[INPUT1]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: [[POW1:%.+]] = VPU.Power([[INPUT1]], [[INPUT0]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: return [[POW0]], [[POW1]] : tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>
}

// -----

// CHECK-LABEL: @SquaredDiffSOHBroadcastedOnSegAxis
// CHECK-SAME:  [[INPUT0:%.+]]: tensor<1x1x256x256xf16>,
// CHECK-SAME:  [[INPUT1:%.+]]: tensor<1x1x1x256xf16>
func.func @SquaredDiffSOHBroadcastedOnSegAxis(%arg0: tensor<1x1x256x256xf16>, %arg1: tensor<1x1x1x256xf16>) -> (tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>) {
    %0 = VPU.SquaredDiff(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x256x256xf16>, tensor<1x1x1x256xf16> -> tensor<1x1x256x256xf16>
    %1 = VPU.SquaredDiff(%arg1, %arg0) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x1x256xf16>, tensor<1x1x256x256xf16> -> tensor<1x1x256x256xf16>
    return %0, %1 : tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>

    // CHECK: [[SQ0:%.+]] = VPU.SquaredDiff([[INPUT0]], [[INPUT1]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: [[SQ1:%.+]] = VPU.SquaredDiff([[INPUT1]], [[INPUT0]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: return [[SQ0]], [[SQ1]] : tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>
}

// -----

// CHECK-LABEL: @SquaredDiffSOWBroadcastedOnSegAxis
// CHECK-SAME:  [[INPUT0:%.+]]: tensor<1x1x1x256xf16>,
// CHECK-SAME:  [[INPUT1:%.+]]: tensor<1x1x1x1xf16>
func.func @SquaredDiffSOWBroadcastedOnSegAxis(%arg0: tensor<1x1x1x256xf16>, %arg1: tensor<1x1x1x1xf16>) -> (tensor<1x1x1x256xf16>, tensor<1x1x1x256xf16>) {
    %0 = VPU.SquaredDiff(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x1x256xf16>, tensor<1x1x1x1xf16> -> tensor<1x1x1x256xf16>
    %1 = VPU.SquaredDiff(%arg1, %arg0) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x1x1xf16>, tensor<1x1x1x256xf16> -> tensor<1x1x1x256xf16>
    ...
    // CHECK: [[SQ1:%.+]] = VPU.SquaredDiff([[INPUT1]], [[INPUT0]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverWidth>
    // CHECK: return [[SQ0]], [[SQ1]] : tensor<1x1x1x256xf16>, tensor<1x1x1x256xf16>
}

// -----

// CHECK-LABEL: @SubtractSOHBroadcastedOnSegAxis
// CHECK-SAME:  [[INPUT0:%.+]]: tensor<1x1x256x256xf16>,
// CHECK-SAME:  [[INPUT1:%.+]]: tensor<1x1x1x256xf16>
func.func @SubtractSOHBroadcastedOnSegAxis(%arg0: tensor<1x1x256x256xf16>, %arg1: tensor<1x1x1x256xf16>) -> (tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>) {
    %0 = VPU.Subtract(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x256x256xf16>, tensor<1x1x1x256xf16> -> tensor<1x1x256x256xf16>
    %1 = VPU.Subtract(%arg1, %arg0) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x1x256xf16>, tensor<1x1x256x256xf16> -> tensor<1x1x256x256xf16>
    return %0, %1 : tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>

    // CHECK: [[SUB0:%.+]] = VPU.Subtract([[INPUT0]], [[INPUT1]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: [[SUB1:%.+]] = VPU.Subtract([[INPUT1]], [[INPUT0]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: return [[SUB0]], [[SUB1]] : tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>
}

// -----

// CHECK-LABEL: @SubtractSOWBroadcastedOnSegAxis
// CHECK-SAME:  [[INPUT0:%.+]]: tensor<1x1x1x256xf16>,
// CHECK-SAME:  [[INPUT1:%.+]]: tensor<1x1x1x1xf16>
func.func @SubtractSOWBroadcastedOnSegAxis(%arg0: tensor<1x1x1x256xf16>, %arg1: tensor<1x1x1x1xf16>) -> (tensor<1x1x1x256xf16>, tensor<1x1x1x256xf16>) {
    %0 = VPU.Subtract(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x1x256xf16>, tensor<1x1x1x1xf16> -> tensor<1x1x1x256xf16>
    %1 = VPU.Subtract(%arg1, %arg0) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x1x1xf16>, tensor<1x1x1x256xf16> -> tensor<1x1x1x256xf16>
    ...
    // CHECK: [[SUB1:%.+]] = VPU.Subtract([[INPUT1]], [[INPUT0]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverWidth>
    // CHECK: return [[SUB0]], [[SUB1]] : tensor<1x1x1x256xf16>, tensor<1x1x1x256xf16>
}

// -----

// CHECK-LABEL: @AndSOHBroadcastedOnSegAxis
// CHECK-SAME:  [[INPUT0:%.+]]: tensor<1x1x256x256xf16>,
// CHECK-SAME:  [[INPUT1:%.+]]: tensor<1x1x1x256xf16>
func.func @AndSOHBroadcastedOnSegAxis(%arg0: tensor<1x1x256x256xf16>, %arg1: tensor<1x1x1x256xf16>) -> (tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>) {
    %0 = VPU.And(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x256x256xf16>, tensor<1x1x1x256xf16> -> tensor<1x1x256x256xf16>
    %1 = VPU.And(%arg1, %arg0) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x1x256xf16>, tensor<1x1x256x256xf16> -> tensor<1x1x256x256xf16>
    return %0, %1 : tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>

    // CHECK: [[AND0:%.+]] = VPU.And([[INPUT0]], [[INPUT1]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: [[AND1:%.+]] = VPU.And([[INPUT1]], [[INPUT0]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: return [[AND0]], [[AND1]] : tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>
}

// -----

// CHECK-LABEL: @LogicalOrSOHBroadcastedOnSegAxis
// CHECK-SAME:  [[INPUT0:%.+]]: tensor<1x1x256x256xf16>,
// CHECK-SAME:  [[INPUT1:%.+]]: tensor<1x1x1x256xf16>
func.func @LogicalOrSOHBroadcastedOnSegAxis(%arg0: tensor<1x1x256x256xf16>, %arg1: tensor<1x1x1x256xf16>) -> (tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>) {
    %0 = VPU.LogicalOr(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x256x256xf16>, tensor<1x1x1x256xf16> -> tensor<1x1x256x256xf16>
    %1 = VPU.LogicalOr(%arg1, %arg0) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x1x256xf16>, tensor<1x1x256x256xf16> -> tensor<1x1x256x256xf16>
    return %0, %1 : tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>

    // CHECK: [[LOR0:%.+]] = VPU.LogicalOr([[INPUT0]], [[INPUT1]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: [[LOR1:%.+]] = VPU.LogicalOr([[INPUT1]], [[INPUT0]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: return [[LOR0]], [[LOR1]] : tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>
}

// -----

// CHECK-LABEL: @EqualSOHBroadcastedOnSegAxis
// CHECK-SAME:  [[INPUT0:%.+]]: tensor<1x1x256x256xf16>,
// CHECK-SAME:  [[INPUT1:%.+]]: tensor<1x1x1x256xf16>
func.func @EqualSOHBroadcastedOnSegAxis(%arg0: tensor<1x1x256x256xf16>, %arg1: tensor<1x1x1x256xf16>) -> (tensor<1x1x256x256xi8>, tensor<1x1x256x256xi8>) {
    %0 = VPU.Equal(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x256x256xf16>, tensor<1x1x1x256xf16> -> tensor<1x1x256x256xi8>
    %1 = VPU.Equal(%arg1, %arg0) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x1x256xf16>, tensor<1x1x256x256xf16> -> tensor<1x1x256x256xi8>
    return %0, %1 : tensor<1x1x256x256xi8>, tensor<1x1x256x256xi8>

    // CHECK: [[EQ0:%.+]] = VPU.Equal([[INPUT0]], [[INPUT1]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: [[EQ1:%.+]] = VPU.Equal([[INPUT1]], [[INPUT0]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: return [[EQ0]], [[EQ1]] : tensor<1x1x256x256xi8>, tensor<1x1x256x256xi8>
}

// -----

// CHECK-LABEL: @EqualSOWBroadcastedOnSegAxis
// CHECK-SAME:  [[INPUT0:%.+]]: tensor<1x1x1x257xf16>,
// CHECK-SAME:  [[INPUT1:%.+]]: tensor<1x1x1x1xf16>
func.func @EqualSOWBroadcastedOnSegAxis(%arg0: tensor<1x1x1x257xf16>, %arg1: tensor<1x1x1x1xf16>) -> (tensor<1x1x1x257xi8>, tensor<1x1x1x257xi8>) {
    %0 = VPU.Equal(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x1x257xf16>, tensor<1x1x1x1xf16> -> tensor<1x1x1x257xi8>
    %1 = VPU.Equal(%arg1, %arg0) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x1x1xf16>, tensor<1x1x1x257xf16> -> tensor<1x1x1x257xi8>
    return %0, %1 : tensor<1x1x1x257xi8>, tensor<1x1x1x257xi8>

    // CHECK: [[EQ0:%.+]] = VPU.Equal([[INPUT0]], [[INPUT1]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverWidth>
    // CHECK: [[EQ1:%.+]] = VPU.Equal([[INPUT1]], [[INPUT0]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverWidth>
    // CHECK: return [[EQ0]], [[EQ1]] : tensor<1x1x1x257xi8>, tensor<1x1x1x257xi8>
}

// -----

// CHECK-LABEL: @GreaterSOHBroadcastedOnSegAxis
// CHECK-SAME:  [[INPUT0:%.+]]: tensor<1x1x256x256xf16>,
// CHECK-SAME:  [[INPUT1:%.+]]: tensor<1x1x1x256xf16>
func.func @GreaterSOHBroadcastedOnSegAxis(%arg0: tensor<1x1x256x256xf16>, %arg1: tensor<1x1x1x256xf16>) -> (tensor<1x1x256x256xi8>, tensor<1x1x256x256xi8>) {
    %0 = VPU.Greater(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x256x256xf16>, tensor<1x1x1x256xf16> -> tensor<1x1x256x256xi8>
    %1 = VPU.Greater(%arg1, %arg0) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x1x256xf16>, tensor<1x1x256x256xf16> -> tensor<1x1x256x256xi8>
    return %0, %1 : tensor<1x1x256x256xi8>, tensor<1x1x256x256xi8>

    // CHECK: [[GT0:%.+]] = VPU.Greater([[INPUT0]], [[INPUT1]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: [[GT1:%.+]] = VPU.Greater([[INPUT1]], [[INPUT0]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: return [[GT0]], [[GT1]] : tensor<1x1x256x256xi8>, tensor<1x1x256x256xi8>
}

// -----

// CHECK-LABEL: @GreaterEqualSOHBroadcastedOnSegAxis
// CHECK-SAME:  [[INPUT0:%.+]]: tensor<1x1x256x256xsi32>,
// CHECK-SAME:  [[INPUT1:%.+]]: tensor<1x1x1x256xsi32>
func.func @GreaterEqualSOHBroadcastedOnSegAxis(%arg0: tensor<1x1x256x256xsi32>, %arg1: tensor<1x1x1x256xsi32>) -> (tensor<1x1x256x256xsi32>, tensor<1x1x256x256xsi32>) {
    %0 = VPU.GreaterEqual(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x256x256xsi32>, tensor<1x1x1x256xsi32> -> tensor<1x1x256x256xsi32>
    %1 = VPU.GreaterEqual(%arg1, %arg0) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x1x256xsi32>, tensor<1x1x256x256xsi32> -> tensor<1x1x256x256xsi32>
    return %0, %1 : tensor<1x1x256x256xsi32>, tensor<1x1x256x256xsi32>

    // CHECK: [[GE0:%.+]] = VPU.GreaterEqual([[INPUT0]], [[INPUT1]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: [[GE1:%.+]] = VPU.GreaterEqual([[INPUT1]], [[INPUT0]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: return [[GE0]], [[GE1]] : tensor<1x1x256x256xsi32>, tensor<1x1x256x256xsi32>
}

// -----

// CHECK-LABEL: @GreaterEqualSOWBroadcastedOnSegAxis
// CHECK-SAME:  [[INPUT0:%.+]]: tensor<1x1x1x256xsi32>,
// CHECK-SAME:  [[INPUT1:%.+]]: tensor<1x1x1x1xsi32>
func.func @GreaterEqualSOWBroadcastedOnSegAxis(%arg0: tensor<1x1x1x256xsi32>, %arg1: tensor<1x1x1x1xsi32>) -> (tensor<1x1x1x256xsi32>, tensor<1x1x1x256xsi32>) {
    %0 = VPU.GreaterEqual(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x1x256xsi32>, tensor<1x1x1x1xsi32> -> tensor<1x1x1x256xsi32>
    %1 = VPU.GreaterEqual(%arg1, %arg0) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x1x1xsi32>, tensor<1x1x1x256xsi32> -> tensor<1x1x1x256xsi32>
    return %0, %1 : tensor<1x1x1x256xsi32>, tensor<1x1x1x256xsi32>

    // CHECK: [[GE0:%.+]] = VPU.GreaterEqual([[INPUT0]], [[INPUT1]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverWidth>
    // CHECK: [[GE1:%.+]] = VPU.GreaterEqual([[INPUT1]], [[INPUT0]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverWidth>
    // CHECK: return [[GE0]], [[GE1]] : tensor<1x1x1x256xsi32>, tensor<1x1x1x256xsi32>
}

// -----

// CHECK-LABEL: @LessSOHBroadcastedOnSegAxis
// CHECK-SAME:  [[INPUT0:%.+]]: tensor<1x1x256x256xf16>,
// CHECK-SAME:  [[INPUT1:%.+]]: tensor<1x1x1x256xf16>
func.func @LessSOHBroadcastedOnSegAxis(%arg0: tensor<1x1x256x256xf16>, %arg1: tensor<1x1x1x256xf16>) -> (tensor<1x1x256x256xi8>, tensor<1x1x256x256xi8>) {
    %0 = VPU.Less(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x256x256xf16>, tensor<1x1x1x256xf16> -> tensor<1x1x256x256xi8>
    %1 = VPU.Less(%arg1, %arg0) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x1x256xf16>, tensor<1x1x256x256xf16> -> tensor<1x1x256x256xi8>
    return %0, %1 : tensor<1x1x256x256xi8>, tensor<1x1x256x256xi8>

    // CHECK: [[LT0:%.+]] = VPU.Less([[INPUT0]], [[INPUT1]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: [[LT1:%.+]] = VPU.Less([[INPUT1]], [[INPUT0]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: return [[LT0]], [[LT1]] : tensor<1x1x256x256xi8>, tensor<1x1x256x256xi8>
}

// -----

// CHECK-LABEL: @LessEqualSOHBroadcastedOnSegAxis
// CHECK-SAME:  [[INPUT0:%.+]]: tensor<1x1x256x256xsi32>,
// CHECK-SAME:  [[INPUT1:%.+]]: tensor<1x1x1x256xsi32>
func.func @LessEqualSOHBroadcastedOnSegAxis(%arg0: tensor<1x1x256x256xsi32>, %arg1: tensor<1x1x1x256xsi32>) -> (tensor<1x1x256x256xi8>, tensor<1x1x256x256xi8>) {
    %0 = VPU.LessEqual(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x256x256xsi32>, tensor<1x1x1x256xsi32> -> tensor<1x1x256x256xi8>
    %1 = VPU.LessEqual(%arg1, %arg0) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x1x256xsi32>, tensor<1x1x256x256xsi32> -> tensor<1x1x256x256xi8>
    return %0, %1 : tensor<1x1x256x256xi8>, tensor<1x1x256x256xi8>

    // CHECK: [[LE0:%.+]] = VPU.LessEqual([[INPUT0]], [[INPUT1]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: [[LE1:%.+]] = VPU.LessEqual([[INPUT1]], [[INPUT0]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: return [[LE0]], [[LE1]] : tensor<1x1x256x256xi8>, tensor<1x1x256x256xi8>
}

// -----

// CHECK-LABEL: @NotEqualSOHBroadcastedOnSegAxis
// CHECK-SAME:  [[INPUT0:%.+]]: tensor<1x1x256x256xf16>,
// CHECK-SAME:  [[INPUT1:%.+]]: tensor<1x1x1x256xf16>
func.func @NotEqualSOHBroadcastedOnSegAxis(%arg0: tensor<1x1x256x256xf16>, %arg1: tensor<1x1x1x256xf16>) -> (tensor<1x1x256x256xi8>, tensor<1x1x256x256xi8>) {
    %0 = VPU.NotEqual(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x256x256xf16>, tensor<1x1x1x256xf16> -> tensor<1x1x256x256xi8>
    %1 = VPU.NotEqual(%arg1, %arg0) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x1x256xf16>, tensor<1x1x256x256xf16> -> tensor<1x1x256x256xi8>
    return %0, %1 : tensor<1x1x256x256xi8>, tensor<1x1x256x256xi8>

    // CHECK: [[NE0:%.+]] = VPU.NotEqual([[INPUT0]], [[INPUT1]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: [[NE1:%.+]] = VPU.NotEqual([[INPUT1]], [[INPUT0]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: return [[NE0]], [[NE1]] : tensor<1x1x256x256xi8>, tensor<1x1x256x256xi8>
}

// -----

// CHECK-LABEL: @SelectSOHBroadcastedOnSegAxis
// CHECK-SAME:  [[COND:%.+]]: tensor<1x1x256x256xf16>, [[INPUT0:%.+]]: tensor<1x1x256x256xf16>, [[INPUT1:%.+]]: tensor<1x1x1x256xf16>
func.func @SelectSOHBroadcastedOnSegAxis(%arg0: tensor<1x1x256x256xf16>, %arg1: tensor<1x1x256x256xf16>, %arg2: tensor<1x1x1x256xf16>) -> (tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>) {
    // arg2 has H=1, which broadcasts to H=256 of the output; both orderings of on_true/on_false should get SplitOverHeight.
    %0 = VPU.Select(%arg0, %arg1, %arg2) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>, tensor<1x1x1x256xf16> -> tensor<1x1x256x256xf16>
    %1 = VPU.Select(%arg0, %arg2, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x256x256xf16>, tensor<1x1x1x256xf16>, tensor<1x1x256x256xf16> -> tensor<1x1x256x256xf16>
    return %0, %1 : tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>

    // CHECK: [[SEL0:%.+]] = VPU.Select([[COND]], [[INPUT0]], [[INPUT1]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: [[SEL1:%.+]] = VPU.Select([[COND]], [[INPUT1]], [[INPUT0]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK: return [[SEL0]], [[SEL1]] : tensor<1x1x256x256xf16>, tensor<1x1x256x256xf16>
}

// -----

// CHECK-LABEL: @SelectSOWBroadcastedOnSegAxis
// CHECK-SAME:  [[COND:%.+]]: tensor<1x1x1x256xf16>, [[INPUT0:%.+]]: tensor<1x1x1x256xf16>, [[INPUT1:%.+]]: tensor<1x1x1x1xf16>
func.func @SelectSOWBroadcastedOnSegAxis(%arg0: tensor<1x1x1x256xf16>, %arg1: tensor<1x1x1x256xf16>, %arg2: tensor<1x1x1x1xf16>) -> (tensor<1x1x1x256xf16>, tensor<1x1x1x256xf16>) {
    // arg2 has W=1, which broadcasts to W=256 of the output; both orderings of on_true/on_false should get SplitOverWidth.
    %0 = VPU.Select(%arg0, %arg1, %arg2) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x1x256xf16>, tensor<1x1x1x256xf16>, tensor<1x1x1x1xf16> -> tensor<1x1x1x256xf16>
    %1 = VPU.Select(%arg0, %arg2, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>}
            : tensor<1x1x1x256xf16>, tensor<1x1x1x1xf16>, tensor<1x1x1x256xf16> -> tensor<1x1x1x256xf16>
    return %0, %1 : tensor<1x1x1x256xf16>, tensor<1x1x1x256xf16>
    ...
    // CHECK: [[SEL1:%.+]] = VPU.Select([[COND]], [[INPUT1]], [[INPUT0]])
    // CHECK-SAME:     multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverWidth>
    // CHECK: return [[SEL0]], [[SEL1]] : tensor<1x1x1x256xf16>, tensor<1x1x1x256xf16>
}

// -----

config.Resources 4 of @NCE at 1.300000e+03 MHz
// CHECK-LABEL:   @ConvertSubbyteAssignedSOH
func.func @ConvertSubbyteAssignedSOH(%arg0: tensor<1x1x4x2048xsi4>) -> tensor<1x1x4x2048xf16> {
    %0 = VPU.Convert(%arg0) {dstElemType = f16} : tensor<1x1x4x2048xsi4> -> tensor<1x1x4x2048xf16>
    return %0 : tensor<1x1x4x2048xf16>
...
config.Resources 4 of @NCE at 1.300000e+03 MHz
// CHECK-LABEL:   @ConvertSubbyteAssignedClustering
func.func @ConvertSubbyteAssignedClustering(%arg0: tensor<1x1x4x2049xsi4>) -> tensor<1x1x4x2049xf16> {
    %0 = VPU.Convert(%arg0) {dstElemType = f16} : tensor<1x1x4x2049xsi4> -> tensor<1x1x4x2049xf16>
    return %0 : tensor<1x1x4x2049xf16>
