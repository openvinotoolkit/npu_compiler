...
module @executors {
    ...
    func.func @GenericTiling(
        ...
        // CHECK:       [[CONV_1:%.+]] = VPU.NCE.Convolution([[INPUT]], [[WEIGHTS1]]) rawFilterShape [144, 144, 3, 3] {pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, ppe = #VPU.PPEStub<>,
    // CHECK-SAME:  strides = [1, 1]}
...
module @executors {
    ...
    func.func @NoTileWithSOH(
        ...
        // CHECK:       [[CONV:%.+]] = VPU.NCE.Convolution([[INPUT]], [[WEIGHTS]]) rawFilterShape [128, 32, 3, 3] {
...
module @executors {
    ...
    func.func @TileWithSOH(
        ...
        %0 = VPU.NCE.Convolution(%arg0, %weights) rawFilterShape [32, 16, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
            multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>,
            pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>,
            ppe = #VPU.PPEStub<>,
        ...
        // CHECK:       [[CONV1:%.+]] = VPU.NCE.Convolution([[INPUT]], [[WEIGHTS]]) rawFilterShape [32, 16, 3, 3] {
    // CHECK-SAME:          multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
        // CHECK-SAME:          pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>
...
module @executors {
    ...
    func.func @NoTileWithSOK(
        ...
        %0 = VPU.NCE.Convolution(%arg0, %weights) rawFilterShape [240, 32, 7, 7] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
        ...
        // CHECK:       [[CONV:%.+]] = VPU.NCE.Convolution([[INPUT]], [[WEIGHTS]]) rawFilterShape [240, 32, 7, 7] {
...
module @executors {
    ...
    func.func @LargeConstPipeliningSOKFor(
        ...
        %0 = VPU.NCE.Convolution(%arg0, %weights) rawFilterShape [512, 256, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
            multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>,
            pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>,
            ppe = #VPU.PPEStub<>,
        ...
        // CHECK:       [[CONV1:%.+]] = VPU.NCE.Convolution([[INPUT]], [[WEIGHTS]]) rawFilterShape [512, 256, 3, 3] {
    // CHECK-SAME:          multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>
        // CHECK-SAME:          pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>
        // CHECK-SAME:          tilingStrategy = [1, 2, 1, 1]
...
module @executors {
    ...
    func.func @PrefetchTilingWithParentConsidered(
        ...
        %0 = VPU.NCE.Convolution(%input, %weights1) rawFilterShape [512, 512, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
        ...
        %1 = VPU.NCE.Convolution(%0, %weights2) rawFilterShape [2048, 512, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
...
module @executors {
    ...
    func.func @SplitConvWithLargeFilter(%arg0: tensor<1x3840x1x1xf16, {order = #NHWC}>, %arg1: tensor<1536x3840x!quantileType>) -> tensor<1x1536x1x1xf16, {order = #NHWC}> {
        ...
        %3 = VPU.NCE.Convolution(%arg0, %2) rawFilterShape [1536, 3840, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
        ...
        // CHECK:       [[OUTPUT:%.+]] = VPU.NCE.Convolution({{.*}}) rawFilterShape [1536, 3840, 1, 1] {
...
module @Test {
    ...
    func.func @NCEMatMulSOGAndPipelined(%arg0: tensor<32x1x128x1x1xf16, {order = #GNHWC}>, %arg1: tensor<32x2176x128x1x1xf16, {order = #GNHWC}>) ->  tensor<32x1x2176x1x1xf16, {order = #GNHWC}>{
        %grouped_matmul = VPU.NCE.MatMul(%arg0, %arg1) rawFilterShape [32, 2176, 128, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, mpe_engine = #VPU.MPEEngine37XX<mode = <SCL>>, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverGroup>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, ppe = #VPU.PPEInt<mode = <NOOP>, clamp_low = -2147483648 : i64, clamp_high = 2147483647 : i64, lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, fp_prelu_alpha = 1.000000e+00 : f64>,  strides = [1, 1]} -> tensor<32x1x2176x1x1xf16, {order = #GNHWC}>

        return %grouped_matmul : tensor<32x1x2176x1x1xf16, {order = #GNHWC}>
