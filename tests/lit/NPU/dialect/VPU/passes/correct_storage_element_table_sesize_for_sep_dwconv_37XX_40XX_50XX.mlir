...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform% allow-custom-values=true" --correct-storage-element-table-sesize-for-sep-dwconv %s | FileCheck %s
