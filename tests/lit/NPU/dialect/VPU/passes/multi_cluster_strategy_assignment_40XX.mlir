...
func.func @ConvAssignedSOHOverlapped(%arg0: tensor<1x64x28x28xf16, {order = #NHWC}>) -> tensor<1x80x28x28xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.Convolution(%arg0, %cst_0, %cst) rawFilterShape [80, 64, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, ppe = #VPU.PPEStub<>, strides = [1, 1]} : tensor<1x64x28x28xf16, {order = #NHWC}>, tensor<80x64x3x3xf16, {order = #NHWC}>, tensor<80x1x1x4xsi32> -> tensor<1x80x28x28xf16, {order = #NHWC}>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x256x12x4xf16, {order = #NHWC}>)
func.func @TwoConvsAssignedSOHOverlapped(%arg0: tensor<1x256x12x4xf16, {order = #NHWC}>) -> tensor<1x64x6x2xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.Convolution(%arg0, %weight_0, %weight_table_0) rawFilterShape [32, 256, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, strides = [2, 2]} : tensor<1x256x12x4xf16, {order = #NHWC}>, tensor<32x256x1x1xf16, {order = #NHWC}>, tensor<32x1x1x4xsi32> -> tensor<1x32x6x2xf16, {order = #NHWC}>
    %1 = VPU.NCE.Convolution(%0, %weight_1, %weight_table_1) rawFilterShape [64, 32, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, ppe = #VPU.PPEStub<>, strides = [1, 1]} : tensor<1x32x6x2xf16, {order = #NHWC}>, tensor<64x32x3x3xf16, {order = #NHWC}>, tensor<64x1x1x4xsi32> -> tensor<1x64x6x2xf16, {order = #NHWC}>
    ...
    //CHECK:        [[CONV_0:%.+]] = VPU.NCE.Convolution([[ARG_0]], [[WEIGHTS_0]], [[WEIGHTSTABLE_0]]) rawFilterShape [32, 256, 1, 1] {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, ppe = #VPU.PPEStub<>,
    // CHECK-SAME:  strides = [2, 2]}
    //CHECK-SAME:        -> tensor<1x32x6x2xf16, {order = #NHWC}>
    ...
    //CHECK:        [[CONV_1:%.+]] = VPU.NCE.Convolution([[CONV_0]], [[WEIGHTS_1]], [[WEIGHTSTABLE_1]]) rawFilterShape [64, 32, 3, 3] {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, ppe = #VPU.PPEStub<>,
    // CHECK-SAME: strides = [1, 1]}
    //CHECK-SAME:        -> tensor<1x64x6x2xf16, {order = #NHWC}>
...
func.func @ConvAssignedSOB3Batches(%arg0: tensor<3x1024x14x14xf16, {order = #NHWC}>) -> tensor<3x256x14x14xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.Convolution(%arg0, %cst_0, %cst) rawFilterShape [256, 1024, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, strides = [1, 1]} : tensor<3x1024x14x14xf16, {order = #NHWC}>, tensor<256x1024x1x1xf16, {order = #NHWC}>, tensor<256x1x1x4xsi32> -> tensor<3x256x14x14xf16, {order = #NHWC}>
    ...
    //CHECK:        [[VAL0:%.+]] = VPU.NCE.Convolution([[INPUT]], [[WEIGHTS]], [[WEIGHTSTABLE]]) rawFilterShape [256, 1024, 1, 1]
    //CHECK-SAME:   {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverBatch>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, ppe = #VPU.PPEStub<>,
    // CHECK-SAME:  strides = [1, 1]}
...
func.func @ConvAssignedClustering(%arg0: tensor<1x64x1x1xf16, {order = #NHWC}>) -> tensor<1x48x1x1xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.Convolution(%arg0, %cst_0, %cst) rawFilterShape [48, 64, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, ppe = #VPU.PPEStub<>, strides = [1, 1]} : tensor<1x64x1x1xf16, {order = #NHWC}>, tensor<48x64x3x3xf16, {order = #NHWC}>, tensor<48x1x1x4xsi32> -> tensor<1x48x1x1xf16, {order = #NHWC}>
    ...
    //CHECK-SAME:   {multiClusterStrategy = #VPU.multi_cluster_strategy<Clustering>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, ppe = #VPU.PPEStub<>,
    // CHECK-SAME:  strides = [1, 1]}
...
func.func @DepthConvAssignedSOHOverlapped(%arg0: tensor<1x32x112x112xf16, {order = #NHWC}>) -> tensor<1x32x112x112xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.DepthConvolution(%arg0, %cst_1, %cst_0) rawFilterShape [32, 1, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, ppe = #VPU.PPEStub<>, strides = [1, 1]} -> tensor<1x32x112x112xf16, {order = #NHWC}>
...
func.func @DepthConvAssignedSOK(%arg0: tensor<1x128x1x1xf16, {order = #NHWC}>) -> tensor<1x128x1x1xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.DepthConvolution(%arg0, %cst_1, %cst_0) rawFilterShape [128, 1, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, ppe = #VPU.PPEStub<>, strides = [1, 1]} -> tensor<1x128x1x1xf16, {order = #NHWC}>
    ...
    //CHECK-SAME:   {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, ppe = #VPU.PPEStub<>,
    // CHECK-SAME:  resultSegmentSizes = array<i32: 1, 0, 0, 0>, strides = [1, 1]}
...
func.func @DepthConvAssignedClustering(%arg0: tensor<1x32x1x1xf16, {order = #NHWC}>) -> tensor<1x32x1x1xf16, {order = #NHWC}> {
    %cst_0 = const.Declare tensor<32x1x1x4xsi32> = dense<10> : tensor<32x1x1x4xsi32>
    %cst_1 = const.Declare tensor<32x16x1x1xf16, {order = #NHWC}> = dense<1.000000e+00> : tensor<32x1x1x3x3xf16>, [#const.Reshape<[32, 1, 3, 3]>, #const.Reorder<#NHWC>, #const.Reorder<#NCHW>, #const.Reshape<[32, 9, 1, 1]>, #const.PadWithZero<[0, 0, 0, 0], [0, 7, 0, 0]>, #const.Reorder<#NHWC>]
    %0 = VPU.NCE.DepthConvolution(%arg0, %cst_1, %cst_0) rawFilterShape [32, 1, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, ppe = #VPU.PPEStub<>, strides = [1, 1]} -> tensor<1x32x1x1xf16, {order = #NHWC}>
...
func.func @MaxPoolAssignedClustering(%arg0: tensor<1x32x1x1xf16, {order = #NHWC}>) -> tensor<1x32x1x1xf16, {order = #NHWC}> {
    ...
    //CHECK:        [[VAL0:%.+]] = VPU.NCE.MaxPool([[ARG_0]])
    //CHECK-SAME:   {kernel_size = [1, 1], multiClusterStrategy = #VPU.multi_cluster_strategy<Clustering>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, ppe = #VPU.PPEStub<>,
    // CHECK-SAME:  strides = [1, 1]}
    //CHECK-SAME:   -> tensor<1x32x1x1xf16, {order = #NHWC}>
...
func.func @MVNAssignedClusteringOn4(%arg0: tensor<1x4x1x512xf16, {order = #NCHW}>) -> tensor<1x4x1x512xf16, {order = #NCHW}> {
    ...
    //CHECK:   [[ResultMVN:%.+]] = VPU.MVN([[ARG_0]]) {across_channels = false, eps = 1.0013580322265625E-5 : f64, multiClusterStrategy = #VPU.multi_cluster_strategy<Clustering>, normalize_variance = true} : tensor<1x4x1x512xf16, {order = #NCHW}> -> tensor<1x4x1x512xf16, {order = #NCHW}>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x12x1x512xf16, {order = #NCHW}>)
func.func @MVNAssignedSplitOverKernel(%arg0: tensor<1x12x1x512xf16, {order = #NCHW}>) -> tensor<1x12x1x512xf16, {order = #NCHW}> {
    ...
    //CHECK:   [[ResultMVN:%.+]] = VPU.MVN([[ARG_0]]) {across_channels = false, eps = 1.0013580322265625E-5 : f64, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>, normalize_variance = true} : tensor<1x12x1x512xf16, {order = #NCHW}> -> tensor<1x12x1x512xf16, {order = #NCHW}>
...
func.func @ConvBeforeMVNAssignedSplitOverKernel(%arg0: tensor<1x128x64x128x!qElemType3, {order = #NHWC}>) -> tensor<1x64x64x128xf16> {
    ...
    %4 = VPU.NCE.Convolution(%arg0, %cst_0, %cst) rawFilterShape [64, 128, 4, 4] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, pad = #VPU.Padding<left = 2 : i64, right = 1 : i64, top = 2 : i64, bottom = 1 : i64>, ppe = #VPU.PPEStub<>, strides = [1, 1]} : tensor<1x128x64x128x!qElemType3, {order = #NHWC}>, tensor<64x128x4x4x!qElemType, {order = #NHWC}>, tensor<64x1x1x4xsi32> -> tensor<1x64x64x128xf16>
    ...
    //CHECK:    [[CONV:%.+]] = VPU.NCE.Convolution({{[^:]+}}, {{[^:]+}}, {{[^:]+}}) rawFilterShape [64, 128, 4, 4] {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>,
...
func.func @TanhAfterConvAssignedClustering(%arg0: tensor<1x4x1x512xf16, {order = #NCHW}>) -> tensor<1x1024x1x1xf16, {order = #NHWC}> {
    ...
    %42 = VPU.NCE.Convolution(%40, %cst_7, %cst_27) rawFilterShape [1024, 1024, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, ppe = #VPU.PPEStub<>, strides = [1, 1]} : tensor<1x1024x1x1xf16, {order = #NHWC}>, tensor<1024x1024x1x1xf16, {order = #NHWC}>, tensor<1024x1x1x4xsi32> -> tensor<1x1024x1x1xf16, {order = #NHWC}>
...
// Track E#160175 - SEP cost support

// CHECK-LABEL: @InterpolateNearestAssignedSOH
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x128x10x10xf16, {order = #NHWC}>)
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x256x10x10xf16, {order = #NHWC}>)
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x96x20x20xf16, {order = #NHWC}>)
func.func @InterpolateBilinearAssignedSOH(%arg0: tensor<1x96x20x20xf16, {order = #NHWC}>) -> tensor<1x96x40x40xf16, {order = #NHWC}> {
    ...
    // CHECK:       [[OUTPUT:%.+]] = VPU.NCE.Interpolate([[INPUT_SPARSE]], [[WEIGHTS]], [[WEIGHTS_TABLE]]) rawFilterShape [96, 96, 2, 2]
...
func.func @AssignSOHForLayerWithLargeActivation(%arg0: tensor<1x64x250x250xf16, {order = #NHWC}>) -> tensor<1x32x250x250xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.Convolution(%arg0, %cst_0, %cst) rawFilterShape [32, 64, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, ppe = #VPU.PPEStub<>, strides = [1, 1]} : tensor<1x64x250x250xf16, {order = #NHWC}>, tensor<32x64x3x3xf16, {order = #NHWC}>, tensor<32x1x1x4xsi32> -> tensor<1x32x250x250xf16, {order = #NHWC}>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x4x8x512xf16, {order = #NCHW}>)
func.func @SoftMaxAssignedSplitOverHeight(%arg0: tensor<1x4x8x512xf16, {order = #NCHW}>) -> tensor<1x4x8x512xf16, {order = #NCHW}> {
    ...
    //CHECK:   [[ResultSoftMax:%.+]] = VPU.SoftMax([[ARG_0]]) {axisInd = 3 : i64, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>} : tensor<1x4x8x512xf16, {order = #NCHW}> -> tensor<1x4x8x512xf16, {order = #NCHW}>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x6x2x512xf16, {order = #NCHW}>)
func.func @SoftMaxAssignedSplitOverKernel(%arg0: tensor<1x6x2x512xf16, {order = #NCHW}>) -> tensor<1x6x2x512xf16, {order = #NCHW}> {
    ...
    //CHECK:   [[ResultSoftMax:%.+]] = VPU.SoftMax([[ARG_0]]) {axisInd = 2 : i64, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>} : tensor<1x6x2x512xf16, {order = #NCHW}> -> tensor<1x6x2x512xf16, {order = #NCHW}>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x4x1x1xf16, {order = #NCHW}>)
func.func @SoftMaxAssignedClustering(%arg0: tensor<1x4x1x1xf16, {order = #NCHW}>) -> tensor<1x4x1x1xf16, {order = #NCHW}> {
    ...
    //CHECK:   [[ResultSoftMax:%.+]] = VPU.SoftMax([[ARG_0]]) {axisInd = 1 : i64, multiClusterStrategy = #VPU.multi_cluster_strategy<Clustering>} : tensor<1x4x1x1xf16, {order = #NCHW}> -> tensor<1x4x1x1xf16, {order = #NCHW}>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x16x1x112xf16>, [[ARG_1:%[^:]+]]: tensor<1x16x32x112xf16>)
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x512x1x16xf16>, [[ARG_1:%[^:]+]]: tensor<1x512x1x32xf16>)
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x3x256x224xf16>)
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<10x2xf32>)
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x106x1x256xf16>, [[ARG_1:%[^:]+]]: tensor<1x106x1x1xf16>)
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x16x256x256xf16>, [[ARG_1:%[^:]+]]: tensor<1x16x1x1xf16>)
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<2x106x1x256xf16>, [[ARG_1:%[^:]+]]: tensor<2x106x1x1xf16>)
...
// CHECK-LABEL:   @NotEqualAssignedSplitOverKernel
// CHECK-SAME:    [[INPUT_0:%.+]]: tensor<1x106x1x256xf16>, [[INPUT_1:%.+]]: tensor<1x106x1x1xf16>
func.func @NotEqualAssignedSplitOverKernel(%arg0: tensor<1x106x1x256xf16>, %arg1: tensor<1x106x1x1xf16>) -> tensor<1x106x1x256xi8> {

    %0 = VPU.NotEqual(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>} : tensor<1x106x1x256xf16>, tensor<1x106x1x1xf16> -> tensor<1x106x1x256xi8>

    return %0 : tensor<1x106x1x256xi8>

    //CHECK:   [[NOTEQUAL:%.+]] = VPU.NotEqual([[INPUT_0]], [[INPUT_1]]) {
    //CHECK-SAME:       multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>}
    //CHECK-SAME:       tensor<1x106x1x256xf16>, tensor<1x106x1x1xf16> -> tensor<1x106x1x256xi8>
    //CHECK:   return [[NOTEQUAL]] : tensor<1x106x1x256xi8>
}

// -----

// CHECK-LABEL:   @NotEqualAssignedSplitOverHeight
// CHECK-SAME:    [[INPUT_0:%.+]]: tensor<1x1x256x256xf16>, [[INPUT_1:%.+]]: tensor<1x1x1x1xf16>
func.func @NotEqualAssignedSplitOverHeight(%arg0: tensor<1x1x256x256xf16>, %arg1: tensor<1x1x1x1xf16>) -> tensor<1x1x256x256xi8> {

    %0 = VPU.NotEqual(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>} : tensor<1x1x256x256xf16>, tensor<1x1x1x1xf16> -> tensor<1x1x256x256xi8>
    ...
    //CHECK-SAME:       multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>}
    //CHECK-SAME:       tensor<1x1x256x256xf16>, tensor<1x1x1x1xf16> -> tensor<1x1x256x256xi8>
    //CHECK:   return [[NOTEQUAL]] : tensor<1x1x256x256xi8>
}

// -----

// CHECK-LABEL:   @NotEqualAssignedClustering
// CHECK-SAME:    [[INPUT_0:%.+]]: tensor<2x106x1x256xf16>, [[INPUT_1:%.+]]: tensor<2x106x1x1xf16>
func.func @NotEqualAssignedClustering(%arg0: tensor<2x106x1x256xf16>, %arg1: tensor<2x106x1x1xf16>) -> tensor<2x106x1x256xi8> {

    %0 = VPU.NotEqual(%arg0, %arg1) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>} : tensor<2x106x1x256xf16>, tensor<2x106x1x1xf16> -> tensor<2x106x1x256xi8>
    ...
    //CHECK-SAME:       multiClusterStrategy = #VPU.multi_cluster_strategy<Clustering>}
    //CHECK-SAME:       tensor<2x106x1x256xf16>, tensor<2x106x1x1xf16> -> tensor<2x106x1x256xi8>
    //CHECK:   return [[NOTEQUAL]] : tensor<2x106x1x256xi8>
}
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x1x16x512xf16, {order = #NCHW}>)
func.func @RoundAssignedSplitOverHeight(%arg0: tensor<1x1x16x512xf16, {order = #NCHW}>) -> tensor<1x1x16x512xf16, {order = #NCHW}> {
    ...
    //CHECK:   [[Result:%.+]] = VPU.Round([[ARG_0]]) {mode = #IE.round_mode<HALF_TO_EVEN>, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>} : tensor<1x1x16x512xf16, {order = #NCHW}> -> tensor<1x1x16x512xf16, {order = #NCHW}>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x1x1x513xf16, {order = #NCHW}>)
func.func @RoundAssignedClustering(%arg0: tensor<1x1x1x513xf16, {order = #NCHW}>) -> tensor<1x1x1x513xf16, {order = #NCHW}> {
    ...
    //CHECK:   [[Result:%.+]] = VPU.Round([[ARG_0]]) {mode = #IE.round_mode<HALF_TO_EVEN>, multiClusterStrategy = #VPU.multi_cluster_strategy<Clustering>} : tensor<1x1x1x513xf16, {order = #NCHW}> -> tensor<1x1x1x513xf16, {order = #NCHW}>
    //CHECK:   return [[Result]] : tensor<1x1x1x513xf16, {order = #NCHW}>
}
...
// CHECK-LABEL:   func.func @ReduceSquareSplitOverHeight(
// CHECK-SAME:                           [[VAL_0:%.+]]: tensor<1x1024x7x7xf16>) -> tensor<1x1x7x1xf16> {
func.func @ReduceSquareSplitOverHeight(%arg0: tensor<1x1024x7x7xf16>) -> tensor<1x1x7x1xf16> {
  %0 = VPU.ReduceSquare(%arg0) {axes_value = [1, 3], keep_dims} : tensor<1x1024x7x7xf16> -> tensor<1x1x7x1xf16>
  return %0 : tensor<1x1x7x1xf16>

// CHECK:       [[VAL_1:%.+]] = VPU.ReduceSquare([[VAL_0]]) {axes_value = [1, 3], keep_dims, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>}
// CHECK-SAME:    : tensor<1x1024x7x7xf16> -> tensor<1x1x7x1xf16>
// CHECK:       return [[VAL_1]] : tensor<1x1x7x1xf16>
}
...
func.func @PropagateDistributedQuantizeCast(%arg0: tensor<1x512x14x14x!qElemType, {order = #NHWC}>) -> tensor<1x512x14x14x!qElemType1, {order = #NHWC}>{
    %eltwise = VPU.NCE.Eltwise(%arg0, %arg0) {resultSegmentSizes = array<i32: 1, 0, 0, 0>,  op_type = #VPU.eltwise_type<ADD>, ppe = #VPU.PPEStub<>} :
    ...
    %conv = VPU.NCE.Convolution(%quant_cast, %weights2, %weightsTable2) rawFilterShape [512, 512, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
        pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,
        ppe = #VPU.PPEStub<>,
        strides = [1, 1]}
            : tensor<1x512x14x14x!qElemType1, {order = #NHWC}>, tensor<512x512x1x1xf16, {order = #NHWC}>, tensor<512x1x1x4xsi32> -> tensor<1x512x14x14x!qElemType1, {order = #NHWC}>
...
func.func @NotInferDistributedTypeOfPermuteCast(%arg0: tensor<1x16x320x256xf16, {order = #NHWC}>, %arg1: tensor<1x16x320x256xf16, {order = #NHWC}>) -> tensor<1x4096x320x1xf16>{
    %eltwise = VPU.NCE.Eltwise(%arg0, %arg1) {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
        is_inplace = true,
        op_type = #VPU.eltwise_type<ADD>,
        ppe = #VPU.PPEStub<>
...
func.func @PropagateDistributedPermuteCast(%arg0: tensor<1x4096x1024x4xf16, {order = #NHWC}>, %arg1: tensor<48x4096x1x1xf16, {order = #NHWC}>) -> tensor<1x320x1024x4x!qElemType, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.Convolution(%arg0, %arg1, %conv_weights_table) rawFilterShape [48, 4096, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
        pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,
        ppe = #VPU.PPEStub<>,
        strides = [1, 1]
    } : tensor<1x4096x1024x4xf16, {order = #NHWC}>, tensor<48x4096x1x1xf16, {order = #NHWC}>, tensor<48x1x1x4xsi32> -> tensor<1x48x1024x4xf16, {order = #NHWC}>
    ...
    %11 = VPU.NCE.DepthConvolution(%10, %dw_conv_weights, %dw_conv_weights_table) rawFilterShape [320, 1, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
        pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,
        ppe = #VPU.PPEStub<>,
        strides = [1, 1]
...
// CHECK-SAME: [[ARG_0:%[^:]+]]: tensor<1x3x20x35971xf16>
// CHECK-SAME: [[ARG_1:%[^:]+]]: tensor<1x3x1x1xf16, {order = #NHWC}>
...
func.func @ConvAssignedSOHWithSOHIncompatibleConsumer(%arg0: tensor<1x256x2000x1xf16, {order = #NHWC}>) -> tensor<1x256x2000x1xf16, {order = #NHWC}> {
    ...
    %0 = VPU.NCE.Convolution(%arg0, %weights_0, %weights_table_0) rawFilterShape [256, 256, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, ppe = #VPU.PPEStub<>, strides = [1, 1]} : tensor<1x256x2000x1xf16, {order = #NHWC}>, tensor<256x256x3x3xf16, {order = #NHWC}>, tensor<256x1x1x4xsi32> -> tensor<1x256x2000x1xf16, {order = #NHWC}>
    ...
    %1 = VPU.NCE.Convolution(%0, %weights_1, %weights_table_1) rawFilterShape [64, 256, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, ppe = #VPU.PPEStub<>, strides = [8, 1]} : tensor<1x256x2000x1xf16, {order = #NHWC}>, tensor<64x256x1x1xf16, {order = #NHWC}>, tensor<64x1x1x4xsi32> -> tensor<1x64x250x1xf16, {order = #NHWC}>
...
func.func @LSTMSequenceBidirectionalSplitOverKernel(%arg0: tensor<1x2x80x512xf16>) -> (tensor<1x2x80x128xf16>, tensor<1x2x1x128xf16>, tensor<1x2x1x128xf16>) {
    ...
    %outputHiddenValues, %outputHiddenState, %outputCellState = VPU.LSTMSequence(%arg0, %cst_0, %cst_0, %cst_2, %cst_5, %cst) {direction = #IE.rnn_seq_direction<BIDIRECTIONAL>, operandSegmentSizes = array<i32: 1, 1, 1, 0, 1, 1, 1>, sequenceLength = 80 : i64} : tensor<1x2x80x512xf16>, tensor<1x2x1x128xf16>, tensor<1x2x1x128xf16>, tensor<2x4x128x128xf16, {order = affine_map<(d0, d1, d2, d3) -> (d0, d3, d2, d1)>}>, tensor<1x2x4x128xf16, {order = #NCWH}>, tensor<1x1x1x2xsi32> -> tensor<1x2x80x128xf16>, tensor<1x2x1x128xf16>, tensor<1x2x1x128xf16>
...
// CHECK-SAME:      {direction = #IE.rnn_seq_direction<BIDIRECTIONAL>, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>, operandSegmentSizes = array<i32: 1, 1, 1, 0, 1, 1, 1>, sequenceLength = 80 : i64}
}
...
func.func @LSTMSequenceBidirectionalSplitOverBatch(%arg0: tensor<3x2x80x512xf16>) -> (tensor<3x2x80x128xf16>, tensor<3x2x1x128xf16>, tensor<3x2x1x128xf16>) {
    ...
    %outputHiddenValues, %outputHiddenState, %outputCellState = VPU.LSTMSequence(%arg0, %cst_0, %cst_0, %cst_2, %cst_5, %cst) {direction = #IE.rnn_seq_direction<BIDIRECTIONAL>, operandSegmentSizes = array<i32: 1, 1, 1, 0, 1, 1, 1>, sequenceLength = 80 : i64} : tensor<3x2x80x512xf16>, tensor<3x2x1x128xf16>, tensor<3x2x1x128xf16>, tensor<2x4x128x128xf16, {order = affine_map<(d0, d1, d2, d3) -> (d0, d3, d2, d1)>}>, tensor<1x2x4x128xf16, {order = #NCWH}>, tensor<1x1x1x2xsi32> -> tensor<3x2x80x128xf16>, tensor<3x2x1x128xf16>, tensor<3x2x1x128xf16>
...
// CHECK:       VPU.LSTMSequence
// CHECK-SAME:      {direction = #IE.rnn_seq_direction<BIDIRECTIONAL>, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverBatch>, operandSegmentSizes = array<i32: 1, 1, 1, 0, 1, 1, 1>, sequenceLength = 80 : i64}
}
...
func.func @LSTMSequenceForwardNoStrategy(%arg0: tensor<1x1x80x512xf16>) -> (tensor<1x1x80x128xf16>, tensor<1x1x1x128xf16>, tensor<1x1x1x128xf16>) {
    ...
    %outputHiddenValues, %outputHiddenState, %outputCellState = VPU.LSTMSequence(%arg0, %cst_0, %cst_0, %cst_2, %cst_5, %cst) {direction = #IE.rnn_seq_direction<FORWARD>, operandSegmentSizes = array<i32: 1, 1, 1, 0, 1, 1, 1>, sequenceLength = 80 : i64} : tensor<1x1x80x512xf16>, tensor<1x1x1x128xf16>, tensor<1x1x1x128xf16>, tensor<1x4x128x128xf16, {order = affine_map<(d0, d1, d2, d3) -> (d0, d3, d2, d1)>}>, tensor<1x2x4x128xf16, {order = #NCWH}>, tensor<1x1x1x2xsi32> -> tensor<1x1x80x128xf16>, tensor<1x1x1x128xf16>, tensor<1x1x1x128xf16>
...
// CHECK-LABEL: func.func @PermuteWithInputSWNotCompatibleSOKAssignedSOK
// CHECK-SAME:      [[INPUT:%.+]]: tensor<1x384x18x32xf16>
func.func @PermuteWithInputSWNotCompatibleSOKAssignedSOK(%arg0: tensor<1x384x18x32xf16>) -> tensor<1x384x36x64xf16, {order = #NHWC}> {
    %INTERPOLATE = VPU.Interpolate(%arg0) {
            ...
            sizes_attr = [36, 64]
        } : tensor<1x384x18x32xf16> -> tensor<1x384x36x64xf16>

    %PERMUTE = VPU.NCE.Permute(%INTERPOLATE) {dstElemType = f16,
            dstOrder = affine_map<(d0, d1, d2, d3) -> (d0, d2, d3, d1)>,
            expandedChannels = 384 : i64, ppe = #VPU.PPEInt<mode = <NOOP>,
            clamp_low = -2147483648 : i64, clamp_high = 2147483647 : i64,
            lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, fp_prelu_alpha = 1.000000e+00 : f64>
        } -> tensor<1x384x36x64xf16, {order = affine_map<(d0, d1, d2, d3) -> (d0, d2, d3, d1)>}>

    return %PERMUTE : tensor<1x384x36x64xf16, {order = #NHWC}>

    // CHECK:       [[INTERPOLATE:%.+]] = VPU.Interpolate([[INPUT]])
    // CHECK:       [[PERMUTE:%.+]] = VPU.NCE.Permute([[INTERPOLATE]]) {dstElemType = f16, dstOrder = #NHWC, expandedChannels = 384 : i64,
    // CHECK-SAME:      multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeightOverlapped>, ppe = #VPU.PPEInt<mode = <NOOP>,
    // CHECK-SAME:      clamp_low = -2147483648 : i64, clamp_high = 2147483647 : i64, lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, fp_prelu_alpha = 1.000000e+00 : f64>}
    // CHECK-SAME:      -> tensor<1x384x36x64xf16, {order = #NHWC}>

    //CHECK:        return [[PERMUTE]] : tensor<1x384x36x64xf16, {order = #NHWC}>
}
...
!qElemType1 = !quant.uniform<u8:f16, 0.078431372549019607>

config.Resources 6 of @NCE at 1.700000e+03 MHz {
    config.ExecutorResource 1 of @DPU
}

// CHECK-LABEL: func.func @DefaultSOHForSwish
func.func @DefaultSOHForSwish(%arg0: tensor<1x4x640x640x!qElemType0, {order = #NHWC}>) -> tensor<1x16x320x320x!qElemType1, {order = #NHWC}> {
    %cst = const.Declare tensor<16x1x1x32x!qElemType0, {order = #NHWC}> =
        dense<1.000000e+00> : tensor<16x1x1x32xf32>, [
            #const.CastElemType<f16>,
            #const.CastElemType<ui8>,
            #const.CastElemType<!qElemType0>,
            #const.Reorder<#NHWC>
        ]
    %cst1 = const.Declare tensor<16x1x1x4xsi32> =
        dense<1> : tensor<16x1x1x4xsi32>

    %0 = VPU.NCE.CompressConvolution(%arg0, %cst, %cst1) rawFilterShape [16, 3, 3, 3] {cm_sp_pattern = 7 : i64, pad = #VPU.Padding<left = 1 : i64, right = 0 : i64, top = 1 : i64, bottom = 0 : i64>, strides = [2, 2], ppe = #VPU.PPEStub<>} -> tensor<1x16x320x320xf16, {order = #NHWC}>
    %1 = VPU.Swish(%0) {beta_value = 1.000000e+00 : f64} : tensor<1x16x320x320xf16, {order = #NHWC}> -> tensor<1x16x320x320xf16, {order = #NHWC}>
    %2 = VPU.NCE.AveragePool(%1) {kernel_size = [1, 1], pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, strides = [1, 1], ppe = #VPU.PPEStub<>} -> tensor<1x16x320x320x!qElemType1, {order = #NHWC}>
    return %2 : tensor<1x16x320x320x!qElemType1, {order = #NHWC}>

    // CHECK:       [[CONV:%.+]] = VPU.NCE.CompressConvolution
    // CHECK-SAME:       multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeightOverlapped>
    // CHECK:       [[SWISH:%.+]] = VPU.Swish
    // CHECK-SAME:       multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK:       [[POOL:%.+]] = VPU.NCE.AveragePool
    // CHECK-SAME:       multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
}
...
func.func @DequantizeSmallChannelNotSOK() -> tensor<1x16x512x512xf16, {order = #NHWC}>  {
    ...
    %conv = VPU.NCE.Convolution(%conv_input, %dequantize, %weight_table) rawFilterShape [16, 128, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, mpe_engine = #VPU.MPEEngine37XX<mode = <SCL>>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, ppe = #VPU.PPEInt<mode = <NOOP>, clamp_low = -2147483648 : i64, clamp_high = 2147483647 : i64, lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, fp_prelu_alpha = 1.000000e+00 : f64>, strides = [1, 1]} : tensor<1x128x512x512xf16, {order = affine_map<(d0, d1, d2, d3) -> (d0, d2, d3, d1)>}>, tensor<16x128x3x3xf16, {order = #NHWC}>, tensor<16x1x1x4xsi32> -> tensor<1x16x512x512xf16, {order = #NHWC}>
...
func.func @ErrorCodeHeuristicSOK(%arg0 : tensor<1x3072x16x4xf16, {order = #NHWC}>) -> tensor<1x4608x16x4xf16, {order = #NHWC}>  {
    ...
    %conv = VPU.NCE.Convolution(%arg0, %cst, %wt) rawFilterShape [4608, 3072, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, mpe_engine = #VPU.MPEEngine37XX<mode = <SCL>>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, ppe = #VPU.PPEInt<mode = <NOOP>, clamp_low = -2147483648 : i64, clamp_high = 2147483647 : i64, lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, fp_prelu_alpha = 1.000000e+00 : f64>, strides = [1, 1]} : tensor<1x3072x16x4xf16, {order = #NHWC}>, tensor<4608x3072x1x1x!qElemType, {order = #NHWC}>, tensor<4608x1x1x4xsi32> -> tensor<1x4608x16x4xf16, {order = affine_map<(d0, d1, d2, d3) -> (d0, d2, d3, d1)>}>
...
func.func @ErrorCodeHeuristicSOH(%arg0 : tensor<1x3072x1152x1xf16, {order = #NHWC}>) -> tensor<1x4608x1152x1xf16, {order = #NHWC}>  {
    ...
    %conv = VPU.NCE.Convolution(%arg0, %cst, %wt) rawFilterShape [4608, 3072, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, mpe_engine = #VPU.MPEEngine37XX<mode = <SCL>>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, ppe = #VPU.PPEInt<mode = <NOOP>, clamp_low = -2147483648 : i64, clamp_high = 2147483647 : i64, lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, fp_prelu_alpha = 1.000000e+00 : f64>, strides = [1, 1]} : tensor<1x3072x1152x1xf16, {order = #NHWC}>, tensor<4608x3072x1x1x!qElemType, {order = #NHWC}>, tensor<4608x1x1x4xsi32> -> tensor<1x4608x1152x1xf16, {order = affine_map<(d0, d1, d2, d3) -> (d0, d2, d3, d1)>}>
...
// CHECK-LABEL: @DWConvWith2DimSWParent
func.func @DWConvWith2DimSWParent(%arg0 : tensor<1x768xf16>) -> tensor<1x32x6x4xf16, {order = #NHWC}> {
    %cst = const.Declare tensor<32x16x1x1xf16, {order = #NHWC}> = dense<-1.000000e+00> : tensor<32x16x1x1xf16>, [#const.Reorder<#NHWC>]
    %wt = const.Declare tensor<32x1x1x4xsi32> = dense<1> : tensor<32x1x1x4xsi32>
    %0 = VPU.NormalizeL2(%arg0) {axes_value = [1], eps = 9.9999999392252903E-9 : f64, eps_mode = #IE.eps_mode<ADD>} : tensor<1x768xf16> -> tensor<1x768xf16>
    %1 = VPU.AffineReshape(%0) {dim_mapping = [[0], [1, 2, 3]], shape_value = [1, 768, 1, 1]} : tensor<1x768xf16> -> tensor<1x768x1x1xf16>
    %2 = VPU.PermuteCast(%1) {dst_order = affine_map<(d0, d1, d2, d3) -> (d0, d2, d3, d1)>, mem_perm = #NHWC} : tensor<1x768x1x1xf16> -> tensor<1x768x1x1xf16, {order = #NHWC}>
    %3 = VPU.ShapeCast {shape = [1, 32, 6, 4]} inputs(%2 : tensor<1x768x1x1xf16, {order = #NHWC}>) -> tensor<1x32x6x4xf16, {order = #NHWC}>
    %4 = VPU.NCE.DepthConvolution(%3, %cst, %wt) rawFilterShape [32, 1, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, ppe = #VPU.PPEInt<mode = <NOOP>, clamp_low = -2147483648 : i64, clamp_high = 2147483647 : i64, lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, fp_prelu_alpha = 1.000000e+00 : f64>, strides = [1, 1]} -> tensor<1x32x6x4xf16, {order = #NHWC}>

    return %4 : tensor<1x32x6x4xf16, {order = #NHWC}>
...
// CHECK-LABEL: @ConvAssignedSOKBasedOnAlignedTile
// CHECK-SAME: [[ARG_0:%[^:]+]]: tensor<1x128x64x1xf16, {order = #NHWC}>)
func.func @ConvAssignedSOKBasedOnAlignedTile(%arg0: tensor<1x128x64x1xf16, {order = #NHWC}>) -> tensor<1x16448x64x1xf16, {order = #NHWC}> {
    %cst = const.Declare tensor<16448x1x1x4xsi32> = dense<10> : tensor<16448x1x1x4xsi32>
    %cst_0 = const.Declare tensor<16448x128x1x1xf16, {order = #NHWC}> = dense<1.000000e+00> : tensor<16448x128x1x1xf16>, [#const.Reorder<#NHWC>]
    %0 = VPU.NCE.Convolution(%arg0, %cst_0, %cst) rawFilterShape [16448, 128, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, ppe = #VPU.PPEStub<>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, strides = [1, 1]} : tensor<1x128x64x1xf16, {order = #NHWC}>, tensor<16448x128x1x1xf16, {order = #NHWC}>, tensor<16448x1x1x4xsi32> -> tensor<1x16448x64x1xf16, {order = #NHWC}>
    return %0 : tensor<1x16448x64x1xf16, {order = #NHWC}>

    //CHECK:        [[WEIGHTSTABLE:%.+]] = const.Declare tensor<16448x1x1x4xsi32> = dense<10> : tensor<16448x1x1x4xsi32>
    //CHECK:        [[WEIGHTS:%.+]] = const.Declare tensor<16448x128x1x1xf16, {order = #NHWC}> = dense<1.000000e+00> : tensor<16448x128x1x1xf16>, [#const.Reorder<#NHWC>]

    // CHECK:        [[VAL0:%.+]] = VPU.NCE.Convolution([[ARG_0]], [[WEIGHTS]], [[WEIGHTSTABLE]]) rawFilterShape [16448, 128, 1, 1]
    // CHECK-SAME:   {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, ppe = #VPU.PPEStub<>,
    // CHECK-SAME:   strides = [1, 1]}
    // CHECK-SAME:   -> tensor<1x16448x64x1xf16, {order = #NHWC}>

    // CHECK:        return [[VAL0]] : tensor<1x16448x64x1xf16, {order = #NHWC}>
}
...
// CHECK-LABEL: @DefaultDequantizeStrategySOK
func.func @DefaultDequantizeStrategySOK() -> tensor<128x128x10x10xf16, {order = #NHWC}>  {
    %weights = const.Declare tensor<128x128x10x10x!qElemType, {order = #NHWC}> = dense<1> : tensor<128x128x10x10xui8>, [#const.CastElemType<f32>, #const.CastElemType<f16>, #const.CastElemType<ui8>, #const.CastElemType<!qElemType>, #const.MemPermute<#NHWC, #NHWC>]
    %dequantize = VPU.Dequantize(%weights) {dstElemType = f16} : tensor<128x128x10x10x!qElemType, {order = #NHWC}> -> tensor<128x128x10x10xf16, {order = #NHWC}>

    return %dequantize :tensor<128x128x10x10xf16, {order = #NHWC}>
...
#NWHC = affine_map<(d0, d1, d2, d3) -> (d0, d3, d2, d1)>
// CHECK-LABEL: func.func @LSTMSequenceBidirectionalSplitOverKernel(
// CHECK-SAME:      [[VAL_0:%.+]]: tensor<1x2x?x512xf16,
// CHECK-SAME:      -> (tensor<1x2x?x128xf16,
// CHECK-SAME:          tensor<1x2x1x128xf16>, tensor<1x2x1x128xf16>) {
func.func @LSTMSequenceBidirectionalSplitOverKernel(%arg0:
            tensor<1x2x?x512xf16, {bounds = #const.OpaqueI64Elements<[1, 2, 80, 512]> : tensor<4xsi64>}>)
        -> (tensor<1x2x?x128xf16, {bounds = #const.OpaqueI64Elements<[1, 2, 80, 128]> : tensor<4xsi64>}>,
            tensor<1x2x1x128xf16>, tensor<1x2x1x128xf16>) {
    %cst_0 = const.Declare tensor<1x2x1x128xf16> = dense<1.000000e+00> : tensor<1x2x1x128xf16>
    %cst_2 = const.Declare tensor<2x4x128x128xf16, {order = #NWHC}> = dense<3.000000e+00>
           : tensor<2x4x128x128xf16, {order = #NWHC}>
    %cst = const.Declare tensor<1x1x1x2xsi32> = dense<0> : tensor<1x1x1x2xsi32>

    %outputHiddenValues, %outputHiddenState, %outputCellState = VPU.LSTMSequence(%arg0, %cst_0, %cst_0, %cst_2, %cst)
        {direction = #IE.rnn_seq_direction<BIDIRECTIONAL>, operandSegmentSizes = array<i32: 1, 1, 1, 0, 1, 0, 1>}
        : tensor<1x2x?x512xf16, {bounds = #const.OpaqueI64Elements<[1, 2, 80, 512]> : tensor<4xsi64>}>,
          tensor<1x2x1x128xf16>, tensor<1x2x1x128xf16>,
          tensor<2x4x128x128xf16, {order = #NWHC}>, tensor<1x1x1x2xsi32>
        -> tensor<1x2x?x128xf16, {bounds = #const.OpaqueI64Elements<[1, 2, 80, 128]> : tensor<4xsi64>}>,
           tensor<1x2x1x128xf16>, tensor<1x2x1x128xf16>
...
// CHECK-SAME:       multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>,
// CHECK-SAME:       operandSegmentSizes = array<i32: 1, 1, 1, 0, 1, 0, 1>}
}
...
#NWHC = affine_map<(d0, d1, d2, d3) -> (d0, d3, d2, d1)>
// CHECK-LABEL: func.func @LSTMSequenceBidirectionalSplitOverBatch(
// CHECK-SAME:      [[VAL_0:%.+]]: tensor<3x2x?x512xf16,
// CHECK-SAME:      -> (tensor<3x2x?x128xf16,
// CHECK-SAME:          tensor<3x2x1x128xf16>, tensor<3x2x1x128xf16>) {
func.func @LSTMSequenceBidirectionalSplitOverBatch(%arg0:
            tensor<3x2x?x512xf16, {bounds = #const.OpaqueI64Elements<[3, 2, 80, 512]> : tensor<4xsi64>}>)
        -> (tensor<3x2x?x128xf16, {bounds = #const.OpaqueI64Elements<[3, 2, 80, 128]> : tensor<4xsi64>}>,
            tensor<3x2x1x128xf16>, tensor<3x2x1x128xf16>) {
    %cst_0 = const.Declare tensor<3x2x1x128xf16> = dense<1.000000e+00> : tensor<3x2x1x128xf16>
    %cst_2 = const.Declare tensor<2x4x128x128xf16, {order = #NWHC}> = dense<3.000000e+00>
           : tensor<2x4x128x128xf16, {order = #NWHC}>
...
// CHECK-SAME: [[ARG_0:%[^:]+]]: tensor<1x368x432x1xf16>
// CHECK-SAME: [[ARG_1:%[^:]+]]: tensor<1x184x216x2xf16>
func.func @YuvToRgbNV12AssignedSOK(%arg0: tensor<1x368x432x1xf16>, %arg1: tensor<1x184x216x2xf16>) -> tensor<1x368x432x3xf16> {
    ...
    // CHECK:       [[YUVTORGB:%.+]] = VPU.YuvToRgb([[ARG_0]], [[ARG_1]])
...
// CHECK-SAME: [[ARG_0:%[^:]+]]: tensor<1x368x432x1xf16>
// CHECK-SAME: [[ARG_1:%[^:]+]]: tensor<1x184x216x1xf16>
// CHECK-SAME: [[ARG_2:%[^:]+]]: tensor<1x184x216x1xf16>
func.func @YuvToRgbI420AssignedSOK(%arg0: tensor<1x368x432x1xf16>, %arg1: tensor<1x184x216x1xf16>, %arg2: tensor<1x184x216x1xf16>) -> tensor<1x368x432x3xf16> {
    ...
    // CHECK:       [[YUVTORGB:%.+]] = VPU.YuvToRgb([[ARG_0]], [[ARG_1]], [[ARG_2]])
...
// CHECK-SAME: [[ARG_0:%[^:]+]]: tensor<1x552x432x1xf16>
func.func @YuvToRgbNV12SinglePlaneNoStrategy(%arg0: tensor<1x552x432x1xf16>) -> tensor<1x368x432x3xf16> {
    ...
    // CHECK:       [[YUVTORGB:%.+]] = VPU.YuvToRgb([[ARG_0]])
...
// CHECK-LABEL: @GatherSOB
// CHECK-SAME:      ([[INPUT_1:%.+]]: tensor<184320x4x1x1xsi4>, [[INPUT_2:%.+]]: tensor<12x1x1x1xi64>)
func.func @GatherSOB(%arg0: tensor<184320x4x1x1xsi4>, %arg1: tensor<12x1x1x1xi64>) -> tensor<12x4x1x1xsi4> {
    %0 =  VPU.GatherDMA(%arg0, %arg1) {axis_value = 0 : i64, batch_dims = 0 : i64} : tensor<184320x4x1x1xsi4>, tensor<12x1x1x1xi64> -> tensor<12x4x1x1xsi4>
    return %0 : tensor<12x4x1x1xsi4>

    // CHECK:       [[GATHER:%.+]] = VPU.GatherDMA([[INPUT_1]], [[INPUT_2]])
    // CHECK-SAME:      {axis_value = 0 : i64, batch_dims = 0 : i64, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverBatch>} : tensor<184320x4x1x1xsi4>, tensor<12x1x1x1xi64> -> tensor<12x4x1x1xsi4>
    // CHECK:       return [[GATHER]] : tensor<12x4x1x1xsi4>
}
