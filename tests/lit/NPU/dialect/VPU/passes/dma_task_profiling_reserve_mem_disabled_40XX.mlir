...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform% allow-custom-values=true" --dma-task-profiling-reserve-mem="dma-profiling=false" %s | FileCheck %s
