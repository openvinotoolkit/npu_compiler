...
module @VerticalFusionOutlining {
    ...
    func.func @main(%arg0: tensor<1x3x256x256xf32, {order = #NHWC}>) -> tensor<1x16x256x256xf16, {order = #NHWC}> {
        ...
        %2 = VPU.NCE.Convolution(%1, %cst_0, %cst) rawFilterShape [16, 16, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
                ppe = #VPU.PPEInt<mode = <NOOP>, clamp_low = -2147483648 : i64, clamp_high = 2147483647 : i64, lrelu_mult = 1 : i64, lrelu_shift = 0 : i64, fp_prelu_alpha = 1.000000e+00 : f64>,
...
// CHECK:     func.func nested @main_vf1([[ARG0:%.+]]: tensor<1x3x256x256xf32, {order = #NHWC}>) -> tensor<1x3x256x256xf16, {order = #NHWC}> {
...
// CHECK:     func.func nested @main_vf2([[ARG0:%.+]]: tensor<1x3x256x256xf16, {order = #NHWC}>) -> tensor<1x16x256x256xf16, {order = #NHWC}> {
