...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform% compilation-mode=DefaultHW" --cmx-stack-frames-reserve-mem --cmx-metadata-reserve-mem --tiling="prefetching=true" %s | FileCheck %s
...
func.func @SplitSoftMaxOverH(%arg0: tensor<1x20x256x384xf16>) -> tensor<1x20x256x384xf16> {
    ...
    // CHECK:       [[INPUT_TILE0:%.+]] = VPU.Slice [[INPUT]] [0, 0, 0, 0] [1, 20, 43, 384]
    // CHECK-SAME:      : tensor<1x20x256x384xf16> to tensor<1x20x43x384xf16>
    // CHECK:       [[OUTPUT_TILE0:%.+]] = VPU.SoftMax([[INPUT_TILE0]]) {axisInd = 1 : i64, tiling_loop_index = 0 : i64}
    // CHECK-SAME:      : tensor<1x20x43x384xf16> -> tensor<1x20x43x384xf16>

    // CHECK:       [[INPUT_TILE1:%.+]] = VPU.Slice [[INPUT]] [0, 0, 43, 0] [1, 20, 43, 384]
    // CHECK-SAME:      : tensor<1x20x256x384xf16> to tensor<1x20x43x384xf16>
    // CHECK:       [[OUTPUT_TILE1:%.+]] = VPU.SoftMax([[INPUT_TILE1]]) {axisInd = 1 : i64, tiling_loop_index = 0 : i64}
    // CHECK-SAME:      : tensor<1x20x43x384xf16> -> tensor<1x20x43x384xf16>

    // CHECK:       [[INPUT_TILE2:%.+]] = VPU.Slice [[INPUT]] [0, 0, 86, 0] [1, 20, 43, 384]
    // CHECK-SAME:      : tensor<1x20x256x384xf16> to tensor<1x20x43x384xf16>
    // CHECK:       [[OUTPUT_TILE2:%.+]] = VPU.SoftMax([[INPUT_TILE2]]) {axisInd = 1 : i64, tiling_loop_index = 0 : i64}
    // CHECK-SAME:      : tensor<1x20x43x384xf16> -> tensor<1x20x43x384xf16>

    // CHECK:       [[INPUT_TILE3:%.+]] = VPU.Slice [[INPUT]] [0, 0, 129, 0] [1, 20, 43, 384]
    // CHECK-SAME:      : tensor<1x20x256x384xf16> to tensor<1x20x43x384xf16>
    // CHECK:       [[OUTPUT_TILE3:%.+]] = VPU.SoftMax([[INPUT_TILE3]]) {axisInd = 1 : i64, tiling_loop_index = 0 : i64}
    // CHECK-SAME:      : tensor<1x20x43x384xf16> -> tensor<1x20x43x384xf16>

    // CHECK:       [[INPUT_TILE4:%.+]] = VPU.Slice [[INPUT]] [0, 0, 172, 0] [1, 20, 42, 384]
    // CHECK-SAME:      : tensor<1x20x256x384xf16> to tensor<1x20x42x384xf16>
    // CHECK:       [[OUTPUT_TILE4:%.+]] = VPU.SoftMax([[INPUT_TILE4]]) {axisInd = 1 : i64, tiling_loop_index = 0 : i64}
    // CHECK-SAME:      : tensor<1x20x42x384xf16> -> tensor<1x20x42x384xf16>

    // CHECK:       [[INPUT_TILE5:%.+]] = VPU.Slice [[INPUT]] [0, 0, 214, 0] [1, 20, 42, 384]
    // CHECK-SAME:      : tensor<1x20x256x384xf16> to tensor<1x20x42x384xf16>
...
// CHECK-SAME:  [[ARG_0:%[^:]+]]: tensor<1x21x65x65xf16>
func.func @InterpSplitOverCDueToUglyScalingFactor(%arg0: tensor<1x21x65x65xf16>) -> tensor<1x21x513x513xf16> {
  %0 = VPU.Interpolate(%arg0) {
    ...
    sizes_attr = [513, 513], useScaleAttr} : tensor<1x21x65x65xf16> -> tensor<1x21x513x513xf16>
  return %0 : tensor<1x21x513x513xf16>

// CHECK:       [[TILE0:%.+]] = VPU.Slice [[ARG_0]] [0, 0, 0, 0] [1, 21, 9, 65]
// CHECK-SAME:      : tensor<1x21x65x65xf16> to tensor<1x21x9x65xf16>
// CHECK:       [[INTERP0:%.+]] = VPU.Interpolate([[TILE0]]) {
// CHECK-SAME:      pads_begin = [0, 0, 0, 0], pads_end = [0, 0, 0, 0]
// CHECK-SAME:      : tensor<1x21x9x65xf16>
// CHECK-SAME:      -> tensor<1x21x57x513xf16>
// CHECK:       [[TILE1:%.+]] = VPU.Slice [[ARG_0]] [0, 0, 7, 0] [1, 21, 9, 65]
// CHECK-SAME:      : tensor<1x21x65x65xf16> to tensor<1x21x9x65xf16>
// CHECK:       [[INTERP1:%.+]] = VPU.Interpolate([[TILE1]]) {
// CHECK-SAME:      pads_begin = [0, 0, 0, 0], pads_end = [0, 0, 0, 0]
// CHECK-SAME:      : tensor<1x21x9x65xf16>
// CHECK-SAME:      -> tensor<1x21x57x513xf16>
// CHECK:       [[TILE2:%.+]] = VPU.Slice [[ARG_0]] [0, 0, 14, 0] [1, 21, 9, 65]
// CHECK-SAME:      : tensor<1x21x65x65xf16> to tensor<1x21x9x65xf16>
// CHECK:       [[INTERP2:%.+]] = VPU.Interpolate([[TILE2]]) {
// CHECK-SAME:      pads_begin = [0, 0, 0, 0], pads_end = [0, 0, 0, 0]
// CHECK-SAME:      : tensor<1x21x9x65xf16>
// CHECK-SAME:      -> tensor<1x21x57x513xf16>
// CHECK:       [[TILE3:%.+]] = VPU.Slice [[ARG_0]] [0, 0, 21, 0] [1, 21, 9, 65]
// CHECK-SAME:      : tensor<1x21x65x65xf16> to tensor<1x21x9x65xf16>
// CHECK:       [[INTERP3:%.+]] = VPU.Interpolate([[TILE3]]) {
// CHECK-SAME:      pads_begin = [0, 0, 0, 0], pads_end = [0, 0, 0, 0]
// CHECK-SAME:      : tensor<1x21x9x65xf16>
// CHECK-SAME:      -> tensor<1x21x57x513xf16>
// CHECK:       [[TILE4:%.+]] = VPU.Slice [[ARG_0]] [0, 0, 28, 0] [1, 21, 9, 65]
// CHECK-SAME:      : tensor<1x21x65x65xf16> to tensor<1x21x9x65xf16>
// CHECK:       [[INTERP4:%.+]] = VPU.Interpolate([[TILE4]]) {
// CHECK-SAME:      pads_begin = [0, 0, 0, 0], pads_end = [0, 0, 0, 0]
// CHECK-SAME:      : tensor<1x21x9x65xf16>
// CHECK-SAME:      -> tensor<1x21x57x513xf16>
// CHECK:       [[TILE5:%.+]] = VPU.Slice [[ARG_0]] [0, 0, 36, 0] [1, 21, 9, 65]
// CHECK-SAME:      : tensor<1x21x65x65xf16> to tensor<1x21x9x65xf16>
// CHECK:       [[INTERP5:%.+]] = VPU.Interpolate([[TILE5]]) {
// CHECK-SAME:      pads_begin = [0, 0, 0, 0], pads_end = [0, 0, 0, 0]
// CHECK-SAME:      : tensor<1x21x9x65xf16>
// CHECK-SAME:      -> tensor<1x21x57x513xf16>
// CHECK:       [[TILE6:%.+]] = VPU.Slice [[ARG_0]] [0, 0, 43, 0] [1, 21, 9, 65]
// CHECK-SAME:      : tensor<1x21x65x65xf16> to tensor<1x21x9x65xf16>
// CHECK:       [[INTERP6:%.+]] = VPU.Interpolate([[TILE6]]) {
// CHECK-SAME:      pads_begin = [0, 0, 0, 0], pads_end = [0, 0, 0, 0]
// CHECK-SAME:      : tensor<1x21x9x65xf16>
// CHECK-SAME:      -> tensor<1x21x57x513xf16>
// CHECK:       [[TILE7:%.+]] = VPU.Slice [[ARG_0]] [0, 0, 50, 0] [1, 21, 9, 65]
// CHECK-SAME:      : tensor<1x21x65x65xf16> to tensor<1x21x9x65xf16>
// CHECK:       [[INTERP7:%.+]] = VPU.Interpolate([[TILE7]]) {
// CHECK-SAME:      pads_begin = [0, 0, 0, 0], pads_end = [0, 0, 0, 0]
// CHECK-SAME:      : tensor<1x21x9x65xf16>
// CHECK-SAME:      -> tensor<1x21x57x513xf16>
// CHECK:       [[TILE8:%.+]] = VPU.Slice [[ARG_0]] [0, 0, 57, 0] [1, 21, 8, 65]
// CHECK-SAME:      : tensor<1x21x65x65xf16> to tensor<1x21x8x65xf16>
// CHECK:       [[INTERP8:%.+]] = VPU.Interpolate([[TILE8]]) {
// CHECK-SAME:      pads_begin = [0, 0, 0, 0], pads_end = [0, 0, 0, 0]
// CHECK-SAME:      : tensor<1x21x8x65xf16>
// CHECK-SAME:      -> tensor<1x21x57x513xf16>
// CHECK:       [[CONCAT:%.+]] = VPU.Concat([[INTERP0]], [[INTERP1]], [[INTERP2]], [[INTERP3]], [[INTERP4]], [[INTERP5]], [[INTERP6]], [[INTERP7]], [[INTERP8]]) {
// CHECK-SAME{LITERAL}: static_offsets = [[0, 0, 0, 0], [0, 0, 57, 0], [0, 0, 114, 0], [0, 0, 171, 0], [0, 0, 228, 0], [0, 0, 285, 0], [0, 0, 342, 0], [0, 0, 399, 0], [0, 0, 456, 0]]}
// CHECK-SAME:      : tensor<1x21x57x513xf16>, tensor<1x21x57x513xf16>, tensor<1x21x57x513xf16>, tensor<1x21x57x513xf16>, tensor<1x21x57x513xf16>, tensor<1x21x57x513xf16>, tensor<1x21x57x513xf16>, tensor<1x21x57x513xf16>, tensor<1x21x57x513xf16>
...
func.func @SplitLeakyReluOverW(%arg0: tensor<1x8x80x960xf16>) -> tensor<1x8x80x960xf16> {
    ...
    // CHECK-SAME:  negative_slope = 0.0099999997764825821 : f64, tiling_loop_index = 0 : i64} : tensor<1x8x80x480xf16> -> tensor<1x8x80x480xf16>
...
func.func @GenericTiling(
    ...
    %3 = VPU.NCE.Convolution(%2, %weights2, %weights_table2) rawFilterShape [576, 144, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
        pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>,
        ppe = #VPU.PPEStub<>,
    ...
    // CHECK:       [[CONV_1:%.+]] = VPU.NCE.Convolution([[INPUT]], [[WEIGHTS1]], [[WEIGHTS_TABLE1]]) rawFilterShape [144, 144, 3, 3]
    ...
    // CHECK:       [[OUTPUT_TILE0:%.+]] = VPU.NCE.Convolution([[AND]], [[WEIGHTS_TILE0]], [[WEIGHTS_TABLE_TILE0]]) rawFilterShape [144, 144, 3, 3]
    // CHECK-SAME:     pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>
    ...
    // CHECK:       [[OUTPUT_TILE1:%.+]] = VPU.NCE.Convolution([[AND]], [[WEIGHTS_TILE1]], [[WEIGHTS_TABLE_TILE1]]) rawFilterShape [144, 144, 3, 3]
    // CHECK-SAME:          pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>
    // CHECK-SAME:          strides = [1, 1], tiling_loop_index = 0 : i64}
    // CHECK-SAME:          -> tensor<1x144x20x20xf16, {order = #NHWC}>
    ...
    // CHECK:       [[OUTPUT_TILE2:%.+]] = VPU.NCE.Convolution([[AND]], [[WEIGHTS_TILE2]], [[WEIGHTS_TABLE_TILE2]]) rawFilterShape [144, 144, 3, 3]
    ...
    // CHECK:       [[OUTPUT_TILE3:%.+]] = VPU.NCE.Convolution([[AND]], [[WEIGHTS_TILE3]], [[WEIGHTS_TABLE_TILE3]]) rawFilterShape [144, 144, 3, 3]
    // CHECK-SAME:     {pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, ppe = #VPU.PPEStub<>
    // CHECK-SAME:  strides = [1, 1], tiling_loop_index = 0 : i64}
    // CHECK-SAME:          -> tensor<1x144x20x20xf16, {order = #NHWC}>
...
func.func @SplitI4QuantNCEConvOverOC(%arg0: tensor<1x128x256x4xf16, {order = #NHWC}>) -> tensor<1x6320x256x4xf16, {order = #NHWC}> {
    ...
    // CHECK-DAG:       [[CST:%.+]] = const.Declare tensor<2096x1x1x4xsi32> = dense<10> : tensor<6320x1x1x4xsi32>, [#const.SubView<[4224, 0, 0, 0], [2096, 1, 1, 4]>]
    // CHECK-DAG:       [[CST_0:%.+]] = const.Declare tensor<2096x128x1x1x!qElemType, {order = #NHWC}> = dense<1.000000e+00> : tensor<6320x128x1x1xf16>, [#const.SubView<[4224, 0, 0, 0], [2096, 128, 1, 1]>, #const.CastElemType<si4>, #const.CastElemType<!qElemType>, #const.Reorder<#NHWC>]

    // CHECK-DAG:       [[CST_1:%.+]] = const.Declare tensor<2112x1x1x4xsi32> = dense<10> : tensor<6320x1x1x4xsi32>, [#const.SubView<[2112, 0, 0, 0], [2112, 1, 1, 4]>]
    // CHECK-DAG:       [[CST_2:%.+]] = const.Declare tensor<2112x128x1x1x!qElemType, {order = #NHWC}> = dense<1.000000e+00> : tensor<6320x128x1x1xf16>, [#const.SubView<[2112, 0, 0, 0], [2112, 128, 1, 1]>, #const.CastElemType<si4>, #const.CastElemType<!qElemType>, #const.Reorder<#NHWC>]

    // CHECK-DAG:       [[CST_3:%.+]] = const.Declare tensor<2112x128x1x1x!qElemType, {order = #NHWC}> = dense<1.000000e+00> : tensor<6320x128x1x1xf16>, [#const.SubView<[0, 0, 0, 0], [2112, 128, 1, 1]>, #const.CastElemType<si4>, #const.CastElemType<!qElemType>, #const.Reorder<#NHWC>]
    // CHECK-DAG:       [[CST_4:%.+]] = const.Declare tensor<2112x1x1x4xsi32> = dense<10> : tensor<6320x1x1x4xsi32>, [#const.SubView<[0, 0, 0, 0], [2112, 1, 1, 4]>]

    // CHECK:           [[CONV_0:%.+]] = VPU.NCE.Convolution([[INPUT]], [[CST_3]], [[CST_4]]) rawFilterShape [2112, 128, 1, 1] {
    ...
    // CHECK:           [[CONV_1:%.+]] = VPU.NCE.Convolution([[INPUT]], [[CST_2]], [[CST_1]]) rawFilterShape [2112, 128, 1, 1] {
    // CHECK-SAME:          multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK-SAME:          pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>
    // CHECK-SAME:          ppe = #VPU.PPEStub<>
    // CHECK-SAME:          strides = [1, 1], tiling_loop_index = 0 : i64}
    ...
    // CHECK:           [[CONV_2:%.+]] = VPU.NCE.Convolution([[INPUT]], [[CST_0]], [[CST]]) rawFilterShape [2096, 128, 1, 1] {
    ...
    // CHECK-SAME:      : tensor<1x2112x256x4xf16, {order = #NHWC}>, tensor<1x2112x256x4xf16, {order = #NHWC}>, tensor<1x2096x256x4xf16, {order = #NHWC}> -> tensor<1x6320x256x4xf16, {order = #NHWC}>
...
func.func @TileWithSOH(
    ...
    // CHECK:       [[CONV3:%.+]] = VPU.NCE.Convolution([[SLICE3]], [[WEIGHTS]], [[WEIGHTS_TABLE]]) rawFilterShape [32, 16, 3, 3]
    // CHECK-SAME:          multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>
    // CHECK-SAME:          pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 0 : i64, bottom = 1 : i64>
    // CHECK-SAME:          strides = [1, 1]
    // CHECK-SAME:          tensor<1x32x70x512xf16, {order = #NHWC}>
...
func.func @TileWithSOK(
  ...
  // CHECK:       [[OUTPUT0:%.+]] = VPU.NCE.Convolution([[SLICE]], [[WEIGHTS]], [[WEIGHTS0]]) rawFilterShape [768, 32, 7, 7]
  // CHECK-SAME:         {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>
  ...
  // CHECK:       [[OUTPUT1:%.+]] = VPU.NCE.Convolution([[SLICE1]], [[WEIGHTS]], [[WEIGHTS0]]) rawFilterShape [768, 32, 7, 7]
  // CHECK-SAME:         {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>
...
// CHECK-SAME:  max = 1.000000e+00 : f64, min = -1.000000e+00 : f64, tiling_loop_index = 0 : i64} : tensor<1x8x80x480xf16> -> tensor<1x8x80x480xf16>
...
// CHECK-SAME:  auto_broadcast = #IE.auto_broadcast_type<NUMPY>, tiling_loop_index = 0 : i64} : tensor<1x10x128x176xf16>, tensor<1x10x128x176xf16> -> tensor<1x10x128x176xf16>
...
// CHECK-SAME:  auto_broadcast = #IE.auto_broadcast_type<NUMPY>, tiling_loop_index = 0 : i64} : tensor<1x10x128x176xf16>, tensor<1x10x128x176xf16> -> tensor<1x10x128x176xi8>
...
// CHECK-SAME:  {tiling_loop_index = 0 : i64} : tensor<1x8x80x480xf16> -> tensor<1x8x80x480xf16>
...
// CHECK:       [[INPUT_TILE0:%.+]] = VPU.Slice [[INPUT_0]] [0, 0, 0, 0] [1, 2, 256, 176]
// CHECK-SAME:   : tensor<1x10x256x176xf16> to tensor<1x2x256x176xf16>

// CHECK:       [[INPUT_TILE1:%.+]] = VPU.Slice [[INPUT_1]] [0, 0, 0, 0] [1, 2, 256, 176]
// CHECK-SAME:   : tensor<1x10x256x176xf16> to tensor<1x2x256x176xf16>

// CHECK:       [[INPUT_TILE2:%.+]] = VPU.Slice [[INPUT_2]] [0, 0, 0, 0] [1, 2, 256, 176]
// CHECK-SAME:   : tensor<1x10x256x176xf16> to tensor<1x2x256x176xf16>

// CHECK:       [[OUTPUT_TILE0:%.+]] = VPU.Select([[INPUT_TILE0]], [[INPUT_TILE1]], [[INPUT_TILE2]]) {
// CHECK-SAME:  auto_broadcast = #IE.auto_broadcast_type<NUMPY>, tiling_loop_index = 0 : i64} : tensor<1x2x256x176xf16>, tensor<1x2x256x176xf16>, tensor<1x2x256x176xf16> -> tensor<1x2x256x176xf16>

// CHECK:       [[INPUT_TILE3:%.+]] = VPU.Slice [[INPUT_0]] [0, 2, 0, 0] [1, 2, 256, 176]
// CHECK-SAME:   : tensor<1x10x256x176xf16> to tensor<1x2x256x176xf16>

// CHECK:       [[INPUT_TILE4:%.+]] = VPU.Slice [[INPUT_1]] [0, 2, 0, 0] [1, 2, 256, 176]
// CHECK-SAME:   : tensor<1x10x256x176xf16> to tensor<1x2x256x176xf16>

// CHECK:       [[INPUT_TILE5:%.+]] = VPU.Slice [[INPUT_2]] [0, 2, 0, 0] [1, 2, 256, 176]
// CHECK-SAME:   : tensor<1x10x256x176xf16> to tensor<1x2x256x176xf16>

// CHECK:       [[OUTPUT_TILE1:%.+]] = VPU.Select([[INPUT_TILE3]], [[INPUT_TILE4]], [[INPUT_TILE5]]) {
// CHECK-SAME:  auto_broadcast = #IE.auto_broadcast_type<NUMPY>, tiling_loop_index = 0 : i64} : tensor<1x2x256x176xf16>, tensor<1x2x256x176xf16>, tensor<1x2x256x176xf16> -> tensor<1x2x256x176xf16>

// CHECK:       [[INPUT_TILE6:%.+]] = VPU.Slice [[INPUT_0]] [0, 4, 0, 0] [1, 2, 256, 176]
// CHECK-SAME:   : tensor<1x10x256x176xf16> to tensor<1x2x256x176xf16>

// CHECK:       [[INPUT_TILE7:%.+]] = VPU.Slice [[INPUT_1]] [0, 4, 0, 0] [1, 2, 256, 176]
// CHECK-SAME:   : tensor<1x10x256x176xf16> to tensor<1x2x256x176xf16>

// CHECK:       [[INPUT_TILE8:%.+]] = VPU.Slice [[INPUT_2]] [0, 4, 0, 0] [1, 2, 256, 176]
// CHECK-SAME:   : tensor<1x10x256x176xf16> to tensor<1x2x256x176xf16>

// CHECK:       [[OUTPUT_TILE2:%.+]] = VPU.Select([[INPUT_TILE6]], [[INPUT_TILE7]], [[INPUT_TILE8]]) {
// CHECK-SAME:  auto_broadcast = #IE.auto_broadcast_type<NUMPY>, tiling_loop_index = 0 : i64} : tensor<1x2x256x176xf16>, tensor<1x2x256x176xf16>, tensor<1x2x256x176xf16> -> tensor<1x2x256x176xf16>

// CHECK:       [[INPUT_TILE9:%.+]] = VPU.Slice [[INPUT_0]] [0, 6, 0, 0] [1, 2, 256, 176]
// CHECK-SAME:   : tensor<1x10x256x176xf16> to tensor<1x2x256x176xf16>

// CHECK:       [[INPUT_TILE10:%.+]] = VPU.Slice [[INPUT_1]] [0, 6, 0, 0] [1, 2, 256, 176]
// CHECK-SAME:   : tensor<1x10x256x176xf16> to tensor<1x2x256x176xf16>

// CHECK:       [[INPUT_TILE11:%.+]] = VPU.Slice [[INPUT_2]] [0, 6, 0, 0] [1, 2, 256, 176]
// CHECK-SAME:   : tensor<1x10x256x176xf16> to tensor<1x2x256x176xf16>

// CHECK:       [[OUTPUT_TILE3:%.+]] = VPU.Select([[INPUT_TILE9]], [[INPUT_TILE10]], [[INPUT_TILE11]]) {
// CHECK-SAME:  auto_broadcast = #IE.auto_broadcast_type<NUMPY>, tiling_loop_index = 0 : i64} : tensor<1x2x256x176xf16>, tensor<1x2x256x176xf16>, tensor<1x2x256x176xf16> -> tensor<1x2x256x176xf16>
// CHECK:       [[INPUT_TILE12:%.+]] = VPU.Slice [[INPUT_0]] [0, 8, 0, 0] [1, 2, 256, 176]
// CHECK-SAME:   : tensor<1x10x256x176xf16> to tensor<1x2x256x176xf16>

// CHECK:       [[INPUT_TILE13:%.+]] = VPU.Slice [[INPUT_1]] [0, 8, 0, 0] [1, 2, 256, 176]
// CHECK-SAME:   : tensor<1x10x256x176xf16> to tensor<1x2x256x176xf16>

// CHECK:       [[INPUT_TILE14:%.+]] = VPU.Slice [[INPUT_2]] [0, 8, 0, 0] [1, 2, 256, 176]
// CHECK-SAME:   : tensor<1x10x256x176xf16> to tensor<1x2x256x176xf16>
...
// CHECK-SAME:  : tensor<1x2x256x176xf16>, tensor<1x2x256x176xf16>, tensor<1x2x256x176xf16>, tensor<1x2x256x176xf16>, tensor<1x2x256x176xf16> -> tensor<1x10x256x176xf16>
...
func.func @SplitTopK(%arg0: tensor<1x5x512x384xf16>) -> (tensor<1x1x512x384xf32>, tensor<1x1x512x384xsi32>) {
    ...
    // CHECK: [[OUTPUT_TILE0:%.+]], [[TARGET_TILE0:%.+]] = VPU.TopK([[INPUT_TILE0]], [[AUX]]) {axis = 1 : i64, element_type = si32, k_value = 1 : i64, mode = #IE.topk_mode<MAX>, sort = #IE.topk_sort_type<SORT_INDICES>, tiling_loop_index = 0 : i64} : tensor<1x5x171x384xf16>, tensor<1x1x1x80xui8> -> tensor<1x1x171x384xf16>, tensor<1x1x171x384xsi32>
    // CHECK: [[INPUT_TILE1:%.+]] = VPU.Slice [[INPUT_0]] [0, 0, 171, 0] [1, 5, 171, 384] : tensor<1x5x512x384xf16> to tensor<1x5x171x384xf16>
    // CHECK: [[OUTPUT_TILE1:%.+]], [[TARGET_TILE1:%.+]] = VPU.TopK([[INPUT_TILE1]], [[AUX]]) {axis = 1 : i64, element_type = si32, k_value = 1 : i64, mode = #IE.topk_mode<MAX>, sort = #IE.topk_sort_type<SORT_INDICES>, tiling_loop_index = 0 : i64} : tensor<1x5x171x384xf16>, tensor<1x1x1x80xui8> -> tensor<1x1x171x384xf16>, tensor<1x1x171x384xsi32>
    // CHECK: [[INPUT_TILE2:%.+]] = VPU.Slice [[INPUT_0]] [0, 0, 342, 0] [1, 5, 170, 384] : tensor<1x5x512x384xf16> to tensor<1x5x170x384xf16>
    // CHECK: [[OUTPUT_TILE2:%.+]], [[TARGET_TILE2:%.+]] = VPU.TopK([[INPUT_TILE2]], [[AUX]]) {axis = 1 : i64, element_type = si32, k_value = 1 : i64, mode = #IE.topk_mode<MAX>, sort = #IE.topk_sort_type<SORT_INDICES>, tiling_loop_index = 0 : i64} : tensor<1x5x170x384xf16>, tensor<1x1x1x80xui8> -> tensor<1x1x170x384xf16>, tensor<1x1x170x384xsi32>
...
// CHECK:    [[MVN4:%.+]] = VPU.MVN([[SLICE4]]) {across_channels = false, eps = 9.9999997473787516E-6 : f64, normalize_variance = true, tiling_loop_index = 0 : i64} : tensor<1x672x512x1xf16> -> tensor<1x672x512x1xf16>
// CHECK:    [[SLICE5:%.+]] = VPU.Slice [[INPUT]] [0, 3360, 0, 0] [1, 672, 512, 1] : tensor<1x5376x512x1xf16> to tensor<1x672x512x1xf16>
// CHECK:    [[MVN5:%.+]] = VPU.MVN([[SLICE5]]) {across_channels = false, eps = 9.9999997473787516E-6 : f64, normalize_variance = true, tiling_loop_index = 0 : i64} : tensor<1x672x512x1xf16> -> tensor<1x672x512x1xf16>
// CHECK:    [[SLICE6:%.+]] = VPU.Slice [[INPUT]] [0, 4032, 0, 0] [1, 672, 512, 1] : tensor<1x5376x512x1xf16> to tensor<1x672x512x1xf16>
// CHECK:    [[MVN6:%.+]] = VPU.MVN([[SLICE6]]) {across_channels = false, eps = 9.9999997473787516E-6 : f64, normalize_variance = true, tiling_loop_index = 0 : i64} : tensor<1x672x512x1xf16> -> tensor<1x672x512x1xf16>
// CHECK:    [[SLICE7:%.+]] = VPU.Slice [[INPUT]] [0, 4704, 0, 0] [1, 672, 512, 1] : tensor<1x5376x512x1xf16> to tensor<1x672x512x1xf16>
// CHECK:    [[MVN7:%.+]] = VPU.MVN([[SLICE7]]) {across_channels = false, eps = 9.9999997473787516E-6 : f64, normalize_variance = true, tiling_loop_index = 0 : i64} : tensor<1x672x512x1xf16> -> tensor<1x672x512x1xf16>
...
// CHECK:    [[MVN0:%.+]] = VPU.MVN([[SLICE0]]) {across_channels = false, eps = 9.9999997473787516E-6 : f64, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>, normalize_variance = true, tiling_loop_index = 0 : i64} : tensor<1x2688x512x1xf16> -> tensor<1x2688x512x1xf16>
// CHECK:    [[SLICE1:%.+]] = VPU.Slice [[INPUT]] [0, 2688, 0, 0] [1, 2688, 512, 1] : tensor<1x5376x512x1xf16> to tensor<1x2688x512x1xf16>
// CHECK:    [[MVN1:%.+]] = VPU.MVN([[SLICE1]]) {across_channels = false, eps = 9.9999997473787516E-6 : f64, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>, normalize_variance = true, tiling_loop_index = 0 : i64} : tensor<1x2688x512x1xf16> -> tensor<1x2688x512x1xf16>
...
// CHECK:    [[MVN2:%.+]] = VPU.MVN([[SLICE2]]) {across_channels = false, eps = 9.9999997473787516E-6 : f64, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>, normalize_variance = true, tiling_loop_index = 0 : i64} : tensor<1x2688x512x1xf16> -> tensor<1x2688x512x1xf16>
// CHECK:    [[SLICE3:%.+]] = VPU.Slice [[INPUT]] [1, 2688, 0, 0] [1, 2688, 512, 1] : tensor<2x5376x512x1xf16> to tensor<1x2688x512x1xf16>
// CHECK:    [[MVN3:%.+]] = VPU.MVN([[SLICE3]]) {across_channels = false, eps = 9.9999997473787516E-6 : f64, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>, normalize_variance = true, tiling_loop_index = 0 : i64} : tensor<1x2688x512x1xf16> -> tensor<1x2688x512x1xf16>
// CHECK:    [[CONCAT:%.+]] = VPU.Concat([[MVN0]], [[MVN1]], [[MVN2]], [[MVN3]])
...
func.func @SplitTileOnDimH(%arg0: tensor<1x32x1x1xf16, {order = #NHWC}>) -> tensor<1x32x512x512xf16, {order = #NHWC}> {
    ...
    // CHECK:         [[TILE_0:%.+]] = VPU.Tile([[ARG_0]]) {repeats_values = [1, 1, 43, 512], tiling_loop_index = 0 : i64} : tensor<1x32x1x1xf16, {order = #NHWC}> -> tensor<1x32x43x512xf16, {order = #NHWC}>
    // CHECK:         [[TILE_1:%.+]] = VPU.Tile([[ARG_0]]) {repeats_values = [1, 1, 43, 512], tiling_loop_index = 0 : i64} : tensor<1x32x1x1xf16, {order = #NHWC}> -> tensor<1x32x43x512xf16, {order = #NHWC}>
    // CHECK:         [[TILE_2:%.+]] = VPU.Tile([[ARG_0]]) {repeats_values = [1, 1, 43, 512], tiling_loop_index = 0 : i64} : tensor<1x32x1x1xf16, {order = #NHWC}> -> tensor<1x32x43x512xf16, {order = #NHWC}>
    // CHECK:         [[TILE_3:%.+]] = VPU.Tile([[ARG_0]]) {repeats_values = [1, 1, 43, 512], tiling_loop_index = 0 : i64} : tensor<1x32x1x1xf16, {order = #NHWC}> -> tensor<1x32x43x512xf16, {order = #NHWC}>
    // CHECK:         [[TILE_4:%.+]] = VPU.Tile([[ARG_0]]) {repeats_values = [1, 1, 43, 512], tiling_loop_index = 0 : i64} : tensor<1x32x1x1xf16, {order = #NHWC}> -> tensor<1x32x43x512xf16, {order = #NHWC}>
    // CHECK:         [[TILE_5:%.+]] = VPU.Tile([[ARG_0]]) {repeats_values = [1, 1, 43, 512], tiling_loop_index = 0 : i64} : tensor<1x32x1x1xf16, {order = #NHWC}> -> tensor<1x32x43x512xf16, {order = #NHWC}>
    // CHECK:         [[TILE_6:%.+]] = VPU.Tile([[ARG_0]]) {repeats_values = [1, 1, 43, 512], tiling_loop_index = 0 : i64} : tensor<1x32x1x1xf16, {order = #NHWC}> -> tensor<1x32x43x512xf16, {order = #NHWC}>
    // CHECK:         [[TILE_7:%.+]] = VPU.Tile([[ARG_0]]) {repeats_values = [1, 1, 43, 512], tiling_loop_index = 0 : i64} : tensor<1x32x1x1xf16, {order = #NHWC}> -> tensor<1x32x43x512xf16, {order = #NHWC}>
    // CHECK:         [[TILE_8:%.+]] = VPU.Tile([[ARG_0]]) {repeats_values = [1, 1, 42, 512], tiling_loop_index = 0 : i64} : tensor<1x32x1x1xf16, {order = #NHWC}> -> tensor<1x32x42x512xf16, {order = #NHWC}>
    // CHECK:         [[TILE_9:%.+]] = VPU.Tile([[ARG_0]]) {repeats_values = [1, 1, 42, 512], tiling_loop_index = 0 : i64} : tensor<1x32x1x1xf16, {order = #NHWC}> -> tensor<1x32x42x512xf16, {order = #NHWC}>
    // CHECK:         [[TILE_10:%.+]] = VPU.Tile([[ARG_0]]) {repeats_values = [1, 1, 42, 512], tiling_loop_index = 0 : i64} : tensor<1x32x1x1xf16, {order = #NHWC}> -> tensor<1x32x42x512xf16, {order = #NHWC}>
    // CHECK:         [[TILE_11:%.+]] = VPU.Tile([[ARG_0]]) {repeats_values = [1, 1, 42, 512], tiling_loop_index = 0 : i64} : tensor<1x32x1x1xf16, {order = #NHWC}> -> tensor<1x32x42x512xf16, {order = #NHWC}>
