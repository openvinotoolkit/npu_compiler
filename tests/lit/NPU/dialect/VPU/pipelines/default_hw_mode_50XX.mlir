...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform% compilation-mode=DefaultHW allow-custom-values=true weights-table-reuse-mode=VF_ENABLED" --mlir-elide-elementsattrs-if-larger 8 --default-hw-mode-vpu="vf-outlining-tile-threshold=1 vf-outlining-instance-threshold=2" %s | FileCheck %s --strict-whitespace
...
module @Convolution attributes {config.compilationMode = #config.compilation_mode<DefaultHW>} {
    ...
    func.func @main(%arg0: tensor<1x3x62x62xf16>) -> tensor<1x48x60x60xf16> {
        ...
        %3 = VPU.NCE.Convolution(%2, %cst_0, %cst) rawFilterShape [48, 16, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
        ...
        // CHECK:       [[CONV:%.+]] = VPU.NCE.Convolution([[COPY2]], [[COPY1]], [[COPY3]]) rawFilterShape [48, 16, 3, 3] {minimumHardwareExecutionCost = 42679 : i64,
...
module @TwoFunctions {
    ...
    // CHECK: func.func nested @main_outline1([[ARG0:%.+]]: tensor<1x3x62x62xui8>) -> tensor<1x3x62x62xf16>
    // CHECK:       [[COPY:%.+]] = VPU.Copy([[ARG0]]
...
module @RepeatingBlocks {
    ...
    // CHECK: func.func nested @main_fn1([[ARG0:%.+]]: tensor<1x48x60x60xf16>) -> tensor<1x48x60x60xf16> {
    func.func nested @main_fn1(%arg0: tensor<1x48x60x60xf16>) -> tensor<1x48x60x60xf16> {
        ...
        %conv = VPU.NCE.Convolution(%shape_cast2, %cst_weights, %cst_weights_table) rawFilterShape [48, 48, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
    ...
    // CHECK: func.func nested @main_outline1([[INPUT:%.+]]: tensor<1x48x60x60xf32>) -> tensor<1x48x60x60xf16> {
...
module @VerticalFusionOutlining {
    ...
    func.func @main(%arg0: tensor<1x30x256x256xf32, {order = #NHWC}>) -> tensor<1x32x256x256xf16, {order = #NHWC}> {
        ...
        %2 = VPU.NCE.Convolution(%1, %cst_0, %cst) rawFilterShape [32, 32, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>,
                ppe = #VPU.PPEFp<mode = <NOOP>, clamp_low = -3.4028234663852886E+38 : f64, clamp_high = 3.4028234663852886E+38 : f64, prelu_alpha = [1.000000e-01], adder = 0.000000e+00 : f64>,
                pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>,  strides = [1, 1]}
...
// CHECK:     func.func nested @main_vf1([[ARG0:%.+]]: tensor<1x30x256x256xf32, {order = #NHWC}>) -> tensor<1x30x256x256xf16, {order = #NHWC}> {
...
// CHECK:     func.func nested @main_vf2([[ARG0:%.+]]: tensor<1x30x256x256xf16, {order = #NHWC}>) -> tensor<1x32x256x256xf16, {order = #NHWC}> attributes {pure_vertical_fusion_region} {
...
module @AdjustMemorySpaceAndOptimizeSharedInputCopyForConcat1T {
  ...
  func.func @main(%arg0: tensor<1x3x128x128xf32>) -> tensor<1x32x128x128xf32> {
    ...
    %3 = VPU.NCE.Convolution(%2, %cst, %cst_6) rawFilterShape [1024, 48, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, mpe_engine = #VPU.MPEEngine37XX<mode = <SCL>>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, ppe = #VPU.PPEFp<mode = <NOOP>, clamp_low = -3.4028234663852886E+38 : f64, clamp_high = 3.4028234663852886E+38 : f64, prelu_alpha = [1.000000e+00], adder = 0.000000e+00 : f64>,  strides = [1, 1]} : tensor<1x48x128x8xf16, {order = #NHWC}>, tensor<1024x48x3x3xf16, {order = #NHWC}>, tensor<1024x1x1x4xsi32> -> tensor<1x1024x128x8xf16, {order = #NHWC}>
    ...
    %5 = VPU.NCE.Convolution(%4, %cst_3, %cst_7) rawFilterShape [32, 64, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, mpe_engine = #VPU.MPEEngine37XX<mode = <SCL>>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, ppe = #VPU.PPEFp<mode = <LPRELU>, clamp_low = -3.4028234663852886E+38 : f64, clamp_high = 3.4028234663852886E+38 : f64, prelu_alpha = [0.199951171875], adder = 0.000000e+00 : f64>,  strides = [1, 1]} : tensor<1x64x128x128xf16, {order = #NHWC}>, tensor<32x64x3x3xf16, {order = #NHWC}>, tensor<32x1x1x4xsi32> -> tensor<1x32x128x128xf16, {order = #NHWC}>
    ...
    %7 = VPU.NCE.Convolution(%6, %cst_2, %cst_8) rawFilterShape [32, 96, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, mpe_engine = #VPU.MPEEngine37XX<mode = <SCL>>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, ppe = #VPU.PPEFp<mode = <LPRELU>, clamp_low = -3.4028234663852886E+38 : f64, clamp_high = 3.4028234663852886E+38 : f64, prelu_alpha = [0.199951171875], adder = 0.000000e+00 : f64>,  strides = [1, 1]} : tensor<1x96x128x128xf16, {order = #NHWC}>, tensor<32x96x3x3xf16, {order = #NHWC}>, tensor<32x1x1x4xsi32> -> tensor<1x32x128x128xf16, {order = #NHWC}>
    ...
    %9 = VPU.NCE.Convolution(%8, %cst_1, %cst_9) rawFilterShape [32, 128, 3, 3] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, mpe_engine = #VPU.MPEEngine37XX<mode = <SCL>>, pad = #VPU.Padding<left = 1 : i64, right = 1 : i64, top = 1 : i64, bottom = 1 : i64>, ppe = #VPU.PPEFp<mode = <NOOP>, clamp_low = -3.4028234663852886E+38 : f64, clamp_high = 3.4028234663852886E+38 : f64, scale = 1.000000e+00 : f64, prelu_alpha = [1.000000e+00], bias = 0.000000e+00 : f64, adder = 0.000000e+00 : f64>,  strides = [1, 1]} : tensor<1x128x128x128xf16, {order = #NHWC}>, tensor<32x128x3x3xf16, {order = #NHWC}>, tensor<32x1x1x4xsi32> -> tensor<1x32x128x128xf16>
...
module @EnableWeightDeqauntEnsuranceBeforeStrategy {
  ...
  net.NetworkInfo entryPoint : @main inputsInfo : {
    ...
    %2 = VPU.NCE.Convolution(%1, %0, %cst_0) rawFilterShape [10240, 128, 1, 1] {resultSegmentSizes = array<i32: 1, 0, 0, 0>, mpe_engine = #VPU.MPEEngine37XX<mode = <SCL>>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, ppe = #VPU.PPEFp<mode = <NOOP>, clamp_low = -3.4028234663852886E+38 : f64, clamp_high = 3.4028234663852886E+38 : f64, prelu_alpha = [1.000000e+00], adder = 0.000000e+00 : f64>,  strides = [1, 1]} : tensor<1x128x64x4xf16, {order = #NHWC}>, tensor<10240x128x1x1xf16, {order = #NHWC}>, tensor<10240x1x1x4xsi32> -> tensor<1x10240x64x4xf16, {order = #NHWC}>
   return %2 : tensor<1x10240x64x4xf16, {order = #NHWC}>
    ...
    // CHECK: [[DEQ0:%.+]] = VPU.Dequantize([[COPY_W0]]) {dstElemType = f16, vf_loop_index = 0 : i64, vf_loop_tile_index = 0 : i64}
    ...
    // CHECK: [[DEQ1:%.+]] = VPU.Dequantize([[COPY_W1]]) {dstElemType = f16, vf_loop_index = 0 : i64, vf_loop_tile_index = 1 : i64}
    ...
    // CHECK: [[DEQ2:%.+]] = VPU.Dequantize([[COPY_W2]]) {dstElemType = f16, vf_loop_index = 0 : i64, vf_loop_tile_index = 2 : i64}
    ...
    // CHECK: [[DEQ3:%.+]] = VPU.Dequantize([[COPY_W3]]) {dstElemType = f16, vf_loop_index = 0 : i64, vf_loop_tile_index = 3 : i64}
    ...
    // CHECK: [[DEQ4:%.+]] = VPU.Dequantize([[COPY_W4]]) {dstElemType = f16, vf_loop_index = 0 : i64, vf_loop_tile_index = 4 : i64}
    ...
    // CHECK: [[DEQ5:%.+]] = VPU.Dequantize([[COPY_W5]]) {dstElemType = f16, vf_loop_index = 0 : i64, vf_loop_tile_index = 5 : i64}
    ...
    // CHECK: [[DEQ6:%.+]] = VPU.Dequantize([[COPY_W6]]) {dstElemType = f16, vf_loop_index = 0 : i64, vf_loop_tile_index = 6 : i64}
    ...
    // CHECK: [[DEQ7:%.+]] = VPU.Dequantize([[COPY_W7]]) {dstElemType = f16, vf_loop_index = 0 : i64, vf_loop_tile_index = 7 : i64}
    ...
    // CHECK: [[DEQ8:%.+]] = VPU.Dequantize([[COPY_W8]]) {dstElemType = f16, vf_loop_index = 0 : i64, vf_loop_tile_index = 8 : i64}
    ...
    // CHECK: [[DEQ9:%.+]] = VPU.Dequantize([[COPY_W9]]) {dstElemType = f16, vf_loop_index = 0 : i64, vf_loop_tile_index = 9 : i64}
    ...
    // CHECK: [[DEQ10:%.+]] = VPU.Dequantize([[COPY_W10]]) {dstElemType = f16, vf_loop_index = 0 : i64, vf_loop_tile_index = 10 : i64}
    ...
    // CHECK: [[DEQ11:%.+]] = VPU.Dequantize([[COPY_W11]]) {dstElemType = f16, vf_loop_index = 0 : i64, vf_loop_tile_index = 11 : i64}
    ...
    // CHECK: [[DEQ12:%.+]] = VPU.Dequantize([[COPY_W12]]) {dstElemType = f16, vf_loop_index = 0 : i64, vf_loop_tile_index = 12 : i64}
    ...
    // CHECK: [[DEQ13:%.+]] = VPU.Dequantize([[COPY_W13]]) {dstElemType = f16, vf_loop_index = 0 : i64, vf_loop_tile_index = 13 : i64}
    ...
    // CHECK: [[DEQ14:%.+]] = VPU.Dequantize([[COPY_W14]]) {dstElemType = f16, vf_loop_index = 0 : i64, vf_loop_tile_index = 14 : i64}
    ...
    // CHECK: [[DEQ15:%.+]] = VPU.Dequantize([[COPY_W15]]) {dstElemType = f16, vf_loop_index = 0 : i64, vf_loop_tile_index = 15 : i64}
