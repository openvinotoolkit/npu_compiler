...
func.func @DynamicDequantize(%input: tensor<1x3x16x16x!qElemType>) -> tensor<1x3x16x16xf16> {
    ...
    %zp = const.Declare tensor<1x1x1x1xsi4> = dense<1.0> : tensor<1x1x1x1xf16>,
    ...
    // CHECK:       [[ZP:%.+]] = const.Declare tensor<1x1x1x1xsi4> = dense<1.000000e+00> : tensor<1x1x1x1xf16>, [#const.CastElemType<si4>]
...
// CHECK-SAME:     [[ZP:%.+]]: tensor<1x3x16x16xsi4>
func.func @DynamicDequantZPScaleArgs(%input: tensor<1x3x16x16x!qElemType>, %scale: tensor<1x3x1x1xf16>, %zp: tensor<1x3x16x16xsi4>) -> tensor<1x3x16x16xf16> {
