...
func.func nested @main_func0(%arg0: memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>,
    ...
    %0 = VPUIP.Copy inputs(%arg0 : memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>)
                    outputs(%arg1 : memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>)
       -> memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>
    %1 = VPUIP.Copy inputs(%arg1 : memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>)
                    outputs(%arg2 : memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>)
       -> memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>

    return %1 : memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>
}
...
func.func @main(%arg0: memref<1x720x1000x16xf16>, %arg1: memref<1x720x1000x16xf16>,
    ...
    scf.for %arg3 = %c0 to %c720 step %c90 {
      ...
      %subview_0 = memref.subview %arg1[0, %arg3, 0, 0] [1, 90, 1000, 16] [1, 1, 1, 1] : memref<1x720x1000x16xf16>
                 to memref<1x90x1000x16xf16, strided<[11520000, 16000, 16, 1], offset: ?>>
      %0 = memref.cast %subview
         : memref<1x90x1000x16xf16, strided<[11520000, 16000, 16, 1], offset: ?>> to memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>
      %1 = memref.cast %subview_0
         : memref<1x90x1000x16xf16, strided<[11520000, 16000, 16, 1], offset: ?>> to memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>
      %alloc_1 = memref.alloc() : memref<1x90x1000x16xf16>
      %alloc_1_cast = memref.cast %alloc_1 : memref<1x90x1000x16xf16> to memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>
      %2 = func.call @main_func0(%0, %1, %alloc_1_cast)
         : (memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>, memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>, memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>) -> memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>
      ...
      memref.copy %2, %subview_2 : memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>
          to memref<1x90x1000x16xf16, strided<[11520000, 16000, 16, 1], offset: ?>>
    }
...
module @ScheduleCopyFunction {
  ...
  func.func @main_func0_static(%arg0: memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>, %arg1: memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>, %arg2: memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>) -> memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>> {
    %1 = VPUIP.Copy inputs(%arg1 : memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>) outputs(%arg2 : memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>) -> memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>
    return %1 : memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>
  }
  func.func @main(%arg0: memref<1x?x1000x16xf16>, %arg1: memref<1x?x1000x16xf16>, %arg2: memref<1x?x1000x16xf16>) -> memref<1x?x1000x16xf16> {
    ...
    scf.for %arg3 = %c0 to %c1000 step %c90 {
      ...
      %3 = memref.cast %input0_subview : memref<1x90x1000x16xf16, strided<[?, 16000, 16, 1], offset: ?>> to memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>
      %4 = memref.cast %input1_subview : memref<1x90x1000x16xf16, strided<[?, 16000, 16, 1], offset: ?>> to memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>
      %tmp_buffer = memref.alloc() : memref<1x90x1000x16xf16>
      %tmp_buffer_cast = memref.cast %tmp_buffer : memref<1x90x1000x16xf16> to memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>
      %5 = func.call @main_func0_static(%3, %4, %tmp_buffer_cast) : (memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>, memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>, memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>) -> memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>
      ...
      memref.copy %5, %output_buf_subview : memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>> to memref<1x90x1000x16xf16, strided<[16000000, 16000, 16, 1], offset: ?>>
    }
    memref.copy %alloc, %arg2 : memref<1x1000x1000x16xf16> to memref<1x?x1000x16xf16>
    return %arg2 : memref<1x?x1000x16xf16>
  }

   // CHECK: func.func [[MAIN_FUNC0:@.+]]([[_:%.+]]: memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>, [[_:%.+]]: memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>, [[_:%.+]]: memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>) -> memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>> {
...
module @ScheduleCopyAndEltwiseFunctions {
  ...
  func.func @main_func1_static(%arg0: memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>, %arg1: memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>, %arg2: memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>) -> memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>> {
    %1 = VPUIP.SW.Kernel {resultSegmentSizes = array<i32: 1, 0, 0>} @VPU.SW::@builtin_Add
        inputs(%arg0 as %input_0: memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>, %arg1 as %input_1: memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>)
        outputs(%arg2 as %output: memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>) on tile 0 -> memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>> {
        VPUIP.SW.Kernel.run (%input_0, %input_1, %output) : memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>, memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>, memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>
    }
    return %1 : memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>
  }
  func.func @main(%arg0: memref<1x?x1000x16xf16>, %arg1: memref<1x?x1000x16xf16>, %arg2: memref<1x?x1000x16xf16>) -> memref<1x?x1000x16xf16> {
    ...
    scf.for %arg3 = %c0 to %c1000 step %c90 {
      ...
      %eltwise_input_static = memref.cast %eltwise_input : memref<1x90x1000x16xf16, strided<[16000000, 16000, 16, 1], offset: ?>> to memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>
      %6 = func.call @main_func1_static(%5, %eltwise_input_static, %tmp_buffer_cast) : (memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>, memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>, memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>) -> memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>
      ...
      memref.copy %6, %subview_3 : memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>> to memref<1x90x1000x16xf16, strided<[16000000, 16000, 16, 1], offset: ?>>
    }
   ...
   // CHECK: func.func [[MAIN_FUNC1:@.+]]([[_:%.+]]: memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>, [[_:%.+]]: memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>, [[_:%.+]]: memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>>) -> memref<1x90x1000x16xf16, strided<[?, ?, ?, ?], offset: ?>> {
   ...
   // CHECK:     [[IN0_SUBVIEW_STATIC:%.+]] = memref.cast [[IN0_SUBVIEW]]
   // CHECK:     [[IN1_SUBVIEW_STATIC:%.+]] = memref.cast [[IN1_SUBVIEW]]
   // CHECK:     [[OUTPUT_SUBVIEW:%.+]] = memref.subview [[ARG2]][0, [[ITER]], 0, 0]
   // CHECK:     [[OUTPUT_STATIC:%.+]] = memref.cast [[OUTPUT_SUBVIEW]]
   // CHECK:     [[COPY_OUTPUT:%.+]] = func.call [[MAIN_FUNC0]]([[IN0_SUBVIEW_STATIC]], [[IN1_SUBVIEW_STATIC]], [[OUTPUT_STATIC]])
   // CHECK:     [[ELTWISE_IN0_SUBVIEW:%.+]] = memref.subview [[ARG2]][0, [[ITER]], 0, 0]
   // CHECK:     [[ELTWISE_IN0_STATIC:%.+]] = memref.cast [[ELTWISE_IN0_SUBVIEW]]
...
func.func @main_func0_dims_H_cases_0_static(%arg0: memref<1x16x30x1280xf16, strided<[?, ?, ?, ?], offset: ?>>, %arg1: memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>) -> memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>> {
    return %arg1 : memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>
  }
func.func @main_func0_dims_H_cases_2_static(%arg0: memref<1x16x29x1280xf16, strided<[?, ?, ?, ?], offset: ?>>, %arg1: memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>) -> memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>> {
    return %arg1 : memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>
  }
func.func @main_func0_dims_H_cases_1_static(%arg0: memref<1x16x29x1280xf16, strided<[?, ?, ?, ?], offset: ?>>, %arg1: memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>) -> memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>> {
    return %arg1 : memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>
  }
func.func @CopiesInCasesOfIndexSwitch(%arg0: memref<1x16x?x1280xf16>, %arg1: memref<1x16x?x1280xf16>, %arg2: index, %arg3: index) -> memref<1x16x?x1280xf16> {
  ...
  scf.for %arg4 = %c0 to %dim step %c28 {
    %13 = scf.index_switch %arg2 -> memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>
    case 0 {
      ...
      %14 = memref.cast %subview_1 : memref<1x16x30x1280xf16, strided<[?, ?, 1280, 1], offset: ?>> to memref<1x16x30x1280xf16, strided<[?, ?, ?, ?], offset: ?>>
      %alloc_2 = memref.alloc() : memref<1x16x28x1280xf16>
      %alloc_2_cast = memref.cast %alloc_2 : memref<1x16x28x1280xf16> to memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>
      %15 = func.call @main_func0_dims_H_cases_0_static(%14, %alloc_2_cast) : (memref<1x16x30x1280xf16, strided<[?, ?, ?, ?], offset: ?>>, memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>) -> memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>
      scf.yield %15 : memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>
    }
    case 1 {
      ...
      %14 = memref.cast %subview_1 : memref<1x16x29x1280xf16, strided<[?, ?, 1280, 1], offset: ?>> to memref<1x16x29x1280xf16, strided<[?, ?, ?, ?], offset: ?>>
      %alloc_2 = memref.alloc() : memref<1x16x28x1280xf16>
      %alloc_2_cast = memref.cast %alloc_2 : memref<1x16x28x1280xf16> to memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>
      %15 = func.call @main_func0_dims_H_cases_1_static(%14, %alloc_2_cast) : (memref<1x16x29x1280xf16, strided<[?, ?, ?, ?], offset: ?>>, memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>) -> memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>
      scf.yield %15 : memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>
    }
    case 2 {
      %subview_1 = memref.subview %arg0[0, 0, %arg3, 0] [1, 16, 29, 1280] [1, 1, 1, 1] : memref<1x16x?x1280xf16> to memref<1x16x29x1280xf16, strided<[?, ?, 1280, 1], offset: ?>>
      ...
      %alloc_2 = memref.alloc() : memref<1x16x28x1280xf16>
      %alloc_2_cast = memref.cast %alloc_2 : memref<1x16x28x1280xf16> to memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>
      %15 = func.call @main_func0_dims_H_cases_2_static(%14, %alloc_2_cast) : (memref<1x16x29x1280xf16, strided<[?, ?, ?, ?], offset: ?>>, memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>) -> memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>
      scf.yield %15 : memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>
    }
    default {
    ...
    memref.copy %13, %subview : memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>> to memref<1x16x28x1280xf16, strided<[?, ?, 1280, 1], offset: ?>>
  }
  memref.copy %alloc, %arg1 : memref<1x16x?x1280xf16> to memref<1x16x?x1280xf16>
  return %arg1 : memref<1x16x?x1280xf16>

  // CHECK: func.func [[FUNC0:@.+]]([[ARG_0:%[^:]+]]: memref<1x16x30x1280xf16, strided<[?, ?, ?, ?], offset: ?>>, [[ARG_1:%[^:]+]]: memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>)
  // CHECK: func.func [[FUNC1:@.+]]([[ARG_0:%[^:]+]]: memref<1x16x29x1280xf16, strided<[?, ?, ?, ?], offset: ?>>, [[ARG_1:%[^:]+]]: memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>)
  // CHECK: func.func [[FUNC2:@.+]]([[ARG_0:%[^:]+]]: memref<1x16x29x1280xf16, strided<[?, ?, ?, ?], offset: ?>>, [[ARG_1:%[^:]+]]: memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>)
...
module @Module0 {
    func.func @main_func0_dims_H_cases_0_static(%arg0: memref<1x16x30x1280xf16, strided<[?, ?, ?, ?], offset: ?>>, %arg1: memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>)
        -> memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>> {
        return %arg1 : memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>
    }
}

module @Module1 {
    func.func @main_func0_dims_H_cases_1_static(%arg0: memref<1x16x29x1280xf16, strided<[?, ?, ?, ?], offset: ?>>, %arg1: memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>)
        -> memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>> {
        return %arg1 : memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>
    }
}
...
module @Module2 {
    func.func @main_func0_dims_H_cases_2_static(%arg0: memref<1x16x29x1280xf16, strided<[?, ?, ?, ?], offset: ?>>, %arg1: memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>)
        -> memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>> {
        return %arg1 : memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>
    }
}
...
func.func @CopiesInCasesOfIndexSwitchWithNestedCall(%arg0: memref<1x16x?x1280xf16>, %arg1: memref<1x16x?x1280xf16>, %arg2: index, %arg3: index) -> memref<1x16x?x1280xf16> {
  ...
  scf.for %arg4 = %c0 to %dim step %c28 {
    ...
    case 0 {
      ...
      %alloc_2 = memref.alloc() : memref<1x16x28x1280xf16>
      %alloc_2_cast = memref.cast %alloc_2 : memref<1x16x28x1280xf16> to memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>
      %15 = Core.NestedCall @Module0::@main_func0_dims_H_cases_0_static(%14, %alloc_2_cast)
          : (memref<1x16x30x1280xf16, strided<[?, ?, ?, ?], offset: ?>>, memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>) -> memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>
      scf.yield %15 : memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>
    }
    case 1 {
      %subview_1 = memref.subview %arg0[0, 0, %arg3, 0] [1, 16, 29, 1280] [1, 1, 1, 1] : memref<1x16x?x1280xf16> to memref<1x16x29x1280xf16, strided<[?, ?, 1280, 1], offset: ?>>
      ...
      %alloc_2 = memref.alloc() : memref<1x16x28x1280xf16>
      %alloc_2_cast = memref.cast %alloc_2 : memref<1x16x28x1280xf16> to memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>
      %15 = Core.NestedCall @Module1::@main_func0_dims_H_cases_1_static(%14, %alloc_2_cast)
          : (memref<1x16x29x1280xf16, strided<[?, ?, ?, ?], offset: ?>>, memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>) -> memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>
      scf.yield %15 : memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>
    }
    case 2 {
      %subview_1 = memref.subview %arg0[0, 0, %arg3, 0] [1, 16, 29, 1280] [1, 1, 1, 1] : memref<1x16x?x1280xf16> to memref<1x16x29x1280xf16, strided<[?, ?, 1280, 1], offset: ?>>
      ...
      %alloc_2 = memref.alloc() : memref<1x16x28x1280xf16>
      %alloc_2_cast = memref.cast %alloc_2 : memref<1x16x28x1280xf16> to memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>
      %15 = Core.NestedCall @Module2::@main_func0_dims_H_cases_2_static(%14, %alloc_2_cast)
          : (memref<1x16x29x1280xf16, strided<[?, ?, ?, ?], offset: ?>>, memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>) -> memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>
      scf.yield %15 : memref<1x16x28x1280xf16, strided<[?, ?, ?, ?], offset: ?>>
    }
    default {
