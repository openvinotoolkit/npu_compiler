...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform%" --optimize-barriers-slots-usage %s | FileCheck %s
// REQUIRES: platform-NPU4000 || platform-NPU5010

#NHWC = affine_map<(d0, d1, d2, d3) -> (d0, d2, d3, d1)>

func.func @OptimizeRedundantProducerAndConsumer() -> memref<1x16x8x32xf16, {order = #NHWC}, [@CMX_NN, 0]> {
