...
// RUN: vpux-opt  --split-input-file --init-compiler="platform=%platform% allow-custom-values=true" --insert-barrier-to-mark-end-of-descriptor-group --canonicalize %s | FileCheck %s
