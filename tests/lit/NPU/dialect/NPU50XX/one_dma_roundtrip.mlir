        ...
        NPUReg50XX.NNDMA descriptor = <
          DMARegister {
            ...
            dma_cfg_fields {
              ...
              UINT dma_cfg_fields_hwp_skip = 0,
              UINT dma_cfg_fields_reserved = 0,
            }
            dma_remote_width_fetch = UINT 0x30,
            dma_width {
            ...
            dma_acc_info_decompress {
              ...
              UINT dma_acc_info_decompress_bitmap_buf_sz = 0,
...
// CHECK: NPUReg50XX.NNDMA descriptor = <
// CHECK: DMARegister {
// CHECK: dma_watermark {
...
// CHECK: UINT dma_cfg_fields_hwp_skip = 0,
...
// CHECK: UINT dma_acc_info_decompress_bitmap_buf_sz = 0,
