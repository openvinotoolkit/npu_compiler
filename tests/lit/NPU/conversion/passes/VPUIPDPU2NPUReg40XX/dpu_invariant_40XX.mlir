...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform%" --convert-VPUIPDPU-to-NPUReg40XX %s | FileCheck %s
            ...
            // CHECK:       NPUReg40XX.DPUInvariant
                ...
                DPUCfg : {
                    ...
                    VPUIPDPU.PPECfg {
                        ...
                        VPUIPDPU.PPEFpScalePreluMult %weight_table:memref<16x1x1x1xi64, {order = #NHWC}, [@CMX_NN, 0]> prelu_alpha(0.1)
