...
module @spaceToDepth {
  ...
  func.func @main(%arg0: memref<1x4x6x12xf16, {order = #NHWC}>, %arg1: memref<1x16x3x6xf16, {order = #NHWC}>) -> memref<1x16x3x6xf16, {order = #NHWC}> {
    ...
    %3 = VPURT.DeclareBuffer <CMX_NN> [0] <0> -> memref<1x4x6x12xf16, {order = #NHWC}, [@CMX_NN, 0]>
    ...
    %6 = VPURT.DeclareBuffer <CMX_NN> [0] <1024> -> memref<1x16x3x6xf16, {order = #NHWC}, [@CMX_NN, 0]>
    ...
    //CHECK:    [[INPUT_BUFFER_0:%.+]] = VPURT.DeclareBuffer <CMX_NN> [0] <0> -> memref<1x4x6x12xf16, {order = #NHWC}, [@CMX_NN, 0]>
    ...
    //CHECK:    [[OUTPUT_BUFFER_0:%.+]] = VPURT.DeclareBuffer <CMX_NN> [0] <1024> -> memref<1x16x3x6xf16, {order = #NHWC}, [@CMX_NN, 0]>
    ...
    VPURT.Task updates(%0 : !VPURT.Barrier) {
      %9 = VPUIP.NNDMA <{port = 0 : i64}> inputs(%arg0 : memref<1x4x6x12xf16, {order = #NHWC}>) outputs(%3 : memref<1x4x6x12xf16, {order = #NHWC}, [@CMX_NN, 0]>) -> memref<1x4x6x12xf16, {order = #NHWC}, [@CMX_NN, 0]>
    }
    ...
    //CHECK-SAME:         inputType = memref<1x4x6x12xf16, {order = #NHWC}>
    //CHECK-SAME:         outputType = memref<1x4x6x12xf16, {order = #NHWC}, [@CMX_NN, 0]>
    ...
    VPURT.Task waits(%1 : !VPURT.Barrier) updates(%2 : !VPURT.Barrier) {
      %9 = VPUIP.NNDMA <{port = 0 : i64}> inputs(%6 : memref<1x16x3x6xf16, {order = #NHWC}, [@CMX_NN, 0]>) outputs(%arg1 : memref<1x16x3x6xf16, {order = #NHWC}>) -> memref<1x16x3x6xf16, {order = #NHWC}>
    }
    ...
    //CHECK-SAME: dma_transaction
    //CHECK-SAME:     #VPUMI40XX.NNDMATransaction
    //CHECK-SAME:         inputType = memref<1x16x3x6xf16, {order = #NHWC}, [@CMX_NN, 0]>
    //CHECK-SAME:         outputType = memref<1x16x3x6xf16, {order = #NHWC}>
