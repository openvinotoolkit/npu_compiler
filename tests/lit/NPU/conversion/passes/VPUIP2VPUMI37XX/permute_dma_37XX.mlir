...
// CHECK-DAG: [[BUF_0:%.+]] = VPURT.DeclareBuffer <NetworkInput> [0] <0> -> memref<16x256xf16, @DDR>
// CHECK-DAG: [[BUF_1:%.+]] = VPURT.DeclareBuffer <NetworkOutput> [0] <0> -> memref<256x16xf16, @DDR>
// CHECK-NOT: VPUIP.NNDMA
// CHECK: [[VAL5:%.+]] = VPUMI37XX.NNDMA <{port = 0 : i64}> inputs([[BUF_0]] : memref<16x256xf16, @DDR>) outputs([[BUF_0]] : memref<16x256xf16, @DDR>) start_after(0) clean_after(0) acceleration_mode(<DISABLE>) -> !VPURegMapped.Index<0:0:5>
// CHECK-NOT: VPUIP.NNDMA
// CHECK: [[VAL4:%.+]] = VPUMI37XX.NNDMA <{port = 0 : i64}> inputs([[BUF_0]] : memref<16x256xf16, @DDR>) outputs([[BUF_0]] : memref<16x256xf16, @DDR>) nextDMAIdx([[VAL5]] : !VPURegMapped.Index<0:0:5>) start_after(0) clean_after(0) acceleration_mode(<DISABLE>) -> !VPURegMapped.Index<0:0:4>
// CHECK-NOT: VPUIP.PermuteDMA
// CHECK: [[VAL3:%.+]] = VPUMI37XX.NNDMA <{dma_descriptor = #VPUIP.DMADescriptorAttr<numPlanes = 16 : i64, len = 512 : i64, srcWidth = 512 : i64, srcStride = 2 : i64, srcPlaneStride = 512 : i64, dstWidth = 2 : i64, dstStride = 32 : i64, dstPlaneStride = 2 : i64>, port = 0 : i64}> inputs([[BUF_0]] : memref<16x256xf16, @DDR>) outputs([[BUF_1]] : memref<256x16xf16, @DDR>) nextDMAIdx([[VAL4]] : !VPURegMapped.Index<0:0:4>) start_after(0) clean_after(0) acceleration_mode(<DISABLE>) -> !VPURegMapped.Index<0:0:3>
// CHECK-NOT: VPUIP.PermuteDMA
// CHECK: [[VAL2:%.+]] = VPUMI37XX.NNDMA <{dma_descriptor = #VPUIP.DMADescriptorAttr<numPlanes = 16 : i64, len = 512 : i64, srcWidth = 512 : i64, srcStride = 2 : i64, srcPlaneStride = 512 : i64, dstWidth = 2 : i64, dstStride = 32 : i64, dstPlaneStride = 2 : i64>, port = 0 : i64}> inputs([[BUF_0]] : memref<16x256xf16, @DDR>) outputs([[BUF_1]] : memref<256x16xf16, @DDR>) nextDMAIdx([[VAL3]] : !VPURegMapped.Index<0:0:3>) start_after(0) clean_after(0) acceleration_mode(<DISABLE>) -> !VPURegMapped.Index<0:0:2>
// CHECK-NOT: VPUIP.NNDMA
// CHECK: [[VAL1:%.+]] = VPUMI37XX.NNDMA <{port = 0 : i64}> inputs([[BUF_0]] : memref<16x256xf16, @DDR>) outputs([[BUF_0]] : memref<16x256xf16, @DDR>) nextDMAIdx([[VAL2]] : !VPURegMapped.Index<0:0:2>) start_after(0) clean_after(0) acceleration_mode(<DISABLE>) -> !VPURegMapped.Index<0:0:1>
// CHECK-NOT: VPUIP.NNDMA
// CHECK: [[VAL0:%.+]] = VPUMI37XX.NNDMA <{port = 0 : i64}> inputs([[BUF_0]] : memref<16x256xf16, @DDR>) outputs([[BUF_0]] : memref<16x256xf16, @DDR>) nextDMAIdx([[VAL1]] : !VPURegMapped.Index<0:0:1>) start_after(0) clean_after(0) acceleration_mode(<DISABLE>) -> !VPURegMapped.Index<0:0:0>
...
// CHECK: [[BUF_0:%.+]] = VPURT.DeclareBuffer <NetworkInput> [0] <0> -> memref<16x256xf16, @DDR>
// CHECK: [[BUF_1:%.+]] = VPURT.DeclareBuffer <NetworkOutput> [0] <0> -> memref<256x16xf16, @DDR>
// CHECK-NOT: VPUIP.PermuteDMA
// CHECK: [[VAL5:%.+]] = VPUMI37XX.NNDMA <{dma_descriptor = #VPUIP.DMADescriptorAttr<numPlanes = 16 : i64, len = 512 : i64, srcWidth = 512 : i64, srcStride = 2 : i64, srcPlaneStride = 512 : i64, dstWidth = 2 : i64, dstStride = 32 : i64, dstPlaneStride = 2 : i64>, port = 0 : i64}> inputs([[BUF_0]] : memref<16x256xf16, @DDR>) outputs([[BUF_1]] : memref<256x16xf16, @DDR>) start_after(0) clean_after(0) acceleration_mode(<DISABLE>) -> !VPURegMapped.Index<0:0:5>
// CHECK-NOT: VPUIP.PermuteDMA
// CHECK: [[VAL4:%.+]] = VPUMI37XX.NNDMA <{dma_descriptor = #VPUIP.DMADescriptorAttr<numPlanes = 16 : i64, len = 512 : i64, srcWidth = 512 : i64, srcStride = 2 : i64, srcPlaneStride = 512 : i64, dstWidth = 2 : i64, dstStride = 32 : i64, dstPlaneStride = 2 : i64>, port = 0 : i64}> inputs([[BUF_0]] : memref<16x256xf16, @DDR>) outputs([[BUF_1]] : memref<256x16xf16, @DDR>) nextDMAIdx([[VAL5]] : !VPURegMapped.Index<0:0:5>) start_after(0) clean_after(0) acceleration_mode(<DISABLE>) -> !VPURegMapped.Index<0:0:4>
// CHECK-NOT: VPUIP.NNDMA
// CHECK: [[VAL3:%.+]] = VPUMI37XX.NNDMA <{port = 0 : i64}> inputs([[BUF_0]] : memref<16x256xf16, @DDR>) outputs([[BUF_0]] : memref<16x256xf16, @DDR>) nextDMAIdx([[VAL4]] : !VPURegMapped.Index<0:0:4>) start_after(0) clean_after(0) acceleration_mode(<DISABLE>) -> !VPURegMapped.Index<0:0:3>
// CHECK-NOT: VPUIP.NNDMA
// CHECK: [[VAL2:%.+]] = VPUMI37XX.NNDMA <{port = 0 : i64}> inputs([[BUF_0]] : memref<16x256xf16, @DDR>) outputs([[BUF_0]] : memref<16x256xf16, @DDR>) nextDMAIdx([[VAL3]] : !VPURegMapped.Index<0:0:3>) start_after(0) clean_after(0) acceleration_mode(<DISABLE>) -> !VPURegMapped.Index<0:0:2>
// CHECK-NOT: VPUIP.PermuteDMA
// CHECK: [[VAL1:%.+]] = VPUMI37XX.NNDMA <{dma_descriptor = #VPUIP.DMADescriptorAttr<numPlanes = 16 : i64, len = 512 : i64, srcWidth = 512 : i64, srcStride = 2 : i64, srcPlaneStride = 512 : i64, dstWidth = 2 : i64, dstStride = 32 : i64, dstPlaneStride = 2 : i64>, port = 0 : i64}> inputs([[BUF_0]] : memref<16x256xf16, @DDR>) outputs([[BUF_1]] : memref<256x16xf16, @DDR>) nextDMAIdx([[VAL2]] : !VPURegMapped.Index<0:0:2>) start_after(0) clean_after(0) acceleration_mode(<DISABLE>) -> !VPURegMapped.Index<0:0:1>
// CHECK-NOT: VPUIP.PermuteDMA
// CHECK: [[VAL0:%.+]] = VPUMI37XX.NNDMA <{dma_descriptor = #VPUIP.DMADescriptorAttr<numPlanes = 16 : i64, len = 512 : i64, srcWidth = 512 : i64, srcStride = 2 : i64, srcPlaneStride = 512 : i64, dstWidth = 2 : i64, dstStride = 32 : i64, dstPlaneStride = 2 : i64>, port = 0 : i64}> inputs([[BUF_0]] : memref<16x256xf16, @DDR>) outputs([[BUF_1]] : memref<256x16xf16, @DDR>) nextDMAIdx([[VAL1]] : !VPURegMapped.Index<0:0:1>) start_after(0) clean_after(0) acceleration_mode(<DISABLE>) -> !VPURegMapped.Index<0:0:0>
