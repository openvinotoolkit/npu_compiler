...
// CHECK:  ELF.CreateSection @info.compiler.hash aligned(64) secType(VPU_SHT_COMPILER_HASH) secFlags("SHF_NONE") secLocation(<DDR>) {
// CHECK-NEXT:    ELF.CompilerHash("0123456789abcdef0123456789abcdef01234567") {sym_name = "CompilerHash"}
