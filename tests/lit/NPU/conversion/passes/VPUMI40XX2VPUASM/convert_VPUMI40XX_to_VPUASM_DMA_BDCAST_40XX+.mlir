...
config.Resources 1 of @NCE at 6.000000e+02 MHz
  ...
  func.func nested @dma_broadcast() {
    ...
    %2316 = VPUMI40XX.NNDMA <{port = 0 : i64}> taskLocation(%352 : !VPURegMapped.Index<0:1:0>) inputs(%2311 : memref<16x32x1x1xf16, {order = #NHWC}, [@CMX_NN, 0]>) outputs(%2305 : memref<16x32x1x1xf16, {order = #NHWC}, @DDR>) start_after(1) clean_after(1) acceleration_mode(<DISABLE>) -> !VPURegMapped.Index<0:1:0>
