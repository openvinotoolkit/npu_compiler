...
module @age_gender attributes {config.compilationMode = #config.compilation_mode<DefaultHW>} {
  VPURT.SW.Runtime entryPoint : @VPU.SW::@runtime stack_configuration : [4096, 4096, 4096, 4096] loc(#loc0)
  module @VPU.SW {
    func.func nested @builtin_MemPermute(memref<*xf16, [@CMX_NN, 0]>, memref<*xf16, [@CMX_NN, 0]>, none) attributes {VPU.kernel_code = "reorder.cpp", VPU.kernel_entry = "reorder"} loc(#loc0)
    func.func nested @builtin_Convert(memref<*xf32, [@CMX_NN, 0]>, memref<*xf16, [@CMX_NN, 0]>) attributes {VPU.kernel_code = "convert.cpp", VPU.kernel_entry = "convert"} loc(#loc0)
    func.func nested @runtime() attributes {VPU.kernel_code = "nnActEntry"} loc(#loc0)
  } loc(#loc0)
  ...
  func.func @main(%arg0: memref<1x3x62x62xf32, @DDR> loc(unknown), %arg1: memref<1x48x30x30xf32, @DDR> loc(unknown), %arg2: memref<76xui32> loc("profiling_result")) -> (memref<1x48x30x30xf32, @DDR>, memref<76xui32>) {
    ...
    %cst_0 = const.Declare memref<48x3x3x3xf16, {order = #NHWC}> = dense<""> : tensor<48x3x3x3xf16, {order = #NHWC}> loc(#loc4)
    ...
    %23 = VPURT.DeclareBuffer <CMX_NN> [0] <256> -> memref<1x16x32x62xf16, {order = #NHWC}, [@CMX_NN, 0]> loc(#loc10)
    %24 = VPURT.DeclareBuffer <CMX_NN> [1] <256> -> memref<1x16x30x62xf16, {order = #NHWC}, [@CMX_NN, 1]> loc(#loc11)
    ...
    %29 = VPURT.DeclareBuffer <CMX_NN> [0] <72640> -> memref<1x48x30x60xf16, {order = #NHWC}, [@CMX_NN, 0]> loc(#loc14)
    %30 = VPURT.DeclareBuffer <CMX_NN> [1] <72640> -> memref<1x48x30x60xf16, {order = #NHWC}, [@CMX_NN, 1]> loc(#loc15)
    %31 = VPURT.DeclareBuffer <CMX_NN> [0] <72640> -> memref<1x48x30x60xf16, {order = #NHWC}, [@CMX_NN, 0]> loc(#loc16)
    %32 = VPURT.DeclareBuffer <CMX_NN> [1] <72640> -> memref<1x48x30x60xf16, {order = #NHWC}, [@CMX_NN, 1]> loc(#loc17)
    ...
    %47 = VPURT.DeclareBuffer <CMX_NN> [0] <69504> -> memref<48x16x3x3xf16, {order = #NHWC}, [@CMX_NN, 0]> loc(#loc25)
    %48 = VPURT.DeclareBuffer <CMX_NN> [1] <69504> -> memref<48x16x3x3xf16, {order = #NHWC}, [@CMX_NN, 1]> loc(#loc26)
    ...
    VPURT.Task attributes {isTrailingSWLayer = false} {
      %109 = VPUIP.NNDMA <{port = 1 : i64}> inputs(%cst_0 : memref<48x3x3x3xf16, {order = #NHWC}>) outputs(%33 : !VPUIP.DistributedBuffer<48x3x3x3xf16, {order = #NHWC, strides = [32, 1, 9, 3]}, @CMX_NN, {mode = "DUPLICATED", num_clusters = 2 : i64}>) -> !VPUIP.DistributedBuffer<48x3x3x3xf16, {order = #NHWC, strides = [32, 1, 9, 3]}, @CMX_NN, {mode = "DUPLICATED", num_clusters = 2 : i64}> loc(#loc59)
    } loc(#loc59)
    VPURT.Task {
    ...
    VPURT.Task waits(%3 : !VPURT.Barrier) updates(%4 : !VPURT.Barrier) attributes {isTrailingSWLayer = false} {
      %109:2 = VPUIP.NCEClusterTask {resultSegmentSizes = array<i32: 1, 0, 1, 0, 0, 0>}
      <{cm_sp_pattern = 7 : i64, is_segmented, kernel_padding = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, kernel_size = [3, 3], kernel_strides = [1, 1], task_type = #VPUIP.nce_task_type<CONV>}> input(%23 : memref<1x16x32x62xf16, {order = #NHWC}, [@CMX_NN, 0]>) weights(%47 : memref<48x16x3x3xf16, {order = #NHWC}, [@CMX_NN, 0]>) weight_table(%25 : memref<48x1x1x4xsi32, [@CMX_NN, 0]>) parent_input(%20 : !VPUIP.DistributedBuffer<1x16x62x62xf16, #NHWC, @CMX_NN, {mode = "SEGMENTED", num_tiles = [1, 1, 2, 1], num_clusters = 2 : i64, alignment = [1, 1, 2, 1]}>) parent_output(%28 : !VPUIP.DistributedBuffer<1x48x60x60xf16, #NHWC, @CMX_NN, {mode = "SEGMENTED", num_tiles = [1, 1, 2, 1], num_clusters = 2 : i64}>) outputs(%31 : memref<1x48x30x60xf16, {order = #NHWC}, [@CMX_NN, 0]>) profiling_data(%49 : memref<2xui64, [@CMX_NN, 0]>) -> memref<1x48x30x60xf16, {order = #NHWC}, [@CMX_NN, 0]>, memref<2xui64, [@CMX_NN, 0]> variants : {
