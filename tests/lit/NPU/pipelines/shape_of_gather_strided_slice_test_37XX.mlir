...
// CHECK-SAME:      -> tensor<?x3xsi64, {bounds = #const.OpaqueI64Elements<[5, 3]> : tensor<2xsi64>, order = #NC}>
...
// CHECK-SAME:      -> tensor<?xf32, {bounds = #const.OpaqueI64Elements<[9]> : tensor<1xsi64>, order = #C}>
